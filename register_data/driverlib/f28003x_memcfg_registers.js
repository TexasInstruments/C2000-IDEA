let MEMCFG_REGISTERS = [
	...
	{ name: "MHICWRAVADDR", description: "(0 <= i < 2) Master  HIC Write Access Violation Address", offset: "(0x2E + ((i) * 0x2))", count: "2", size: "16",
		bits: [
		]
	},
	{ name: "NMHICRDAVADDR", description: "Non-Master HIC Read Access Violation Address", offset: "0x3C", size: "16",
		bits: [
		]
	},
	{ name: "NMHICWRAVADDR", description: "Non-Master HIC Write Access Violation Address", offset: "0x3E", size: "16",
		bits: [
		]
	},
	...
	{ name: "UCHICAREADDR", description: "Uncorrectable HICA Read Error Address", offset: "0x10", size: "16",
		bits: [
		]
	},
	...
	{ name: "CHICREADDR", description: "Correctable HIC Read Error Address", offset: "0x3A", size: "16",
		bits: [
		]
	},
