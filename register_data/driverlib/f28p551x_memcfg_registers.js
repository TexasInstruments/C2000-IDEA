let MEMCFG_REGISTERS = [
	...
	{ name: "NMAVCLR", description: "Non-Controller Access Violation Flag Clear Register", offset: "0x4", size: "16",
		bits: [
			...
			{ name: "NPUWRITE", description: "Non Controller NPU Write Access Violation Flag Clear", size: "1", shift: "12", mask: "0x1000" },
		]
	},
	{ name: "NMAVINTEN", description: "Non-Controller Access Violation Interrupt Enable Register", offset: "0x6", size: "16",
		bits: [
			...
			{ name: "NPUREAD", description: "Non Controller NPU Read Access Violation Interrupt Enable", size: "1", shift: "11", mask: "0x800" },
			{ name: "NPUWRITE", description: "Non Controller NPU Write Violation Interrupt Enable", size: "1", shift: "12", mask: "0x1000" },
		]
	},
	...
	{ name: "NMNPURDAVADDR", description: "Non-Controller NPU Read Access Violation Address", offset: "0x3A", size: "16",
		bits: [
		]
	},
	{ name: "NMNPUWRAVADDR", description: "Non-Controller NPU Write Access Violation Address", offset: "0x3C", size: "16",
		bits: [
		]
	},
	...
	{ name: "UCNPUREADDR", description: "Uncorrectable NPU Read Error Address", offset: "0x10", size: "16",
		bits: [
		]
	},
