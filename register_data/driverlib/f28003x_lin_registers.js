let LIN_REGISTERS = [
	{ name: "SCIGCR0", description: "Global Control Register 0", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "SCIGCR1", description: "Global Control Register 1", offset: "0x4", size: "32",
		bits: [
			...
			{ name: "CLK_COMMANDER", description: "LIN Master/Slave selection and SCI clock enable", size: "1", shift: "5", mask: "0x20" },
	...
	{ name: "SCIGCR2", description: "Global Control Register 2", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "SCISETINTLVL", description: "Set Interrupt Level Register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "SCICLEARINTLVL", description: "Clear Interrupt Level Register", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "SCIINTVECT0", description: "Interrupt Vector Offset Register 0", offset: "0x20", size: "16",
		bits: [
			{ name: "INTVECT0", description: "LIN Module reset bit", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "SCIINTVECT1", description: "Interrupt Vector Offset Register 1", offset: "0x24", size: "16",
		bits: [
			{ name: "INTVECT1", description: "LIN Module reset bit", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "SCIFORMAT", description: "Length Control Register", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "SCIED", description: "Emulation buffer Register", offset: "0x30", size: "16",
		bits: [
			{ name: "ED", description: "Receiver Emulation Data.", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SCIRD", description: "Receiver data buffer Register", offset: "0x34", size: "16",
		bits: [
			{ name: "RD", description: "Received Data.", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SCITD", description: "Transmit data buffer Register", offset: "0x38", size: "16",
		bits: [
			{ name: "TD", description: "Transmit data", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SCIPIO0", description: "Pin control Register 0", offset: "0x3C", size: "16",
		bits: [
	...
	{ name: "SCIPIO2", description: "Pin control Register 2", offset: "0x44", size: "16",
		bits: [
	...
	{ name: "COMP", description: "Compare register", offset: "0x60", size: "16",
		bits: [
	...
	{ name: "RD0", description: "Receive data register 0", offset: "0x64", size: "32",
		bits: [
	...
	{ name: "RD1", description: "Receive data register 1", offset: "0x68", size: "32",
		bits: [
	...
	{ name: "MASK", description: "Acceptance mask register", offset: "0x6C", size: "16",
		bits: [
	...
	{ name: "ID", description: "LIN ID Register", offset: "0x70", size: "32",
		bits: [
			{ name: "IDBYTE", description: "LIN message ID (LIN only)", size: "8", shift: "0", mask: "0xFF" },
			{ name: "IDRESPONDERTASKBYTE", description: "ID  Slave Task byte (LIN only)", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "RECEIVEDID", description: "Current Message ID (LIN only)", size: "8", shift: "16", mask: "0xFF0000" },
		]
	},
	{ name: "TD0", description: "Transmit Data Register 0", offset: "0x74", size: "32",
		bits: [
	...
	{ name: "TD1", description: "Transmit Data Register 1", offset: "0x78", size: "32",
		bits: [
	...
	{ name: "MBRSR", description: "Maximum Baud Rate Selection Register", offset: "0x7C", size: "16",
		bits: [
	...
	{ name: "GLB_INT_EN", description: "LIN Global Interrupt Enable Register", offset: "0xE0", size: "16",
		bits: [
	...
	{ name: "GLB_INT_FLG", description: "LIN Global Interrupt Flag Register", offset: "0xE4", size: "16",
		bits: [
	...
	{ name: "GLB_INT_CLR", description: "LIN Global Interrupt Clear Register", offset: "0xE8", size: "16",
		bits: [
