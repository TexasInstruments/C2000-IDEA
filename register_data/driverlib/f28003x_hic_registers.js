let HIC_REGISTERS = [
	{ name: "REV", description: "Module Revision Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "GCR", description: "Global Control Register", offset: "0x2", size: "16",
		bits: [
			{ name: "HICEN", description: "Host Interface Enable", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "LOCK", description: "Lock Register", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "MODECR", description: "Mode Control Register", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "PINPOLCR", description: "Pin Polarity Control Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "BASESEL", description: "Base Select Register", offset: "0xA", size: "16",
		bits: [
			{ name: "BASE_SELECT", description: "Base Select", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "HOSTCR", description: "HIC Host Control Register", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "ERRADDR", description: "Host Error Address register", offset: "0xE", size: "32",
		bits: [
	...
	{ name: "H2DTOKEN", description: "Host to Device Token Register", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "D2HTOKEN", description: "Devie to Host Token Register", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "DBADDR0", description: "Device Base Address Register 0", offset: "0x14", size: "32",
		bits: [
			{ name: "BASE_ADDR", description: "Base address of device region", size: "25", shift: "7", mask: "0xFFFFFF80" },
		]
	},
	{ name: "DBADDR1", description: "Device Base Address Register 1", offset: "0x16", size: "32",
		bits: [
			{ name: "BASE_ADDR", description: "Base address of device region", size: "25", shift: "7", mask: "0xFFFFFF80" },
		]
	},
	{ name: "DBADDR2", description: "Device Base Address Register 2", offset: "0x18", size: "32",
		bits: [
			{ name: "BASE_ADDR", description: "Base address of device region", size: "25", shift: "7", mask: "0xFFFFFF80" },
		]
	},
	{ name: "DBADDR3", description: "Device Base Address Register 3", offset: "0x1A", size: "32",
		bits: [
			{ name: "BASE_ADDR", description: "Base address of device region", size: "25", shift: "7", mask: "0xFFFFFF80" },
		]
	},
	{ name: "DBADDR4", description: "Device Base Address Register 4", offset: "0x1C", size: "32",
		bits: [
			{ name: "BASE_ADDR", description: "Base address of device region", size: "25", shift: "7", mask: "0xFFFFFF80" },
		]
	},
	{ name: "DBADDR5", description: "Device Base Address Register 5", offset: "0x1E", size: "32",
		bits: [
			{ name: "BASE_ADDR", description: "Base address of device region", size: "25", shift: "7", mask: "0xFFFFFF80" },
		]
	},
	{ name: "DBADDR6", description: "Device Base Address Register 6", offset: "0x20", size: "32",
		bits: [
			{ name: "BASE_ADDR", description: "Base address of device region", size: "25", shift: "7", mask: "0xFFFFFF80" },
		]
	},
	{ name: "DBADDR7", description: "Device Base Address Register 7", offset: "0x22", size: "32",
		bits: [
			{ name: "BASE_ADDR", description: "Base address of device region", size: "25", shift: "7", mask: "0xFFFFFF80" },
		]
	},
	{ name: "H2DINTEN", description: "H2D Interrupt Enable", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "H2DINTFLG", description: "H2D Interrupt status Flag", offset: "0x2A", size: "16",
		bits: [
	...
	{ name: "H2DINTCLR", description: "H2D Interrupt status Clear", offset: "0x2C", size: "16",
		bits: [
	...
	{ name: "H2DINTFRC", description: "H2D Interrupt Set Force", offset: "0x2E", size: "16",
		bits: [
	...
	{ name: "D2HINTEN", description: "D2H Interrupt Enable", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "D2HINTFLG", description: "D2H Interrupt status Flag", offset: "0x32", size: "32",
		bits: [
	...
	{ name: "D2HINTCLR", description: "D2H Interrupt status Clear", offset: "0x34", size: "32",
		bits: [
	...
	{ name: "D2HINTFRC", description: "D2H Interrupt Set Force", offset: "0x36", size: "32",
		bits: [
	...
	{ name: "ACCVIOADDR", description: "Access Violation Address", offset: "0x38", size: "16",
		bits: [
		]
	},
	{ name: "COMMIT", description: "Commit Register", offset: "0x3A", size: "32",
		bits: [
			{ name: "COMMIT", description: "Commit bit for the HICLOCK register", size: "1", shift: "0", mask: "0x1" },
			{ name: "WRITE_ENABLE_KEY", description: "Key for enabling write", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "H2D_BUF0", description: "Host to Device Buffer 0", offset: "0x40", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF1", description: "Host to Device Buffer 1", offset: "0x42", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF2", description: "Host to Device Buffer 2", offset: "0x44", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF3", description: "Host to Device Buffer 3", offset: "0x46", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF4", description: "Host to Device Buffer 4", offset: "0x48", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF5", description: "Host to Device Buffer 5", offset: "0x4A", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF6", description: "Host to Device Buffer 6", offset: "0x4C", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF7", description: "Host to Device Buffer 7", offset: "0x4E", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF8", description: "Host to Device Buffer 8", offset: "0x50", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF9", description: "Host to Device Buffer 9", offset: "0x52", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF10", description: "Host to Device Buffer 10", offset: "0x54", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF11", description: "Host to Device Buffer 11", offset: "0x56", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF12", description: "Host to Device Buffer 12", offset: "0x58", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF13", description: "Host to Device Buffer 13", offset: "0x5A", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF14", description: "Host to Device Buffer 14", offset: "0x5C", size: "16",
		bits: [
		]
	},
	{ name: "H2D_BUF15", description: "Host to Device Buffer 15", offset: "0x5E", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF0", description: "Device to Host Buffer 0", offset: "0x60", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF1", description: "Device to Host Buffer 1", offset: "0x62", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF2", description: "Device to Host Buffer 2", offset: "0x64", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF3", description: "Device to Host Buffer 3", offset: "0x66", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF4", description: "Device to Host Buffer 4", offset: "0x68", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF5", description: "Device to Host Buffer 5", offset: "0x6A", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF6", description: "Device to Host Buffer 6", offset: "0x6C", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF7", description: "Device to Host Buffer 7", offset: "0x6E", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF8", description: "Device to Host Buffer 8", offset: "0x70", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF9", description: "Device to Host Buffer 9", offset: "0x72", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF10", description: "Device to Host Buffer 10", offset: "0x74", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF11", description: "Device to Host Buffer 11", offset: "0x76", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF12", description: "Device to Host Buffer 12", offset: "0x78", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF13", description: "Device to Host Buffer 13", offset: "0x7A", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF14", description: "Device to Host Buffer 14", offset: "0x7C", size: "16",
		bits: [
		]
	},
	{ name: "D2H_BUF15", description: "Device to Host Buffer 15", offset: "0x7E", size: "16",
		bits: [
		]
	},
];
