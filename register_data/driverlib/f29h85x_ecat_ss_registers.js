let ECAT_SS_REGISTERS = [
	{ name: "ESCSS_IPREVNUM", description: "IP Revision Number", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "ESCSS_INTR_RIS", description: "EtherCATSS Interrupt Raw Status", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "ESCSS_INTR_MASK", description: "EtherCATSS Interrupt Mask", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "ESCSS_INTR_MIS", description: "EtherCATSS Masked Interrupt Status", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "ESCSS_INTR_CLR", description: "EtherCATSS Interrupt Clear", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "ESCSS_INTR_SET", description: "EtherCATSS Interrupt Set to emulate", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "ESCSS_LATCH_SEL", description: "Select for Latch0/1 inputs and LATCHIN input", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "ESCSS_ACCESS_CTRL", description: "PDI interface access control config.", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "ESCSS_GPIN_DAT", description: "GPIN data capture for debug & override", offset: "0x20", size: "16",
		bits: [
		]
	},
	{ name: "ESCSS_GPIN_PIPE", description: "GPIN pipeline select", offset: "0x24", size: "16",
		bits: [
		]
	},
	{ name: "ESCSS_GPIN_GRP_CAP_SEL", description: "GPIN pipe group capture trigger", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "ESCSS_GPOUT_DAT", description: "GPOUT data capture for debug & override", offset: "0x2C", size: "16",
		bits: [
		]
	},
	{ name: "ESCSS_GPOUT_PIPE", description: "GPOUT pipeline select", offset: "0x30", size: "16",
		bits: [
		]
	},
	{ name: "ESCSS_GPOUT_GRP_CAP_SEL", description: "GPOUT pipe group capture trigger", offset: "0x34", size: "16",
		bits: [
	...
	{ name: "ESCSS_MEM_TEST", description: "Memory Test Control", offset: "0x38", size: "16",
		bits: [
	...
	{ name: "ESCSS_RESET_DEST_CONFIG", description: "ResetOut impact or destination config", offset: "0x3C", size: "16",
		bits: [
	...
	{ name: "ESCSS_SYNC0_CONFIG", description: "SYNC0 Configuration for various triggers", offset: "0x40", size: "16",
		bits: [
			{ name: "CPUX_INT_EN", description: "Connects the SYNC0 to CPUx Interrupt", size: "1", shift: "0", mask: "0x1" },
			{ name: "DMAX_TRIG_EN", description: "Connects the SYNC0 to DMA Trigger", size: "1", shift: "2", mask: "0x4" },
			{ name: "WRITE_KEY", description: "Key to enable writing lock", size: "8", shift: "8", mask: "0xFF00" },
		]
	},
	{ name: "ESCSS_SYNC1_CONFIG", description: "SYNC1 Configuration for various triggers", offset: "0x44", size: "16",
		bits: [
			{ name: "CPUX_INT_EN", description: "Connects the SYNC1 to CPUx Interrupt", size: "1", shift: "0", mask: "0x1" },
			{ name: "DMAX_TRIG_EN", description: "Connects the SYNC1 to CPUx DMA Trigger", size: "1", shift: "2", mask: "0x4" },
			{ name: "WRITE_KEY", description: "Key to enable writing lock", size: "8", shift: "8", mask: "0xFF00" },
		]
	},
	{ name: "ESCSS_CONFIG_LOCK", description: "EtherCATSS Configuration Lock", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "ESCSS_MISC_IO_CONFIG", description: "RESET_IN, EEPROM IO connections select", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "ESCSS_PHY_IO_CONFIG", description: "Control Register of ESCSS", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "ESCSS_SYNC_IO_CONFIG", description: "SYNC Signals IO configurations", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "ESCSS_LATCH_IO_CONFIG", description: "LATCH inputs IO pad select", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "ESCSS_GPIN_SEL", description: "GPIN Select between IO PAD & tieoff", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "ESCSS_GPOUT_SEL", description: "GPOUT IO pad connect select", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "ESCSS_LED_CONFIG", description: "Selection of LED o/p connect to IO pad", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "ESCSS_MISC_CONFIG", description: "Miscelleneous Configuration", offset: "0x28", size: "16",
		bits: [
