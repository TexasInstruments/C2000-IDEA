let I2C_REGISTERS = [
	{ name: "OAR", description: "I2C Own address", offset: "0x0", size: "16",
		bits: [
			{ name: "OAR", description: "I2C Own address", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "IER", description: "I2C Interrupt Enable", offset: "0x1", size: "16",
		bits: [
	...
	{ name: "STR", description: "I2C Status", offset: "0x2", size: "16",
		bits: [
			...
			{ name: "AAT", description: "Addressed-as-TARGET bit", size: "1", shift: "9", mask: "0x200" },
	...
	{ name: "CLKL", description: "I2C Clock low-time divider", offset: "0x3", size: "16",
		bits: [
		]
	},
	{ name: "CLKH", description: "I2C Clock high-time divider", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "CNT", description: "I2C Data count", offset: "0x5", size: "16",
		bits: [
		]
	},
	{ name: "DRR", description: "I2C Data receive", offset: "0x6", size: "16",
		bits: [
			{ name: "DATA", description: "Receive data", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "TAR", description: "I2C TARGET address", offset: "0x7", size: "16",
		bits: [
			{ name: "TAR", description: "TARGET Address", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "DXR", description: "I2C Data Transmit", offset: "0x8", size: "16",
		bits: [
			{ name: "DATA", description: "Transmit data", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "MDR", description: "I2C Mode", offset: "0x9", size: "16",
		bits: [
			...
			{ name: "CNT", description: "CONTROLLER Mode", size: "1", shift: "10", mask: "0x400" },
	...
	{ name: "ISRC", description: "I2C Interrupt Source", offset: "0xA", size: "16",
		bits: [
			{ name: "INTCODE", description: "Interrupt code bits.", size: "4", shift: "0", mask: "0xF" },
			{ name: "WRITE_ZEROS", description: "Always write all 0s to this field", size: "4", shift: "8", mask: "0xF00" },
		]
	},
	{ name: "EMDR", description: "I2C Extended Mode", offset: "0xB", size: "16",
		bits: [
			{ name: "BC", description: "Backwards compatibility mode", size: "1", shift: "0", mask: "0x1" },
			{ name: "FCM", description: "Forward Compatibility for TX behavior in Type1", size: "1", shift: "1", mask: "0x2" },
			{ name: "ECS", description: "Extended Automatic Clock Stretching Mode", size: "1", shift: "2", mask: "0x4" },
			{ name: "MCS", description: "Manual Clock Stretching Mode", size: "1", shift: "3", mask: "0x8" },
			{ name: "SCLKEY", description: "KEY", size: "4", shift: "4", mask: "0xF0" },
			{ name: "NACK_CM", description: "NACK Compatibility Mode", size: "1", shift: "8", mask: "0x100" },
			{ name: "ECS_ALT", description: "Alternative Extended Automatic Clock Stretching Mode", size: "1", shift: "9", mask: "0x200" },
		]
	},
	{ name: "PSC", description: "I2C Prescaler", offset: "0xC", size: "16",
		bits: [
			{ name: "IPSC", description: "I2C Prescaler Divide Down", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "FFTX", description: "I2C FIFO Transmit", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "FFRX", description: "I2C FIFO Receive", offset: "0x21", size: "16",
		bits: [
