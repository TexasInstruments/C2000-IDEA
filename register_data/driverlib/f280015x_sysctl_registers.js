let SYSCTL_REGISTERS = [
	...
	{ name: "X1CNT", description: "11-bit Counter on X1 Clock", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "LSEN", description: "Lockstep enable configuration", offset: "0x82", size: "16",
		bits: [
	...
	{ name: "LCM_ERR_FLG", description: "Status register indicating lockstep compare error flag", offset: "0x18", size: "16",
		bits: [
			...
			{ name: "CPU", description: "CPU1 Lockstep Miscompare flag", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "LCM_ERR_FLG_CLR", description: "LCM_ERR_FLG clear register", offset: "0x1A", size: "16",
		bits: [
			...
			{ name: "CPU", description: "CPU1 Lockstep Miscompare flag clear", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "LCM_ERR_FLG_SET", description: "LCM_ERR_FLG set register", offset: "0x1C", size: "16",
		bits: [
			{ name: "CPU", description: "CPU1 Lockstep Miscompare flag clear set", size: "1", shift: "1", mask: "0x2" },
			{ name: "KEY", description: "KEY field", size: "8", shift: "24", mask: "0xFF000000" },
		]
	},
