let EPWM_REGISTERS = [
	...
	{ name: "SYNCINSEL", description: "EPWMxSYNCIN Source Select Register", offset: "0x3", size: "16",
		bits: [
	...
	{ name: "SYNCOUTEN", description: "EPWMxSYNCOUT Source Enable Register", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "XLINK", description: "EPWMx Link Register", offset: "0x38", size: "32",
		bits: [
	...
	{ name: "XLINK2", description: "EPWMx Link 2 Register", offset: "0x3A", size: "16",
		bits: [
	...
	{ name: "LOCK", description: "EPWM Lock Register", offset: "0xFA", size: "32",
		bits: [
	...
	{ name: "XLINKXLOAD", description: "Link register across PWM modules", offset: "0xE", size: "16",
		bits: [
