let EQEP_REGISTERS = [
	{ name: "QPOSCNT", description: "Position Counter", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "QPOSINIT", description: "Position Counter Init", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "QPOSMAX", description: "Maximum Position Count", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "QPOSCMP", description: "Position Compare", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "QPOSILAT", description: "Index Position Latch", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "QPOSSLAT", description: "Strobe Position Latch", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "QPOSLAT", description: "Position Latch", offset: "0x18", size: "16",
		bits: [
		]
	},
	{ name: "QUTMR", description: "QEP Unit Timer", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "QUPRD", description: "QEP Unit Period", offset: "0x20", size: "16",
		bits: [
		]
	},
	{ name: "QWDTMR", description: "QEP Watchdog Timer", offset: "0x24", size: "16",
		bits: [
		]
	},
	{ name: "QWDPRD", description: "QEP Watchdog Period", offset: "0x26", size: "16",
		bits: [
		]
	},
	{ name: "QDECCTL", description: "Quadrature Decoder Control", offset: "0x28", size: "16",
		bits: [
			{ name: "QIDIRE", description: "Qep Index Direction Enhancement enable", size: "1", shift: "0", mask: "0x1" },
	...
	{ name: "QEPCTL", description: "QEP Control", offset: "0x2A", size: "16",
		bits: [
	...
	{ name: "QCAPCTL", description: "Qaudrature Capture Control", offset: "0x2C", size: "16",
		bits: [
	...
	{ name: "QPOSCTL", description: "Position Compare Control", offset: "0x2E", size: "16",
		bits: [
	...
	{ name: "QEINT", description: "QEP Interrupt Control", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "QFLG", description: "QEP Interrupt Flag", offset: "0x32", size: "16",
		bits: [
	...
	{ name: "QCLR", description: "QEP Interrupt Clear", offset: "0x34", size: "16",
		bits: [
	...
	{ name: "QFRC", description: "QEP Interrupt Force", offset: "0x36", size: "16",
		bits: [
	...
	{ name: "QEPSTS", description: "QEP Status", offset: "0x38", size: "16",
		bits: [
	...
	{ name: "QCTMR", description: "QEP Capture Timer", offset: "0x3A", size: "16",
		bits: [
		]
	},
	{ name: "QCPRD", description: "QEP Capture Period", offset: "0x3C", size: "16",
		bits: [
		]
	},
	{ name: "QCTMRLAT", description: "QEP Capture Latch", offset: "0x3E", size: "16",
		bits: [
		]
	},
	{ name: "QCPRDLAT", description: "QEP Capture Period Latch", offset: "0x40", size: "16",
		bits: [
		]
	},
	{ name: "REV", description: "QEP Revision Number", offset: "0x60", size: "16",
		bits: [
	...
	{ name: "QEPSTROBESEL", description: "QEP Strobe select register", offset: "0x64", size: "16",
		bits: [
			{ name: "STROBESEL", description: "QMA Mode Select", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "QMACTRL", description: "QMA Control register", offset: "0x68", size: "16",
		bits: [
			{ name: "MODE", description: "QMA Mode Select", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "QEPSRCSEL", description: "QEP Source Select Register", offset: "0x6C", size: "16",
		bits: [
			{ name: "QEPASEL", description: "QEPA Source select", size: "4", shift: "0", mask: "0xF" },
			{ name: "QEPBSEL", description: "QEPB Source select", size: "4", shift: "4", mask: "0xF0" },
			{ name: "QEPISEL", description: "QEPI Source select", size: "4", shift: "8", mask: "0xF00" },
			{ name: "QEPSSEL", description: "QEPS Source select", size: "4", shift: "12", mask: "0xF000" },
		]
	},
];
module.exports = {
