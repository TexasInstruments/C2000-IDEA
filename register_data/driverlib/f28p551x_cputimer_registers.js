let CPUTIMER_REGISTERS = [
	...
	{ name: "PRD", description: "CPU-Timer, Period Register", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "TCR", description: "CPU-Timer, Control Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "TPR", description: "CPU-Timer, Prescale Register", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "TPRH", description: "CPU-Timer, Prescale Register High", offset: "0x7", size: "16",
		bits: [
