let DAC_REGISTERS = [
	{ name: "REV", description: "DAC Revision Register", offset: "0x0", size: "16",
		bits: [
			{ name: "REV", description: "DAC Revision Register", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "CTL", description: "DAC Control Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "VALA", description: "DAC Value Register - Active", offset: "0x4", size: "16",
		bits: [
			{ name: "DACVALA", description: "DAC Active Output Code", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "VALS", description: "DAC Value Register - Shadow", offset: "0x6", size: "16",
		bits: [
			{ name: "DACVALS", description: "DAC Shadow Output Code", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "OUTEN", description: "DAC Output Enable Register", offset: "0x8", size: "16",
		bits: [
			{ name: "DACOUTEN", description: "DAC Output Code", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "LOCK", description: "DAC Lock Register", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "TRIM", description: "DAC Trim Register", offset: "0xC", size: "16",
		bits: [
