let LPOST_REGISTERS = [
	...
	{ name: "CONTROL", description: "Register to start the power-on self-test operation.", offset: "0x8", size: "16",
		bits: [
			{ name: "GO", description: "Start the self-test operation", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "CONFIG", description: "Register to configure the coverage for the power-on self-test operation.", offset: "0x10", size: "16",
		bits: [
			{ name: "COVERAGE", description: "Coverage configuration for the power on self-test", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "STATUS", description: "Register indicating the status of power-on self-test operation.", offset: "0x40", size: "16",
		bits: [
	...
	{ name: "STATUS_CLEAR", description: "Register to clear the LPOST Status", offset: "0x48", size: "16",
		bits: [
	...
	{ name: "LOCK", description: "Register to lock the LPOST register configurations", offset: "0x70", size: "16",
		bits: [
	...
	{ name: "COMMIT", description: "Register to commit the LPOST register configuration", offset: "0x78", size: "16",
		bits: [
