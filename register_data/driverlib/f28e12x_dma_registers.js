let DMA_REGISTERS = [
	{ name: "CTRL", description: "DMA Control Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "SRC_BURST_STEP", description: "Source Burst Step Register", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "DST_BURST_STEP", description: "Destination Burst Step Register", offset: "0x5", size: "16",
		bits: [
		]
	},
	{ name: "TRANSFER_SIZE", description: "Transfer Size Register", offset: "0x6", size: "16",
		bits: [
			{ name: "TRANSFERSIZE", description: "These bits specify the number of bursts to transfer:", size: "9", shift: "0", mask: "0x1FF" },
		]
	},
	{ name: "TRANSFER_COUNT", description: "Transfer Count Register", offset: "0x7", size: "16",
		bits: [
			{ name: "TRANSFERCOUNT", description: "These bits specify the current transfer counter value:", size: "9", shift: "0", mask: "0x1FF" },
		]
	},
	{ name: "SRC_TRANSFER_STEP", description: "Source Transfer Step Register", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "DST_TRANSFER_STEP", description: "Destination Transfer Step Register", offset: "0x9", size: "16",
		bits: [
		]
	},
	...
	{ name: "SRC_WRAP_COUNT", description: "Source Wrap Count Register", offset: "0xB", size: "16",
		bits: [
			{ name: "WRAPSIZE", description: "These bits indicate the current wrap counter value:", size: "9", shift: "0", mask: "0x1FF" },
		]
	},
	...
	{ name: "DST_WRAP_SIZE", description: "Destination Wrap Size Register", offset: "0xD", size: "16",
		bits: [
			{ name: "WRAPSIZE", description: "Number of bursts to transfer before wrapping", size: "9", shift: "0", mask: "0x1FF" },
		]
	},
	{ name: "DST_WRAP_COUNT", description: "Destination Wrap Count Register", offset: "0xE", size: "16",
		bits: [
			{ name: "WRAPSIZE", description: "These bits indicate the current wrap counter value:", size: "9", shift: "0", mask: "0x1FF" },
		]
	},
	{ name: "DST_WRAP_STEP", description: "Destination Wrap Step Register", offset: "0xF", size: "16",
		bits: [
		]
	},
	{ name: "SRC_BEG_ADDR_SHADOW", description: "Source Begin Address Shadow Register", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "SRC_ADDR_SHADOW", description: "Source Address Shadow Register", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "SRC_BEG_ADDR_ACTIVE", description: "Source Begin Address Active Register", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "SRC_ADDR_ACTIVE", description: "Source Address Active Register", offset: "0x16", size: "16",
		bits: [
		]
	},
	{ name: "DST_BEG_ADDR_SHADOW", description: "Destination Begin Address Shadow Register", offset: "0x18", size: "16",
		bits: [
		]
	},
	{ name: "DST_ADDR_SHADOW", description: "Destination Address Shadow Register", offset: "0x1A", size: "16",
		bits: [
		]
	},
	{ name: "DST_BEG_ADDR_ACTIVE", description: "Destination Begin Address Active Register", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "DST_ADDR_ACTIVE", description: "Destination Address Active Register", offset: "0x1E", size: "16",
		bits: [
		]
	},
];
