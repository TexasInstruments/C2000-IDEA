let CMPSS_LITE_REGISTERS = [
	...
	{ name: "COMPLOCK", description: "CMPSS Lock Register", offset: "0x1A", size: "16",
		bits: [
			...
			{ name: "CMPSSLITE_CTRIPLFILCTL_SAMPWIN", description: "Sample Window", size: "5", shift: "3", mask: "0xF8" },
			{ name: "CMPSSLITE_CTRIPLFILCTL_THRESH", description: "Majority Voting Threshold", size: "5", shift: "9", mask: "0x3E00" },
			{ name: "CMPSSLITE_CTRIPLFILCTL_FILINIT", description: "Filter Initialization Bit", size: "1", shift: "15", mask: "0x8000" },
			{ name: "CMPSSLITE_CTRIPHFILCTL_SAMPWIN", description: "Sample Window", size: "5", shift: "3", mask: "0xF8" },
			{ name: "CMPSSLITE_CTRIPHFILCTL_THRESH", description: "Majority Voting Threshold", size: "5", shift: "9", mask: "0x3E00" },
