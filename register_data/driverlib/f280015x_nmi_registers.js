let NMI_REGISTERS = [
	{ name: "CFG", description: "NMI Configuration Register", offset: "0x0", size: "16",
		bits: [
			{ name: "NMIE", description: "Global NMI Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "FLG", description: "NMI Flag Register (SYSRsn Clear)", offset: "0x1", size: "16",
		bits: [
			...
			{ name: "LSCMPERR", description: "Lockstep Compare Error", size: "1", shift: "4", mask: "0x10" },
			{ name: "SWERR", description: "SW Error Force NMI Flag", size: "1", shift: "13", mask: "0x2000" },
		]
	},
	{ name: "FLGCLR", description: "NMI Flag Clear Register", offset: "0x2", size: "16",
		bits: [
			...
			{ name: "REGPARITYERR", description: "Register parity error flag clear", size: "1", shift: "3", mask: "0x8" },
			{ name: "LSCMPERR", description: "Lockstep Compare Error flag clear", size: "1", shift: "4", mask: "0x10" },
			{ name: "SWERR", description: "SW Error Flag Clear", size: "1", shift: "13", mask: "0x2000" },
		]
	},
	{ name: "FLGFRC", description: "NMI Flag Force Register", offset: "0x3", size: "16",
		bits: [
			...
			{ name: "REGPARITYERR", description: "Register parity error flag force", size: "1", shift: "3", mask: "0x8" },
			{ name: "LSCMPERR", description: "Lockstep Compare Error flag force", size: "1", shift: "4", mask: "0x10" },
			{ name: "SWERR", description: "SW Error Flag Force", size: "1", shift: "13", mask: "0x2000" },
		]
	},
	{ name: "WDCNT", description: "NMI Watchdog Counter Register", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "WDPRD", description: "NMI Watchdog Period Register", offset: "0x5", size: "16",
		bits: [
		]
	},
	{ name: "SHDFLG", description: "NMI Shadow Flag Register", offset: "0x6", size: "16",
		bits: [
			...
			{ name: "REGPARITYERR", description: "Register parity error shadow flag", size: "1", shift: "3", mask: "0x8" },
			{ name: "LSCMPERR", description: "Lockstep Compare Error shadow flag", size: "1", shift: "4", mask: "0x10" },
