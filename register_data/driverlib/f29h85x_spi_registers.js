let SPI_REGISTERS = [
	...
	{ name: "CTL", description: "SPI Operation Control Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "STS", description: "SPI Status Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "BRR", description: "SPI Baud Rate Register", offset: "0x8", size: "16",
		bits: [
			{ name: "SPI_BIT_RATE", description: "SPI Bit Rate Control", size: "7", shift: "0", mask: "0x7F" },
		]
	},
	{ name: "RXEMU", description: "SPI Emulation Buffer Register", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "RXBUF", description: "SPI Serial Input Buffer Register", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "TXBUF", description: "SPI Serial Output Buffer Register", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "DAT", description: "SPI Serial Data Register", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "FFTX", description: "SPI FIFO Transmit Register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "FFRX", description: "SPI FIFO Receive Register", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "FFCT", description: "SPI FIFO Control Register", offset: "0x18", size: "16",
		bits: [
			{ name: "TXDLY", description: "FIFO Transmit Delay Bits", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PRI", description: "SPI Priority Control Register", offset: "0x1E", size: "16",
		bits: [
