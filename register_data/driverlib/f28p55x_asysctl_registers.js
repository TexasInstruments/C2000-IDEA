let ASYSCTL_REGISTERS = [
	...
	{ name: "CONFIGLOCK", description: "Lock Register for all the config registers.", offset: "0x5E", size: "16",
		bits: [
	...
	{ name: "CMPHPMXSEL", description: "Bits to select one of the many sources on CompHP inputs. Refer to Pimux diagram for details.", offset: "0x82", size: "16",
		bits: [
	...
	{ name: "CMPLPMXSEL", description: "Bits to select one of the many sources on CompLP inputs. Refer to Pimux diagram for details.", offset: "0x84", size: "16",
		bits: [
	...
	{ name: "CMPSSDACBUFCONFIG", description: "Config bits for CMPSS DAC buffer", offset: "0x8C", size: "16",
		bits: [
			{ name: "CMPSSADACL", description: "Configuration bits for CMPSS DACA", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "LOCK", description: "Lock Register", offset: "0x8E", size: "16",
		bits: [
	...
	{ name: "AGPIOCTRLA", description: "AGPIO Control Register", offset: "0x10A", size: "16",
		bits: [
	...
	{ name: "AGPIOCTRLB", description: "AGPIO Control Register", offset: "0x10C", size: "16",
		bits: [
			{ name: "GPIO33", description: "AGPIOCTRL for GPIO33", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "AGPIOCTRLG", description: "AGPIO Control Register", offset: "0x116", size: "16",
		bits: [
	...
	{ name: "AGPIOCTRLH", description: "AGPIO Control Register", offset: "0x118", size: "16",
		bits: [
	...
	{ name: "GPIOINENACTRL", description: "GPIOINENACTRL Control Register", offset: "0x132", size: "16",
		bits: [
	...
	{ name: "ADCSOCFRCGB", description: "ADC Global SOC Force", offset: "0x136", size: "16",
		bits: [
