let I2C_REGISTERS = [
	...
	{ name: "IER", description: "I2C Interrupt Enable", offset: "0x1", size: "16",
		bits: [
			...
			{ name: "AAT", description: "Addressed as slave interrupt enable", size: "1", shift: "6", mask: "0x40" },
		]
	},
	{ name: "STR", description: "I2C Status", offset: "0x2", size: "16",
		bits: [
			...
			{ name: "AAT", description: "Addressed-as-slave bit", size: "1", shift: "9", mask: "0x200" },
			...
			{ name: "TDIR", description: "Slave direction bit", size: "1", shift: "14", mask: "0x4000" },
		]
	},
	...
	{ name: "TAR", description: "I2C Slave address", offset: "0x7", size: "16",
		bits: [
			{ name: "TAR", description: "Slave Address", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	...
	{ name: "MDR", description: "I2C Mode", offset: "0x9", size: "16",
		bits: [
			...
			{ name: "CNT", description: "Master Mode", size: "1", shift: "10", mask: "0x400" },
