let MEMCFG_REGISTERS = [
	...
	{ name: "DXACCPROT1", description: "Dedicated RAM Config Register", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "LSXACCPROT2", description: "(0 <= i < 2) Local Shared RAM Config Register 2", offset: "(0x2C + ((i) * 0x2))", count: "2", size: "16",
		bits: [
	...
	{ name: "GSXTEST", description: "Global Shared RAM TEST Register", offset: "0x50", size: "16",
		bits: [
	...
	{ name: "NMAVFLG", description: "Non-Controller Access Violation Flag Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "NMAVSET", description: "Non-Controller Access Violation Flag Set Register", offset: "0x2", size: "16",
		bits: [
			...
			{ name: "TINIEREAD", description: "Non Controller TINIE Read Access Violation Flag Set", size: "1", shift: "11", mask: "0x800" },
			{ name: "TINIEWRITE", description: "Non Controller TINIE Write Access Violation Flag Set", size: "1", shift: "12", mask: "0x1000" },
		]
	},
	{ name: "NMAVCLR", description: "Non-Controller Access Violation Flag Clear Register", offset: "0x4", size: "16",
		bits: [
			...
			{ name: "TINIEREAD", description: "Non Controller TINIE Read Access Violation Flag Clear", size: "1", shift: "11", mask: "0x800" },
			{ name: "TINIEWRITE", description: "Non Controller TINIE Write Access Violation Flag Clear", size: "1", shift: "12", mask: "0x1000" },
		]
	},
	{ name: "NMAVINTEN", description: "Non-Controller Access Violation Interrupt Enable Register", offset: "0x6", size: "16",
		bits: [
			...
			{ name: "TINIEREAD", description: "Non Controller TINIE Read Access Violation Interrupt Enable", size: "1", shift: "11", mask: "0x800" },
			{ name: "TINIEWRITE", description: "Non Controller TINIE Write Violation Interrupt Enable", size: "1", shift: "12", mask: "0x1000" },
		]
	},
	{ name: "NMCPURDAVADDR", description: "Non-Controller CPU Read Access Violation Address", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "NMCPUWRAVADDR", description: "Non-Controller CPU Write Access Violation Address", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "NMCPUFAVADDR", description: "Non-Controller CPU Fetch Access Violation Address", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "NMDMAWRAVADDR", description: "Non-Controller DMA Write Access Violation Address", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "NMCLA1RDAVADDR", description: "Non-Controller CLA1 Read Access Violation Address", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "NMCLA1WRAVADDR", description: "Non-Controller CLA1 Write Access Violation Address", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "NMCLA1FAVADDR", description: "Non-Controller CLA1 Fetch Access Violation Address", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "NMDMARDAVADDR", description: "Non-Controller DMA Read Access Violation Address", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "MAVFLG", description: "Controller Access Violation Flag Register", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "MAVSET", description: "Controller Access Violation Flag Set Register", offset: "0x22", size: "16",
		bits: [
	...
	{ name: "MAVCLR", description: "Controller Access Violation Flag Clear Register", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "MAVINTEN", description: "Controller Access Violation Interrupt Enable Register", offset: "0x26", size: "16",
		bits: [
	...
	{ name: "MCPUFAVADDR", description: "Controller CPU Fetch Access Violation Address", offset: "0x28", size: "16",
		bits: [
		]
	},
	{ name: "MCPUWRAVADDR", description: "Controller CPU Write Access Violation Address", offset: "0x2A", size: "16",
		bits: [
		]
	},
	{ name: "MDMAWRAVADDR", description: "Controller  DMA Write Access Violation Address", offset: "0x2C", size: "16",
		bits: [
		]
	},
	{ name: "NMTINIERDAVADDR", description: "Non-Controller TINIE Read Access Violation Address", offset: "0x3A", size: "16",
		bits: [
		]
	},
	{ name: "NMTINIEWRAVADDR", description: "Non-Controller TINIE Write Access Violation Address", offset: "0x3C", size: "16",
		bits: [
		]
	},
	...
	{ name: "UCTINIEREADDR", description: "Uncorrectable TINIE Read Error Address", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "FLUCERRSTATUS", description: "Flash read uncorrectable ecc err status", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "CDMAREADDR", description: "Correctable DMA Read Error Address", offset: "0x28", size: "16",
		bits: [
		]
	},
