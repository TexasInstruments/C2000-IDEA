let SCI_REGISTERS = [
	{ name: "CCR", description: "Communications control register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "CTL1", description: "Control register 1", offset: "0x1", size: "16",
		bits: [
	...
	{ name: "HBAUD", description: "Baud rate (high) register", offset: "0x2", size: "16",
		bits: [
			{ name: "BAUD", description: "SCI 16-bit baud selection Registers SCIHBAUD", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "LBAUD", description: "Baud rate (low) register", offset: "0x3", size: "16",
		bits: [
			{ name: "BAUD", description: "SCI 16-bit baud selection Registers SCILBAUD", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "CTL2", description: "Control register 2", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "RXST", description: "Receive status register", offset: "0x5", size: "16",
		bits: [
	...
	{ name: "RXEMU", description: "Receive emulation buffer register", offset: "0x6", size: "16",
		bits: [
			{ name: "ERXDT", description: "Receive emulation buffer data", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "RXBUF", description: "Receive data buffer", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "TXBUF", description: "Transmit data buffer", offset: "0x9", size: "16",
		bits: [
			{ name: "TXDT", description: "Transmit data buffer", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "FFTX", description: "FIFO transmit register", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "FFRX", description: "FIFO receive register", offset: "0xB", size: "16",
		bits: [
	...
	{ name: "FFCT", description: "FIFO control register", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "PRI", description: "SCI priority control", offset: "0xF", size: "16",
		bits: [
