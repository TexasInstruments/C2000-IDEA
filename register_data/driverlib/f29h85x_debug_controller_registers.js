let DEBUG_CONTROLLER_REGISTERS = [
	{ name: "DBG_CAP", description: "Debug Capability", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "DBG_PID", description: "Debug Part ID", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "DBG_CONNECT", description: "Debug Connect", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "DBG_CNTL0", description: "Debug Execution Control 0", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "DBG_CNTL1", description: "Debug Execution Control 1", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "DBG_STAT", description: "Debug Status", offset: "0x14", size: "32",
		bits: [
	...
	{ name: "DBG_MEM_CNTL", description: "Debug  Access control", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "DBG_MEM_ADDR0", description: "Debyg Acess Address", offset: "0x40", size: "16",
		bits: [
		]
	},
	{ name: "DBG_MEM_DATA0", description: "Debug Access Data 0", offset: "0x48", size: "16",
		bits: [
		]
	},
	{ name: "DBG_MEM_DATA1", description: "Debug Access Data 1", offset: "0x4C", size: "16",
		bits: [
		]
	},
	{ name: "DBG_VIS_READ_P0", description: "Debug Visibility Read Port 0", offset: "0x50", size: "32",
		bits: [
	...
	{ name: "DBG_VIS_READ_P1", description: "Debug Visibility Read Port 1", offset: "0x54", size: "16",
		bits: [
		]
	},
	{ name: "DBG_VIS_CLR_P1", description: "Debug Visibility Port 1 Clear", offset: "0x58", size: "16",
		bits: [
		]
	},
];
