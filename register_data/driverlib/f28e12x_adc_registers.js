let ADC_REGISTERS = [
	...
	{ name: "INTSEL", description: "ADC Interrupt 1, 2, 3 and 4 Selection Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "DMAINTSEL", description: "ADC DMA Interrupt 1, 2, 3 and 4 Selection Register", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "RAWINTFLG", description: "ADC Raw Interrupt Flag Register", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "INTFLGFRC", description: "ADC Interrupt Flag Force Register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "INTFLGCLR", description: "ADC Interrupt Flag Clear Register", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "INTOVF", description: "ADC Interrupt Overflow Register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "INTOVFCLR", description: "ADC Interrupt Overflow Clear Register", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "SOCPRICTL", description: "ADC SOC Priority Control Register", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "INTSOCSEL1", description: "ADC Interrupt SOC Selection 1 Register", offset: "0x1A", size: "32",
		bits: [
	...
	{ name: "SOCFLG1", description: "ADC SOC Flag 1 Register", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "SOCFRC1", description: "ADC SOC Force 1 Register", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "SOCOVF1", description: "ADC SOC Overflow 1 Register", offset: "0x22", size: "16",
		bits: [
	...
	{ name: "SOCOVFCLR1", description: "ADC SOC Overflow Clear 1 Register", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "SOC0CTL", description: "ADC SOC0 Control Register", offset: "0x26", size: "32",
		bits: [
	...
	{ name: "SOC1CTL", description: "ADC SOC1 Control Register", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "SOC2CTL", description: "ADC SOC2 Control Register", offset: "0x2A", size: "32",
		bits: [
	...
	{ name: "SOC3CTL", description: "ADC SOC3 Control Register", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "SOC4CTL", description: "ADC SOC4 Control Register", offset: "0x2E", size: "32",
		bits: [
	...
	{ name: "SOC5CTL", description: "ADC SOC5 Control Register", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "SOC6CTL", description: "ADC SOC6 Control Register", offset: "0x32", size: "32",
		bits: [
	...
	{ name: "SOC7CTL", description: "ADC SOC7 Control Register", offset: "0x34", size: "32",
		bits: [
	...
	{ name: "SOC8CTL", description: "ADC SOC8 Control Register", offset: "0x36", size: "32",
		bits: [
	...
	{ name: "SOC9CTL", description: "ADC SOC9 Control Register", offset: "0x38", size: "32",
		bits: [
	...
	{ name: "SOC10CTL", description: "ADC SOC10 Control Register", offset: "0x3A", size: "32",
		bits: [
	...
	{ name: "SOC11CTL", description: "ADC SOC11 Control Register", offset: "0x3C", size: "32",
		bits: [
	...
	{ name: "SOC12CTL", description: "ADC SOC12 Control Register", offset: "0x3E", size: "32",
		bits: [
	...
	{ name: "SOC13CTL", description: "ADC SOC13 Control Register", offset: "0x40", size: "32",
		bits: [
	...
	{ name: "SOC14CTL", description: "ADC SOC14 Control Register", offset: "0x42", size: "32",
		bits: [
	...
	{ name: "SOC15CTL", description: "ADC SOC15 Control Register", offset: "0x44", size: "32",
		bits: [
	...
	{ name: "EVTSTAT", description: "ADC Event Status Register", offset: "0x66", size: "16",
		bits: [
	...
	{ name: "EVTCLR", description: "ADC Event Clear Register", offset: "0x68", size: "16",
		bits: [
	...
	{ name: "EVTSEL", description: "ADC Event Selection Register", offset: "0x6A", size: "16",
		bits: [
	...
	{ name: "EVTINTSEL", description: "ADC Event Interrupt Selection Register", offset: "0x6C", size: "16",
		bits: [
			...
			{ name: "PPB1INLIMIT", description: "Post Processing Block 1 Within trip limit interrupt enable", size: "1", shift: "3", mask: "0x8" },
			...
			{ name: "PPB2INLIMIT", description: "Post Processing Block 2 Within trip limit interrupt enable", size: "1", shift: "7", mask: "0x80" },
			...
			{ name: "PPB3INLIMIT", description: "Post Processing Block 3 Within trip limit interrupt enable", size: "1", shift: "11", mask: "0x800" },
		]
	},
	{ name: "REV", description: "ADC Revision Register", offset: "0x72", size: "32",
		bits: [
			{ name: "TYPE", description: "ADC Type", size: "8", shift: "0", mask: "0xFF" },
			{ name: "REV", description: "ADC Revision", size: "24", shift: "8", mask: "0xFFFFFF00" },
		]
	},
	{ name: "OFFTRIM", description: "ADC Offset Trim Register 1", offset: "0x74", size: "16",
		bits: [
			{ name: "OFFTRIM", description: "ADC Offset Trim", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PPB1CONFIG", description: "ADC PPB{#} Config Register", offset: "0x80", size: "16",
		bits: [
			...
			{ name: "TWOSCOMPEN", description: "ADC Post Processing Block {#} Two's Complement Enable", size: "1", shift: "7", mask: "0x80" },
		]
	},
	{ name: "PPB1OFFCAL", description: "ADC PPB1 Offset Calibration Register", offset: "0x84", size: "16",
		bits: [
			{ name: "OFFCAL", description: "ADC Post Processing Block Offset Correction", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "PPB1OFFREF", description: "ADC PPB1 Offset Reference Register", offset: "0x86", size: "16",
		bits: [
			{ name: "OFFREF", description: "ADC Post Processing Block 1 Offset Reference", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "PPB1TRIPHI", description: "ADC PPB1 Trip High Register", offset: "0x88", size: "16",
		bits: [
			{ name: "LIMITHI", description: "ADC Post Processing Block 1 Trip High Limit", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "PPB1TRIPLO", description: "ADC PPB1 Trip Low/Trigger Time Stamp Register", offset: "0x8A", size: "16",
		bits: [
			{ name: "LIMITLO", description: "ADC Post Processing Block 1 Trip Low Limit", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "PPB2CONFIG", description: "ADC PPB{#} Config Register", offset: "0x90", size: "16",
		bits: [
			{ name: "CONFIG", description: "ADC Post Processing Block {#} Configuration", size: "4", shift: "0", mask: "0xF" },
			{ name: "CBCEN", description: "Cycle By Cycle Enable", size: "1", shift: "5", mask: "0x20" },
			{ name: "TWOSCOMPEN", description: "ADC Post Processing Block {#} Two's Complement Enable", size: "1", shift: "7", mask: "0x80" },
	...
	{ name: "PPB2OFFCAL", description: "ADC PPB2 Offset Calibration Register", offset: "0x94", size: "16",
		bits: [
			{ name: "OFFCAL", description: "ADC Post Processing Block Offset Correction", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "PPB2OFFREF", description: "ADC PPB2 Offset Reference Register", offset: "0x96", size: "16",
		bits: [
			{ name: "OFFREF", description: "ADC Post Processing Block 2 Offset Reference", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "PPB2TRIPHI", description: "ADC PPB2 Trip High Register", offset: "0x98", size: "16",
		bits: [
			{ name: "LIMITHI", description: "ADC Post Processing Block 2 Trip High Limit", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "PPB2TRIPLO", description: "ADC PPB2 Trip Low/Trigger Time Stamp Register", offset: "0x9A", size: "16",
		bits: [
			{ name: "LIMITLO", description: "ADC Post Processing Block 2 Trip Low Limit", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "PPB3CONFIG", description: "ADC PPB{#} Config Register", offset: "0xA0", size: "16",
		bits: [
			{ name: "CONFIG", description: "ADC Post Processing Block {#} Configuration", size: "4", shift: "0", mask: "0xF" },
			{ name: "CBCEN", description: "Cycle By Cycle Enable", size: "1", shift: "5", mask: "0x20" },
			{ name: "TWOSCOMPEN", description: "ADC Post Processing Block {#} Two's Complement Enable", size: "1", shift: "7", mask: "0x80" },
	...
	{ name: "PPB3OFFCAL", description: "ADC PPB3 Offset Calibration Register", offset: "0xA4", size: "16",
		bits: [
			{ name: "OFFCAL", description: "ADC Post Processing Block Offset Correction", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "PPB3OFFREF", description: "ADC PPB3 Offset Reference Register", offset: "0xA6", size: "16",
		bits: [
			{ name: "OFFREF", description: "ADC Post Processing Block 3 Offset Reference", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "PPB3TRIPHI", description: "ADC PPB3 Trip High Register", offset: "0xA8", size: "16",
		bits: [
			{ name: "LIMITHI", description: "ADC Post Processing Block 3 Trip High Limit", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "PPB3TRIPLO", description: "ADC PPB3 Trip Low/Trigger Time Stamp Register", offset: "0xAA", size: "16",
		bits: [
			{ name: "LIMITLO", description: "ADC Post Processing Block 3 Trip Low Limit", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "INTCYCLE", description: "ADC Early Interrupt Generation Cycle", offset: "0xC0", size: "16",
		bits: [
			{ name: "DELAY", description: "Delay from ADCSOC fall edge to early interrupt generation.", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "INLTRIM1", description: "ADC Linearity Trim 1 Register", offset: "0xC2", size: "16",
		bits: [
		]
	},
	{ name: "INLTRIM2", description: "ADC Linearity Trim 2 Register", offset: "0xC4", size: "16",
		bits: [
		]
	},
	{ name: "REV2", description: "ADC Wrapper Revision Register", offset: "0xCE", size: "32",
		bits: [
	...
	{ name: "REP1CTL", description: "ADC Trigger Repeater 1 Control Register", offset: "0xE0", size: "16",
		bits: [
	...
	{ name: "REP1N", description: "ADC Trigger Repeater 1 N Select Register", offset: "0xE2", size: "16",
		bits: [
	...
	{ name: "REP1SPREAD", description: "ADC Trigger Repeater 1 Spread Select Register", offset: "0xE6", size: "32",
		bits: [
	...
	{ name: "REP1FRC", description: "ADC Trigger Repeater 1 Software Force Register", offset: "0xE8", size: "16",
		bits: [
			{ name: "SWFRC", description: "ADC Trigger Repeater 1 Software Force", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PPB1LIMIT", description: "ADC PPB1Conversion Count Limit Register", offset: "0x100", size: "16",
		bits: [
			{ name: "LIMIT", description: "Post Processing Block 1 Limit", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "PPBP1PCOUNT", description: "ADC PPB1 Partial Conversion Count Register", offset: "0x102", size: "16",
		bits: [
			{ name: "PCOUNT", description: "Post Processing Block 1 Partial Count", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "PPB1CONFIG2", description: "ADC PPB1 Sum Shift Register", offset: "0x104", size: "16",
		bits: [
	...
	{ name: "PPB1PSUM", description: "ADC PPB1 Partial Sum Register", offset: "0x106", size: "32",
		bits: [
