let PGA_REGISTERS = [
	{ name: "CTL", description: "PGA Control Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "LOCK", description: "PGA Lock Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "GAIN3TRIM", description: "PGA Gain Trim Register for a gain setting of 3", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "GAIN6TRIM", description: "PGA Gain Trim Register for a gain setting of 6", offset: "0x5", size: "16",
		bits: [
	...
	{ name: "GAIN12TRIM", description: "PGA Gain Trim Register for a gain setting of 12", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "GAIN24TRIM", description: "PGA Gain Trim Register for a gain setting of 24", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "TYPE", description: "PGA Type Register", offset: "0x8", size: "16",
		bits: [
