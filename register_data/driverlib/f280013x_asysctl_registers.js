let ASYSCTL_REGISTERS = [
	{ name: "EXTROSCCSR1", description: "ExtR Oscillator Status Register", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "ANAREFCTL", description: "Analog Reference Control Register. This register is not configurable for 32QFN package", offset: "0x68", size: "16",
		bits: [
			...
			{ name: "ANAREFSEL_SUP_OVERRIDE", description: "Control for overriding the analog reference with VDDA/VSSA", size: "1", shift: "15", mask: "0x8000" },
		]
	},
