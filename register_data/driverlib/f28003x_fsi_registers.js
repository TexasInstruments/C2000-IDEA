let FSI_REGISTERS = [
	{ name: "TX_MAIN_CTRL", description: "Transmit main control register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "TX_CLK_CTRL", description: "Transmit clock control register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "TX_OPER_CTRL_LO", description: "Transmit operation control register low", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "TX_OPER_CTRL_HI", description: "Transmit operation control register high", offset: "0x5", size: "16",
		bits: [
			...
			{ name: "EXT_TRIG_SEL", description: "External Trigger Select", size: "6", shift: "7", mask: "0x1F80" },
		]
	},
	{ name: "TX_FRAME_CTRL", description: "Transmit frame control register", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "TX_FRAME_TAG_UDATA", description: "Transmit frame tag and user data register", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "TX_BUF_PTR_LOAD", description: "Transmit buffer pointer control load register", offset: "0x8", size: "16",
		bits: [
			{ name: "BUF_PTR_LOAD", description: "Buffer Pointer Force Load", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "TX_BUF_PTR_STS", description: "Transmit buffer pointer control status register", offset: "0x9", size: "16",
		bits: [
	...
	{ name: "TX_PING_CTRL", description: "Transmit ping control register", offset: "0xA", size: "16",
		bits: [
			...
			{ name: "EXT_TRIG_SEL", description: "External Trigger Select", size: "6", shift: "3", mask: "0x1F8" },
		]
	},
	{ name: "TX_PING_TAG", description: "Transmit ping tag register", offset: "0xB", size: "16",
		bits: [
			{ name: "TAG", description: "Ping Frame Tag", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "TX_PING_TO_REF", description: "Transmit ping timeout counter reference", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "TX_PING_TO_CNT", description: "Transmit ping timeout current count", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "TX_INT_CTRL", description: "Transmit interrupt event control register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "TX_DMA_CTRL", description: "Transmit DMA event control register", offset: "0x11", size: "16",
		bits: [
			{ name: "DMA_EVT_EN", description: "DMA Event Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "TX_LOCK_CTRL", description: "Transmit lock control register", offset: "0x12", size: "16",
		bits: [
			{ name: "LOCK", description: "Control Register Lock Enable", size: "1", shift: "0", mask: "0x1" },
			{ name: "KEY", description: "Write Key", size: "8", shift: "8", mask: "0xFF00" },
		]
	},
	{ name: "TX_EVT_STS", description: "Transmit event and error status flag register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "TX_EVT_CLR", description: "Transmit event and error clear register", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "TX_EVT_FRC", description: "Transmit event and error flag force register", offset: "0x17", size: "16",
		bits: [
	...
	{ name: "TX_USER_CRC", description: "Transmit user-defined CRC register", offset: "0x18", size: "16",
		bits: [
			{ name: "USER_CRC", description: "User-defined CRC", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "TX_ECC_DATA", description: "Transmit ECC data register", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "TX_ECC_VAL", description: "Transmit ECC value register", offset: "0x22", size: "16",
		bits: [
			{ name: "ECC_VAL", description: "Computed ECC Value", size: "7", shift: "0", mask: "0x7F" },
		]
	},
	{ name: "TX_DLYLINE_CTRL", description: "Transmit delay Line control register", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "TX_BUF_BASE", description: "(0 <= i < 16) Base address for transmit buffer", offset: "(0x40 + (i))", count: "16", size: "16",
		bits: [
		]
	},
	{ name: "RX_MAIN_CTRL", description: "Receive main control register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "RX_OPER_CTRL", description: "Receive operation control register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "RX_FRAME_INFO", description: "Receive frame control register", offset: "0x6", size: "16",
		bits: [
			{ name: "FRAME_TYPE", description: "Received Frame Type", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RX_FRAME_TAG_UDATA", description: "Receive frame tag and user data register", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "RX_DMA_CTRL", description: "Receive DMA event control register", offset: "0x8", size: "16",
		bits: [
			{ name: "DMA_EVT_EN", description: "DMA Event Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "RX_EVT_STS", description: "Receive event and error status flag register", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "RX_CRC_INFO", description: "Receive CRC info of received and computed CRC", offset: "0xB", size: "16",
		bits: [
	...
	{ name: "RX_EVT_CLR", description: "Receive event and error clear register", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "RX_EVT_FRC", description: "Receive event and error flag force register", offset: "0xD", size: "16",
		bits: [
	...
	{ name: "RX_BUF_PTR_LOAD", description: "Receive buffer pointer load register", offset: "0xE", size: "16",
		bits: [
			{ name: "BUF_PTR_LOAD", description: "Load value for receive buffer pointer", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RX_BUF_PTR_STS", description: "Receive buffer pointer status register", offset: "0xF", size: "16",
		bits: [
			{ name: "CURR_BUF_PTR", description: "Current Buffer Pointer Index", size: "4", shift: "0", mask: "0xF" },
			{ name: "CURR_WORD_CNT", description: "Available Words in Buffer", size: "5", shift: "8", mask: "0x1F00" },
		]
	},
	{ name: "RX_FRAME_WD_CTRL", description: "Receive frame watchdog control register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "RX_FRAME_WD_REF", description: "Receive frame watchdog counter reference", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "RX_FRAME_WD_CNT", description: "Receive frame watchdog current count", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "RX_PING_WD_CTRL", description: "Receive ping watchdog control register", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "RX_PING_TAG", description: "Receive ping tag register", offset: "0x17", size: "16",
		bits: [
			{ name: "PING_TAG", description: "Ping Frame Tag", size: "4", shift: "1", mask: "0x1E" },
		]
	},
	{ name: "RX_PING_WD_REF", description: "Receive ping watchdog counter reference", offset: "0x18", size: "16",
		bits: [
		]
	},
	{ name: "RX_PING_WD_CNT", description: "Receive pingwatchdog current count", offset: "0x1A", size: "16",
		bits: [
		]
	},
	{ name: "RX_INT1_CTRL", description: "Receive interrupt control register for RX_INT1", offset: "0x1C", size: "16",
		bits: [
			{ name: "INT1_EN_PING_WD_TO", description: "Enable Ping Watchdog Timeout Interrupt to INT1", size: "1", shift: "0", mask: "0x1" },
			{ name: "INT1_EN_FRAME_WD_TO", description: "Enable Frame Watchdog Timeout Interrupt to INT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INT1_EN_CRC_ERR", description: "Enable CRC Error Interrupt to INT1", size: "1", shift: "2", mask: "0x4" },
			{ name: "INT1_EN_TYPE_ERR", description: "Enable Frame Type Error Interrupt to INT1", size: "1", shift: "3", mask: "0x8" },
			{ name: "INT1_EN_EOF_ERR", description: "Enable End-of-Frame Error Interrupt to INT1", size: "1", shift: "4", mask: "0x10" },
			{ name: "INT1_EN_OVERRUN", description: "Enable Receive Buffer Overrun Interrupt to INT1", size: "1", shift: "5", mask: "0x20" },
			{ name: "INT1_EN_FRAME_DONE", description: "Enable Frame Done Interrupt to INT1", size: "1", shift: "6", mask: "0x40" },
			{ name: "INT1_EN_UNDERRUN", description: "Enable Buffer Underrun Interrupt to INT1", size: "1", shift: "7", mask: "0x80" },
			{ name: "INT1_EN_ERR_FRAME", description: "Enable Error Frame Received Interrupt to INT1", size: "1", shift: "8", mask: "0x100" },
			{ name: "INT1_EN_PING_FRAME", description: "Enable Ping Frame Received Interrupt to INT1", size: "1", shift: "9", mask: "0x200" },
			{ name: "INT1_EN_FRAME_OVERRUN", description: "Enable Frame Overrun Interrupt to INT1", size: "1", shift: "10", mask: "0x400" },
			{ name: "INT1_EN_DATA_FRAME", description: "Enable Data Frame Received Interrupt to INT1", size: "1", shift: "11", mask: "0x800" },
			{ name: "INT1_EN_PING_TAG_MATCH", description: "Enable Ping Frame Tag Matched Interrupt to INT1", size: "1", shift: "12", mask: "0x1000" },
			{ name: "INT1_EN_DATA_TAG_MATCH", description: "Enable Data Frame Tag Matched Interrupt to INT1", size: "1", shift: "13", mask: "0x2000" },
			{ name: "INT1_EN_ERROR_TAG_MATCH", description: "Enable Error Frame Tag Matched Interrupt to INT1", size: "1", shift: "14", mask: "0x4000" },
		]
	},
	{ name: "RX_INT2_CTRL", description: "Receive interrupt control register for RX_INT2", offset: "0x1D", size: "16",
		bits: [
			{ name: "INT2_EN_PING_WD_TO", description: "Enable Ping Watchdog Timeout Interrupt to INT2", size: "1", shift: "0", mask: "0x1" },
			{ name: "INT2_EN_FRAME_WD_TO", description: "Enable Frame Watchdog Timeout Interrupt to INT2", size: "1", shift: "1", mask: "0x2" },
			{ name: "INT2_EN_CRC_ERR", description: "Enable CRC Errror Interrupt to INT2", size: "1", shift: "2", mask: "0x4" },
			{ name: "INT2_EN_TYPE_ERR", description: "Enable Frame Type Error Interrupt to INT2", size: "1", shift: "3", mask: "0x8" },
			{ name: "INT2_EN_EOF_ERR", description: "Enable End-of-Frame Error Interrupt to INT2", size: "1", shift: "4", mask: "0x10" },
			{ name: "INT2_EN_OVERRUN", description: "Enable Buffer Overrun Interrupt to INT2", size: "1", shift: "5", mask: "0x20" },
			{ name: "INT2_EN_FRAME_DONE", description: "Enable Frame Done Interrupt to INT2", size: "1", shift: "6", mask: "0x40" },
			{ name: "INT2_EN_UNDERRUN", description: "Enable Buffer Underrun Interrupt to INT2", size: "1", shift: "7", mask: "0x80" },
			{ name: "INT2_EN_ERR_FRAME", description: "Enable Error Frame Received Interrupt to INT2", size: "1", shift: "8", mask: "0x100" },
			{ name: "INT2_EN_PING_FRAME", description: "Enable Ping Frame Received Interrupt to INT2", size: "1", shift: "9", mask: "0x200" },
			{ name: "INT2_EN_FRAME_OVERRUN", description: "Enable Frame Overrun Interrupt to INT2", size: "1", shift: "10", mask: "0x400" },
			{ name: "INT2_EN_DATA_FRAME", description: "Enable Data Frame Received Interrupt to INT2", size: "1", shift: "11", mask: "0x800" },
			{ name: "INT2_EN_PING_TAG_MATCH", description: "Enable Ping Frame Tag Matched Interrupt to INT2", size: "1", shift: "12", mask: "0x1000" },
			{ name: "INT2_EN_DATA_TAG_MATCH", description: "Enable Data Frame Tag Matched Interrupt to INT2", size: "1", shift: "13", mask: "0x2000" },
			{ name: "INT2_EN_ERROR_TAG_MATCH", description: "Enable Error Frame Tag Matched Interrupt to INT2", size: "1", shift: "14", mask: "0x4000" },
		]
	},
	{ name: "RX_LOCK_CTRL", description: "Receive lock control register", offset: "0x1E", size: "16",
		bits: [
			{ name: "LOCK", description: "Control Register Lock Enable", size: "1", shift: "0", mask: "0x1" },
			{ name: "KEY", description: "Write Key", size: "8", shift: "8", mask: "0xFF00" },
		]
	},
	{ name: "RX_ECC_DATA", description: "Receive ECC data register", offset: "0x20", size: "32",
		bits: [
			{ name: "DATA_LOW", description: "ECC Data Lower 16 Bits", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA_HIGH", description: "ECC Data Upper 16 Bits", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "RX_ECC_VAL", description: "Receive ECC value register", offset: "0x22", size: "16",
		bits: [
			{ name: "ECC_VAL", description: "Computed ECC Value", size: "7", shift: "0", mask: "0x7F" },
		]
	},
	{ name: "RX_ECC_SEC_DATA", description: "Receive ECC corrected data register", offset: "0x24", size: "16",
		bits: [
		]
	},
	{ name: "RX_ECC_LOG", description: "Receive ECC log and status register", offset: "0x26", size: "16",
		bits: [
	...
	{ name: "RX_FRAME_TAG_CMP", description: "Receive frame tag compare register", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "RX_PING_TAG_CMP", description: "Receive ping tag compare register", offset: "0x29", size: "16",
		bits: [
	...
	{ name: "RX_TRIG_CTRL_0", description: "Receive Trigger Control register 0", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "RX_TRIG_WIDTH_0", description: "Receive Trigger Wdith register 0", offset: "0x2E", size: "16",
		bits: [
			{ name: "RX_TRIG_WIDTH", description: "Output Pulse Width", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "RX_DLYLINE_CTRL", description: "Receive delay line control register", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "RX_TRIG_CTRL_1", description: "Receive Trigger Control register 1", offset: "0x32", size: "32",
		bits: [
			{ name: "TRIG_EN", description: "Enable Trigger Function", size: "1", shift: "0", mask: "0x1" },
			{ name: "TRIG_SEL", description: "Input Select for Trigger", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RX_TRIG_DLY", description: "Delay for Trigger generation", size: "24", shift: "8", mask: "0xFFFFFF00" },
	...
	{ name: "RX_TRIG_CTRL_2", description: "Receive Trigger Control register 2", offset: "0x34", size: "32",
		bits: [
			{ name: "TRIG_EN", description: "Enable Trigger Function", size: "1", shift: "0", mask: "0x1" },
			{ name: "TRIG_SEL", description: "Input Select for Trigger", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RX_TRIG_DLY", description: "Delay for Trigger generation", size: "24", shift: "8", mask: "0xFFFFFF00" },
	...
	{ name: "RX_TRIG_CTRL_3", description: "Receive Trigger Control register 3", offset: "0x36", size: "32",
		bits: [
			{ name: "TRIG_EN", description: "Enable Trigger Function", size: "1", shift: "0", mask: "0x1" },
			{ name: "TRIG_SEL", description: "Input Select for Trigger", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RX_TRIG_DLY", description: "Delay for Trigger generation", size: "24", shift: "8", mask: "0xFFFFFF00" },
	...
	{ name: "RX_VIS_1", description: "Receive debug visibility register 1", offset: "0x38", size: "16",
		bits: [
			{ name: "RX_CORE_STS", description: "Receiver Core Status", size: "1", shift: "3", mask: "0x8" },
		]
	},
	{ name: "RX_UDATA_FILTER", description: "Receive User Data Filter Control register", offset: "0x3A", size: "16",
		bits: [
	...
	{ name: "RX_BUF_BASE", description: "(0 <= i < 16) Base address for receive data buffer", offset: "(0x40 + (i))", count: "16", size: "16",
		bits: [
		]
	},
];
module.exports = {
	fsiRegisters: FSI_REGISTERS,
}
