let XBAR_REGISTERS = [
	...
	{ name: "FLG3", description: "X-Bar Input Flag Register 3", offset: "0x4", size: "16",
		bits: [
			...
			{ name: "ADCEEVT1", description: "Input Flag for ADCEEVT1 Signal", size: "1", shift: "15", mask: "0x8000" },
			{ name: "ADCEEVT2", description: "Input Flag for ADCEEVT2 Signal", size: "1", shift: "16", mask: "0x10000" },
			{ name: "ADCEEVT3", description: "Input Flag for ADCEEVT3 Signal", size: "1", shift: "17", mask: "0x20000" },
			{ name: "ADCEEVT4", description: "Input Flag for ADCEEVT4 Signal", size: "1", shift: "18", mask: "0x40000" },
		]
	},
	{ name: "FLG4", description: "X-Bar Input Flag Register 4", offset: "0x6", size: "16",
		bits: [
			...
			{ name: "MCANB_FEVT0", description: "Input Flag for MCANB_FEVT0 Signal", size: "1", shift: "12", mask: "0x1000" },
			{ name: "MCANB_FEVT1", description: "Input Flag for MCANB_FEVT1 Signal", size: "1", shift: "13", mask: "0x2000" },
			{ name: "MCANB_FEVT2", description: "Input Flag for MCANB_FEVT2 Signal", size: "1", shift: "14", mask: "0x4000" },
			{ name: "CLB1_OUT4", description: "Input Latch for CLB1_OUT4 Signal", size: "1", shift: "16", mask: "0x10000" },
			{ name: "CLB1_OUT5", description: "Input Latch for CLB1_OUT5 Signal", size: "1", shift: "17", mask: "0x20000" },
			{ name: "CLB2_OUT4", description: "Input Latch for CLB2_OUT4 Signal", size: "1", shift: "18", mask: "0x40000" },
			{ name: "CLB2_OUT5", description: "Input Latch for CLB2_OUT5 Signal", size: "1", shift: "19", mask: "0x80000" },
	...
	{ name: "CLR3", description: "X-Bar Input Flag Clear Register 3", offset: "0xC", size: "16",
		bits: [
			...
			{ name: "ADCEEVT1", description: "Input Flag Clear for ADCEEVT1 Signal", size: "1", shift: "15", mask: "0x8000" },
			{ name: "ADCEEVT2", description: "Input Flag Clear for ADCEEVT2 Signal", size: "1", shift: "16", mask: "0x10000" },
			{ name: "ADCEEVT3", description: "Input Flag Clear for ADCEEVT3 Signal", size: "1", shift: "17", mask: "0x20000" },
			{ name: "ADCEEVT4", description: "Input Flag Clear for ADCEEVT4 Signal", size: "1", shift: "18", mask: "0x40000" },
		]
	},
	{ name: "CLR4", description: "X-Bar Input Flag Clear Register 4", offset: "0xE", size: "16",
		bits: [
			...
			{ name: "MCANB_FEVT0", description: "Input Flag clear for MCANB_FEVT0 Signal", size: "1", shift: "12", mask: "0x1000" },
			{ name: "MCANB_FEVT1", description: "Input Flag clear for MCANB_FEVT1 Signal", size: "1", shift: "13", mask: "0x2000" },
			{ name: "MCANB_FEVT2", description: "Input Flag clear for MCANB_FEVT2 Signal", size: "1", shift: "14", mask: "0x4000" },
			{ name: "CLB1_OUT4", description: "Input Latch clear for CLB1_OUT4 Signal", size: "1", shift: "16", mask: "0x10000" },
			{ name: "CLB1_OUT5", description: "Input Latch clear for CLB1_OUT5 Signal", size: "1", shift: "17", mask: "0x20000" },
			{ name: "CLB2_OUT4", description: "Input Latch clear for CLB2_OUT4 Signal", size: "1", shift: "18", mask: "0x40000" },
			{ name: "CLB2_OUT5", description: "Input Latch clear for CLB2_OUT5 Signal", size: "1", shift: "19", mask: "0x80000" },
