let MCBSP_REGISTERS = [
	{ name: "DRR2", description: "Data receive register bits 31-16", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "DRR1", description: "Data receive register bits 15-0", offset: "0x1", size: "16",
		bits: [
	...
	{ name: "DXR2", description: "Data transmit register bits 31-16", offset: "0x2", size: "16",
		bits: [
			{ name: "HWLB", description: "High word low byte", size: "8", shift: "0", mask: "0xFF" },
			{ name: "HWHB", description: "High word high byte", size: "8", shift: "8", mask: "0xFF00" },
		]
	},
	{ name: "DXR1", description: "Data transmit register bits 15-0", offset: "0x3", size: "16",
		bits: [
			{ name: "LWLB", description: "Low word low byte", size: "8", shift: "0", mask: "0xFF" },
			{ name: "LWHB", description: "Low word high byte", size: "8", shift: "8", mask: "0xFF00" },
		]
	},
	{ name: "SPCR2", description: "Serial port control register 2", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "SPCR1", description: "Serial port control register 1", offset: "0x5", size: "16",
		bits: [
	...
	{ name: "RCR2", description: "Receive Control register 2", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "RCR1", description: "Receive Control register 1", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "XCR2", description: "Transmit Control register 2", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "XCR1", description: "Transmit Control register 1", offset: "0x9", size: "16",
		bits: [
	...
	{ name: "SRGR2", description: "Sample rate generator register 2", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "SRGR1", description: "Sample rate generator register 1", offset: "0xB", size: "16",
		bits: [
	...
	{ name: "MCR2", description: "Multi-channel control register 2", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "MCR1", description: "Multi-channel control register 1", offset: "0xD", size: "16",
		bits: [
	...
	{ name: "RCERA", description: "Receive channel enable partition A", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "RCERB", description: "Receive channel enable partition B", offset: "0xF", size: "16",
		bits: [
		]
	},
	{ name: "XCERA", description: "Transmit channel enable partition A", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "XCERB", description: "Transmit channel enable partition B", offset: "0x11", size: "16",
		bits: [
		]
	},
	{ name: "PCR", description: "Pin Control register", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "RCERC", description: "Receive channel enable partition C", offset: "0x13", size: "16",
		bits: [
		]
	},
	{ name: "RCERD", description: "Receive channel enable partition D", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "XCERC", description: "Transmit channel enable partition C", offset: "0x15", size: "16",
		bits: [
		]
	},
	{ name: "XCERD", description: "Transmit channel enable partition D", offset: "0x16", size: "16",
		bits: [
		]
	},
	{ name: "RCERE", description: "Receive channel enable partition E", offset: "0x17", size: "16",
		bits: [
		]
	},
	{ name: "RCERF", description: "Receive channel enable partition F", offset: "0x18", size: "16",
		bits: [
		]
	},
	{ name: "XCERE", description: "Transmit channel enable partition E", offset: "0x19", size: "16",
		bits: [
		]
	},
	{ name: "XCERF", description: "Transmit channel enable partition F", offset: "0x1A", size: "16",
		bits: [
		]
	},
	{ name: "RCERG", description: "Receive channel enable partition G", offset: "0x1B", size: "16",
		bits: [
		]
	},
	{ name: "RCERH", description: "Receive channel enable partition H", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "XCERG", description: "Transmit channel enable partition G", offset: "0x1D", size: "16",
		bits: [
		]
	},
	{ name: "XCERH", description: "Transmit channel enable partition H", offset: "0x1E", size: "16",
		bits: [
		]
	},
	{ name: "MFFINT", description: "Interrupt enable", offset: "0x23", size: "16",
		bits: [
