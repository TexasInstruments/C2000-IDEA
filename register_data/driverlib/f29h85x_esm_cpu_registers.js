let ESM_CPU_REGISTERS = [
	...
	{ name: "HI_PRI_WD_CFG", description: "High Priority Watchdog Config Register", offset: "0x80", size: "16",
		bits: [
			{ name: "WD_EN", description: "", size: "4", shift: "0", mask: "0xF" },
			{ name: "EMU_FREE", description: "", size: "4", shift: "8", mask: "0xF00" },
		]
	},
	{ name: "HI_PRI_WD_CNTR", description: "High Priority Watchdog Counter Value Register", offset: "0x84", size: "16",
		bits: [
		]
	},
	{ name: "HI_PRI_WD_CNTR_PRE", description: "High Priority Watchdog Pre-Load Register", offset: "0x88", size: "16",
		bits: [
		]
	},
	{ name: "HI_PRI_WD_INTR_SET", description: "High Priority Watchdog Interrupt Status/Set Register", offset: "0x8C", size: "16",
		bits: [
			{ name: "VAL", description: "", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "HI_PRI_WD_INTR_CLR", description: "High Priority Watchdog Interrupt Status/Clear Register", offset: "0x90", size: "16",
		bits: [
			{ name: "VAL", description: "", size: "1", shift: "0", mask: "0x1" },
		]
	},
