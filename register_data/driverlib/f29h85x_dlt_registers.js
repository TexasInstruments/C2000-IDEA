let DLT_REGISTERS = [
	{ name: "ERAD_START_MASK_L", description: "ERAD Start Mask for Lower 32 lines", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "ERAD_START_MASK_H", description: "ERAD Start Mask for Higher 32 lines", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "ERAD_END_MASK_L", description: "ERAD End Mask for Lower 32 lines", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "ERAD_END_MASK_H", description: "ERAD End Mask for Higher 32 lines", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "TAG_FILTER_START_REF", description: "Tag Filer Start Reference", offset: "0x10", size: "16",
		bits: [
			{ name: "START_REF", description: "Reference for TAG start comparison", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "TAG_FILTER_START_MASK", description: "Tag Filer Start Mask", offset: "0x14", size: "16",
		bits: [
			{ name: "START_MASK", description: "MASK for TAG start comparison", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "TAG_FILTER_END_REF", description: "Tag Filer End Reference", offset: "0x18", size: "16",
		bits: [
			{ name: "END_REF", description: "Reference for TAG end comparison", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "TAG_FILTER_END_MASK", description: "Tag Filer End Mask", offset: "0x1C", size: "16",
		bits: [
			{ name: "END_MASK", description: "MASK for TAG end comparison", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "LINK_EN", description: "Link Enable", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "CONTROL", description: "DLT Control Register", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "FIFO_CONTROL", description: "FIFO Control Register", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "TIMER_CONTROL", description: "Timer Control Register", offset: "0x2C", size: "16",
		bits: [
			{ name: "TIMER2_RST", description: "Timer 2 is reset", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "FIFO_STS", description: "Number of entries in FIFO", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "FIFO_PTR", description: "Pointer locations in FIFO", offset: "0x34", size: "32",
		bits: [
	...
	{ name: "TIMER2_COUNT", description: "Timer2 Status", offset: "0x38", size: "32",
		bits: [
			{ name: "COUNT", description: "Current value of TIMER2", size: "29", shift: "0", mask: "0x1FFFFFFF" },
		]
	},
	{ name: "INT_FLG", description: "Interrupt Flag", offset: "0x3C", size: "16",
		bits: [
	...
	{ name: "INT_EN", description: "Interrupt Enable", offset: "0x40", size: "16",
		bits: [
	...
	{ name: "INT_FRC", description: "Interrupt Force", offset: "0x44", size: "16",
		bits: [
	...
	{ name: "INT_CLR", description: "Interrupt Clear", offset: "0x48", size: "16",
		bits: [
	...
	{ name: "FIFO_BUF_L", description: "FIFO Content Register", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "FIFO_BUF_H", description: "FIFO Content Register", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "FIFO_MEM", description: "(0 <= i < 512) FIFO access in Memory mode", offset: "(0x1000 + ((i) * 0x4))", count: "512", size: "16",
		bits: [
		]
	},
];
