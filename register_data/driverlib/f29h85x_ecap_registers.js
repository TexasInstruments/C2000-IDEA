let ECAP_REGISTERS = [
	...
	{ name: "CTRPHS", description: "Counter Phase Offset Value Register", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "CAP1", description: "Capture 1 Register", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "CAP2", description: "Capture 2 Register", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "CAP3", description: "Capture 3 Register", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "CAP4", description: "Capture 4 Register", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "ECCTL0", description: "Capture Control Register 0", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "ECCTL1", description: "Capture Control Register 1", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "ECCTL2", description: "Capture Control Register 2", offset: "0x2A", size: "16",
		bits: [
	...
	{ name: "ECEINT", description: "Capture Interrupt Enable Register", offset: "0x2C", size: "16",
		bits: [
	...
	{ name: "ECFLG", description: "Capture Interrupt Flag Register", offset: "0x2E", size: "16",
		bits: [
	...
	{ name: "ECCLR", description: "Capture Interrupt Clear Register", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "ECFRC", description: "Capture Interrupt Force Register", offset: "0x32", size: "16",
		bits: [
	...
	{ name: "SYNCINSEL", description: "SYNC source select register", offset: "0x3C", size: "16",
		bits: [
			{ name: "SEL", description: "SYNCIN source select", size: "7", shift: "0", mask: "0x7F" },
		]
	},
	{ name: "HRCTL", description: "High-Res Control Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "HRINTEN", description: "High-Res Calibration Interrupt Enable Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "HRFLG", description: "High-Res Calibration Interrupt Flag Register", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "HRCLR", description: "High-Res Calibration Interrupt Clear Register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "HRFRC", description: "High-Res Calibration Interrupt Force Register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "HRCALPRD", description: "High-Res Calibration Period Register", offset: "0x18", size: "16",
		bits: [
		]
	},
	{ name: "HRSYSCLKCTR", description: "High-Res Calibration SYSCLK Counter Register", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "HRSYSCLKCAP", description: "High-Res Calibration SYSCLK Capture Register", offset: "0x20", size: "16",
		bits: [
		]
	},
	{ name: "HRCLKCTR", description: "High-Res Calibration HRCLK Counter Register", offset: "0x24", size: "16",
		bits: [
		]
	},
	{ name: "HRCLKCAP", description: "High-Res Calibration HRCLK Capture Register", offset: "0x28", size: "16",
		bits: [
		]
	},
	...
	{ name: "MUNIT_1_CTL", description: "Control registers for monitoring unit 1", offset: "0x40", size: "16",
		bits: [
	...
	{ name: "MUNIT_1_SHADOW_CTL", description: "Shadow control registers for monitoring unit 1", offset: "0x44", size: "16",
		bits: [
	...
	{ name: "MUNIT_1_MIN", description: "Min value for monitoring unit 1", offset: "0x50", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_1_MAX", description: "Max value for monitoring unit 1", offset: "0x54", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_1_MIN_SHADOW", description: "Shadow register for Min value of monitoring unit 1", offset: "0x58", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_1_MAX_SHADOW", description: "Shadow register for Max value of monitoring unit 1", offset: "0x5C", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_1_DEBUG_RANGE_MIN", description: "Observed Min value of check being enabled on minotoring unit 1", offset: "0x60", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_1_DEBUG_RANGE_MAX", description: "Observed Max value of check being enabled on minotoring unit 1", offset: "0x64", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_2_CTL", description: "Control registers for monitoring unit 2", offset: "0x80", size: "16",
		bits: [
			{ name: "EN", description: "Enable bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "DEBUG_RANGE_EN", description: "Debug enable to aquire the range of check being done", size: "1", shift: "1", mask: "0x2" },
			{ name: "DISABLE_EARLY_MAX_ERR", description: "Disable early max error check", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MUNIT_2_SHADOW_CTL", description: "Shadow control registers for monitoring unit 2", offset: "0x84", size: "16",
		bits: [
			{ name: "SYNCI_EN", description: "Enable for shadowing on Min and Max Registers", size: "1", shift: "0", mask: "0x1" },
			{ name: "SWSYNC", description: "SW sync to copy shadow to active Min and Max registers", size: "1", shift: "1", mask: "0x2" },
			{ name: "LOADMODE", description: "Load mode", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MUNIT_2_MIN", description: "Min value for monitoring unit 2", offset: "0x90", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_2_MAX", description: "Max value for monitoring unit 2", offset: "0x94", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_2_MIN_SHADOW", description: "Shadow register for Min value of monitoring unit 2", offset: "0x98", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_2_MAX_SHADOW", description: "Shadow register for Max value of monitoring unit 2", offset: "0x9C", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_2_DEBUG_RANGE_MIN", description: "Observed Min value of check being enabled on minotoring unit 2", offset: "0xA0", size: "16",
		bits: [
		]
	},
	{ name: "MUNIT_2_DEBUG_RANGE_MAX", description: "Observed Max value of check being enabled on minotoring unit 2", offset: "0xA4", size: "16",
		bits: [
		]
	},
];
