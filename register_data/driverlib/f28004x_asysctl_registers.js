let ASYSCTL_REGISTERS = [
	{ name: "ANAREFPP", description: "ADC Analog Reference Peripheral Properties register. The value of this register is populated during boot rom.", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "ANAREFCTL", description: "Analog Reference Control Register", offset: "0x68", size: "16",
		bits: [
	...
	{ name: "DCDCCTL", description: "DC-DC control register.", offset: "0x78", size: "16",
		bits: [
			{ name: "DCDCEN", description: "DCDC Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "DCDCSTS", description: "DC-DC status register.", offset: "0x7A", size: "16",
		bits: [
	...
	{ name: "CMPHPMXSEL", description: "Bits to select one of the many sources on CopmHP inputs. Refer to Pimux diagram for details.", offset: "0x82", size: "32",
		bits: [
	...
	{ name: "CMPLPMXSEL", description: "Bits to select one of the many sources on CopmLP inputs. Refer to Pimux diagram for details.", offset: "0x84", size: "32",
		bits: [
	...
	{ name: "CMPHNMXSEL", description: "Bits to select one of the many sources on CopmHN inputs. Refer to Pimux diagram for details.", offset: "0x86", size: "16",
		bits: [
	...
	{ name: "CMPLNMXSEL", description: "Bits to select one of the many sources on CopmLN inputs. Refer to Pimux diagram for details.", offset: "0x87", size: "16",
		bits: [
