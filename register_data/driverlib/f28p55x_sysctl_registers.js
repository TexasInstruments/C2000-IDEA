let SYSCTL_REGISTERS = [
	...
	{ name: "SOFTPRES11", description: "McBSP/USB Software Reset register", offset: "0x98", size: "16",
		bits: [
	...
	{ name: "SOFTPRES30", description: "TINIE Software reset register", offset: "0xBE", size: "16",
		bits: [
	...
	{ name: "MCUCNF12", description: "MCU Configuration: McBSP_USB", offset: "0x1B8", size: "16",
		bits: [
	...
	{ name: "MCUCNF32", description: "MCU Configuration: Flash Bank1", offset: "0x1E0", size: "16",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCUCNF34", description: "MCU Configuration: Flash Bank3", offset: "0x1E4", size: "16",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "AUXCLKDIVSEL", description: "Auxillary Clock Divider Select register", offset: "0x24", size: "16",
		bits: [
			...
			{ name: "MCANBCLKDIV", description: "Divider between MCANB Source Clock and MCANB Bit CLK", size: "5", shift: "13", mask: "0x3E000" },
		]
	},
	...
	{ name: "PCLKCR11", description: "Peripheral Clock Gating Register - McBSP_USB", offset: "0x38", size: "16",
		bits: [
	...
	{ name: "USBA_AC", description: "USBA Controller Access Control Register", offset: "0x182", size: "16",
		bits: [
			{ name: "CPU1_ACC", description: "CPU1 Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
