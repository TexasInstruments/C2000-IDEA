let SYSCTL_REGISTERS = [
	{ name: "DEVCFGLOCK1", description: "Lock bit for CPUSELx registers", offset: "0x0", size: "16",
		bits: [
			...
			{ name: "CPUSEL10", description: "Lock bit for CPUSEL10 register", size: "1", shift: "10", mask: "0x400" },
	...
	{ name: "DC0", description: "Device Capability: Device Information", offset: "0x10", size: "16",
		bits: [
			{ name: "SINGLE_CORE", description: "Single Core vs Dual Core", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "DC1", description: "Device Capability: Processing Block Customization", offset: "0x12", size: "16",
		bits: [
			{ name: "CPU1_FPU_TMU", description: "CPU1's FPU1+TMU1", size: "1", shift: "0", mask: "0x1" },
			{ name: "CPU2_FPU_TMU", description: "CPU2's FPU2+TMU2", size: "1", shift: "1", mask: "0x2" },
			{ name: "CPU1_VCU", description: "CPU1's VCU", size: "1", shift: "2", mask: "0x4" },
			{ name: "CPU2_VCU", description: "CPU2's VCU", size: "1", shift: "3", mask: "0x8" },
			{ name: "CPU1_CLA1", description: "CPU1.CLA1", size: "1", shift: "6", mask: "0x40" },
			{ name: "CPU2_CLA1", description: "CPU2.CLA1", size: "1", shift: "8", mask: "0x100" },
		]
	},
	{ name: "DC2", description: "Device Capability: EMIF Customization", offset: "0x14", size: "16",
		bits: [
			{ name: "EMIF1", description: "EMIF1", size: "1", shift: "0", mask: "0x1" },
			{ name: "EMIF2", description: "EMIF2", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "DC3", description: "Device Capability: Peripheral Customization", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "DC4", description: "Device Capability: Peripheral Customization", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "DC5", description: "Device Capability: Peripheral Customization", offset: "0x1A", size: "16",
		bits: [
	...
	{ name: "DC6", description: "Device Capability: Peripheral Customization", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "DC7", description: "Device Capability: Peripheral Customization", offset: "0x1E", size: "16",
		bits: [
			{ name: "SD1", description: "SD1", size: "1", shift: "0", mask: "0x1" },
			{ name: "SD2", description: "SD2", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "DC8", description: "Device Capability: Peripheral Customization", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "DC9", description: "Device Capability: Peripheral Customization", offset: "0x22", size: "16",
		bits: [
	...
	{ name: "DC10", description: "Device Capability: Peripheral Customization", offset: "0x24", size: "16",
		bits: [
			{ name: "I2C_A", description: "I2C_A", size: "1", shift: "0", mask: "0x1" },
			{ name: "I2C_B", description: "I2C_B", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "DC11", description: "Device Capability: Peripheral Customization", offset: "0x26", size: "16",
		bits: [
			{ name: "CAN_A", description: "CAN_A", size: "1", shift: "0", mask: "0x1" },
			{ name: "CAN_B", description: "CAN_B", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "DC12", description: "Device Capability: Peripheral Customization", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "DC13", description: "Device Capability: Peripheral Customization", offset: "0x2A", size: "16",
		bits: [
			{ name: "UPP_A", description: "uPP_A", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "DC14", description: "Device Capability: Analog Modules Customization", offset: "0x2C", size: "16",
		bits: [
	...
	{ name: "DC15", description: "Device Capability: Analog Modules Customization", offset: "0x2E", size: "16",
		bits: [
	...
	{ name: "DC17", description: "Device Capability: Analog Modules Customization", offset: "0x32", size: "16",
		bits: [
	...
	{ name: "DC18", description: "Device Capability: CPU1 Lx SRAM Customization", offset: "0x34", size: "16",
		bits: [
	...
	{ name: "DC19", description: "Device Capability: CPU2 Lx SRAM Customization", offset: "0x36", size: "16",
		bits: [
			{ name: "LS0_2", description: "LS0_2", size: "1", shift: "0", mask: "0x1" },
			{ name: "LS1_2", description: "LS1_2", size: "1", shift: "1", mask: "0x2" },
			{ name: "LS2_2", description: "LS2_2", size: "1", shift: "2", mask: "0x4" },
			{ name: "LS3_2", description: "LS3_2", size: "1", shift: "3", mask: "0x8" },
			{ name: "LS4_2", description: "LS4_2", size: "1", shift: "4", mask: "0x10" },
			{ name: "LS5_2", description: "LS5_2", size: "1", shift: "5", mask: "0x20" },
		]
	},
	{ name: "DC20", description: "Device Capability: GSx SRAM Customization", offset: "0x38", size: "16",
		bits: [
	...
	{ name: "PERCNF1", description: "Peripheral Configuration register", offset: "0x60", size: "16",
		bits: [
			...
			{ name: "ADC_C_MODE", description: "ADC_C mode setting bit", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CPUSEL14", description: "CPU Select register for common peripherals", offset: "0xF2", size: "16",
		bits: [
			...
			{ name: "DAC_B", description: "Buffered_DAC_B CPU select bit", size: "1", shift: "17", mask: "0x20000" },
	...
	{ name: "RSTSTAT", description: "Reset Status register for secondary C28x CPUs", offset: "0x124", size: "16",
		bits: [
			...
			{ name: "CPU2HWBISTRST0", description: "Indicates whether a HWBIST reset was issued to CPU2", size: "1", shift: "2", mask: "0x4" },
			{ name: "CPU2HWBISTRST1", description: "Indicates whether a HWBIST reset was issued to CPU2", size: "1", shift: "3", mask: "0x8" },
		]
	},
	...
	{ name: "SYSDBGCTL", description: "System Debug Control register", offset: "0x12C", size: "16",
		bits: [
	...
	{ name: "AUXPLLMULT", description: "AUXPLL Multiplier register", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "HIBBOOTMODE", description: "HIB Boot Mode Register", offset: "0x6", size: "16",
		bits: [
		]
	},
	{ name: "IORESTOREADDR", description: "IORestore() routine Address Register", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "PCLKCR12", description: "Peripheral Clock Gating Registers", offset: "0x3A", size: "16",
		bits: [
	...
	{ name: "SECMSEL", description: "Secondary Master Select register for common peripherals: Selects between CLA & DMA", offset: "0x74", size: "16",
		bits: [
