let ASYSCTL_REGISTERS = [
	...
	{ name: "CONFIGLOCK", description: "Lock Register for all the config registers.", offset: "0x6A", size: "16",
		bits: [
	...
	{ name: "CMPHPMXSEL", description: "Bits to select one of the many sources on CompHP inputs. Refer to Pimux diagram for details.", offset: "0x8E", size: "16",
		bits: [
	...
	{ name: "CMPLPMXSEL", description: "Bits to select one of the many sources on CompLP inputs. Refer to Pimux diagram for details.", offset: "0x90", size: "16",
		bits: [
	...
	{ name: "LOCK", description: "Lock Register", offset: "0x9A", size: "16",
		bits: [
	...
	{ name: "AGPIOCTRLA", description: "AGPIO Control Register", offset: "0x120", size: "16",
		bits: [
	...
	{ name: "AGPIOCTRLH", description: "AGPIO Control Register", offset: "0x12E", size: "16",
		bits: [
	...
	{ name: "GPIOINENACTRL", description: "GPIOINENACTRL Control Register", offset: "0x140", size: "16",
		bits: [
