let CLB_REGISTERS = [
	{ name: "COUNT_RESET", description: "Counter Block RESET", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "COUNT_MODE_1", description: "Counter Block MODE_1", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "COUNT_MODE_0", description: "Counter Block MODE_0", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "COUNT_EVENT", description: "Counter Block EVENT", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "FSM_EXTRA_IN0", description: "FSM Extra EXT_IN0", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "FSM_EXTERNAL_IN0", description: "FSM EXT_IN0", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "FSM_EXTERNAL_IN1", description: "FSM_EXT_IN1", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "FSM_EXTRA_IN1", description: "FSM Extra_EXT_IN1", offset: "0x20", size: "16",
		bits: [
			{ name: "SEL_0", description: "FSM extra ext input select 0", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SEL_1", description: "FSM extra ext input select 1", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "SEL_2", description: "FSM extra ext input select 2", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "LUT4_IN0", description: "LUT4_0/1/2 IN0 input source", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "LUT4_IN1", description: "LUT4_0/1/2 IN1 input source", offset: "0x28", size: "16",
		bits: [
			{ name: "SEL_0", description: "Select inputs for unit 0", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SEL_1", description: "Select inputs for unit 1", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "SEL_2", description: "Select inputs for unit 2", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "LUT4_IN2", description: "LUT4_0/1/2 IN2 input source", offset: "0x2C", size: "16",
		bits: [
			{ name: "SEL_0", description: "Select inputs for unit 0", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SEL_1", description: "Select inputs for unit 1", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "SEL_2", description: "Select inputs for unit 2", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "LUT4_IN3", description: "LUT4_0/1/2 IN3 input source", offset: "0x30", size: "16",
		bits: [
			{ name: "SEL_0", description: "Select inputs for unit 0", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SEL_1", description: "Select inputs for unit 1", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "SEL_2", description: "Select inputs for unit 2", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "FSM_LUT_FN1_0", description: "LUT function for FSM Unit 1 and Unit 0", offset: "0x38", size: "32",
		bits: [
	...
	{ name: "FSM_LUT_FN2", description: "LUT function for FSM Unit 2", offset: "0x3C", size: "16",
		bits: [
			{ name: "FN1", description: "FSM LUT output function for unit 2", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "LUT4_FN1_0", description: "LUT function for LUT4 block of Unit 1 and 0", offset: "0x40", size: "32",
		bits: [
	...
	{ name: "LUT4_FN2", description: "LUT function for LUT4 block of Unit 2", offset: "0x44", size: "16",
		bits: [
			{ name: "FN1", description: "LUT4 output function for unit 2", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "FSM_NEXT_STATE_0", description: "FSM Next state equations for Unit 0", offset: "0x48", size: "32",
		bits: [
	...
	{ name: "FSM_NEXT_STATE_1", description: "FSM Next state equations for Unit 1", offset: "0x4C", size: "32",
		bits: [
			{ name: "S0", description: "FSM next state function for S0", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "S1", description: "FSM next state function for S1", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "FSM_NEXT_STATE_2", description: "FSM Next state equations for Unit 2", offset: "0x50", size: "32",
		bits: [
			{ name: "S0", description: "FSM next state function for S0", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "S1", description: "FSM next state function for S1", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "MISC_CONTROL", description: "Static controls for Ctr,FSM", offset: "0x54", size: "32",
		bits: [
	...
	{ name: "OUTPUT_LUT_0", description: "Inp Sel, LUT fns for Out0", offset: "0x58", size: "32",
		bits: [
	...
	{ name: "OUTPUT_LUT_1", description: "Inp Sel, LUT fns for Out1", offset: "0x5C", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "OUTPUT_LUT_2", description: "Inp Sel, LUT fns for Out2", offset: "0x60", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "OUTPUT_LUT_3", description: "Inp Sel, LUT fns for Out3", offset: "0x64", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "OUTPUT_LUT_4", description: "Inp Sel, LUT fns for Out4", offset: "0x68", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "OUTPUT_LUT_5", description: "Inp Sel, LUT fns for Out5", offset: "0x6C", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "OUTPUT_LUT_6", description: "Inp Sel, LUT fns for Out6", offset: "0x70", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "OUTPUT_LUT_7", description: "Inp Sel, LUT fns for Out7", offset: "0x74", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "HLC_EVENT_SEL", description: "Event Selector register for the High Level controller", offset: "0x78", size: "32",
		bits: [
	...
	{ name: "COUNT_MATCH_TAP_SEL", description: "Counter tap values for match1 and match2 outputs", offset: "0x7C", size: "32",
		bits: [
	...
	{ name: "OUTPUT_COND_CTRL_0", description: "Output conditioning control for output 0", offset: "0x80", size: "16",
		bits: [
	...
	{ name: "OUTPUT_COND_CTRL_1", description: "Output conditioning control for output 1", offset: "0x84", size: "16",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "OUTPUT_COND_CTRL_2", description: "Output conditioning control for output 2", offset: "0x88", size: "16",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "OUTPUT_COND_CTRL_3", description: "Output conditioning control for output 3", offset: "0x8C", size: "16",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "OUTPUT_COND_CTRL_4", description: "Output conditioning control for output 4", offset: "0x90", size: "16",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "OUTPUT_COND_CTRL_5", description: "Output conditioning control for output 5", offset: "0x94", size: "16",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "OUTPUT_COND_CTRL_6", description: "Output conditioning control for output 6", offset: "0x98", size: "16",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "OUTPUT_COND_CTRL_7", description: "Output conditioning control for output 7", offset: "0x9C", size: "16",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "MISC_ACCESS_CTRL", description: "Miscellaneous Access and enable control", offset: "0xA0", size: "16",
		bits: [
	...
	{ name: "SPI_DATA_CTRL_HI", description: "CLB to SPI buffer control High", offset: "0xA2", size: "16",
		bits: [
	...
	{ name: "LOAD_EN", description: "Global enable & indirect load enable control, only Global Enable Bit is LOCK protected", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "LOAD_ADDR", description: "Indirect address", offset: "0x4", size: "16",
		bits: [
			{ name: "ADDR", description: "Indirect Address", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "LOAD_DATA", description: "Data for indirect loads", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "INPUT_FILTER", description: "Input filter selection for both edge detection and synchronizers", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "IN_MUX_SEL_0", description: "Input selection to decide between Signals and GP register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "LCL_MUX_SEL_1", description: "Input Mux selection for local mux", offset: "0x14", size: "32",
		bits: [
	...
	{ name: "LCL_MUX_SEL_2", description: "Input Mux selection for local mux", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "BUF_PTR", description: "PUSH and PULL pointers", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "GP_REG", description: "General purpose register for CELL inputs", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "OUT_EN", description: "CELL output enable register", offset: "0x24", size: "16",
		bits: [
		]
	},
	{ name: "GLBL_MUX_SEL_1", description: "Global Mux select for CELL inputs", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "GLBL_MUX_SEL_2", description: "Global Mux select for CELL inputs", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "PRESCALE_CTRL", description: "Prescaler register control", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "INTR_TAG_REG", description: "Interrupt Tag register", offset: "0x40", size: "16",
		bits: [
			{ name: "TAG", description: "Interrupt tag", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "LOCK", description: "Lock control register", offset: "0x44", size: "32",
		bits: [
	...
	{ name: "HLC_INSTR_READ_PTR", description: "HLC instruction read pointer", offset: "0x48", size: "16",
		bits: [
			{ name: "READ_PTR", description: "HLC instruction read pointer", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "HLC_INSTR_VALUE", description: "HLC instruction read value", offset: "0x4C", size: "16",
		bits: [
			{ name: "INSTR", description: "HLC instruction value", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "DBG_OUT_2", description: "Visibility for CLB inputs and final  asynchronous outputs", offset: "0x5C", size: "16",
		bits: [
		]
	},
	{ name: "DBG_R0", description: "R0 of High level Controller", offset: "0x60", size: "16",
		bits: [
		]
	},
	{ name: "DBG_R1", description: "R1 of High level Controller", offset: "0x64", size: "16",
		bits: [
		]
	},
	{ name: "DBG_R2", description: "R2 of High level Controller", offset: "0x68", size: "16",
		bits: [
		]
	},
	{ name: "DBG_R3", description: "R3 of High level Controller", offset: "0x6C", size: "16",
		bits: [
		]
	},
	{ name: "DBG_C0", description: "Count of Unit 0", offset: "0x70", size: "16",
		bits: [
		]
	},
	{ name: "DBG_C1", description: "Count of Unit 1", offset: "0x74", size: "16",
		bits: [
		]
	},
	{ name: "DBG_C2", description: "Count of Unit 2", offset: "0x78", size: "16",
		bits: [
		]
	},
	{ name: "DBG_OUT", description: "Outputs of various units in the Cell", offset: "0x7C", size: "32",
		bits: [
	...
	{ name: "PUSH", description: "(0 <= i < 4) CLB_PUSH FIFO Registers (from HLC)", offset: "(0x0 + ((i) * 0x4))", count: "4", size: "16",
		bits: [
		]
	},
	{ name: "PULL", description: "(0 <= i < 4) CLB_PULL FIFO Registers (TO HLC)", offset: "(0x80 + ((i) * 0x4))", count: "4", size: "16",
		bits: [
		]
	},
];
