let MEMCFG_REGISTERS = [
	...
	{ name: "GSXACCPROT0", description: "Global Shared RAM Access Protection Register 0", offset: "0x48", size: "16",
		bits: [
	...
	{ name: "GSXACCPROT1", description: "Global Shared RAM Access Protection Register 1", offset: "0x4A", size: "16",
		bits: [
	...
	{ name: "GSXACCPROT2", description: "Global Shared RAM Access Protection Register 2", offset: "0x4C", size: "16",
		bits: [
	...
	{ name: "GSXACCPROT3", description: "Global Shared RAM Access Protection Register 3", offset: "0x4E", size: "16",
		bits: [
	...
	{ name: "MSGXLOCK", description: "Message RAM Config Lock Register", offset: "0x60", size: "16",
		bits: [
	...
	{ name: "MSGXCOMMIT", description: "Message RAM Config Lock Commit Register", offset: "0x62", size: "16",
		bits: [
	...
	{ name: "MSGXACCPROT0", description: "Message RAM Access Protection Register 0", offset: "0x68", size: "16",
		bits: [
	...
	{ name: "MSGXACCPROT1", description: "Message RAM Access Protection Register 1", offset: "0x6A", size: "16",
		bits: [
	...
	{ name: "MSGXACCPROT2", description: "Message RAM Access Protection Register 2", offset: "0x6C", size: "16",
		bits: [
	...
	{ name: "ROM_TEST", description: "ROM  TEST Register", offset: "0xA2", size: "16",
		bits: [
	...
	{ name: "ROM_FORCE_ERROR", description: "ROM Force Error register", offset: "0xA4", size: "16",
		bits: [
	...
	{ name: "PERI_MEM_TEST_CONTROL", description: "Peripheral Memory Test control Register", offset: "0xAC", size: "16",
		bits: [
	...
	{ name: "NMDMARDAVADDR", description: "Non-Master DMA Read Access Violation Address", offset: "0x1C", size: "16",
		bits: [
		]
	},
	...
	{ name: "UCECATRAMADDR", description: "Uncorrectable etherCAT RAM Read Error Address", offset: "0xE", size: "16",
		bits: [
		]
	},
	...
	{ name: "CCLA1READDR", description: "Correctable CLA1 Read Error Address", offset: "0x2A", size: "16",
		bits: [
		]
	},
	...
	{ name: "CPU_RAM_TEST_ERROR_STS_CLR", description: "Ram Test: Error Status Clear Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "CPU_RAM_TEST_ERROR_ADDR", description: "Ram Test: Error address register", offset: "0x4", size: "16",
		bits: [
		]
	},
];
