let UART_REGISTERS = [
	{ name: "DR", description: "UART Data", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "RSR", description: "UART Receive Status/Error Clear", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "FR", description: "UART Flag", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "ILPR", description: "UART IrDA Low-Power Register", offset: "0x10", size: "16",
		bits: [
			{ name: "ILPDVSR", description: "IrDA Low-Power Divisor", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "IBRD", description: "UART Integer Baud-Rate Divisor", offset: "0x12", size: "16",
		bits: [
			{ name: "DIVINT", description: "Integer Baud-Rate Divisor", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "FBRD", description: "UART Fractional Baud-Rate Divisor", offset: "0x14", size: "16",
		bits: [
			{ name: "DIVFRAC", description: "Fractional Baud-Rate Divisor", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "LCRH", description: "UART Line Control", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "CTL", description: "UART Control", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "IFLS", description: "UART Interrupt FIFO Level Select", offset: "0x1A", size: "16",
		bits: [
			...
			{ name: "TXIFLSEL_FINE", description: "UART Transmit Interrupt Fine-grained FIFO Level Select", size: "4", shift: "8", mask: "0xF00" },
			{ name: "RXIFLSEL_FINE", description: "UART Receive Interrupt Fine-grained FIFO Level Select", size: "4", shift: "16", mask: "0xF0000" },
		]
	},
	{ name: "IM", description: "UART Interrupt Mask", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "RIS", description: "UART Raw Interrupt Status", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "MIS", description: "UART Masked Interrupt Status", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "ICR", description: "UART Interrupt Clear", offset: "0x22", size: "16",
		bits: [
	...
	{ name: "DMACTL", description: "UART DMA Control", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "GLB_INT_FLG", description: "UART Global Interrupt Flag Register", offset: "0x42", size: "16",
		bits: [
			{ name: "INT_FLG", description: "Global Interrupt Flag for UART Interrupt", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "GLB_INT_CLR", description: "UART Global Interrupt Clear Register", offset: "0x44", size: "16",
		bits: [
			{ name: "INT_FLG_CLR", description: "Global Interrupt flag clear for UART Interrupt", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "9BITADDR", description: "UART 9-Bit Self Address", offset: "0x52", size: "16",
		bits: [
	...
	{ name: "9BITAMASK", description: "UART 9-Bit Self Address Mask", offset: "0x54", size: "16",
		bits: [
			{ name: "MASK", description: "Self Address Mask for 9-Bit Mode", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PP", description: "UART Peripheral Properties", offset: "0x7E0", size: "16",
		bits: [
			{ name: "SC", description: "Smart Card Support", size: "1", shift: "0", mask: "0x1" },
			{ name: "NB", description: "9-Bit Support", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "PERIPHID4", description: "UART Peripheral Identification 4", offset: "0x7E8", size: "16",
		bits: [
			{ name: "PID4", description: "UART Peripheral ID Register [7:0]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PERIPHID5", description: "UART Peripheral Identification 5", offset: "0x7EA", size: "16",
		bits: [
			{ name: "PID5", description: "UART Peripheral ID Register [15:8]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PERIPHID6", description: "UART Peripheral Identification 6", offset: "0x7EC", size: "16",
		bits: [
			{ name: "PID6", description: "UART Peripheral ID Register [23:16]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PERIPHID7", description: "UART Peripheral Identification 7", offset: "0x7EE", size: "16",
		bits: [
			{ name: "PID7", description: "UART Peripheral ID Register [31:24]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PERIPHID0", description: "UART Peripheral Identification 0", offset: "0x7F0", size: "16",
		bits: [
			{ name: "PID0", description: "UART Peripheral ID Register [7:0]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PERIPHID1", description: "UART Peripheral Identification 1", offset: "0x7F2", size: "16",
		bits: [
			{ name: "PID1", description: "UART Peripheral ID Register [15:8]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PERIPHID2", description: "UART Peripheral Identification 2", offset: "0x7F4", size: "16",
		bits: [
			{ name: "PID2", description: "UART Peripheral ID Register [23:16]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PERIPHID3", description: "UART Peripheral Identification 3", offset: "0x7F6", size: "16",
		bits: [
			{ name: "PID3", description: "UART Peripheral ID Register [31:24]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PCELLID0", description: "UART PrimeCell Identification 0", offset: "0x7F8", size: "16",
		bits: [
			{ name: "CID0", description: "UART PrimeCell ID Register [7:0]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PCELLID1", description: "UART PrimeCell Identification 1", offset: "0x7FA", size: "16",
		bits: [
			{ name: "CID1", description: "UART PrimeCell ID Register [15:8]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PCELLID2", description: "UART PrimeCell Identification 2", offset: "0x7FC", size: "16",
		bits: [
			{ name: "CID2", description: "UART PrimeCell ID Register [23:16]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PCELLID3", description: "UART PrimeCell Identification 3", offset: "0x7FE", size: "16",
		bits: [
			{ name: "CID3", description: "UART PrimeCell ID Register [31:24]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "ECR", description: "UART Error Clear", offset: "0x2", size: "16",
		bits: [
