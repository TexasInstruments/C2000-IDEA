let DCC_REGISTERS = [
	{ name: "GCTRL", description: "Global Control Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "REV", description: "DCC Revision Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "CLKSRC0", description: "Clock Source 0", offset: "0x28", size: "16",
		bits: [
