let PMBUS_REGISTERS = [
	...
	{ name: "PMBTXBUF", description: "PMBUS Transmit Buffer", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "PMBRXBUF", description: "PMBUS Receive buffer", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "PMBACK", description: "PMBUS Acknowledge Register", offset: "0xC", size: "16",
		bits: [
			{ name: "ACK", description: "Allows firmware to ack/nack received data", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PMBSTS", description: "PMBUS Status Register", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "PMBINTM", description: "PMBUS Interrupt Mask Register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "PMBTCR", description: "PMBUS TARGET Mode Configuration Register", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "PMBHTA", description: "PMBUS Hold TARGET Address Register", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "PMBCTRL", description: "PMBUS Control Register", offset: "0x20", size: "32",
		bits: [
			...
			{ name: "FAST_MODE_PLUS", description: "Fast Mode Plus Enable", size: "1", shift: "4", mask: "0x10" },
			...
			{ name: "ZH_EN", description: "Zero data hold enable", size: "1", shift: "30", mask: "0x40000000" },
			{ name: "I2CMODE", description: "Bit to enable I2C mode", size: "1", shift: "31", mask: "0x80000000" },
		]
	},
	{ name: "PMBTIMCTL", description: "PMBUS Timing Control Register", offset: "0x24", size: "16",
		bits: [
			{ name: "TIM_OVERRIDE", description: "Overide the default settings of the timing parameters.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PMBTIMCLK", description: "PMBUS Clock Timing Register", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "PMBTIMSTSETUP", description: "PMBUS Start Setup Time Register", offset: "0x2C", size: "16",
		bits: [
			{ name: "TSU_STA", description: "Setup time, rise edge of CONTROLLER clock to start edge.", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PMBTIMBIDLE", description: "PMBUS Bus Idle Time Register", offset: "0x30", size: "16",
		bits: [
			{ name: "BUSIDLE", description: "Determines the Bus Idle Limit", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "PMBTIMLOWTIMOUT", description: "PMBUS Clock Low Timeout Value Register", offset: "0x34", size: "32",
		bits: [
			{ name: "CLKLOWTIMOUT", description: "Determines the clock low timeout value", size: "20", shift: "0", mask: "0xFFFFF" },
		]
	},
	{ name: "PMBTIMHIGHTIMOUT", description: "PMBUS Clock High Timeout Value Register", offset: "0x38", size: "16",
		bits: [
