let DCC_REGISTERS = [
	{ name: "GCTRL", description: "Starts / stops the counters. Clears the error signal.", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "CNTSEED0", description: "Seed value for the counter attached to Clock Source 0.", offset: "0x8", size: "32",
		bits: [
			{ name: "COUNTSEED0", description: "Seed Value for Counter 0", size: "20", shift: "0", mask: "0xFFFFF" },
		]
	},
	{ name: "VALIDSEED0", description: "Seed value for the timeout counter attached to Clock Source 0.", offset: "0xC", size: "16",
		bits: [
			{ name: "VALIDSEED", description: "Seed Value for Valid Duration Counter 0", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "CNTSEED1", description: "Seed value for the counter attached to Clock Source 1.", offset: "0x10", size: "32",
		bits: [
			{ name: "COUNTSEED1", description: "Seed Value for Counter 1", size: "20", shift: "0", mask: "0xFFFFF" },
		]
	},
	{ name: "STATUS", description: "Specifies the status of the DCC Module.", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "CNT0", description: "Value of the counter attached to Clock Source 0.", offset: "0x18", size: "32",
		bits: [
			{ name: "COUNT0", description: "Current Value of Counter 0", size: "20", shift: "0", mask: "0xFFFFF" },
		]
	},
	{ name: "VALID0", description: "Value of the valid counter attached to Clock Source 0.", offset: "0x1C", size: "16",
		bits: [
			{ name: "VALID0", description: "Current Value of Valid 0", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "CNT1", description: "Value of the counter attached to Clock Source 1.", offset: "0x20", size: "32",
		bits: [
			{ name: "COUNT1", description: "Current Value of Counter 1", size: "20", shift: "0", mask: "0xFFFFF" },
		]
	},
	{ name: "CLKSRC1", description: "Selects the clock source for Counter 1.", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "CLKSRC0", description: "Selects the clock source for Counter 0.", offset: "0x28", size: "16",
		bits: [
