let MEMCFG_REGISTERS = [
	{ name: "DXLOCK", description: "Dedicated RAM Config Lock Register", offset: "0x0", size: "16",
		bits: [
			{ name: "LOCK_D0", description: "D0 RAM access protection and master select fields lock bit", size: "1", shift: "2", mask: "0x4" },
			{ name: "LOCK_D1", description: "D1 RAM access protection and master select fields lock bit", size: "1", shift: "3", mask: "0x8" },
		]
	},
	{ name: "DXCOMMIT", description: "Dedicated RAM Config Lock Commit Register", offset: "0x2", size: "16",
		bits: [
			{ name: "COMMIT_D0", description: "D0 RAM access protection and master select permanent lock", size: "1", shift: "2", mask: "0x4" },
			{ name: "COMMIT_D1", description: "D1 RAM access protection and master select permanent lock", size: "1", shift: "3", mask: "0x8" },
		]
	},
	{ name: "DXACCPROT0", description: "Dedicated RAM Config Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "DXTEST", description: "Dedicated RAM TEST Register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "DXINIT", description: "Dedicated RAM Init Register", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "DXINITDONE", description: "Dedicated RAM InitDone Status Register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "LSXLOCK", description: "Local Shared RAM Config Lock Register", offset: "0x20", size: "16",
		bits: [
			{ name: "LOCK_LS0", description: "LS0 RAM access protection and master select fields lock bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "LOCK_LS1", description: "LS1 RAM access protection and master select fields lock bit", size: "1", shift: "1", mask: "0x2" },
			{ name: "LOCK_LS2", description: "LS2 RAM access protection and master select fields lock bit", size: "1", shift: "2", mask: "0x4" },
			{ name: "LOCK_LS3", description: "LS3 RAM access protection and master select fields lock bit", size: "1", shift: "3", mask: "0x8" },
			{ name: "LOCK_LS4", description: "LS4 RAM access protection and master select fields lock bit", size: "1", shift: "4", mask: "0x10" },
			{ name: "LOCK_LS5", description: "LS5 RAM access protection and master select fields lock bit", size: "1", shift: "5", mask: "0x20" },
		]
	},
	{ name: "LSXCOMMIT", description: "Local Shared RAM Config Lock Commit Register", offset: "0x22", size: "16",
		bits: [
			{ name: "COMMIT_LS0", description: "LS0 RAM access protection and master select permanent lock", size: "1", shift: "0", mask: "0x1" },
			{ name: "COMMIT_LS1", description: "LS1 RAM access protection and master select permanent lock", size: "1", shift: "1", mask: "0x2" },
			{ name: "COMMIT_LS2", description: "LS2 RAM access protection and master select permanent lock", size: "1", shift: "2", mask: "0x4" },
			{ name: "COMMIT_LS3", description: "LS3 RAM access protection and master select permanent lock", size: "1", shift: "3", mask: "0x8" },
			{ name: "COMMIT_LS4", description: "LS4 RAM access protection and master select permanent lock", size: "1", shift: "4", mask: "0x10" },
			{ name: "COMMIT_LS5", description: "LS5 RAM access protection and master select permanent lock", size: "1", shift: "5", mask: "0x20" },
		]
	},
	{ name: "LSXMSEL", description: "Local Shared RAM Master Sel Register", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "LSXCLAPGM", description: "Local Shared RAM Prog/Exe control Register", offset: "0x26", size: "16",
		bits: [
	...
	{ name: "LSXACCPROT0", description: "Local Shared RAM Config Register 0", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "LSXACCPROT1", description: "Local Shared RAM Config Register 1", offset: "0x2A", size: "16",
		bits: [
	...
	{ name: "LSXTEST", description: "Local Shared RAM TEST Register", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "LSXINIT", description: "Local Shared RAM Init Register", offset: "0x32", size: "16",
		bits: [
	...
	{ name: "LSXINITDONE", description: "Local Shared RAM InitDone Status Register", offset: "0x34", size: "16",
		bits: [
	...
	{ name: "GSXLOCK", description: "Global Shared RAM Config Lock Register", offset: "0x40", size: "16",
		bits: [
			{ name: "LOCK_GS0", description: "GS0 RAM access protection and master select fields lock bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "LOCK_GS1", description: "GS1 RAM access protection and master select fields lock bit", size: "1", shift: "1", mask: "0x2" },
			{ name: "LOCK_GS2", description: "GS2 RAM access protection and master select fields lock bit", size: "1", shift: "2", mask: "0x4" },
			{ name: "LOCK_GS3", description: "GS3 RAM access protection and master select fields lock bit", size: "1", shift: "3", mask: "0x8" },
			{ name: "LOCK_GS4", description: "GS4 RAM access protection and master select fields lock bit", size: "1", shift: "4", mask: "0x10" },
			{ name: "LOCK_GS5", description: "GS5 RAM access protection and master select fields lock bit", size: "1", shift: "5", mask: "0x20" },
			{ name: "LOCK_GS6", description: "GS6 RAM access protection and master select fields lock bit", size: "1", shift: "6", mask: "0x40" },
			{ name: "LOCK_GS7", description: "GS7 RAM access protection and master select fields lock bit", size: "1", shift: "7", mask: "0x80" },
			{ name: "LOCK_GS8", description: "GS8 RAM access protection and master select fields lock bit", size: "1", shift: "8", mask: "0x100" },
			{ name: "LOCK_GS9", description: "GS9 RAM access protection and master select fields lock bit", size: "1", shift: "9", mask: "0x200" },
			{ name: "LOCK_GS10", description: "GS10 RAM access protection and master select fields lock bit", size: "1", shift: "10", mask: "0x400" },
			{ name: "LOCK_GS11", description: "GS11 RAM access protection and master select fields lock bit", size: "1", shift: "11", mask: "0x800" },
			{ name: "LOCK_GS12", description: "GS12 RAM access protection and master select fields lock bit", size: "1", shift: "12", mask: "0x1000" },
			{ name: "LOCK_GS13", description: "GS13 RAM access protection and master select fields lock bit", size: "1", shift: "13", mask: "0x2000" },
			{ name: "LOCK_GS14", description: "GS14 RAM access protection and master select fields lock bit", size: "1", shift: "14", mask: "0x4000" },
			{ name: "LOCK_GS15", description: "GS15 RAM access protection and master select fields lock bit", size: "1", shift: "15", mask: "0x8000" },
		]
	},
	{ name: "GSXCOMMIT", description: "Global Shared RAM Config Lock Commit Register", offset: "0x42", size: "16",
		bits: [
			{ name: "COMMIT_GS0", description: "GS0 RAM access protection and master select permanent lock", size: "1", shift: "0", mask: "0x1" },
			{ name: "COMMIT_GS1", description: "GS1 RAM access protection and master select permanent lock", size: "1", shift: "1", mask: "0x2" },
			{ name: "COMMIT_GS2", description: "GS2 RAM access protection and master select permanent lock", size: "1", shift: "2", mask: "0x4" },
			{ name: "COMMIT_GS3", description: "GS3 RAM access protection and master select permanent lock", size: "1", shift: "3", mask: "0x8" },
			{ name: "COMMIT_GS4", description: "GS4 RAM access protection and master select permanent lock", size: "1", shift: "4", mask: "0x10" },
			{ name: "COMMIT_GS5", description: "GS5 RAM access protection and master select permanent lock", size: "1", shift: "5", mask: "0x20" },
			{ name: "COMMIT_GS6", description: "GS6 RAM access protection and master select permanent lock", size: "1", shift: "6", mask: "0x40" },
			{ name: "COMMIT_GS7", description: "GS7 RAM access protection and master select permanent lock", size: "1", shift: "7", mask: "0x80" },
			{ name: "COMMIT_GS8", description: "GS8 RAM access protection and master select permanent lock", size: "1", shift: "8", mask: "0x100" },
			{ name: "COMMIT_GS9", description: "GS9 RAM access protection and master select permanent lock", size: "1", shift: "9", mask: "0x200" },
			{ name: "COMMIT_GS10", description: "GS10 RAM access protection and master select permanent lock", size: "1", shift: "10", mask: "0x400" },
			{ name: "COMMIT_GS11", description: "GS11 RAM access protection and master select permanent lock", size: "1", shift: "11", mask: "0x800" },
			{ name: "COMMIT_GS12", description: "GS12 RAM access protection and master select permanent lock", size: "1", shift: "12", mask: "0x1000" },
			{ name: "COMMIT_GS13", description: "GS13 RAM access protection and master select permanent lock", size: "1", shift: "13", mask: "0x2000" },
			{ name: "COMMIT_GS14", description: "GS14 RAM access protection and master select permanent lock", size: "1", shift: "14", mask: "0x4000" },
			{ name: "COMMIT_GS15", description: "GS15 RAM access protection and master select permanent lock", size: "1", shift: "15", mask: "0x8000" },
		]
	},
	{ name: "GSXMSEL", description: "Global Shared RAM Master Sel Register", offset: "0x44", size: "16",
		bits: [
	...
	{ name: "GSXACCPROT0", description: "Global Shared RAM Config Register 0", offset: "0x48", size: "16",
		bits: [
	...
	{ name: "GSXACCPROT1", description: "Global Shared RAM Config Register 1", offset: "0x4A", size: "16",
		bits: [
	...
	{ name: "GSXACCPROT2", description: "Global Shared RAM Config Register 2", offset: "0x4C", size: "16",
		bits: [
	...
	{ name: "GSXACCPROT3", description: "Global Shared RAM Config Register 3", offset: "0x4E", size: "16",
		bits: [
	...
	{ name: "GSXINIT", description: "Global Shared RAM Init Register", offset: "0x52", size: "16",
		bits: [
	...
	{ name: "GSXINITDONE", description: "Global Shared RAM InitDone Status Register", offset: "0x54", size: "16",
		bits: [
	...
	{ name: "MSGXTEST", description: "Message RAM TEST Register", offset: "0x70", size: "16",
		bits: [
	...
	{ name: "MSGXINIT", description: "Message RAM Init Register", offset: "0x72", size: "16",
		bits: [
	...
	{ name: "MSGXINITDONE", description: "Message RAM InitDone Status Register", offset: "0x74", size: "16",
		bits: [
	...
	{ name: "EMIF1LOCK", description: "EMIF1 Config Lock Register", offset: "0x0", size: "16",
		bits: [
			{ name: "LOCK_EMIF1", description: "EMIF1 access protection and master select fields lock bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "EMIF1COMMIT", description: "EMIF1 Config Lock Commit Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "EMIF1ACCPROT0", description: "EMIF1 Config Register 0", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "EMIF2LOCK", description: "EMIF2 Config Lock Register", offset: "0x0", size: "16",
		bits: [
			{ name: "LOCK_EMIF2", description: "EMIF2 access protection and master select permanent lock", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "EMIF2COMMIT", description: "EMIF2 Config Lock Commit Register", offset: "0x2", size: "16",
		bits: [
			{ name: "COMMIT_EMIF2", description: "EMIF2 access protection and master select permanent lock", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "EMIF2ACCPROT0", description: "EMIF2 Config Register 0", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "NMAVFLG", description: "Non-Master Access Violation Flag Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "NMAVSET", description: "Non-Master Access Violation Flag Set Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "NMAVCLR", description: "Non-Master Access Violation Flag Clear Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "NMAVINTEN", description: "Non-Master Access Violation Interrupt Enable Register", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "NMCPURDAVADDR", description: "Non-Master CPU Read Access Violation Address", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "NMCPUWRAVADDR", description: "Non-Master CPU Write Access Violation Address", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "NMCPUFAVADDR", description: "Non-Master CPU Fetch Access Violation Address", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "NMDMAWRAVADDR", description: "Non-Master DMA Write Access Violation Address", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "NMCLA1RDAVADDR", description: "Non-Master CLA1 Read Access Violation Address", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "NMCLA1WRAVADDR", description: "Non-Master CLA1 Write Access Violation Address", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "NMCLA1FAVADDR", description: "Non-Master CLA1 Fetch Access Violation Address", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "MAVFLG", description: "Master Access Violation Flag Register", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "MAVSET", description: "Master Access Violation Flag Set Register", offset: "0x22", size: "16",
		bits: [
	...
	{ name: "MAVCLR", description: "Master Access Violation Flag Clear Register", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "MAVINTEN", description: "Master Access Violation Interrupt Enable Register", offset: "0x26", size: "16",
		bits: [
	...
	{ name: "MCPUFAVADDR", description: "Master CPU Fetch Access Violation Address", offset: "0x28", size: "16",
		bits: [
		]
	},
	{ name: "MCPUWRAVADDR", description: "Master CPU Write Access Violation Address", offset: "0x2A", size: "16",
		bits: [
		]
	},
	{ name: "MDMAWRAVADDR", description: "Master  DMA Write Access Violation Address", offset: "0x2C", size: "16",
		bits: [
		]
	},
	{ name: "UCERRFLG", description: "Uncorrectable Error Flag Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "UCERRSET", description: "Uncorrectable Error Flag Set Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "UCERRCLR", description: "Uncorrectable Error Flag Clear Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "UCCPUREADDR", description: "Uncorrectable CPU Read Error Address", offset: "0x6", size: "16",
		bits: [
		]
	},
	{ name: "UCDMAREADDR", description: "Uncorrectable DMA Read Error Address", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "UCCLA1READDR", description: "Uncorrectable CLA1 Read Error Address", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "CERRFLG", description: "Correctable Error Flag Register", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "CERRSET", description: "Correctable Error Flag Set Register", offset: "0x22", size: "16",
		bits: [
	...
	{ name: "CERRCLR", description: "Correctable Error Flag Clear Register", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "CCPUREADDR", description: "Correctable CPU Read Error Address", offset: "0x26", size: "16",
		bits: [
		]
	},
	{ name: "CERRCNT", description: "Correctable Error Count Register", offset: "0x2E", size: "16",
		bits: [
		]
	},
	{ name: "CERRTHRES", description: "Correctable Error Threshold Value Register", offset: "0x30", size: "16",
		bits: [
		]
	},
	{ name: "CEINTFLG", description: "Correctable Error Interrupt Flag Status Register", offset: "0x32", size: "16",
		bits: [
			{ name: "CEINTFLAG", description: "Total corrected error count exceeded threshold flag.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CEINTCLR", description: "Correctable Error Interrupt Flag Clear Register", offset: "0x34", size: "16",
		bits: [
			{ name: "CEINTCLR", description: "CPU Corrected Error Threshold Exceeded Error Clear.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CEINTSET", description: "Correctable Error Interrupt Flag Set Register", offset: "0x36", size: "16",
		bits: [
			{ name: "CEINTSET", description: "Total corrected error count exceeded flag set.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CEINTEN", description: "Correctable Error Interrupt Enable Register", offset: "0x38", size: "16",
		bits: [
			{ name: "CEINTEN", description: "CPU/DMA Correctable Error Interrupt Enable.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "ROMWAITSTATE", description: "ROM Wait State Configuration Register", offset: "0x0", size: "16",
		bits: [
...
module.exports = {
	memcfgRegisters: MEMCFG_REGISTERS,
}
