let BGCRC_REGISTERS = [
	{ name: "EN", description: "BGCRC Enable", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "CTRL1", description: "BGCRC Control register 1", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "CTRL2", description: "BGCRC Control register 2", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "START_ADDR", description: "Start address for the BGCRC check", offset: "0x6", size: "16",
		bits: [
		]
	},
	{ name: "SEED", description: "Seed for CRC calculation", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "GOLDEN", description: "Golden CRC to be compared against", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "RESULT", description: "CRC calculated", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "CURR_ADDR", description: "Current address regsiter", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "WD_CFG", description: "BGCRC windowed watchdog configuration", offset: "0x1C", size: "16",
		bits: [
			{ name: "WDDIS", description: "CRC Watchdog disable", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "WD_MIN", description: "BGCRC windowed watchdog min value", offset: "0x1E", size: "16",
		bits: [
		]
	},
	{ name: "WD_MAX", description: "BGCRC windowed watchdog max value", offset: "0x20", size: "16",
		bits: [
		]
	},
	{ name: "WD_CNT", description: "BGCRC windowed watchdog count", offset: "0x22", size: "16",
		bits: [
		]
	},
	{ name: "NMIFLG", description: "BGCRC NMI flag register", offset: "0x2A", size: "16",
		bits: [
	...
	{ name: "NMICLR", description: "BGCRC NMI flag clear register", offset: "0x2C", size: "16",
		bits: [
	...
	{ name: "NMIFRC", description: "BGCRC NMI flag force register", offset: "0x2E", size: "16",
		bits: [
	...
	{ name: "INTEN", description: "Interrupt enable", offset: "0x34", size: "16",
		bits: [
	...
	{ name: "INTFLG", description: "Interrupt flag", offset: "0x36", size: "16",
		bits: [
	...
	{ name: "INTCLR", description: "Interrupt flag clear", offset: "0x38", size: "16",
		bits: [
	...
	{ name: "INTFRC", description: "Interrupt flag force", offset: "0x3A", size: "16",
		bits: [
	...
	{ name: "LOCK", description: "BGCRC register map lockconfiguration", offset: "0x3C", size: "16",
		bits: [
	...
	{ name: "COMMIT", description: "BGCRC register map commit configuration", offset: "0x3E", size: "16",
		bits: [
