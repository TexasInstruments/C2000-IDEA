let ASYSCTL_REGISTERS = [
	{ name: "ADCOSDETECT", description: "I2V Logic Control", offset: "0x26", size: "16",
		bits: [
	...
	{ name: "REFCONFIGB", description: "Config register for analog reference B.", offset: "0x36", size: "16",
		bits: [
