let EMIF_REGISTERS = [
	{ name: "RCSR", description: "Revision Code and Status Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "ASYNC_WCCR", description: "Async Wait Cycle Config Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "SDRAM_CR", description: "SDRAM (EMxCS0n) Config Register", offset: "0x8", size: "16",
		bits: [
			...
			{ name: "BIT_11_9_LOCK", description: "Bits 11 to 9 are writable only if this bit is set.", size: "1", shift: "8", mask: "0x100" },
	...
	{ name: "SDRAM_RCR", description: "SDRAM Refresh Control Register", offset: "0xC", size: "16",
		bits: [
			{ name: "REFRESH_RATE", description: "Refresh Rate.", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
	{ name: "ASYNC_CS2_CR", description: "Async 1 (EMxCS2n) Config Register", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "ASYNC_CS3_CR", description: "Async 2 (EMxCS3n) Config Register", offset: "0x14", size: "32",
		bits: [
			{ name: "ASIZE", description: "Asynchronous Memory Size.", size: "2", shift: "0", mask: "0x3" },
			{ name: "TA", description: "Turn Around cycles.", size: "2", shift: "2", mask: "0xC" },
			{ name: "R_HOLD", description: "Read Strobe Hold cycles.", size: "3", shift: "4", mask: "0x70" },
	...
	{ name: "ASYNC_CS4_CR", description: "Async 3 (EMxCS4n) Config Register", offset: "0x18", size: "32",
		bits: [
			{ name: "ASIZE", description: "Asynchronous Memory Size.", size: "2", shift: "0", mask: "0x3" },
			{ name: "TA", description: "Turn Around cycles.", size: "2", shift: "2", mask: "0xC" },
			{ name: "R_HOLD", description: "Read Strobe Hold cycles.", size: "3", shift: "4", mask: "0x70" },
	...
	{ name: "SDRAM_TR", description: "SDRAM Timing Register", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "TOTAL_SDRAM_AR", description: "Total SDRAM Accesses Register", offset: "0x30", size: "16",
		bits: [
		]
	},
	{ name: "TOTAL_SDRAM_ACTR", description: "Total SDRAM Activate Register", offset: "0x34", size: "16",
		bits: [
		]
	},
	{ name: "SDR_EXT_TMNG", description: "SDRAM SR/PD Exit Timing Register", offset: "0x3C", size: "16",
		bits: [
			{ name: "T_XS", description: "Self Refresh exit to new command timing.", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "INT_RAW", description: "Interrupt Raw Register", offset: "0x40", size: "16",
		bits: [
	...
	{ name: "INT_MSK", description: "Interrupt Masked Register", offset: "0x44", size: "16",
		bits: [
	...
	{ name: "INT_MSK_SET", description: "Interrupt Mask Set Register", offset: "0x48", size: "16",
		bits: [
	...
	{ name: "INT_MSK_CLR", description: "Interrupt Mask Clear Register", offset: "0x4C", size: "16",
		bits: [
