let SPI_REGISTERS = [
	{ name: "CCR", description: "SPI Configuration Control Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "CTL", description: "SPI Operation Control Register", offset: "0x1", size: "16",
		bits: [
	...
	{ name: "STS", description: "SPI Status Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "BRR", description: "SPI Baud Rate Register", offset: "0x4", size: "16",
		bits: [
			{ name: "SPI_BIT_RATE", description: "SPI Bit Rate Control", size: "7", shift: "0", mask: "0x7F" },
		]
	},
	{ name: "RXEMU", description: "SPI Emulation Buffer Register", offset: "0x6", size: "16",
		bits: [
		]
	},
	{ name: "RXBUF", description: "SPI Serial Input Buffer Register", offset: "0x7", size: "16",
		bits: [
		]
	},
	{ name: "TXBUF", description: "SPI Serial Output Buffer Register", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "DAT", description: "SPI Serial Data Register", offset: "0x9", size: "16",
		bits: [
		]
	},
	{ name: "FFTX", description: "SPI FIFO Transmit Register", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "FFRX", description: "SPI FIFO Receive Register", offset: "0xB", size: "16",
		bits: [
	...
	{ name: "FFCT", description: "SPI FIFO Control Register", offset: "0xC", size: "16",
		bits: [
			{ name: "TXDLY", description: "FIFO Transmit Delay Bits", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "PRI", description: "SPI Priority Control Register", offset: "0xF", size: "16",
		bits: [
			{ name: "TRIWIRE", description: "3-wire mode select bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "PTEINV", description: "SPISTE inversion bit", size: "1", shift: "1", mask: "0x2" },
