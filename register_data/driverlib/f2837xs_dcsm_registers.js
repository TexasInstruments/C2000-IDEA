let DCSM_REGISTERS = [
	{ name: "Z1OTP_LINKPOINTER1", description: "Zone 1 Link Pointer1 in Z1 OTP", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "Z1OTP_LINKPOINTER2", description: "Zone 1 Link Pointer2 in Z1 OTP", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "Z1OTP_LINKPOINTER3", description: "Zone 1 Link Pointer3 in Z1 OTP", offset: "0x8", size: "16",
		bits: [
		]
	},
	...
	{ name: "Z1OTP_BOOTCTRL", description: "Boot Mode in Z1 OTP", offset: "0x1E", size: "16",
		bits: [
		]
	},
	{ name: "Z2OTP_LINKPOINTER1", description: "Zone 2 Link Pointer1 in Z2 OTP", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "Z2OTP_LINKPOINTER2", description: "Zone 2 Link Pointer2 in Z2 OTP", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "Z2OTP_LINKPOINTER3", description: "Zone 2 Link Pointer3 in Z2 OTP", offset: "0x8", size: "16",
		bits: [
		]
	},
	...
	{ name: "Z2OTP_BOOTCTRL", description: "Boot Mode in Z2 OTP", offset: "0x1E", size: "16",
		bits: [
		]
	},
	...
	{ name: "Z1_BOOTCTRL", description: "Boot Mode", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "Z1_GRABSECTR", description: "Zone 1 Grab Flash Sectors Register", offset: "0x1A", size: "32",
		bits: [
	...
	{ name: "Z1_EXEONLYSECTR", description: "Zone 1 Flash Execute_Only Sector Register", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "Z2_BOOTCTRL", description: "Boot Mode", offset: "0x4", size: "32",
		bits: [
			{ name: "KEY", description: "OTP Boot Key", size: "8", shift: "0", mask: "0xFF" },
			{ name: "BMODE", description: "OTP Boot Mode", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "BOOTPIN0", description: "OTP Boot Pin 0 Mapping", size: "8", shift: "16", mask: "0xFF0000" },
	...
	{ name: "Z2_GRABSECTR", description: "Zone 2 Grab Flash Sectors Register", offset: "0x1A", size: "32",
		bits: [
			{ name: "GRAB_SECTA", description: "Grab Flash Sector A", size: "2", shift: "0", mask: "0x3" },
			{ name: "GRAB_SECTB", description: "Grab Flash Sector B", size: "2", shift: "2", mask: "0xC" },
			{ name: "GRAB_SECTC", description: "Grab Flash Sector C", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "Z2_EXEONLYSECTR", description: "Zone 2 Flash Execute_Only Sector Register", offset: "0x1E", size: "16",
		bits: [
			{ name: "EXEONLY_SECTA", description: "Execute-Only Flash Sector A", size: "1", shift: "0", mask: "0x1" },
			{ name: "EXEONLY_SECTB", description: "Execute-Only Flash Sector B", size: "1", shift: "1", mask: "0x2" },
			{ name: "EXEONLY_SECTC", description: "Execute-Only Flash Sector C", size: "1", shift: "2", mask: "0x4" },
