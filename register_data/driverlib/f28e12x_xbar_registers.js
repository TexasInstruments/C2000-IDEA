let XBAR_REGISTERS = [
	...
	{ name: "FLG4", description: "X-Bar Input Flag Register 4", offset: "0x6", size: "16",
		bits: [
			{ name: "ERRORSTS_ERROR", description: "Input Flag for ERRORSTS_ERROR Signal", size: "1", shift: "28", mask: "0x10000000" },
		]
	},
	{ name: "FLG5", description: "X-Bar Input Flag Register 5", offset: "0x8", size: "16",
		bits: [
			{ name: "EMUSTOP", description: "Input Flag for EMUSTOP Signal", size: "1", shift: "0", mask: "0x1" },
			{ name: "EQEP1ERR", description: "Input Flag for EQEP1ERR Signal", size: "1", shift: "1", mask: "0x2" },
			{ name: "CLOCKFAIL", description: "Input Flag for CLOCKFAIL Signal", size: "1", shift: "3", mask: "0x8" },
			{ name: "ECCDBLERR", description: "Input Flag for ECCDBLERR Signal", size: "1", shift: "4", mask: "0x10" },
			{ name: "PIEERR", description: "Input Flag for PIEERR Signal", size: "1", shift: "5", mask: "0x20" },
		]
	},
	{ name: "CLR1", description: "X-Bar Input Flag Clear Register 1", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "CLR2", description: "X-Bar Input Flag Clear Register 2", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "CLR3", description: "X-Bar Input Flag Clear Register 3", offset: "0xE", size: "16",
		bits: [
	...
	{ name: "CLR4", description: "X-Bar Input Flag Clear Register 4", offset: "0x10", size: "16",
		bits: [
			{ name: "ERRORSTS_ERROR", description: "Input Flag clear for ERRORSTS_ERROR Signal", size: "1", shift: "28", mask: "0x10000000" },
		]
	},
	{ name: "CLR5", description: "X-Bar Input Flag Clear Register 5", offset: "0x12", size: "16",
		bits: [
			{ name: "EMUSTOP", description: "Input Flag clear for EMUSTOP Signal", size: "1", shift: "0", mask: "0x1" },
			{ name: "EQEP1ERR", description: "Input Flag clear for EQEP1ERR Signal", size: "1", shift: "1", mask: "0x2" },
			{ name: "CLOCKFAIL", description: "Input Flag clear for CLOCKFAIL Signal", size: "1", shift: "3", mask: "0x8" },
			{ name: "ECCDBLERR", description: "Input Flag clear for ECCDBLERR Signal", size: "1", shift: "4", mask: "0x10" },
			{ name: "PIEERR", description: "Input Flag clear for PIEERR Signal", size: "1", shift: "5", mask: "0x20" },
		]
	},
];
module.exports = {
