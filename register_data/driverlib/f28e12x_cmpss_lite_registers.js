let CMPSS_LITE_REGISTERS = [
	...
	{ name: "CTRIPHFILCLKCTL2", description: "CTRIPH Filter Clock Control Register 2", offset: "0x39", size: "16",
		bits: [
			...
			{ name: "CMPSSLITE_COMPSTSCLR_HSYNCCLREN", description: "High Comparator MCPWMSYNCPER Clear Enable", size: "1", shift: "2", mask: "0x4" },
			{ name: "CMPSSLITE_COMPSTSCLR_LLATCHCLR", description: "Low Comparator Latched Status Clear", size: "1", shift: "9", mask: "0x200" },
			{ name: "CMPSSLITE_COMPSTSCLR_LSYNCCLREN", description: "Low Comparator MCPWMSYNCPER Clear Enable", size: "1", shift: "10", mask: "0x400" },
