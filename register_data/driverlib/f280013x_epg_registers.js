let EPG_REGISTERS = [
	...
	{ name: "CLKDIV0_CTL0", description: "Clock divider 0's control register 0", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "CLKDIV1_CTL0", description: "Clock divider 1's control register 0", offset: "0x24", size: "16",
		bits: [
			{ name: "PRD", description: "Clock divider value", size: "8", shift: "0", mask: "0xFF" },
			{ name: "CLKSTOP", description: "Clock Stop Configuration", size: "3", shift: "16", mask: "0x70000" },
		]
