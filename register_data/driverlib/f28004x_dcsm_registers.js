let DCSM_REGISTERS = [
	{ name: "B0_Z1OTP_LINKPOINTER1", description: "Zone 1 Link Pointer1 in Z1 OTP for flash BANK0", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "B0_Z1OTP_LINKPOINTER2", description: "Zone 1 Link Pointer2 in Z1 OTP for flash BANK0", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "B0_Z1OTP_LINKPOINTER3", description: "Zone 1 Link Pointer3 in Z1 OTP for flash BANK0", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "Z1OTP_BOOTPIN_CONFIG", description: "Boot Pin Configuration", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "Z1OTP_GPREG2", description: "Zone-1 General Purpose Register-2 content", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "Z1OTP_PSWDLOCK", description: "Secure Password Lock in Z1 OTP", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "Z1OTP_CRCLOCK", description: "Secure CRC Lock in Z1 OTP", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "Z1OTP_BOOTDEF_LOW", description: "Boot definition (low 32bit)", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "Z1OTP_BOOTDEF_HIGH", description: "Boot definition (high 32bit)", offset: "0x1E", size: "16",
		bits: [
		]
	},
	{ name: "B0_Z2OTP_LINKPOINTER1", description: "Zone 2Link Pointer1 in Z2 OTP for flash BANK0", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "B0_Z2OTP_LINKPOINTER2", description: "Zone 2 Link Pointer2 in Z2 OTP for flash BANK0", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "B0_Z2OTP_LINKPOINTER3", description: "Zone 12Link Pointer3 in Z2 OTP for flash BANK0", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "Z2OTP_PSWDLOCK", description: "Secure Password Lock in Z2 OTP", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "Z2OTP_CRCLOCK", description: "Secure CRC Lock in Z2 OTP", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "B0_Z1_LINKPOINTER", description: "Zone 1 Link Pointer for flash BANK0", offset: "0x0", size: "32",
		bits: [
			{ name: "LINKPOINTER", description: "Zone1 LINK Pointer for zone Flash BANK0", size: "29", shift: "0", mask: "0x1FFFFFFF" },
		]
	},
	{ name: "Z1_OTPSECLOCK", description: "Zone 1 OTP Secure JTAG lock", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "Z1_BOOTDEF_HIGH", description: "Boot definition (high 32bit)", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "B0_Z1_LINKPOINTERERR", description: "Link Pointer Error for flash BANK0", offset: "0x6", size: "32",
		bits: [
			{ name: "Z1_LINKPOINTERERR", description: "Error to Resolve Z1 Link pointer from OTP loaded values", size: "29", shift: "0", mask: "0x1FFFFFFF" },
		]
	},
	{ name: "Z1_BOOTPIN_CONFIG", description: "Boot Pin Configuration", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "Z1_GPREG2", description: "Zone1 General Purpose Register-2", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "Z1_BOOTDEF_LOW", description: "Boot definition (low 32bit)", offset: "0xC", size: "16",
		bits: [
		]
	},
	...
	{ name: "Z1_CR", description: "Zone 1 CSM Control Register", offset: "0x19", size: "16",
		bits: [
	...
	{ name: "B0_Z1_GRABSECTR", description: "Zone 1 Grab Flash BANK0 Sectors Register", offset: "0x1A", size: "32",
		bits: [
	...
	{ name: "Z1_GRABRAMR", description: "Zone 1 Grab RAM Blocks Register", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "B0_Z1_EXEONLYSECTR", description: "Zone 1 Flash BANK0 Execute_Only Sector Register", offset: "0x1E", size: "16",
		bits: [
			{ name: "EXEONLY_SECT0", description: "Execute-Only Flash Sector 0 in Flash BANK0", size: "1", shift: "0", mask: "0x1" },
			{ name: "EXEONLY_SECT1", description: "Execute-Only Flash Sector 1 in Flash BANK0", size: "1", shift: "1", mask: "0x2" },
			{ name: "EXEONLY_SECT2", description: "Execute-Only Flash Sector 2 in Flash BANK0", size: "1", shift: "2", mask: "0x4" },
			{ name: "EXEONLY_SECT3", description: "Execute-Only Flash Sector 3 in Flash BANK0", size: "1", shift: "3", mask: "0x8" },
			{ name: "EXEONLY_SECT4", description: "Execute-Only Flash Sector 4 in Flash BANK0", size: "1", shift: "4", mask: "0x10" },
			{ name: "EXEONLY_SECT5", description: "Execute-Only Flash Sector 5 in Flash BANK0", size: "1", shift: "5", mask: "0x20" },
			{ name: "EXEONLY_SECT6", description: "Execute-Only Flash Sector 6 in Flash BANK0", size: "1", shift: "6", mask: "0x40" },
			{ name: "EXEONLY_SECT7", description: "Execute-Only Flash Sector 7 in Flash BANK0", size: "1", shift: "7", mask: "0x80" },
			{ name: "EXEONLY_SECT8", description: "Execute-Only Flash Sector 8 in Flash BANK0", size: "1", shift: "8", mask: "0x100" },
			{ name: "EXEONLY_SECT9", description: "Execute-Only Flash Sector 9 in Flash BANK0", size: "1", shift: "9", mask: "0x200" },
			{ name: "EXEONLY_SECT10", description: "Execute-Only Flash Sector 10 in Flash BANK0", size: "1", shift: "10", mask: "0x400" },
			{ name: "EXEONLY_SECT11", description: "Execute-Only Flash Sector 11 in Flash BANK0", size: "1", shift: "11", mask: "0x800" },
			{ name: "EXEONLY_SECT12", description: "Execute-Only Flash Sector 12 in Flash BANK0", size: "1", shift: "12", mask: "0x1000" },
			{ name: "EXEONLY_SECT13", description: "Execute-Only Flash Sector 13 in Flash BANK0", size: "1", shift: "13", mask: "0x2000" },
			{ name: "EXEONLY_SECT14", description: "Execute-Only Flash Sector 14 in Flash BANK0", size: "1", shift: "14", mask: "0x4000" },
			{ name: "EXEONLY_SECT15", description: "Execute-Only Flash Sector 15 in Flash BANK0", size: "1", shift: "15", mask: "0x8000" },
		]
	},
	{ name: "Z1_EXEONLYRAMR", description: "Zone 1 RAM Execute_Only Block Register", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "B0_Z2_LINKPOINTER", description: "Zone 2 Link Pointer for flash BANK0", offset: "0x0", size: "32",
		bits: [
			{ name: "LINKPOINTER", description: "Zone2 LINK Pointer in Flash BANK0", size: "29", shift: "0", mask: "0x1FFFFFFF" },
		]
	},
	{ name: "Z2_OTPSECLOCK", description: "Zone 2 OTP Secure JTAG lock", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "B0_Z2_LINKPOINTERERR", description: "Link Pointer Error for flash BANK0", offset: "0x6", size: "32",
		bits: [
			{ name: "Z2_LINKPOINTERERR", description: "Error to Resolve Z2 Link pointer from OTP loaded values", size: "29", shift: "0", mask: "0x1FFFFFFF" },
		]
	},
	...
	{ name: "Z2_CR", description: "Zone 2 CSM Control Register", offset: "0x19", size: "16",
		bits: [
			{ name: "ALLZERO", description: "CSMPSWD All Zeros", size: "1", shift: "3", mask: "0x8" },
			{ name: "ALLONE", description: "CSMPSWD All Ones", size: "1", shift: "4", mask: "0x10" },
			{ name: "UNSECURE", description: "CSMPSWD Match CSMKEY", size: "1", shift: "5", mask: "0x20" },
	...
	{ name: "B0_Z2_GRABSECTR", description: "Zone 2 Grab Flash BANK0 Sectors Register", offset: "0x1A", size: "32",
		bits: [
	...
	{ name: "Z2_GRABRAMR", description: "Zone 2 Grab RAM Blocks Register", offset: "0x1C", size: "16",
		bits: [
			{ name: "GRAB_RAM0", description: "Grab RAM LS0", size: "2", shift: "0", mask: "0x3" },
			{ name: "GRAB_RAM1", description: "Grab RAM LS1", size: "2", shift: "2", mask: "0xC" },
			{ name: "GRAB_RAM2", description: "Grab RAM LS2", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "B0_Z2_EXEONLYSECTR", description: "Zone 2 Flash BANK0 Execute_Only Sector Register", offset: "0x1E", size: "16",
		bits: [
			{ name: "EXEONLY_SECT0", description: "Execute-Only Flash Sector 0 in Flash BANK0", size: "1", shift: "0", mask: "0x1" },
			{ name: "EXEONLY_SECT1", description: "Execute-Only Flash Sector 1 in Flash BANK0", size: "1", shift: "1", mask: "0x2" },
			{ name: "EXEONLY_SECT2", description: "Execute-Only Flash Sector 2 in Flash BANK0", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "Z2_EXEONLYRAMR", description: "Zone 2 RAM Execute_Only Block Register", offset: "0x20", size: "16",
		bits: [
			{ name: "EXEONLY_RAM0", description: "Execute-Only RAM LS0", size: "1", shift: "0", mask: "0x1" },
			{ name: "EXEONLY_RAM1", description: "Execute-Only RAM LS1", size: "1", shift: "1", mask: "0x2" },
			{ name: "EXEONLY_RAM2", description: "Execute-Only RAM LS2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "B0_SECTSTAT", description: "Flash BANK0 Sectors Status Register", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "RAMSTAT", description: "RAM Status Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "B1_SECTSTAT", description: "Flash BANK1 Sectors Status Register", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "SECERRSTAT", description: "Security Error Status Register", offset: "0xA", size: "16",
		bits: [
			{ name: "ERR", description: "Security Configuration load Error Status", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SECERRCLR", description: "Security Error Clear Register", offset: "0xC", size: "16",
		bits: [
			{ name: "ERR", description: "Clear Security Configuration Load Error Status Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SECERRFRC", description: "Security Error Force Register", offset: "0xE", size: "16",
		bits: [
			{ name: "ERR", description: "Set Security Configuration Load Error Status Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "B1_Z1OTP_LINKPOINTER1", description: "Zone 1 Link Pointer1 in Z1 OTP for flash BANK1", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "B1_Z1OTP_LINKPOINTER2", description: "Zone 1 Link Pointer2 in Z1 OTP for flash BANK1", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "B1_Z1OTP_LINKPOINTER3", description: "Zone 1 Link Pointer3 in Z1 OTP for flash BANK1", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "B1_Z2OTP_LINKPOINTER1", description: "Zone 2 Link Pointer1 in Z2 OTP for flash BANK1", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "B1_Z2OTP_LINKPOINTER2", description: "Zone 2 Link Pointer2 in Z2 OTP for flash BANK1", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "B1_Z2OTP_LINKPOINTER3", description: "Zone 2 Link Pointer3 in Z2 OTP for flash BANK1", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "B1_Z1_LINKPOINTER", description: "Zone 1 Link Pointer for flash BANK1", offset: "0x0", size: "32",
		bits: [
			{ name: "LINKPOINTER", description: "Zone1 LINK Pointer in Flash BANK1", size: "29", shift: "0", mask: "0x1FFFFFFF" },
		]
	},
	{ name: "B1_Z1_LINKPOINTERERR", description: "Link Pointer Error for flash BANK1", offset: "0x6", size: "32",
		bits: [
			{ name: "Z1_LINKPOINTERERR", description: "Error to Resolve Z1 Link pointer from OTP loaded values", size: "29", shift: "0", mask: "0x1FFFFFFF" },
		]
	},
	{ name: "B1_Z1_GRABSECTR", description: "Zone 1 Grab Flash BANK1 Sectors Register", offset: "0x1A", size: "32",
		bits: [
	...
	{ name: "B1_Z1_EXEONLYSECTR", description: "Zone 1 Flash BANK1 Execute_Only Sector Register", offset: "0x1E", size: "16",
		bits: [
			{ name: "EXEONLY_SECT0", description: "Execute-Only Flash Sector 0 in Flash BANK1", size: "1", shift: "0", mask: "0x1" },
			{ name: "EXEONLY_SECT1", description: "Execute-Only Flash Sector 1 in Flash BANK1", size: "1", shift: "1", mask: "0x2" },
			{ name: "EXEONLY_SECT2", description: "Execute-Only Flash Sector 2 in Flash BANK1", size: "1", shift: "2", mask: "0x4" },
			{ name: "EXEONLY_SECT3", description: "Execute-Only Flash Sector 3 in Flash BANK1", size: "1", shift: "3", mask: "0x8" },
			{ name: "EXEONLY_SECT4", description: "Execute-Only Flash Sector 4 in Flash BANK1", size: "1", shift: "4", mask: "0x10" },
			{ name: "EXEONLY_SECT5", description: "Execute-Only Flash Sector 5 in Flash BANK1", size: "1", shift: "5", mask: "0x20" },
			{ name: "EXEONLY_SECT6", description: "Execute-Only Flash Sector 6 in Flash BANK1", size: "1", shift: "6", mask: "0x40" },
			{ name: "EXEONLY_SECT7", description: "Execute-Only Flash Sector 7 in Flash BANK1", size: "1", shift: "7", mask: "0x80" },
			{ name: "EXEONLY_SECT8", description: "Execute-Only Flash Sector 8 in Flash BANK1", size: "1", shift: "8", mask: "0x100" },
			{ name: "EXEONLY_SECT9", description: "Execute-Only Flash Sector 9 in Flash BANK1", size: "1", shift: "9", mask: "0x200" },
			{ name: "EXEONLY_SECT10", description: "Execute-Only Flash Sector 10 in Flash BANK1", size: "1", shift: "10", mask: "0x400" },
			{ name: "EXEONLY_SECT11", description: "Execute-Only Flash Sector 11 in Flash BANK1", size: "1", shift: "11", mask: "0x800" },
			{ name: "EXEONLY_SECT12", description: "Execute-Only Flash Sector 12 in Flash BANK1", size: "1", shift: "12", mask: "0x1000" },
			{ name: "EXEONLY_SECT13", description: "Execute-Only Flash Sector 13 in Flash BANK1", size: "1", shift: "13", mask: "0x2000" },
			{ name: "EXEONLY_SECT14", description: "Execute-Only Flash Sector 14 in Flash BANK1", size: "1", shift: "14", mask: "0x4000" },
			{ name: "EXEONLY_SECT15", description: "Execute-Only Flash Sector 15 in Flash BANK1", size: "1", shift: "15", mask: "0x8000" },
		]
	},
	{ name: "B1_Z2_LINKPOINTER", description: "Zone 2 Link Pointer for flash BANK1", offset: "0x0", size: "32",
		bits: [
			{ name: "LINKPOINTER", description: "Zone2 LINK Pointer in Flash BANK1", size: "29", shift: "0", mask: "0x1FFFFFFF" },
		]
	},
	{ name: "B1_Z2_LINKPOINTERERR", description: "Link Pointer Error for flash BANK1", offset: "0x6", size: "32",
		bits: [
			{ name: "Z2_LINKPOINTERERR", description: "Error to Resolve Z2 Link pointer from OTP loaded values", size: "29", shift: "0", mask: "0x1FFFFFFF" },
		]
	},
	{ name: "B1_Z2_GRABSECTR", description: "Zone 2 Grab Flash BANK1 Sectors Register", offset: "0x1A", size: "32",
		bits: [
	...
	{ name: "B1_Z2_EXEONLYSECTR", description: "Zone 2 Flash BANK1 Execute_Only Sector Register", offset: "0x1E", size: "16",
		bits: [
			{ name: "EXEONLY_SECT0", description: "Execute-Only Flash Sector 0 in Flash BANK1", size: "1", shift: "0", mask: "0x1" },
			{ name: "EXEONLY_SECT1", description: "Execute-Only Flash Sector 1 in Flash BANK1", size: "1", shift: "1", mask: "0x2" },
			{ name: "EXEONLY_SECT2", description: "Execute-Only Flash Sector 2 in Flash BANK1", size: "1", shift: "2", mask: "0x4" },
