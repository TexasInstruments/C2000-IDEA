let DAC_REGISTERS = [
	...
	{ name: "CTL", description: "DAC Control Register", offset: "0x1", size: "16",
		bits: [
	...
	{ name: "VALA", description: "DAC Value Register - Active", offset: "0x2", size: "16",
		bits: [
			{ name: "DACVALA", description: "DAC Active Output Code", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "VALS", description: "DAC Value Register - Shadow", offset: "0x3", size: "16",
		bits: [
			{ name: "DACVALS", description: "DAC Shadow Output Code", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "OUTEN", description: "DAC Output Enable Register", offset: "0x4", size: "16",
		bits: [
			{ name: "DACOUTEN", description: "DAC Output Code", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "LOCK", description: "DAC Lock Register", offset: "0x5", size: "16",
		bits: [
	...
	{ name: "TRIM", description: "DAC Trim Register", offset: "0x6", size: "16",
		bits: [
