let MEMCFG_REGISTERS = [
	...
	{ name: "DXTEST", description: "Dedicated RAM TEST Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "DXINIT", description: "Dedicated RAM Init Register", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "DXINITDONE", description: "Dedicated RAM InitDone Status Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "GSXLOCK", description: "Global Shared RAM Config Lock Register", offset: "0x20", size: "16",
		bits: [
			{ name: "LOCK_GS0", description: "GS0 RAM Lock bits", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "GSXCOMMIT", description: "Global Shared RAM conffig Lock Commit Register", offset: "0x22", size: "16",
		bits: [
			{ name: "COMMIT_GS0", description: "GS0 RAM Permanent Lock bits", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "GSXTEST", description: "Global Shared RAM TEST Register", offset: "0x24", size: "16",
		bits: [
			{ name: "TEST_GS0", description: "Selects the different modes for GS0 RAM", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "GSXINIT", description: "Global Shared RAM Init Register", offset: "0x26", size: "16",
		bits: [
			{ name: "INIT_GS0", description: "RAM Initialization control for GS0 RAM.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "GSXINITDONE", description: "Global Shared RAM InitDone Status Register", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "ROM_TEST", description: "ROM  TEST Register", offset: "0x32", size: "16",
		bits: [
			{ name: "TEST_BOOTROM_SECUREROM", description: "Selects the different modes for BOOTROM and SECURE ROM", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "ROM_FORCE_ERROR", description: "ROM Force Error register", offset: "0x34", size: "16",
		bits: [
	...
	{ name: "UCCPUREADDR", description: "Uncorrectable CPU Error Address", offset: "0x6", size: "16",
		bits: [
		]
	},
	{ name: "UCDMAREADDR", description: "Uncorrectable DMA Error Address", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "FLUCERRSTATUS", description: "Flash read uncorrectable ecc err status", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "CCPUREADDR", description: "Correctable CPU  Error Address", offset: "0x26", size: "16",
		bits: [
		]
	},
	{ name: "CDMAREADDR", description: "Correctable DMA Error Address", offset: "0x28", size: "16",
		bits: [
		]
	},
	{ name: "CERRCNT", description: "Correctable Error Count Register", offset: "0x30", size: "16",
		bits: [
		]
	},
	{ name: "CERRTHRES", description: "Correctable Error Threshold Value Register", offset: "0x32", size: "16",
		bits: [
			{ name: "CERRTHRES", description: "Correctable error threshold", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "CEINTFLG", description: "Correctable Error Interrupt Flag Status Register", offset: "0x34", size: "16",
		bits: [
			{ name: "CEINTFLAG", description: "Total corrected error count exceeded threshold flag.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CEINTCLR", description: "Correctable Error Interrupt Flag Clear Register", offset: "0x36", size: "16",
		bits: [
			{ name: "CEINTCLR", description: "Total corrected error count exceeded flag clear", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CEINTSET", description: "Correctable Error Interrupt Flag Set Register", offset: "0x38", size: "16",
		bits: [
			{ name: "CEINTSET", description: "Total corrected error count exceeded flag set", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CEINTEN", description: "Correctable Error Interrupt Enable Register", offset: "0x3A", size: "16",
		bits: [
