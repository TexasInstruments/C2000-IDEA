let ASYSCTL_REGISTERS = [
	...
	{ name: "CMPHPMXSEL1", description: "Bits to select one of the many sources on CopmHP inputs. Refer to Pimux diagram for details.", offset: "0x90", size: "16",
		bits: [
			{ name: "CMP11HPMXSEL", description: "CMP15HPMXSEL bits", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "CMPLPMXSEL1", description: "Bits to select one of the many sources on CopmLP inputs. Refer to Pimux diagram for details.", offset: "0x92", size: "16",
		bits: [
			{ name: "CMP11LPMXSEL", description: "CMP15LPMXSEL bits", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "ADCSOCFRCGB", description: "ADC Global SOC Force", offset: "0x10E", size: "16",
		bits: [
	...
	{ name: "GPIOINENACTRL", description: "GPIOINENACTRL Control Register", offset: "0x134", size: "16",
		bits: [
