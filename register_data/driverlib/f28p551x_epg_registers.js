let EPG_REGISTERS = [
	{ name: "GCTL0", description: "EPG Global control register 0", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "GCTL1", description: "EPG Global control register 1", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "LOCK", description: "EPG LOCK Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "COMMIT", description: "EPG COMMIT register", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "GINTSTS", description: "EPG Global interrupt status register.", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "GINTEN", description: "EPG Global interrupt enable register.", offset: "0xE", size: "16",
		bits: [
	...
	{ name: "GINTCLR", description: "EPG Global interrupt clear register.", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "GINTFRC", description: "EPG Global interrupt force register.", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "SIGGEN0_CTL0", description: "Signal generator 0's control register 0", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "SIGGEN0_CTL1", description: "Signal generator 0's control register 1", offset: "0x32", size: "16",
		bits: [
	...
	{ name: "SIGGEN0_DATA0", description: "Signal generator 0's data register 0", offset: "0x38", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA1", description: "Signal generator 0's data register 1", offset: "0x3A", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA0_ACTIVE", description: "Signal generator 0's data active register 0", offset: "0x3C", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA1_ACTIVE", description: "Signal generator 0's data active register 1", offset: "0x3E", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN1_CTL0", description: "Signal generator 1's control register 0", offset: "0x40", size: "16",
		bits: [
			{ name: "MODE", description: "Signal generator modes", size: "4", shift: "0", mask: "0xF" },
			{ name: "BRIN", description: "Reverse bits before transform", size: "1", shift: "5", mask: "0x20" },
			{ name: "BROUT", description: "Reverse bits after transform", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SIGGEN1_CTL1", description: "Signal generator 1's control register 1", offset: "0x42", size: "16",
		bits: [
			{ name: "DATA0_INSEL", description: "Select the source of DATA[0] bit.", size: "4", shift: "0", mask: "0xF" },
			{ name: "DATA63_INSEL", description: "Select the source of DATA[63] bit.", size: "4", shift: "28", mask: "0xF0000000" },
		]
	},
	{ name: "SIGGEN1_DATA0", description: "Signal generator 1's data register 0", offset: "0x48", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN1_DATA1", description: "Signal generator 1's data register 1", offset: "0x4A", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN1_DATA0_ACTIVE", description: "Signal generator 1's data active register 0", offset: "0x4C", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN1_DATA1_ACTIVE", description: "Signal generator 1's data active register 1", offset: "0x4E", size: "16",
		bits: [
		]
	},
	...
	{ name: "MXSEL0", description: "EPG Mux select register 0", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "MXSEL1", description: "EPG Mux select register 1", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "MXSELLOCK", description: "EPG Mux select register lock", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "MXSELCOMMIT", description: "EPG Mux select register commit", offset: "0xE", size: "16",
		bits: [
