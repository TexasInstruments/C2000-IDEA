let CPUTIMER_REGISTERS = [
	{ name: "TIM", description: "CPU-Timer, Counter Register", offset: "0x0", size: "32",
		bits: [
			{ name: "TIMER_LSW", description: "CPU-Timer Counter Registers", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "TIMER_MSW", description: "CPU-Timer Counter Registers High", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "PRD", description: "CPU-Timer, Period Register", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "TCR", description: "CPU-Timer, Control Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "TPR", description: "CPU-Timer, Prescale Register", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "TPRH", description: "CPU-Timer, Prescale Register High", offset: "0xE", size: "16",
		bits: [
...
module.exports = {
	cputimerRegisters: CPUTIMER_REGISTERS,
}
