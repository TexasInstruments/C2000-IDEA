let HWBIST_REGISTERS = [
	{ name: "CSTCGCR1", description: "STC Global Control Register1", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "CSTCGCR3", description: "STC Global Control Register3", offset: "0xC", size: "16",
		bits: [
			{ name: "ILS", description: "Interrupt Logging Start", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "CSTCGCR4", description: "STC Global Control Register4", offset: "0x10", size: "16",
		bits: [
			{ name: "BISTGO", description: "BIST Start", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "CSTCGCR5", description: "STC Global Control Register5", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "CSTCGCR6", description: "STC Global Control Register6", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "CSTCGCR8", description: "STC Global Control Register8", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "CSTCCONFIG", description: "STC Registers Configuration Status", offset: "0x28", size: "16",
		bits: [
	...
	{ name: "CSTCRET", description: "C28 Return PC Address", offset: "0x34", size: "16",
		bits: [
		]
	},
	{ name: "CSTCCRD", description: "C28 Context Restore Done Register", offset: "0x38", size: "16",
		bits: [
			{ name: "RESTORE_DONE", description: "Context Restone Done", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "CSTCGSTAT", description: "STC Global Status Register", offset: "0x40", size: "16",
		bits: [
	...
	{ name: "CSTCCPCR", description: "STC Current Pattern Count Register", offset: "0x48", size: "16",
		bits: [
	...
	{ name: "CSTCMISR0", description: "MISR Result Register 0", offset: "0x50", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR1", description: "MISR Result Register 1", offset: "0x54", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR2", description: "MISR Result Register 2", offset: "0x58", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR3", description: "MISR Result Register 3", offset: "0x5C", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR4", description: "MISR Result Register 4", offset: "0x60", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR5", description: "MISR Result Register 5", offset: "0x64", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR6", description: "MISR Result Register 6", offset: "0x68", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR7", description: "MISR Result Register 7", offset: "0x6C", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR8", description: "MISR Result Register 8", offset: "0x70", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR9", description: "MISR Result Register 9", offset: "0x74", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR10", description: "MISR Result Register 10", offset: "0x78", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR11", description: "MISR Result Register 11", offset: "0x7C", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR12", description: "MISR Result Register 12", offset: "0x80", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR13", description: "MISR Result Register 13", offset: "0x84", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR14", description: "MISR Result Register 14", offset: "0x88", size: "16",
		bits: [
		]
	},
	{ name: "CSTCMISR15", description: "MISR Result Register 15", offset: "0x8C", size: "16",
		bits: [
		]
	},
];
