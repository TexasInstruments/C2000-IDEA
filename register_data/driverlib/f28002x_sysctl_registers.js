let SYSCTL_REGISTERS = [
	...
	{ name: "SOFTPRES18", description: "Peripheral Software Reset register", offset: "0xA6", size: "16",
		bits: [
	...
	{ name: "SOFTPRES25", description: "Peripheral Software Reset register", offset: "0xB4", size: "16",
		bits: [
	...
	{ name: "PCLKCR22", description: "Peripheral Clock Gating Register - MPOST", offset: "0x4E", size: "16",
		bits: [
	...
	{ name: "GPIOLPMSEL1", description: "GPIO LPM Wakeup select registers", offset: "0x7A", size: "16",
		bits: [
