let SDFM_REGISTERS = [
	{ name: "SDIFLG", description: "Interrupt Flag Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "SDIFLGCLR", description: "Interrupt Flag Clear Register", offset: "0x2", size: "32",
		bits: [
			{ name: "IFH1", description: "High-level Interrupt flag Filter 1", size: "1", shift: "0", mask: "0x1" },
			{ name: "IFL1", description: "Low-Level Interrupt flag Filter 1", size: "1", shift: "1", mask: "0x2" },
			{ name: "IFH2", description: "High-level Interrupt flag Filter 2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "SDDPARM1", description: "Integer Parameter Register for Ch1", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "SDCPARM1", description: "Comparator Parameter Register for Ch1", offset: "0x15", size: "16",
		bits: [
			...
			{ name: "CS1_CS0", description: "Comparator filter structure (Sincfast/Sinc1/Sinc2/Sinc3", size: "2", shift: "7", mask: "0x180" },
			{ name: "MFIE", description: "Modulator Failure Interrupt enable", size: "1", shift: "9", mask: "0x200" },
		]
	},
	{ name: "SDDATA1", description: "Filter Data Register (16 or 32bit) for Ch1", offset: "0x16", size: "32",
		bits: [
			{ name: "DATA16", description: "16-bit Data in 16b mode, Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
	...
	{ name: "SDDPARM2", description: "Integer Parameter Register for Ch2", offset: "0x22", size: "16",
		bits: [
			{ name: "DR", description: "Data Representation (0/1 = 16/32b 2's complement)", size: "1", shift: "10", mask: "0x400" },
			{ name: "SH", description: "Shift Control (# bits to shift in 16b mode)", size: "5", shift: "11", mask: "0xF800" },
		]
	...
	{ name: "SDCPARM2", description: "Comparator Parameter Register for Ch2", offset: "0x25", size: "16",
		bits: [
			{ name: "COSR", description: "Comparator Oversample Ratio = COSR + 1", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IEH", description: "High-level interrupt enable", size: "1", shift: "5", mask: "0x20" },
			{ name: "IEL", description: "Low-level interrupt enable", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDDATA2", description: "Filter Data Register (16 or 32bit) for Ch2", offset: "0x26", size: "32",
		bits: [
			{ name: "DATA16", description: "16-bit Data in 16b mode, Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	...
	{ name: "SDDPARM3", description: "Integer Parameter Register for Ch3", offset: "0x32", size: "16",
		bits: [
			{ name: "DR", description: "Data Representation (0/1 = 16/32b 2's complement)", size: "1", shift: "10", mask: "0x400" },
			{ name: "SH", description: "Shift Control (# bits to shift in 16b mode)", size: "5", shift: "11", mask: "0xF800" },
		]
	...
	{ name: "SDCPARM3", description: "Comparator Parameter Register for Ch3", offset: "0x35", size: "16",
		bits: [
			{ name: "COSR", description: "Comparator Oversample Ratio = COSR + 1", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IEH", description: "High-level interrupt enable", size: "1", shift: "5", mask: "0x20" },
			{ name: "IEL", description: "Low-level interrupt enable", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDDATA3", description: "Filter Data Register (16 or 32bit) for Ch3", offset: "0x36", size: "32",
		bits: [
			{ name: "DATA16", description: "16-bit Data in 16b mode, Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	...
	{ name: "SDDPARM4", description: "Integer Parameter Register for Ch4", offset: "0x42", size: "16",
		bits: [
			{ name: "DR", description: "Data Representation (0/1 = 16/32b 2's complement)", size: "1", shift: "10", mask: "0x400" },
			{ name: "SH", description: "Shift Control (# bits to shift in 16b mode)", size: "5", shift: "11", mask: "0xF800" },
		]
	...
	{ name: "SDCPARM4", description: "Comparator Parameter Register for Ch4", offset: "0x45", size: "16",
		bits: [
			{ name: "COSR", description: "Comparator Oversample Ratio = COSR + 1", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IEH", description: "High-level interrupt enable", size: "1", shift: "5", mask: "0x20" },
			{ name: "IEL", description: "Low-level interrupt enable", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDDATA4", description: "Filter Data Register (16 or 32bit) for Ch4", offset: "0x46", size: "32",
		bits: [
			{ name: "DATA16", description: "16-bit Data in 16b mode, Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
