let MDL_XBAR_REGISTERS = [
	{ name: "MDLXBAROUTINVERT", description: "Output Signal Invert Select", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "MDLXBARLOCK", description: "Configuration Lock register", offset: "0x80", size: "32",
		bits: [
			{ name: "LOCK", description: "Locks the configuration for EMDL-XBAR", size: "1", shift: "0", mask: "0x1" },
			{ name: "KEY", description: "Write protection KEY", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "MDLXBARG0SEL", description: "(0 <= i < 16) MDLXBAR G0 Input Select", offset: "(0x100 + ((i) * 64))", count: "16", size: "32",
		bits: [
	...
	{ name: "MDLXBARG1SEL", description: "(0 <= i < 16) MDLXBAR G1 Input Select", offset: "(0x104 + ((i) * 64))", count: "16", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MDLXBARG2SEL", description: "(0 <= i < 16) MDLXBAR G2 Input Select", offset: "(0x108 + ((i) * 64))", count: "16", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
...
module.exports = {
	mdl_xbarRegisters: MDL_XBAR_REGISTERS,
}
