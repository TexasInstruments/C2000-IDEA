let XINT_REGISTERS = [
	...
	{ name: "2CR", description: "XINT2 configuration register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "3CR", description: "XINT3 configuration register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "4CR", description: "XINT4 configuration register", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "5CR", description: "XINT5 configuration register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "1CTR", description: "XINT1 counter register", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "2CTR", description: "XINT2 counter register", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "3CTR", description: "XINT3 counter register", offset: "0x14", size: "16",
		bits: [
		]
	},
];
