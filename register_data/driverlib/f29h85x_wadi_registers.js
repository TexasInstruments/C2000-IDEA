let WADI_REGISTERS = [
	...
	{ name: "SIGTOSIGCFG", description: "Configuration for SIG1 to SIG2 comparison for WADI Block", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "SIGTOSIG_PKCFG", description: "Signal1 to Signal2 peak comparison value and margin for WADI Block", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "SIGTOSIG_AVGCFG", description: "Signal1 to Signal2 average comparison value and margin for WADI Block", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "SIGTOSIG_DBOLAPA", description: "Signal1 to Signal2 dead-band comparison difference and margin for WADI Block", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "SIGTOSIG_DBOLAPB", description: "Signal1 to Signal2 dead-band and Overlap compare values for WADI Block", offset: "0x14", size: "32",
		bits: [
	...
	{ name: "BLKTRIGCFG", description: "The trigger configuration for SIG1 and SIG2 of the WADI Block", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "SIG1CFG", description: "Measurement configuration for SIG1 of WADI Block", offset: "0x40", size: "16",
		bits: [
	...
	{ name: "SIG1CMPA", description: "Envelope-1 compare value and margin for SIG1 for WADI Block", offset: "0x44", size: "32",
		bits: [
	...
	{ name: "SIG1CMPB", description: "Envelope-2 compare value and margin for SIG1 for WADI Block", offset: "0x48", size: "32",
		bits: [
	...
	{ name: "SIG1PKCFG", description: "Peak of the aggregation compare configuration for SIG1 of WADI Block", offset: "0x4C", size: "32",
		bits: [
	...
	{ name: "SIG1AVGCFG", description: "Average of the aggregation comparison configuration for SIG1 of WADI Block", offset: "0x50", size: "32",
		bits: [
	...
	{ name: "SIG1EDGECFG", description: "Frequency measurement  configuration for SIG1 of WADI Block", offset: "0x54", size: "32",
		bits: [
	...
	{ name: "SIG1EDGEMVWCFG", description: "Moving Window Configuration for SIG1 of WADI Block", offset: "0x58", size: "32",
		bits: [
	...
	{ name: "SIG2CFG", description: "Measurement configuration for SIG2 of WADI Block", offset: "0x80", size: "16",
		bits: [
			{ name: "SIGPOL", description: "Starting edge select as rise, fall or either", size: "2", shift: "0", mask: "0x3" },
			{ name: "EDGESPAN", description: "Defines span of edges of given type to measure the width.", size: "4", shift: "8", mask: "0xF00" },
			{ name: "NUMAGGR", description: "Defines number of measurements to be aggregated", size: "3", shift: "16", mask: "0x70000" },
	...
	{ name: "SIG2CMPA", description: "Compare value A and +/- margin for SIG2 for WADI Block", offset: "0x84", size: "32",
		bits: [
	...
	{ name: "SIG2CMPB", description: "Compare value B and +/- margin for SIG2 for WADI Block", offset: "0x88", size: "32",
		bits: [
	...
	{ name: "SIG2PKCFG", description: "Peak of the aggregation compare configuration for SIG2 of WADI Block", offset: "0x8C", size: "32",
		bits: [
	...
	{ name: "SIG2AVGCFG", description: "Average of the aggregation comparison configuration for SIG2 of WADI Block", offset: "0x90", size: "32",
		bits: [
	...
	{ name: "SIG2EDGECFG", description: "Frequency measurement  configuration for SIG2 of WADI Block", offset: "0x94", size: "32",
		bits: [
	...
	{ name: "SIG2EDGEMVWCFG", description: "Moving Window Configuration for SIG2 of WADI Block", offset: "0x98", size: "32",
		bits: [
			{ name: "MVWTIME", description: "Moving Window time", size: "26", shift: "0", mask: "0x3FFFFFF" },
			{ name: "MVWCNT", description: "Moving window count:number of MWVTIME windows to accumulate", size: "2", shift: "28", mask: "0x30000000" },
			{ name: "MVWEN", description: "Moving window operation enable", size: "1", shift: "31", mask: "0x80000000" },
	...
	{ name: "BLKERRSTS", description: "Block status register", offset: "0xC0", size: "32",
		bits: [
	...
	{ name: "BLKERRINFO", description: "Block count value of failed register", offset: "0xC4", size: "32",
		bits: [
	...
	{ name: "BLKERRCFG", description: "Block Debug additional info.", offset: "0xC8", size: "16",
		bits: [
	...
	{ name: "SSS_EVTMASK", description: "Mask to combine Block errors for trigger of SSS in event word Output by WADI block", offset: "0xCC", size: "32",
		bits: [
	...
	{ name: "PARTEST", description: "Enables parity test", offset: "0xE8", size: "16",
		bits: [
			{ name: "TESTEN", description: "Parity test enable configuration", size: "4", shift: "0", mask: "0xF" },
			{ name: "TESTEN", description: "Parity test enable configuration", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "BASETIMERLOW", description: "Read only value for lower word of the base timer.", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "BASETIMERHIGH", description: "Upper word of the base timer and trigger to start the timer.", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "INTSTS", description: "Gives the block wise aggregated raw error status that shall trigger the interrupt.", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "INTSTSMASK", description: "Provides mask for application to suppress or allow a particular block related errors to cause", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "BLKSMASKSTS", description: "This is AND combination of active high indication of block-wise status asserting an interrupt.", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "INTSTSCLR", description: "Provides way for application to clear the interrupt status.", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "INTSTSFRC", description: "Allows emulation of the RIS to raise interrupt in software", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "SIGSYNCFILTCFG", description: "Each input SIG to be connected through synchroniser or not", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "TRIGSYNCFILTCFG", description: "Each trigger to be connected through synchroniser or not", offset: "0x20", size: "16",
		bits: [
		]
	},
	{ name: "REVISION", description: "IP Revision", offset: "0x3C", size: "32",
		bits: [
	...
	{ name: "DMATRIGSTS", description: "Status of the DMA triggers active", offset: "0x40", size: "32",
		bits: [
	...
	{ name: "DMATRIGEN", description: "Mask to enable individual trigger cause", offset: "0x44", size: "32",
		bits: [
	...
	{ name: "DMASTSUPDATE", description: "Indicates the register set updated post DMA write", offset: "0x48", size: "32",
		bits: [
	...
	{ name: "DMAFILTWRCFG", description: "DMA writes Filter enable for each of WADI & SSS blocks", offset: "0x4C", size: "32",
		bits: [
	...
	{ name: "CFGREGLOCK", description: "Configuration Register Lock", offset: "0xA4", size: "16",
		bits: [
			{ name: "LOCK", description: "Register Lock", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CFGREGCOMMIT", description: "Configuration Register Commit", offset: "0xA8", size: "16",
		bits: [
			{ name: "COMMIT", description: "CONFIG_REG_LOCK Permanent Commit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "OPERREGLOCK", description: "Operating Register Lock", offset: "0xAC", size: "16",
		bits: [
			{ name: "LOCK", description: "Register Lock", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "OPERREGCOMMIT", description: "Operating Register Commit", offset: "0xB0", size: "16",
		bits: [
			{ name: "COMMIT", description: "OPER_REG_LOCK Permanent Commit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SSS_EVTTRIG", description: "Event trigger word output by WADI instance for SSS", offset: "0xB8", size: "16",
		bits: [
		]
	},
	{ name: "SSS_OUTEVTSTS", description: "Status of the active event", offset: "0xBC", size: "16",
		bits: [
	...
	{ name: "SSS_BLK1_2OUTSEL", description: "Mux select word for outputs 0-3", offset: "0xC0", size: "32",
		bits: [
	...
	{ name: "SSS_BLK3_4OUTSEL", description: "Mux select word for outputs 4-7", offset: "0xC4", size: "32",
		bits: [
	...
	{ name: "SSS_BLK5_6OUTSEL", description: "Mux select word for outputs 8-11", offset: "0xC8", size: "32",
		bits: [
	...
	{ name: "SSS_BLK7_8OUTSEL", description: "Mux select word for outputs 12-15", offset: "0xCC", size: "32",
		bits: [
	...
	{ name: "SSS_OUTEVT1LINKCFG", description: "Output event1 Link configuration", offset: "0xE0", size: "16",
		bits: [
			{ name: "OUTEVT1LINK", description: "Links output events (OUTEVTs) as per one hot encoding", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SSS_OUTEVT2LINKCFG", description: "Output event2 link configuration", offset: "0xE4", size: "16",
		bits: [
			{ name: "OUTEVT2LINK", description: "Links output events (OUTEVTs) as per one hot encoding", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SSS_OUTEVT3LINKCFG", description: "Output event3 link configuration", offset: "0xE8", size: "16",
		bits: [
			{ name: "OUTEVT3LINK", description: "Links output events (OUTEVTs) as per one hot encoding", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SSS_OUTEVT4LINKCFG", description: "Output event4 link configuration", offset: "0xEC", size: "16",
		bits: [
			{ name: "OUTEVT4LINK", description: "Links output events (OUTEVTs) as per one hot encoding", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SSS_OUTEVT5LINKCFG", description: "Output event5 link configuration", offset: "0xF0", size: "16",
		bits: [
			{ name: "OUTEVT5LINK", description: "Links output events (OUTEVTs) as per one hot encoding", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SSS_OUTEVT6LINKCFG", description: "Output event6 link configuration", offset: "0xF4", size: "16",
		bits: [
			{ name: "OUTEVT6LINK", description: "Links output events (OUTEVTs) as per one hot encoding", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SSS_OUTEVT7LINKCFG", description: "Output event7 link configuration", offset: "0xF8", size: "16",
		bits: [
			{ name: "OUTEVT7LINK", description: "Links output events (OUTEVTs) as per one hot encoding", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SSS_OUTEVT8LINKCFG", description: "Output event8 link configuration", offset: "0xFC", size: "16",
		bits: [
			{ name: "OUT8LINK", description: "Links output events (OUTEVTs) as per one hot encoding", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SSS_EVT1CFG", description: "Event1 that compares to trigger word SSS_EVTTRIG", offset: "0x100", size: "16",
		bits: [
		]
	},
	{ name: "SSS_EVT2CFG", description: "Event2 that compares to trigger word SSS_EVTTRIG", offset: "0x104", size: "16",
		bits: [
		]
	},
	{ name: "SSS_EVT3CFG", description: "Event3 that compares to trigger word SSS_EVTTRIG", offset: "0x108", size: "16",
		bits: [
		]
	},
	{ name: "SSS_EVT4CFG", description: "Event4 that compares to trigger word SSS_EVTTRIG", offset: "0x10C", size: "16",
		bits: [
		]
	},
	{ name: "SSS_TRIGEVT1_4CFG", description: "Configuration for using trigger word in specific manner", offset: "0x110", size: "16",
		bits: [
	...
	{ name: "SSS_BLKSOUTEVT1CFG", description: "Output event1 to be applied for output", offset: "0x180", size: "16",
		bits: [
		]
	},
	{ name: "SSS_BLKSOUTEVT2CFG", description: "Output event2 to be applied for output", offset: "0x184", size: "16",
		bits: [
		]
	},
	{ name: "SSS_BLKSOUTEVT3CFG", description: "Output event3 to be applied for output", offset: "0x188", size: "16",
		bits: [
		]
	},
	{ name: "SSS_BLKSOUTEVT4CFG", description: "Output event4 to be applied for output", offset: "0x18C", size: "16",
		bits: [
		]
	},
	{ name: "SSS_OUTEVT1TRIGCFG", description: "Output event1 configuration for triggers, link", offset: "0x190", size: "16",
		bits: [
	...
	{ name: "SSS_OUTEVT2TRIGCFG", description: "Output event2 configuration for triggers, link", offset: "0x194", size: "16",
		bits: [
	...
	{ name: "SSS_OUTEVT3TRIGCFG", description: "Output event3 configuration for triggers, link", offset: "0x198", size: "16",
		bits: [
	...
	{ name: "SSS_OUTEVT4TRIGCFG", description: "Output event4 configuration for triggers, link", offset: "0x19C", size: "16",
		bits: [
	...
	{ name: "SSS_OUTEVT1DUR", description: "Output event1 configuration of delays", offset: "0x1A0", size: "32",
		bits: [
			{ name: "TIME", description: "Duration time for application of OUTEVT1", size: "24", shift: "0", mask: "0xFFFFFF" },
		]
	},
	{ name: "SSS_OUTEVT2DUR", description: "Output event2 configuration of delays", offset: "0x1A4", size: "32",
		bits: [
			{ name: "TIME", description: "Duration time for application of OUTEVT2", size: "24", shift: "0", mask: "0xFFFFFF" },
		]
	},
	{ name: "SSS_OUTEVT3DUR", description: "Output event3 configuration of delays", offset: "0x1A8", size: "32",
		bits: [
			{ name: "TIME", description: "Duration time for application of OUTEVT3", size: "24", shift: "0", mask: "0xFFFFFF" },
		]
	},
	{ name: "SSS_OUTEVT4DUR", description: "Output event4 configuration of delays", offset: "0x1AC", size: "32",
		bits: [
			{ name: "TIME", description: "Duration time for application of OUTEVT4", size: "24", shift: "0", mask: "0xFFFFFF" },
		]
	},
	{ name: "SSS_EVT5CFG", description: "Event5 that compares to trigger word SSS_EVTTRIG", offset: "0x200", size: "16",
		bits: [
		]
	},
	{ name: "SSS_EVT6CFG", description: "Event6 that compares to trigger word SSS_EVTTRIG", offset: "0x204", size: "16",
		bits: [
		]
	},
	{ name: "SSS_EVT7CFG", description: "Event7 that compares to trigger word SSS_EVTTRIG", offset: "0x208", size: "16",
		bits: [
		]
	},
	{ name: "SSS_EVT8CFG", description: "Event8 that compares to trigger word SSS_EVTTRIG", offset: "0x20C", size: "16",
		bits: [
		]
	},
	{ name: "SSS_TRIGEVT5_8CFG", description: "Configuration for using trigger word in specific manner", offset: "0x210", size: "16",
		bits: [
	...
	{ name: "SSS_BLKSOUTEVT5CFG", description: "Output event5 to be applied for output", offset: "0x280", size: "16",
		bits: [
		]
	},
	{ name: "SSS_BLKSOUTEVT6CFG", description: "Output event6 to be applied for output", offset: "0x284", size: "16",
		bits: [
		]
	},
	{ name: "SSS_BLKSOUTEVT7CFG", description: "Output event7 to be applied for output", offset: "0x288", size: "16",
		bits: [
		]
	},
	{ name: "SSS_BLKSOUTEVT8CFG", description: "Output event8 to be applied for output", offset: "0x28C", size: "16",
		bits: [
		]
	},
	{ name: "SSS_OUTEVT5TRIGCFG", description: "Output event5 configuration for triggers, link", offset: "0x290", size: "16",
		bits: [
	...
	{ name: "SSS_OUTEVT6TRIGCFG", description: "Output event6 configuration for triggers, link", offset: "0x294", size: "16",
		bits: [
	...
	{ name: "SSS_OUTEVT7TRIGCFG", description: "Output event7 configuration for triggers, link", offset: "0x298", size: "16",
		bits: [
	...
	{ name: "SSS_OUTEVT8TRIGCFG", description: "Output event8 configuration for triggers, link", offset: "0x29C", size: "16",
		bits: [
	...
	{ name: "SSS_OUTEVT5DUR", description: "Output event5 configuration of delays", offset: "0x2A0", size: "32",
		bits: [
			{ name: "TIME", description: "Duration time for application of OUTEVT5", size: "24", shift: "0", mask: "0xFFFFFF" },
		]
	},
	{ name: "SSS_OUTEVT6DUR", description: "Output event6 configuration of delays", offset: "0x2A4", size: "32",
		bits: [
			{ name: "TIME", description: "Duration time for application of OUTEVT6", size: "24", shift: "0", mask: "0xFFFFFF" },
		]
	},
	{ name: "SSS_OUTEVT7DUR", description: "Output event7 configuration of delays", offset: "0x2A8", size: "32",
		bits: [
			{ name: "TIME", description: "Duration time for application of OUTEVT7", size: "24", shift: "0", mask: "0xFFFFFF" },
		]
	},
	{ name: "SSS_OUTEVT8DUR", description: "Output event8 configuration of delays", offset: "0x2AC", size: "32",
		bits: [
			{ name: "TIME", description: "Duration time for application of OUTEVT8", size: "24", shift: "0", mask: "0xFFFFFF" },
		]
	},
	{ name: "PARTEST", description: "Enables parity test", offset: "0x2C8", size: "16",
		bits: [
			{ name: "TESTEN", description: "Parity test enable configuration", size: "4", shift: "0", mask: "0xF" },
			{ name: "TESTEN", description: "Parity test enable configuration", size: "4", shift: "0", mask: "0xF" },
		]
