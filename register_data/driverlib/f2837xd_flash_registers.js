let FLASH_REGISTERS = [
	...
	{ name: "FBAC", description: "Flash Bank Access Control Register", offset: "0x1E", size: "16",
		bits: [
			{ name: "VREADST", description: "VREAD Setup Time Count", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	...
	{ name: "PUMPREQUEST", description: "Flash programming semaphore PUMP request register", offset: "0x0", size: "32",
		bits: [
			{ name: "PUMP_OWNERSHIP", description: "Flash Pump Request Semaphore between CPU1 and CPU2", size: "2", shift: "0", mask: "0x3" },
