let EPG_REGISTERS = [
	...
	{ name: "GCTL1", description: "EPG Global control register 1", offset: "0x4", size: "16",
		bits: [
			{ name: "SIGGEN0_CLKSEL", description: "Clock source select of SIGGEN0", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "GCTL2", description: "EPG Global control register 2", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "GCTL3", description: "EPG Global control register 3", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "LOCK", description: "EPG LOCK Register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "COMMIT", description: "EPG COMMIT register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "GINTSTS", description: "EPG Global interrupt status register.", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "GINTEN", description: "EPG Global interrupt enable register.", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "GINTCLR", description: "EPG Global interrupt clear register.", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "GINTFRC", description: "EPG Global interrupt force register.", offset: "0x24", size: "16",
		bits: [
	...
	{ name: "CLKDIV0_CTL0", description: "Clock divider 0's control register 0", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "CLKDIV0_CLKOFFSET", description: "Clock divider 0's clock offset value", offset: "0x3C", size: "32",
		bits: [
	...
	{ name: "CLKDIV1_CTL0", description: "Clock divider 1's control register 0", offset: "0x48", size: "32",
		bits: [
			{ name: "PRD", description: "Clock divider value", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "CLKSTOP", description: "Clock Stop Configuration", size: "3", shift: "16", mask: "0x70000" },
		]
	},
	{ name: "CLKDIV1_CLKOFFSET", description: "Clock divider 1's clock offset value", offset: "0x54", size: "32",
		bits: [
			{ name: "CLK0OFFSET", description: "Clock output 0 offset delay value.", size: "8", shift: "0", mask: "0xFF" },
			{ name: "CLK1OFFSET", description: "Clock output 0 offset delay value.", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "CLK2OFFSET", description: "Clock output 0 offset delay value.", size: "8", shift: "16", mask: "0xFF0000" },
	...
	{ name: "SIGGEN0_CTL0", description: "Signal generator 0's control register 0", offset: "0x60", size: "16",
		bits: [
	...
	{ name: "SIGGEN0_CTL1", description: "Signal generator 0's control register 1", offset: "0x64", size: "16",
		bits: [
	...
	{ name: "SIGGEN0_DATA0", description: "Signal generator 0's data register 0", offset: "0x70", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA1", description: "Signal generator 0's data register 1", offset: "0x74", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA0_ACTIVE", description: "Signal generator 0's data active register 0", offset: "0x78", size: "16",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA1_ACTIVE", description: "Signal generator 0's data active register 1", offset: "0x7C", size: "16",
		bits: [
		]
	},
	{ name: "REVISION", description: "IP Revision tie-off value", offset: "0xA0", size: "32",
		bits: [
	...
	{ name: "MXSELLOCK", description: "EPG Mux select register lock", offset: "0x18", size: "16",
		bits: [
			{ name: "EPGMXSEL0", description: "EPGMXSEL0 lock bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "MXSELCOMMIT", description: "EPG Mux select register commit", offset: "0x1C", size: "16",
		bits: [
