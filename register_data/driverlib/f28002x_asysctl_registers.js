let ASYSCTL_REGISTERS = [
	...
	{ name: "CMPHPMXSEL", description: "Bits to select one of the many sources on CopmHP inputs. Refer to Pimux diagram for details.", offset: "0x82", size: "16",
		bits: [
	...
	{ name: "CMPLPMXSEL", description: "Bits to select one of the many sources on CopmLP inputs. Refer to Pimux diagram for details.", offset: "0x84", size: "16",
		bits: [
