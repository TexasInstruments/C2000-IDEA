let SYSCTL_REGISTERS = [
	{ name: "PARTIDL", description: "Lower 32-bit of Device PART Identification Number", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "PARTIDH", description: "Upper 32-bit of Device PART Identification Number", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "REVID", description: "Device Revision Number", offset: "0x6", size: "16",
		bits: [
			{ name: "REVID", description: "Device Revision ID. This is specific to the Device", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "DC_MEMORY", description: "Device Capability: Memory Blocks Customization", offset: "0xE", size: "16",
		bits: [
	...
	{ name: "PERCNF", description: "Peripheral Configuration register - GPIO", offset: "0x10", size: "16",
		bits: [
			{ name: "GPIO_228_226", description: "GPIO226, GPIO228 Double bond protection configuration", size: "1", shift: "0", mask: "0x1" },
			{ name: "GPIO_230_227", description: "GPIO227, GPIO230 Double bond protection configuration", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "TRIMERRSTS", description: "TRIM Error Status register", offset: "0x12", size: "16",
		bits: [
			{ name: "LERR", description: "TRIM Load error status", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "SOFTPRES_PROC_INFRA", description: "Processing and Infra Blocks Software Reset register", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "SOFTPRES_CTRL_PERIPH", description: "Control Peripherals Software Reset register", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "SOFTPRES_COMM_PERIPH", description: "Communication Peripherals Software Reset register", offset: "0x22", size: "16",
		bits: [
	...
	{ name: "SOFTPRES_JTAG", description: "JTAG Software Reset register", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "TAP_STATUS", description: "Status of JTAG State machine & Debugger Connect", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "ECAPTYPE", description: "Configures ECAP Type for the device", offset: "0x2A", size: "16",
		bits: [
	...
	{ name: "TAP_CONTROL", description: "Disable TAP control", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "CLKCFGLOCK", description: "Lock bit for CLKCFG registers", offset: "0x0", size: "16",
		bits: [
			{ name: "ALL", description: "Lock bit for CLKCFG registers", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CLKSRCCTL1", description: "Clock Source Control register-1", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "SYSPLLCTL", description: "SYSPLL Control register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "SYSPLLMULT", description: "SYSPLL Multiplier register", offset: "0xA", size: "16",
		bits: [
			{ name: "QDIV", description: "SYSPLL Feedback Divider (decides the Multiplier factor)", size: "7", shift: "0", mask: "0x7F" },
	...
	{ name: "SYSPLLSTS", description: "SYSPLL Status register", offset: "0xC", size: "16",
		bits: [
			{ name: "LOCKS", description: "SYSPLL Lock Status Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SYSCLKDIVSEL", description: "System Clock Divider Select register", offset: "0xE", size: "16",
		bits: [
			{ name: "PLLSYSCLKDIV", description: "PLLSYSCLK Divide Select", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "XCLKOUTDIVSEL", description: "XCLKOUT Divider Select register", offset: "0x12", size: "16",
		bits: [
			{ name: "XCLKOUTDIV", description: "XCLKOUT Divide Select", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "LOSPCP", description: "Low Speed Clock Source Prescalar", offset: "0x14", size: "16",
		bits: [
			{ name: "LSPCLKDIV", description: "LSPCLK Divide Select", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "MCDCR", description: "Missing Clock Detect Control Register", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "X1CNT", description: "10-bit Counter on X1 Clock", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "XTALCR", description: "XTAL Control Register", offset: "0x1A", size: "16",
		bits: [
	...
	{ name: "XTALCR2", description: "XTAL Control Register for pad init", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "CLKFAILCFG", description: "Clock Fail cause Configuration", offset: "0x1E", size: "16",
		bits: [
			{ name: "DCC0_ERROR_EN", description: "DCC0 Error causes Clock fail NMI, ERROR", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CLKSRCSTS", description: "Clock Source Status", offset: "0x20", size: "16",
		bits: [
	...
	{ name: "CPUSYSLOCK", description: "Lock bit for CPUSYS registers", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "PIEVERRADDR", description: "PIE Vector Fetch Error Address register", offset: "0x2", size: "32",
		bits: [
			{ name: "ADDR", description: "PIE Vector Fetch Error Handler Routine Address", size: "22", shift: "0", mask: "0x3FFFFF" },
		]
	},
	{ name: "SIMRESET", description: "Simulated Reset Register", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "LPMCR", description: "LPM Control Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "GPIOLPMSEL0", description: "GPIO LPM Wakeup select registers", offset: "0xA", size: "32",
		bits: [
	...
	{ name: "GPIOLPMSEL1", description: "GPIO LPM Wakeup select registers", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "TMR2CLKCTL", description: "Timer2 Clock Measurement functionality control register", offset: "0xE", size: "16",
		bits: [
	...
	{ name: "RESCCLR", description: "Reset Cause Clear Register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "RESC", description: "Reset Cause register", offset: "0x12", size: "16",
		bits: [
			{ name: "POR", description: "POR Reset Cause Indication Bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "XRSN", description: "XRSn Reset Cause Indication Bit", size: "1", shift: "1", mask: "0x2" },
			{ name: "WDRSN", description: "WDRSn Reset Cause Indication Bit", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CMPSSLPMSEL", description: "CMPSS LPM Wakeup select registers", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "CLKSTOPACK", description: "Peripheral Clock Stop Ackonwledge Register", offset: "0x18", size: "16",
		bits: [
			{ name: "CAN_A", description: "CAN_A Clock Stop Ack Bit", size: "1", shift: "4", mask: "0x10" },
		]
	},
	{ name: "USER_REG1_SYSRSN", description: "Software Configurable registers reset by SYSRSn", offset: "0x1A", size: "16",
		bits: [
		]
	},
	{ name: "USER_REG2_SYSRSN", description: "Software Configurable registers reset by SYSRSn", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "USER_REG1_XRSN", description: "Software Configurable registers reset by XRSn", offset: "0x1E", size: "16",
		bits: [
		]
	},
	{ name: "USER_REG2_XRSN", description: "Software Configurable registers reset by XRSn", offset: "0x20", size: "16",
		bits: [
		]
	},
	{ name: "USER_REG1_PORESETN", description: "Software Configurable registers reset by PORESETn", offset: "0x22", size: "16",
		bits: [
		]
	},
	{ name: "USER_REG2_PORESETN", description: "Software Configurable registers reset by PORESETn", offset: "0x24", size: "16",
		bits: [
		]
	},
	{ name: "USER_REG3_PORESETN", description: "Software Configurable registers reset by PORESETn", offset: "0x26", size: "16",
		bits: [
		]
	},
	{ name: "USER_REG4_PORESETN", description: "Software Configurable registers reset by PORESETn", offset: "0x28", size: "16",
		bits: [
		]
	},
	{ name: "PERCLKCR", description: "Peripheral Clock Control", offset: "0x3C", size: "16",
		bits: [
	...
	{ name: "DMACLASRCSELLOCK", description: "DMA/CLA Trigger Source Select Lock Register", offset: "0x0", size: "16",
		bits: [
			{ name: "ALL", description: "DMACLASRCSEL Registers Lock bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "DMACHSRCSEL1", description: "DMA Channel Trigger Source Select Register-1", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "LFU_LOCK", description: "LFU Lock Configuration", offset: "0x4", size: "16",
		bits: [
			{ name: "LFUCONFIG", description: "Register lock configuration", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "LFU_COMMIT", description: "LFU Commit Configuration", offset: "0x6", size: "16",
		bits: [
			{ name: "LFUCONFIG", description: "Register commit configuration", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SYS_ERR_INT_FLG", description: "Status of interrupts due to multiple different errors in the system.", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "SYS_ERR_INT_CLR", description: "SYS_ERR_INT_FLG clear register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "SYS_ERR_INT_SET", description: "SYS_ERR_INT_FLG set register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "SYS_ERR_MASK", description: "SYS_ERR_MASK register", offset: "0x6", size: "16",
		bits: [
