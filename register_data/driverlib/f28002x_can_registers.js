let CAN_REGISTERS = [
	{ name: "CTL", description: "CAN Control Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "ES", description: "Error and Status Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "ERRC", description: "Error Counter Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "BTR", description: "Bit Timing Register", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "INT", description: "Interrupt Register", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "TEST", description: "Test Register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "PERR", description: "CAN Parity Error Code Register", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "RAM_INIT", description: "CAN RAM Initialization Register", offset: "0x40", size: "16",
		bits: [
	...
	{ name: "GLB_INT_EN", description: "CAN Global Interrupt Enable Register", offset: "0x50", size: "16",
		bits: [
	...
	{ name: "GLB_INT_FLG", description: "CAN Global Interrupt Flag Register", offset: "0x54", size: "16",
		bits: [
	...
	{ name: "GLB_INT_CLR", description: "CAN Global Interrupt Clear Register", offset: "0x58", size: "16",
		bits: [
	...
	{ name: "ABOTR", description: "Auto-Bus-On Time Register", offset: "0x80", size: "16",
		bits: [
		]
	},
	{ name: "TXRQ_X", description: "CAN Transmission Request Register", offset: "0x84", size: "16",
		bits: [
	...
	{ name: "TXRQ_21", description: "CAN Transmission Request 2_1 Register", offset: "0x88", size: "16",
		bits: [
		]
	},
	{ name: "NDAT_X", description: "CAN New Data Register", offset: "0x98", size: "16",
		bits: [
	...
	{ name: "NDAT_21", description: "CAN New Data 2_1 Register", offset: "0x9C", size: "16",
		bits: [
		]
	},
	{ name: "IPEN_X", description: "CAN Interrupt Pending Register", offset: "0xAC", size: "16",
		bits: [
	...
	{ name: "IPEN_21", description: "CAN Interrupt Pending 2_1 Register", offset: "0xB0", size: "16",
		bits: [
		]
	},
	{ name: "MVAL_X", description: "CAN Message Valid Register", offset: "0xC0", size: "16",
		bits: [
	...
	{ name: "MVAL_21", description: "CAN Message Valid 2_1 Register", offset: "0xC4", size: "16",
		bits: [
		]
	},
	{ name: "IP_MUX21", description: "CAN Interrupt Multiplexer 2_1 Register", offset: "0xD8", size: "16",
		bits: [
		]
	},
	{ name: "IF1CMD", description: "IF1 Command Register", offset: "0x100", size: "32",
		bits: [
			{ name: "MSG_NUM", description: "Message Number", size: "8", shift: "0", mask: "0xFF" },
	...
	{ name: "IF1MSK", description: "IF1 Mask Register", offset: "0x104", size: "32",
		bits: [
	...
	{ name: "IF1ARB", description: "IF1 Arbitration Register", offset: "0x108", size: "32",
		bits: [
	...
	{ name: "IF1MCTL", description: "IF1 Message Control Register", offset: "0x10C", size: "16",
		bits: [
	...
	{ name: "IF1DATA", description: "IF1 Data A Register", offset: "0x110", size: "32",
		bits: [
	...
	{ name: "IF1DATB", description: "IF1 Data B Register", offset: "0x114", size: "32",
		bits: [
	...
	{ name: "IF2CMD", description: "IF2 Command Register", offset: "0x120", size: "32",
		bits: [
			{ name: "MSG_NUM", description: "Message Number", size: "8", shift: "0", mask: "0xFF" },
			{ name: "DMAACTIVE", description: "DMA Status", size: "1", shift: "14", mask: "0x4000" },
			{ name: "BUSY", description: "Busy Flag", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "IF2MSK", description: "IF2 Mask Register", offset: "0x124", size: "32",
		bits: [
			{ name: "MSK", description: "Identifier Mask", size: "29", shift: "0", mask: "0x1FFFFFFF" },
			{ name: "MDIR", description: "Mask Message Direction", size: "1", shift: "30", mask: "0x40000000" },
			{ name: "MXTD", description: "Mask Extended Identifier", size: "1", shift: "31", mask: "0x80000000" },
	...
	{ name: "IF2ARB", description: "IF2 Arbitration Register", offset: "0x128", size: "32",
		bits: [
	...
	{ name: "IF2MCTL", description: "IF2 Message Control Register", offset: "0x12C", size: "16",
		bits: [
			{ name: "DLC", description: "Data length code", size: "4", shift: "0", mask: "0xF" },
			{ name: "EOB", description: "End of Block", size: "1", shift: "7", mask: "0x80" },
			{ name: "TXRQST", description: "Transmit Request", size: "1", shift: "8", mask: "0x100" },
	...
	{ name: "IF2DATA", description: "IF2 Data A Register", offset: "0x130", size: "32",
		bits: [
			{ name: "DATA_0", description: "Data Byte 0", size: "8", shift: "0", mask: "0xFF" },
			{ name: "DATA_1", description: "Data Byte 1", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "DATA_2", description: "Data Byte 2", size: "8", shift: "16", mask: "0xFF0000" },
	...
	{ name: "IF2DATB", description: "IF2 Data B Register", offset: "0x134", size: "32",
		bits: [
			{ name: "DATA_4", description: "Data Byte 4", size: "8", shift: "0", mask: "0xFF" },
			{ name: "DATA_5", description: "Data Byte 5", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "DATA_6", description: "Data Byte 6", size: "8", shift: "16", mask: "0xFF0000" },
	...
	{ name: "IF3OBS", description: "IF3 Observation Register", offset: "0x140", size: "16",
		bits: [
	...
	{ name: "IF3MSK", description: "IF3 Mask Register", offset: "0x144", size: "32",
		bits: [
	...
	{ name: "IF3ARB", description: "IF3 Arbitration Register", offset: "0x148", size: "32",
		bits: [
			{ name: "ID", description: "Message  Identifier", size: "29", shift: "0", mask: "0x1FFFFFFF" },
			{ name: "DIR", description: "Message Direction", size: "1", shift: "29", mask: "0x20000000" },
			{ name: "XTD", description: "Extended Identifier", size: "1", shift: "30", mask: "0x40000000" },
	...
	{ name: "IF3MCTL", description: "IF3 Message Control Register", offset: "0x14C", size: "16",
		bits: [
			{ name: "DLC", description: "Data length code", size: "4", shift: "0", mask: "0xF" },
			{ name: "EOB", description: "End of Block", size: "1", shift: "7", mask: "0x80" },
			{ name: "TXRQST", description: "Transmit Request", size: "1", shift: "8", mask: "0x100" },
	...
	{ name: "IF3DATA", description: "IF3 Data A Register", offset: "0x150", size: "32",
		bits: [
			{ name: "DATA_0", description: "Data Byte 0", size: "8", shift: "0", mask: "0xFF" },
			{ name: "DATA_1", description: "Data Byte 1", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "DATA_2", description: "Data Byte 2", size: "8", shift: "16", mask: "0xFF0000" },
	...
	{ name: "IF3DATB", description: "IF3 Data B Register", offset: "0x154", size: "32",
		bits: [
			{ name: "DATA_4", description: "Data Byte 4", size: "8", shift: "0", mask: "0xFF" },
			{ name: "DATA_5", description: "Data Byte 5", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "DATA_6", description: "Data Byte 6", size: "8", shift: "16", mask: "0xFF0000" },
	...
	{ name: "IF3UPD", description: "IF3 Update Enable Register", offset: "0x160", size: "16",
		bits: [
		]
	},
];
