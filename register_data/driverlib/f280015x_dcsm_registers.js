let DCSM_REGISTERS = [
	...
	{ name: "SECTSTAT3", description: "Flash Sectors Status Register 3", offset: "0xC", size: "32",
		bits: [
			{ name: "STATUS_SECT39_32", description: "Zone Status flash Bank 0 Sectors 39-32", size: "2", shift: "8", mask: "0x300" },
			{ name: "STATUS_SECT47_40", description: "Zone Status flash Bank 0 Sectors 47-40", size: "2", shift: "10", mask: "0xC00" },
			{ name: "STATUS_SECT55_48", description: "Zone Status flash Bank 0 Sectors 55-48", size: "2", shift: "12", mask: "0x3000" },
			{ name: "STATUS_SECT63_56", description: "Zone Status flash Bank 0 Sectors 63-56", size: "2", shift: "14", mask: "0xC000" },
			{ name: "STATUS_SECT71_64", description: "Zone Status flash Bank 0 Sectors 71-64", size: "2", shift: "16", mask: "0x30000" },
			{ name: "STATUS_SECT79_72", description: "Zone Status flash Bank 0 Sectors 79-72", size: "2", shift: "18", mask: "0xC0000" },
			{ name: "STATUS_SECT87_80", description: "Zone Status flash Bank 0 Sectors 87-80", size: "2", shift: "20", mask: "0x300000" },
			{ name: "STATUS_SECT95_88", description: "Zone Status flash Bank 0 Sectors 95-88", size: "2", shift: "22", mask: "0xC00000" },
			{ name: "STATUS_SECT103_96", description: "Zone Status flash Bank 0 Sectors 103-96", size: "2", shift: "24", mask: "0x3000000" },
			{ name: "STATUS_SECT111_104", description: "Zone Status flash Bank 0 Sectors 111-104", size: "2", shift: "26", mask: "0xC000000" },
			{ name: "STATUS_SECT119_112", description: "Zone Status flash Bank 0 Sectors 119-112", size: "2", shift: "28", mask: "0x30000000" },
			{ name: "STATUS_SECT127_120", description: "Zone Status flash Bank 0 Sectors 127-120", size: "2", shift: "30", mask: "0xC0000000" },
		]
	},
	...
	{ name: "RAMOPENSTAT", description: "RAM Security Open Status Register", offset: "0x20", size: "16",
		bits: [
			{ name: "RAMOPEN", description: "RAM Security Open", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "RAMOPENFRC", description: "RAM Security Open Force Register", offset: "0x22", size: "32",
		bits: [
	...
	{ name: "RAMOPENCLR", description: "RAM Security Open Clear Register", offset: "0x24", size: "32",
		bits: [
			{ name: "CLEAR", description: "Clear RAM Open request", size: "1", shift: "0", mask: "0x1" },
			{ name: "KEY", description: "Valid Write KEY", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "RAMOPENLOCK", description: "RAMOPEN Lock Register", offset: "0x26", size: "16",
		bits: [
