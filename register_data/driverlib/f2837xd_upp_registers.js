let UPP_REGISTERS = [
	{ name: "PID", description: "Peripheral ID Register", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "PERCTL", description: "Peripheral Control Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "CHCTL", description: "General Control Register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "IFCFG", description: "Interface Configuration Register", offset: "0xA", size: "16",
		bits: [
	...
	{ name: "IFIVAL", description: "Interface Idle Value Register", offset: "0xC", size: "16",
		bits: [
			{ name: "VALA", description: "Idle Value", size: "9", shift: "0", mask: "0x1FF" },
		]
	},
	{ name: "THCFG", description: "Threshold Configuration Register", offset: "0xE", size: "16",
		bits: [
	...
	{ name: "RAWINTST", description: "Raw Interrupt Status Register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "ENINTST", description: "Enable Interrupt Status Register", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "INTENSET", description: "Interrupt Enable Set Register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "INTENCLR", description: "Interrupt Enable Clear Register", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "CHIDESC0", description: "DMA Channel I Descriptor 0 Register", offset: "0x20", size: "16",
		bits: [
		]
	},
	...
	{ name: "CHIDESC2", description: "DMA Channel I Descriptor 2 Register", offset: "0x24", size: "16",
		bits: [
			{ name: "LOFFSET", description: "Current start address to next start address offset.", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "CHIST0", description: "DMA Channel I Status 0 Register", offset: "0x28", size: "16",
		bits: [
		]
	},
	...
	{ name: "CHIST2", description: "DMA Channel I Status 2 Register", offset: "0x2C", size: "16",
		bits: [
	...
	{ name: "CHQDESC0", description: "DMA Channel Q Descriptor 0 Register", offset: "0x30", size: "16",
		bits: [
		]
	},
	...
	{ name: "CHQDESC2", description: "DMA Channel Q Descriptor 2 Register", offset: "0x34", size: "16",
		bits: [
			{ name: "LOFFSET", description: "Current start address to next start address offset.", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "CHQST0", description: "DMA Channel Q Status 0 Register", offset: "0x38", size: "16",
		bits: [
		]
	},
	...
	{ name: "CHQST2", description: "DMA Channel Q Status 2 Register", offset: "0x3C", size: "16",
		bits: [
			{ name: "ACT", description: "Status of DMA descriptor.", size: "1", shift: "0", mask: "0x1" },
			{ name: "PEND", description: "Status of DMA.", size: "1", shift: "1", mask: "0x2" },
	...
	{ name: "GINTEN", description: "Global Peripheral Interrupt Enable Register", offset: "0x40", size: "16",
		bits: [
			{ name: "GINTEN", description: "Global Interrupt Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "GINTFLG", description: "Global Peripheral Interrupt Flag Register", offset: "0x42", size: "16",
		bits: [
			{ name: "GINTFLG", description: "Global Interrupt Flag", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "GINTCLR", description: "Global Peripheral Interrupt Clear Register", offset: "0x44", size: "16",
		bits: [
			{ name: "GINTCLR", description: "Global Interrupt Clear", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "DLYCTL", description: "IO clock data skew control Register", offset: "0x46", size: "16",
		bits: [
