let AES_REGISTERS = [
	...
	{ name: "KEY2_7", description: "XTS Second Key or CBC-MAC Third Key", offset: "0x2", size: "16",
		bits: [
		]
	},
	{ name: "KEY2_4", description: "XTS/CCM Second Key or CBC-MAC Third Key", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "KEY2_5", description: "XTS Second Key or CBC-MAC Third Key", offset: "0x6", size: "16",
		bits: [
		]
	},
	{ name: "KEY2_2", description: "XTS/CCM/CBC-MAC Second Key or Hash Key Input", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "KEY2_3", description: "XTS/CCM/CBC-MAC Second Key or Hash Key Input", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "KEY2_0", description: "XTS/CCM/CBC-MAC Second Key or Hash Key Input", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "KEY2_1", description: "XTS/CCM/CBC-MAC Second Key or Hash Key Input", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "KEY1_6", description: "Key", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "KEY1_7", description: "Key", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "KEY1_4", description: "Key", offset: "0x14", size: "16",
		bits: [
		]
	},
	{ name: "KEY1_5", description: "Key", offset: "0x16", size: "16",
		bits: [
		]
	},
	{ name: "KEY1_2", description: "Key", offset: "0x18", size: "16",
		bits: [
		]
	},
	{ name: "KEY1_3", description: "Key", offset: "0x1A", size: "16",
		bits: [
		]
	},
	{ name: "KEY1_0", description: "Key", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "KEY1_1", description: "Key", offset: "0x1E", size: "16",
		bits: [
		]
	},
	{ name: "IV_IN_OUT_0", description: "Initialization Vector 0", offset: "0x20", size: "16",
		bits: [
		]
	},
	{ name: "IV_IN_OUT_1", description: "Initialization Vector 1", offset: "0x22", size: "16",
		bits: [
		]
	},
	{ name: "IV_IN_OUT_2", description: "Initialization Vector 2", offset: "0x24", size: "16",
		bits: [
		]
	},
	{ name: "IV_IN_OUT_3", description: "Initialization Vector 3", offset: "0x26", size: "16",
		bits: [
		]
	},
	{ name: "CTRL", description: "Input/Output Buffer Control and Mode Selection", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "C_LENGTH_0", description: "Crypto Data Length 0", offset: "0x2A", size: "16",
		bits: [
		]
	},
	{ name: "C_LENGTH_1", description: "Crypto Data Length 1", offset: "0x2C", size: "16",
		bits: [
		]
	},
	{ name: "AUTH_LENGTH", description: "AAD Data Length", offset: "0x2E", size: "16",
		bits: [
		]
	},
	{ name: "DATA_IN_OUT_0", description: "Data Word 0", offset: "0x30", size: "16",
		bits: [
		]
	},
	{ name: "DATA_IN_OUT_1", description: "Data Word 1", offset: "0x32", size: "16",
		bits: [
		]
	},
	{ name: "DATA_IN_OUT_2", description: "Data Word 2", offset: "0x34", size: "16",
		bits: [
		]
	},
	{ name: "DATA_IN_OUT_3", description: "Data Word 3", offset: "0x36", size: "16",
		bits: [
		]
	},
	{ name: "TAG_OUT_0", description: "Hash Result 0", offset: "0x38", size: "16",
		bits: [
		]
	},
	{ name: "TAG_OUT_1", description: "Hash Result 1", offset: "0x3A", size: "16",
		bits: [
		]
	},
	{ name: "TAG_OUT_2", description: "Hash Result 2", offset: "0x3C", size: "16",
		bits: [
		]
	},
	{ name: "TAG_OUT_3", description: "Hash Result 3", offset: "0x3E", size: "16",
		bits: [
		]
	},
	{ name: "REV", description: "Module Revision Number", offset: "0x40", size: "16",
		bits: [
		]
	},
	{ name: "SYSCONFIG", description: "System Configuration", offset: "0x42", size: "16",
		bits: [
	...
	{ name: "SYSSTATUS", description: "Reset Status", offset: "0x44", size: "16",
		bits: [
			{ name: "RESETDONE", description: "Reset Done", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "IRQSTATUS", description: "Interrupt Status", offset: "0x46", size: "16",
		bits: [
	...
	{ name: "IRQENABLE", description: "Interrupt Enable", offset: "0x48", size: "16",
		bits: [
	...
	{ name: "DIRTY_BITS", description: "Accessed / Dirty Bits", offset: "0x4A", size: "16",
		bits: [
