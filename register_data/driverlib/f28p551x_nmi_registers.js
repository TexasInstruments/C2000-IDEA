let NMI_REGISTERS = [
	...
	{ name: "FLGCLR", description: "NMI Flag Clear Register", offset: "0x2", size: "16",
		bits: [
			...
			{ name: "CLBNMI", description: "RLNMI Flag Clear", size: "1", shift: "8", mask: "0x100" },
	...
	{ name: "FLGFRC", description: "NMI Flag Force Register", offset: "0x3", size: "16",
		bits: [
			...
			{ name: "CLBNMI", description: "RLNMI Flag Force", size: "1", shift: "8", mask: "0x100" },
	...
	{ name: "SHDFLG", description: "NMI Shadow Flag Register", offset: "0x6", size: "16",
		bits: [
			...
			{ name: "CLBNMI", description: "Shadow RLNMI Flag", size: "1", shift: "8", mask: "0x100" },
