let CLB_XBAR_REGISTERS = [
	{ name: "CLBXBAROUTINVERT", description: "Output Signal Invert Select", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "CLBXBARLOCK", description: "Configuration Lock register", offset: "0x80", size: "32",
		bits: [
			{ name: "LOCK", description: "Locks the configuration for ECLB-XBAR", size: "1", shift: "0", mask: "0x1" },
			{ name: "KEY", description: "Write protection KEY", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "CLBXBARG0SEL", description: "(0 <= i < 8) CLBXBAR G0 Input Select", offset: "(0x100 + ((i) * 64))", count: "8", size: "32",
		bits: [
	...
	{ name: "CLBXBARG1SEL", description: "(0 <= i < 8) CLBXBAR G1 Input Select", offset: "(0x104 + ((i) * 64))", count: "8", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CLBXBARG2SEL", description: "(0 <= i < 8) CLBXBAR G2 Input Select", offset: "(0x108 + ((i) * 64))", count: "8", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CLBXBARG3SEL", description: "(0 <= i < 8) CLBXBAR G3 Input Select", offset: "(0x10C + ((i) * 64))", count: "8", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CLBXBARG4SEL", description: "(0 <= i < 8) CLBXBAR G4 Input Select", offset: "(0x110 + ((i) * 64))", count: "8", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CLBXBARG5SEL", description: "(0 <= i < 8) CLBXBAR G5 Input Select", offset: "(0x114 + ((i) * 64))", count: "8", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CLBXBARG6SEL", description: "(0 <= i < 8) CLBXBAR G6 Input Select", offset: "(0x118 + ((i) * 64))", count: "8", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CLBXBARG7SEL", description: "(0 <= i < 8) CLBXBAR G7 Input Select", offset: "(0x11C + ((i) * 64))", count: "8", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
...
module.exports = {
	clb_xbarRegisters: CLB_XBAR_REGISTERS,
}
