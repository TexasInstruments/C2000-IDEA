let EQEP_REGISTERS = [
	...
	{ name: "QPOSINIT", description: "Position Counter Init", offset: "0x2", size: "16",
		bits: [
		]
	},
	{ name: "QPOSMAX", description: "Maximum Position Count", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "QPOSCMP", description: "Position Compare", offset: "0x6", size: "16",
		bits: [
		]
	},
	{ name: "QPOSILAT", description: "Index Position Latch", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "QPOSSLAT", description: "Strobe Position Latch", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "QPOSLAT", description: "Position Latch", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "QUTMR", description: "QEP Unit Timer", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "QUPRD", description: "QEP Unit Period", offset: "0x10", size: "16",
		bits: [
		]
	},
	...
	{ name: "REV", description: "QEP Revision Number", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "QEPSTROBESEL", description: "QEP Strobe select register", offset: "0x32", size: "16",
		bits: [
			{ name: "STROBESEL", description: "QMA Mode Select", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "QMACTRL", description: "QMA Control register", offset: "0x34", size: "16",
		bits: [
			{ name: "MODE", description: "QMA Mode Select", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "QEPSRCSEL", description: "QEP Source Select Register", offset: "0x36", size: "16",
		bits: [
