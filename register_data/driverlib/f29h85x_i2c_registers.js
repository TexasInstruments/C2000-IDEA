let I2C_REGISTERS = [
	...
	{ name: "IER", description: "I2C Interrupt Enable", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "STR", description: "I2C Status", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "CLKL", description: "I2C Clock low-time divider", offset: "0x6", size: "16",
		bits: [
		]
	},
	{ name: "CLKH", description: "I2C Clock high-time divider", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "CNT", description: "I2C Data count", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "DRR", description: "I2C Data receive", offset: "0xC", size: "16",
		bits: [
			{ name: "DATA", description: "Receive data", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "TAR", description: "I2C TARGET address", offset: "0xE", size: "16",
		bits: [
			{ name: "TAR", description: "TARGET Address", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "DXR", description: "I2C Data Transmit", offset: "0x10", size: "16",
		bits: [
			{ name: "DATA", description: "Transmit data", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "MDR", description: "I2C Mode", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "ISRC", description: "I2C Interrupt Source", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "EMDR", description: "I2C Extended Mode", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "PSC", description: "I2C Prescaler", offset: "0x18", size: "16",
		bits: [
			{ name: "IPSC", description: "I2C Prescaler Divide Down", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "FFTX", description: "I2C FIFO Transmit", offset: "0x40", size: "16",
		bits: [
	...
	{ name: "FFRX", description: "I2C FIFO Receive", offset: "0x42", size: "16",
		bits: [
