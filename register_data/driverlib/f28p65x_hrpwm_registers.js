let HRPWM_REGISTERS = [
	...
	{ name: "EPWMXLINK2", description: "EPWMx Link 2 Register", offset: "0x3A", size: "16",
		bits: [
	...
	{ name: "XCMPCTL1", description: "XCMP Mode Control Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "XLOAD", description: "XCMP Mode Load Enable Register", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "EPWMXLINKXLOAD", description: "Link register across PWM modules", offset: "0xE", size: "16",
		bits: [
			{ name: "XLOADLINK", description: "XLOAD  Link Register", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "XREGSHDW1STS", description: "Shadow Buffer 1 Update Status Register", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "XREGSHDW2STS", description: "Shadow Buffer 2 Update Status Register", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "XREGSHDW3STS", description: "Shadow Buffer 3 Update Status Register", offset: "0x18", size: "16",
		bits: [
	...
	{ name: "DECTL", description: "DE control register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "DECOMPSEL", description: "DE comparator source select register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "DEACTCTL", description: "DE Action Control", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "DEMONTHRES", description: "DE monitor counter threshold", offset: "0x16", size: "16",
		bits: [
			{ name: "THRESHOLD", description: "DE monitor counter compare threshold.", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "MINDBCFG", description: "Minimum dead band configuration register.", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "LUTCTLA", description: "LUT control register on PWMA", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "LUTCTLB", description: "LUT control register on PWMB", offset: "0x12", size: "16",
		bits: [
