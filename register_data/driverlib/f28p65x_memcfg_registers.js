let MEMCFG_REGISTERS = [
	...
	{ name: "LSXACCPROT2", description: "Local Shared RAM Config Register 2", offset: "0x2C", size: "16",
		bits: [
	...
	{ name: "GSXMSEL", description: "Global Shared RAM Controller Sel Register", offset: "0x44", size: "16",
		bits: [
	...
	{ name: "MSGXRAMTEST_LOCK", description: "Lock register for MSGx RAM TEST Register", offset: "0x76", size: "32",
		bits: [
			...
			{ name: "CPUTOCPU_MSGRAM1", description: " MSGxRAMTEST_LOCK.CPUTOCPU_MSGRAM1Lock", size: "1", shift: "7", mask: "0x80" },
			{ name: "KEY", description: "KEY to enable write to lock", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
