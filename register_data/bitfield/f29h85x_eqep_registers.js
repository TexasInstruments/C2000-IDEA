let EQEP_REGISTERS = [
	...
	{ name: "REV", description: "QEP Revision Number", offset: "0x3F", size: "32",
		bits: [
	...
	{ name: "QEPSTROBESEL", description: "QEP Strobe select register", offset: "0x41", size: "32",
		bits: [
			{ name: "STROBESEL", description: "QMA Mode Select", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "QMACTRL", description: "QMA Control register", offset: "0x43", size: "32",
		bits: [
			{ name: "MODE", description: "QMA Mode Select", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "QEPSRCSEL", description: "QEP Source Select Register", offset: "0x45", size: "32",
		bits: [
