let PBIST_REGISTERS = [
	...
	{ name: "DLRT", description: "PBIST Data Logger Register", offset: "0x162", size: "32",
		bits: [
	...
	{ name: "STR", description: "Program Control Register", offset: "0x168", size: "32",
		bits: [
			{ name: "RESUME", description: "Read", size: "1", shift: "1", mask: "0x2" },
			{ name: "STOP", description: "Stops PBIST testing", size: "1", shift: "2", mask: "0x4" },
		]
	},
	{ name: "PACT", description: "PBIST Activate Register", offset: "0x17A", size: "32",
		bits: [
			{ name: "ENABLE", description: "Enable clocks to PBIST", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "OVERRIDE", description: "PBIST Override Register", offset: "0x180", size: "32",
		bits: [
	...
	{ name: "FSRF0", description: "Fail Status - Port 0", offset: "0x186", size: "32",
		bits: [
		]
	},
	{ name: "FSRF1", description: "Fail Status - Port 1", offset: "0x188", size: "32",
		bits: [
		]
	},
	{ name: "FSRC0", description: "Fail Status Count - Port 0", offset: "0x18A", size: "32",
		bits: [
		]
	},
	{ name: "FSRC1", description: "Fail Status Count - Port 1", offset: "0x18C", size: "32",
		bits: [
		]
	},
	{ name: "ALGO", description: "PBIST Algorithm", offset: "0x1B2", size: "32",
		bits: [
		]
	},
	{ name: "RINFOL", description: "RAM Info Mask Register Lower", offset: "0x1B4", size: "32",
		bits: [
		]
	},
	{ name: "RINFOU", description: "RAM Info Mask Register Higher", offset: "0x1B6", size: "32",
		bits: [
		]
	},
];
