let UART_REGISTERS = [
	...
	{ name: "UARTFR", description: "UART Flag", offset: "0x14", size: "32",
		bits: [
	...
	{ name: "UARTILPR", description: "UART IrDA Low-Power Register", offset: "0x1A", size: "32",
		bits: [
			{ name: "ILPDVSR", description: "IrDA Low-Power Divisor", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTIBRD", description: "UART Integer Baud-Rate Divisor", offset: "0x1C", size: "32",
		bits: [
			{ name: "DIVINT", description: "Integer Baud-Rate Divisor", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "UARTFBRD", description: "UART Fractional Baud-Rate Divisor", offset: "0x1E", size: "32",
		bits: [
			{ name: "DIVFRAC", description: "Fractional Baud-Rate Divisor", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "UARTLCRH", description: "UART Line Control", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "UARTCTL", description: "UART Control", offset: "0x22", size: "32",
		bits: [
	...
	{ name: "UARTIFLS", description: "UART Interrupt FIFO Level Select", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "UARTIM", description: "UART Interrupt Mask", offset: "0x26", size: "32",
		bits: [
	...
	{ name: "UARTRIS", description: "UART Raw Interrupt Status", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "UARTMIS", description: "UART Masked Interrupt Status", offset: "0x2A", size: "32",
		bits: [
	...
	{ name: "UARTICR", description: "UART Interrupt Clear", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "UARTDMACTL", description: "UART DMA Control", offset: "0x2E", size: "32",
		bits: [
	...
	{ name: "UART_GLB_INT_FLG", description: "UART Global Interrupt Flag Register", offset: "0x68", size: "32",
		bits: [
			{ name: "INT_FLG", description: "Global Interrupt Flag for UART Interrupt", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "UART_GLB_INT_CLR", description: "UART Global Interrupt Clear Register", offset: "0x6A", size: "32",
		bits: [
			{ name: "INT_FLG_CLR", description: "Global Interrupt flag clear for UART Interrupt", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "UART9BITADDR", description: "UART 9-Bit Self Address", offset: "0x84", size: "32",
		bits: [
	...
	{ name: "UART9BITAMASK", description: "UART 9-Bit Self Address Mask", offset: "0x86", size: "32",
		bits: [
			{ name: "MASK", description: "Self Address Mask for 9-Bit Mode", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPP", description: "UART Peripheral Properties", offset: "0xF9C", size: "32",
		bits: [
	...
	{ name: "UARTPeriphID4", description: "UART Peripheral Identification 4", offset: "0xFAA", size: "32",
		bits: [
			{ name: "PID4", description: "UART Peripheral ID Register [7:0]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPeriphID5", description: "UART Peripheral Identification 5", offset: "0xFAC", size: "32",
		bits: [
			{ name: "PID5", description: "UART Peripheral ID Register [15:8]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPeriphID6", description: "UART Peripheral Identification 6", offset: "0xFAE", size: "32",
		bits: [
			{ name: "PID6", description: "UART Peripheral ID Register [23:16]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPeriphID7", description: "UART Peripheral Identification 7", offset: "0xFB0", size: "32",
		bits: [
			{ name: "PID7", description: "UART Peripheral ID Register [31:24]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPeriphID0", description: "UART Peripheral Identification 0", offset: "0xFB2", size: "32",
		bits: [
			{ name: "PID0", description: "UART Peripheral ID Register [7:0]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPeriphID1", description: "UART Peripheral Identification 1", offset: "0xFB4", size: "32",
		bits: [
			{ name: "PID1", description: "UART Peripheral ID Register [15:8]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPeriphID2", description: "UART Peripheral Identification 2", offset: "0xFB6", size: "32",
		bits: [
			{ name: "PID2", description: "UART Peripheral ID Register [23:16]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPeriphID3", description: "UART Peripheral Identification 3", offset: "0xFB8", size: "32",
		bits: [
			{ name: "PID3", description: "UART Peripheral ID Register [31:24]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPCellID0", description: "UART PrimeCell Identification 0", offset: "0xFBA", size: "32",
		bits: [
			{ name: "CID0", description: "UART PrimeCell ID Register [7:0]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPCellID1", description: "UART PrimeCell Identification 1", offset: "0xFBC", size: "32",
		bits: [
			{ name: "CID1", description: "UART PrimeCell ID Register [15:8]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPCellID2", description: "UART PrimeCell Identification 2", offset: "0xFBE", size: "32",
		bits: [
			{ name: "CID2", description: "UART PrimeCell ID Register [23:16]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTPCellID3", description: "UART PrimeCell Identification 3", offset: "0xFC0", size: "32",
		bits: [
			{ name: "CID3", description: "UART PrimeCell ID Register [31:24]", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "UARTECR", description: "UART Error Clear", offset: "0x4", size: "32",
		bits: [
