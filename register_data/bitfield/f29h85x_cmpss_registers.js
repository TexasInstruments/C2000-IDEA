let CMPSS_REGISTERS = [
	...
	{ name: "COMPDACHCTL2", description: "CMPSS High DAC Control Register 2", offset: "0x5", size: "16",
		bits: [
	...
	{ name: "RAMPHREFA", description: "CMPSS High Ramp Reference Active Register", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "RAMPHREFS", description: "CMPSS High Ramp Reference Shadow Register", offset: "0xB", size: "16",
		bits: [
		]
	},
	{ name: "RAMPHSTEPVALA", description: "CMPSS High Ramp Step Value Active Register", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "RAMPHCTLA", description: "CMPSS High Ramp Control Active Register", offset: "0xF", size: "16",
		bits: [
			{ name: "RAMPCLKDIV", description: "Ramp Clock Divider Active Value", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RAMPHSTEPVALS", description: "CMPSS High Ramp Step Value Shadow Register", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "RAMPHCTLS", description: "CMPSS High Ramp Control Shadow Register", offset: "0x11", size: "16",
		bits: [
			{ name: "RAMPCLKDIV", description: "Ramp Clock Divider Shadow Value", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RAMPHSTS", description: "CMPSS High Ramp Status Register", offset: "0x12", size: "16",
		bits: [
		]
	},
	{ name: "DACLVALS", description: "CMPSS Low DAC Value Shadow Register", offset: "0x15", size: "16",
		bits: [
			{ name: "DACVAL", description: "DAC Value Control", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "DACLVALA", description: "CMPSS Low DAC Value Active Register", offset: "0x16", size: "16",
		bits: [
			{ name: "DACVAL", description: "DAC Value Control", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "RAMPHDLYA", description: "CMPSS High Ramp Delay Active Register", offset: "0x17", size: "16",
		bits: [
			{ name: "DELAY", description: "High Ramp Delay Value Active", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
	{ name: "RAMPHDLYS", description: "CMPSS High Ramp Delay Shadow Register", offset: "0x18", size: "16",
		bits: [
			{ name: "DELAY", description: "High Ramp Delay Value Shadow", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
	{ name: "CTRIPLFILCTL", description: "CTRIPL Filter Control Register", offset: "0x19", size: "16",
		bits: [
	...
	{ name: "CTRIPLFILCLKCTL", description: "CTRIPL Filter Clock Control Register", offset: "0x1A", size: "16",
		bits: [
		]
	},
	{ name: "CTRIPHFILCTL", description: "CTRIPH Filter Control Register", offset: "0x1B", size: "16",
		bits: [
			{ name: "FILTINSEL", description: "Filter Input Select", size: "3", shift: "0", mask: "0x7" },
			{ name: "SAMPWIN", description: "Sample Window", size: "6", shift: "3", mask: "0x1F8" },
			{ name: "THRESH", description: "Majority Voting Threshold", size: "6", shift: "9", mask: "0x7E00" },
	...
	{ name: "CTRIPHFILCLKCTL", description: "CTRIPH Filter Clock Control Register", offset: "0x1C", size: "16",
		bits: [
		]
	},
	{ name: "COMPLOCK", description: "CMPSS Lock Register", offset: "0x1D", size: "16",
		bits: [
	...
	{ name: "DACHVALS2", description: "CMPSS High DAC Value Shadow Register 2", offset: "0x20", size: "16",
		bits: [
			{ name: "DACVAL", description: "DAC Value Control", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "DACLVALS2", description: "CMPSS Low DAC Value Shadow Register 2", offset: "0x21", size: "16",
		bits: [
			{ name: "DACVAL", description: "DAC Value Control", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "COMPDACLCTL", description: "CMPSS Low DAC Control Register", offset: "0x2E", size: "16",
		bits: [
			{ name: "DACSOURCE", description: "DAC Source Control", size: "1", shift: "0", mask: "0x1" },
			{ name: "RAMPSOURCE", description: "Ramp Generator Source Control", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RAMPLOADSEL", description: "Ramp Load Select", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "COMPDACLCTL2", description: "CMPSS Low DAC Control Register 2", offset: "0x2F", size: "16",
		bits: [
			{ name: "BLANKSOURCEUSEL", description: "BLANK source upper group select", size: "1", shift: "8", mask: "0x100" },
			{ name: "RAMPSOURCEUSEL", description: "RAMP source upper group select", size: "1", shift: "10", mask: "0x400" },
		]
	},
	{ name: "RAMPLREFA", description: "CMPSS Low Ramp Reference Active Register", offset: "0x34", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLREFS", description: "CMPSS Low Ramp Reference Shadow Register", offset: "0x37", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLSTEPVALA", description: "CMPSS Low Ramp Step Value Active Register", offset: "0x3A", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLCTLA", description: "CMPSS Low Ramp Control Active Register", offset: "0x3B", size: "16",
		bits: [
			{ name: "RAMPCLKDIV", description: "Ramp Clock Divider Active Value", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RAMPLSTEPVALS", description: "CMPSS Low Ramp Step Value Shadow Register", offset: "0x3C", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLCTLS", description: "CMPSS Low Ramp Control Shadow Register", offset: "0x3D", size: "16",
		bits: [
			{ name: "RAMPCLKDIV", description: "Ramp Clock Divider Shadow Value", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RAMPLSTS", description: "CMPSS Low Ramp Status Register", offset: "0x3E", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLDLYA", description: "CMPSS Low Ramp Delay Active Register", offset: "0x45", size: "16",
		bits: [
			{ name: "DELAY", description: "Low Ramp Delay Value Active", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
	{ name: "RAMPLDLYS", description: "CMPSS Low Ramp Delay Shadow Register", offset: "0x46", size: "16",
		bits: [
			{ name: "DELAY", description: "Low Ramp Delay Value Shadow", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
	{ name: "CTRIPLFILCLKCTL2", description: "CTRIPL Filter Clock Control Register 2", offset: "0x49", size: "16",
		bits: [
			{ name: "CLKPRESCALEU", description: "Sample Clock Prescale Upper Bits", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "CTRIPHFILCLKCTL2", description: "CTRIPH Filter Clock Control Register 2", offset: "0x4C", size: "16",
		bits: [
			{ name: "CLKPRESCALEU", description: "Sample Clock Prescale Upper Bits", size: "8", shift: "0", mask: "0xFF" },
		]
	},
