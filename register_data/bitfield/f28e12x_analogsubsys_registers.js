let ANALOGSUBSYS_REGISTERS = [
	{ name: "EXTROSCCSR1", description: "ExtR Oscillator Status Register", offset: "0x2A", size: "32",
		bits: [
			{ name: "OSCSTATUS", description: "Running status of ExtR.", size: "8", shift: "24", mask: "0xFF000000" },
		]
	},
	{ name: "REFCONFIGA", description: "Config register for analog reference A.", offset: "0x3A", size: "32",
		bits: [
			{ name: "CONFIG8", description: "Analog reference mode select", size: "1", shift: "20", mask: "0x100000" },
		]
	},
	{ name: "INTERNALTESTCTL", description: "INTERNALTEST Node Control Register", offset: "0x56", size: "32",
		bits: [
			{ name: "TESTSEL", description: "Test Select", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "CONFIGLOCK", description: "Lock Register for all the config registers.", offset: "0x6A", size: "32",
		bits: [
	...
	{ name: "TSNSCTL", description: "Temperature Sensor Control Register", offset: "0x6C", size: "16",
		bits: [
			{ name: "ENABLE", description: "Temperature Sensor Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "ANAREFCTL", description: "Analog Reference Control Register. This register is not configurable for 32QFN package", offset: "0x74", size: "16",
		bits: [
			{ name: "ANAREF2P5SEL", description: "Analog Reference Select", size: "1", shift: "8", mask: "0x100" },
		]
	},
	{ name: "VMONCTL", description: "Voltage Monitor Control Register", offset: "0x7C", size: "16",
		bits: [
			{ name: "BORLVMONDIS", description: "Disable BORL(ow) feature on VDDIO", size: "1", shift: "8", mask: "0x100" },
		]
	},
	{ name: "CMPHPMXSEL", description: "Bits to select one of the many sources on CompHP inputs. Refer to Pimux diagram for details.", offset: "0x8E", size: "32",
		bits: [
	...
	{ name: "CMPLPMXSEL", description: "Bits to select one of the many sources on CompLP inputs. Refer to Pimux diagram for details.", offset: "0x90", size: "32",
		bits: [
	...
	{ name: "CMPHNMXSEL", description: "Bits to select one of the many sources on CompHN inputs. Refer to Pimux diagram for details.", offset: "0x92", size: "16",
		bits: [
	...
	{ name: "CMPLNMXSEL", description: "Bits to select one of the many sources on CompLN inputs. Refer to Pimux diagram for details.", offset: "0x93", size: "16",
		bits: [
	...
	{ name: "ADCDACLOOPBACK", description: "Enabble loopback from DAC to ADCs", offset: "0x94", size: "32",
		bits: [
	...
	{ name: "CMPSSCTL", description: "CMPSS Control Register", offset: "0x97", size: "16",
		bits: [
			{ name: "CMP3LDACOUTEN", description: "Enable general purpose DAC functionality for CMPSS3.COMPDACL", size: "1", shift: "0", mask: "0x1" },
			{ name: "CMPSSCTLEN", description: "Enable the CMPSSCTL Register", size: "1", shift: "15", mask: "0x8000" },
		]
	},
	{ name: "LOCK", description: "Lock Register", offset: "0x9A", size: "32",
		bits: [
	...
	{ name: "AGPIOCTRLA", description: "AGPIO Control Register", offset: "0x120", size: "32",
		bits: [
	...
	{ name: "AGPIOCTRLH", description: "AGPIO Control Register", offset: "0x12E", size: "32",
		bits: [
	...
	{ name: "GPIOINENACTRL", description: "GPIOINENACTRL Control Register", offset: "0x140", size: "32",
		bits: [
