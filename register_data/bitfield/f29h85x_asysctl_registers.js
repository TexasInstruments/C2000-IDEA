let ASYSCTL_REGISTERS = [
	{ name: "PMMVREGTRIM", description: "Power Management Module VREG Trim Register", offset: "0x44", size: "32",
		bits: [
			{ name: "VREGTRIM", description: "Core VDD Voltage Regulator Trim", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "CTLTRIMSTS", description: "HWCTL TRIM Error Status register", offset: "0x6E", size: "32",
		bits: [
	...
	{ name: "REFBUFCONFIGCDE", description: "Config register for analog reference CDE", offset: "0x150", size: "32",
		bits: [
	...
	{ name: "INTERNALTESTCTL", description: "INTERNALTEST Node Control Register", offset: "0x1A2", size: "32",
		bits: [
	...
	{ name: "CONFIGLOCK", description: "Lock Register for all the config registers.", offset: "0x1E0", size: "32",
		bits: [
	...
	{ name: "TSNSCTL", description: "Temperature Sensor Control Register", offset: "0x1E2", size: "32",
		bits: [
			{ name: "ENABLE", description: "Temperature Sensor Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "ANAREFCTL", description: "Analog Reference Control Register.", offset: "0x200", size: "32",
		bits: [
	...
	{ name: "VREGCTL", description: "Voltage Regulator Control Register", offset: "0x206", size: "32",
		bits: [
	...
	{ name: "VMONCTL", description: "Voltage Monitor Control Register", offset: "0x21C", size: "32",
		bits: [
			{ name: "BORLVMONDIS", description: "Disable BORL(ow) feature on VDDIO", size: "1", shift: "8", mask: "0x100" },
		]
	},
	{ name: "CMPHPMXSEL", description: "Bits to select one of the many sources on CopmHP inputs. Refer to Pimux diagram for details.", offset: "0x25A", size: "32",
		bits: [
	...
	{ name: "CMPHPMXSEL1", description: "Bits to select one of the many sources on CopmHP inputs. Refer to Pimux diagram for details.", offset: "0x25C", size: "32",
		bits: [
	...
	{ name: "CMPLPMXSEL", description: "Bits to select one of the many sources on CopmLP inputs. Refer to Pimux diagram for details.", offset: "0x25E", size: "32",
		bits: [
	...
	{ name: "CMPLPMXSEL1", description: "Bits to select one of the many sources on CopmLP inputs. Refer to Pimux diagram for details.", offset: "0x260", size: "32",
		bits: [
	...
	{ name: "CMPHNMXSEL", description: "Bits to select one of the many sources on CopmHN inputs. Refer to Pimux diagram for details.", offset: "0x262", size: "32",
		bits: [
	...
	{ name: "CMPLNMXSEL", description: "Bits to select one of the many sources on CopmLN inputs. Refer to Pimux diagram for details.", offset: "0x264", size: "32",
		bits: [
	...
	{ name: "LOCK", description: "Lock Register", offset: "0x276", size: "32",
		bits: [
	...
	{ name: "IODRVSEL", description: "5V FS IO Drive strength select register", offset: "0x438", size: "32",
		bits: [
	...
	{ name: "IOMODESEL", description: "PMBUS IO Mode select register", offset: "0x43A", size: "32",
		bits: [
	...
	{ name: "AGPIOFILTER", description: "AGPIO Filter Control Register", offset: "0x440", size: "32",
		bits: [
			{ name: "FILTER", description: "AGPIOFILTER Control for filter ALL AGPIO pins", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "AGPIOCTRLH", description: "AGPIO Control Register", offset: "0x466", size: "32",
		bits: [
	...
	{ name: "PARITY_TEST", description: "Enables parity test", offset: "0x48C", size: "32",
		bits: [
	...
	{ name: "ADCSOCFRCGBSEL", description: "ADC Global SOC Force Select", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "PARITY_TEST_ALT1", description: "Enables parity test", offset: "0x4", size: "32",
		bits: [
			{ name: "TESTEN", description: "Parity test enable configuration", size: "4", shift: "0", mask: "0xF" },
		]
	},
