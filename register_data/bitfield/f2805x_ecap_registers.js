let ECAP_REGISTERS = [
	...
	{ name: "ECCTL2", description: "Capture Control Reg 2", offset: "0x15", size: "16",
		bits: [
			...
			{ name: "STOP_WRAP", description: "STOP_WRAP:2;", size: "2", shift: "1", mask: "0x6" },
	...
	{ name: "ECEINT", description: "ECAP __interrupt enable", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "ECFLG", description: "ECAP __interrupt flags", offset: "0x17", size: "16",
		bits: [
	...
	{ name: "ECCLR", description: "ECAP __interrupt clear", offset: "0x18", size: "16",
		bits: [
			{ name: "INT", description: "Global Flag", size: "1", shift: "0", mask: "0x1" },
			{ name: "CEVT1", description: "Capture Event 1 Interrupt Flag", size: "1", shift: "1", mask: "0x2" },
			{ name: "CEVT2", description: "Capture Event 2 Interrupt Flag", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "ECFRC", description: "ECAP __interrupt force", offset: "0x19", size: "16",
		bits: [
			{ name: "INT", description: "Global Flag", size: "1", shift: "0", mask: "0x1" },
			{ name: "CEVT1", description: "Capture Event 1 Interrupt Flag", size: "1", shift: "1", mask: "0x2" },
			{ name: "CEVT2", description: "Capture Event 2 Interrupt Flag", size: "1", shift: "2", mask: "0x4" },
