let SCI_REGISTERS = [
	...
	{ name: "SCICTL1", description: "Control register 1", offset: "0x1", size: "16",
		bits: [
			...
			{ name: "RXERRINTENA", description: "Recieve interrupt enable", size: "1", shift: "6", mask: "0x40" },
		]
	},
	...
	{ name: "SCICTL2", description: "Control register 2", offset: "0x4", size: "16",
		bits: [
			{ name: "TXINTENA", description: "Transmit interrupt enable", size: "1", shift: "0", mask: "0x1" },
