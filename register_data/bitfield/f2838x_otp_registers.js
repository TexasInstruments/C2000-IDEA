let OTP_REGISTERS = [
	...
	{ name: "UID_PSRAND5", description: "UID Psuedo-random 160 bit number", offset: "0xA", size: "32",
		bits: [
		]
	},
	{ name: "UID_UNIQUE", description: "UID Unique 32 bit number", offset: "0xC", size: "32",
		bits: [
		]
	},
