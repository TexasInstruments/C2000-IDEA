let CMPSS_REGISTERS = [
	...
	{ name: "RAMPHREFS", description: "CMPSS High Ramp Reference Shadow Register", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "RAMPHSTEPVALA", description: "CMPSS High Ramp Step Value Active Register", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "RAMPHCTLA", description: "CMPSS High Ramp Control Active Register", offset: "0xD", size: "16",
		bits: [
			{ name: "RAMPCLKDIV", description: "Ramp Clock Divider Active Value", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RAMPHSTEPVALS", description: "CMPSS High Ramp Step Value Shadow Register", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "RAMPHCTLS", description: "CMPSS High Ramp Control Shadow Register", offset: "0xF", size: "16",
		bits: [
			{ name: "RAMPCLKDIV", description: "Ramp Clock Divider Shadow Value", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RAMPHSTS", description: "CMPSS High Ramp Status Register", offset: "0x10", size: "16",
		bits: [
		]
	},
	...
	{ name: "RAMPHDLYA", description: "CMPSS High Ramp Delay Active Register", offset: "0x14", size: "16",
		bits: [
			{ name: "DELAY", description: "High Ramp Delay Value Active", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
	{ name: "RAMPHDLYS", description: "CMPSS High Ramp Delay Shadow Register", offset: "0x15", size: "16",
		bits: [
	...
	{ name: "DACHVALS2", description: "CMPSS High DAC Value Shadow Register 2", offset: "0x1C", size: "16",
		bits: [
			{ name: "DACVAL", description: "DAC Value Control", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "DACLVALS2", description: "CMPSS Low DAC Value Shadow Register 2", offset: "0x1D", size: "16",
		bits: [
			{ name: "DACVAL", description: "DAC Value Control", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	...
	{ name: "COMPDACLCTL2", description: "CMPSS Low DAC Control Register 2", offset: "0x25", size: "16",
		bits: [
			{ name: "BLANKSOURCEUSEL", description: "BLANK source upper group select", size: "1", shift: "8", mask: "0x100" },
			{ name: "RAMPSOURCEUSEL", description: "RAMP source upper group select", size: "1", shift: "10", mask: "0x400" },
		]
	},
	{ name: "RAMPLREFA", description: "CMPSS Low Ramp Reference Active Register", offset: "0x28", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLREFS", description: "CMPSS Low Ramp Reference Shadow Register", offset: "0x2A", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLSTEPVALA", description: "CMPSS Low Ramp Step Value Active Register", offset: "0x2C", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLCTLA", description: "CMPSS Low Ramp Control Active Register", offset: "0x2D", size: "16",
		bits: [
			{ name: "RAMPCLKDIV", description: "Ramp Clock Divider Active Value", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RAMPLSTEPVALS", description: "CMPSS Low Ramp Step Value Shadow Register", offset: "0x2E", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLCTLS", description: "CMPSS Low Ramp Control Shadow Register", offset: "0x2F", size: "16",
		bits: [
			{ name: "RAMPCLKDIV", description: "Ramp Clock Divider Shadow Value", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RAMPLSTS", description: "CMPSS Low Ramp Status Register", offset: "0x30", size: "16",
		bits: [
		]
	},
	{ name: "RAMPLDLYA", description: "CMPSS Low Ramp Delay Active Register", offset: "0x34", size: "16",
		bits: [
			{ name: "DELAY", description: "Low Ramp Delay Value Active", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
	{ name: "RAMPLDLYS", description: "CMPSS Low Ramp Delay Shadow Register", offset: "0x35", size: "16",
		bits: [
