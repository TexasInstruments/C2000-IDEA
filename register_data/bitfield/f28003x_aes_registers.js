let AES_REGISTERS = [
	{ name: "AES_KEY2_6", description: "XTS Second Key or CBC-MAC Third Key", offset: "0x0", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY2_7", description: "XTS Second Key or CBC-MAC Third Key", offset: "0x2", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY2_4", description: "XTS/CCM Second Key or CBC-MAC Third Key", offset: "0x4", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY2_5", description: "XTS Second Key or CBC-MAC Third Key", offset: "0x6", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY2_2", description: "XTS/CCM/CBC-MAC Second Key or Hash Key Input", offset: "0x8", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY2_3", description: "XTS/CCM/CBC-MAC Second Key or Hash Key Input", offset: "0xA", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY2_0", description: "XTS/CCM/CBC-MAC Second Key or Hash Key Input", offset: "0xC", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY2_1", description: "XTS/CCM/CBC-MAC Second Key or Hash Key Input", offset: "0xE", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY1_6", description: "Key", offset: "0x10", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY1_7", description: "Key", offset: "0x12", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY1_4", description: "Key", offset: "0x14", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY1_5", description: "Key", offset: "0x16", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY1_2", description: "Key", offset: "0x18", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY1_3", description: "Key", offset: "0x1A", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY1_0", description: "Key", offset: "0x1C", size: "32",
		bits: [
		]
	},
	{ name: "AES_KEY1_1", description: "Key", offset: "0x1E", size: "32",
		bits: [
		]
	},
	{ name: "AES_IV_IN_OUT_0", description: "Initialization Vector 0", offset: "0x20", size: "32",
		bits: [
		]
	},
	{ name: "AES_IV_IN_OUT_1", description: "Initialization Vector 1", offset: "0x22", size: "32",
		bits: [
		]
	},
	{ name: "AES_IV_IN_OUT_2", description: "Initialization Vector 2", offset: "0x24", size: "32",
		bits: [
		]
	},
	{ name: "AES_IV_IN_OUT_3", description: "Initialization Vector 3", offset: "0x26", size: "32",
		bits: [
		]
	},
	{ name: "AES_CTRL", description: "Input/Output Buffer Control and Mode Selection", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "AES_C_LENGTH_0", description: "Crypto Data Length 0", offset: "0x2A", size: "32",
		bits: [
		]
	},
	{ name: "AES_C_LENGTH_1", description: "Crypto Data Length 1", offset: "0x2C", size: "32",
		bits: [
		]
	},
	{ name: "AES_AUTH_LENGTH", description: "AAD Data Length", offset: "0x2E", size: "32",
		bits: [
		]
	},
	{ name: "AES_DATA_IN_OUT_0", description: "Data Word 0", offset: "0x30", size: "32",
		bits: [
		]
	},
	{ name: "AES_DATA_IN_OUT_1", description: "Data Word 1", offset: "0x32", size: "32",
		bits: [
		]
	},
	{ name: "AES_DATA_IN_OUT_2", description: "Data Word 2", offset: "0x34", size: "32",
		bits: [
		]
	},
	{ name: "AES_DATA_IN_OUT_3", description: "Data Word 3", offset: "0x36", size: "32",
		bits: [
		]
	},
	{ name: "AES_TAG_OUT_0", description: "Hash Result 0", offset: "0x38", size: "32",
		bits: [
		]
	},
	{ name: "AES_TAG_OUT_1", description: "Hash Result 1", offset: "0x3A", size: "32",
		bits: [
		]
	},
	{ name: "AES_TAG_OUT_2", description: "Hash Result 2", offset: "0x3C", size: "32",
		bits: [
		]
	},
	{ name: "AES_TAG_OUT_3", description: "Hash Result 3", offset: "0x3E", size: "32",
		bits: [
		]
	},
	{ name: "AES_REV", description: "Module Revision Number", offset: "0x40", size: "32",
		bits: [
		]
	},
	{ name: "AES_SYSCONFIG", description: "System Configuration", offset: "0x42", size: "32",
		bits: [
	...
	{ name: "AES_SYSSTATUS", description: "Reset Status", offset: "0x44", size: "32",
		bits: [
			{ name: "RESETDONE", description: "Reset Done", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "AES_IRQSTATUS", description: "Interrupt Status", offset: "0x46", size: "32",
		bits: [
	...
	{ name: "AES_IRQENABLE", description: "Interrupt Enable", offset: "0x48", size: "32",
		bits: [
	...
	{ name: "AES_DIRTY_BITS", description: "Accessed / Dirty Bits", offset: "0x4A", size: "32",
		bits: [
		]
	},
];
