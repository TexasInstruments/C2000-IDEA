let PGA_REGISTERS = [
	{ name: "PGACTL", description: "PGA Control Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "PGALOCK", description: "PGA Lock Register", offset: "0x2", size: "16",
		bits: [
	...
	{ name: "PGAGAIN3TRIM", description: "PGA Gain Trim Register for a gain setting of 3", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "PGAGAIN6TRIM", description: "PGA Gain Trim Register for a gain setting of 6", offset: "0x5", size: "16",
		bits: [
	...
	{ name: "PGAGAIN12TRIM", description: "PGA Gain Trim Register for a gain setting of 12", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "PGAGAIN24TRIM", description: "PGA Gain Trim Register for a gain setting of 24", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "PGATYPE", description: "PGA Type Register", offset: "0x8", size: "16",
		bits: [
