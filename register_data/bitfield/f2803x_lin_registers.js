let LIN_REGISTERS = [
	{ name: "SCIGCR0", description: "Global Control Register 0", offset: "0x0", size: "32",
		bits: [
			{ name: "RESET", description: "LIN Module reset bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SCIGCR1", description: "Global Control Register 1", offset: "0x4", size: "32",
		bits: [
			{ name: "COMMMODE", description: "SCI/LIN communications mode bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "TIMINGMODE", description: "TIMINGMODE:1;", size: "1", shift: "1", mask: "0x2" },
			...
			{ name: "CLK_MASTER", description: "LIN Master/Slave selection and SCI clock enable", size: "1", shift: "5", mask: "0x20" },
			...
			{ name: "RXENA", description: "SCI mode receiver enable", size: "1", shift: "24", mask: "0x1000000" },
			{ name: "TXENA", description: "SCI mode transmitter enable", size: "1", shift: "25", mask: "0x2000000" },
		]
	},
	{ name: "SCIGCR2", description: "Global Control Register 2", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "SCISETINT", description: "Interrupt Enable Register", offset: "0xC", size: "32",
		bits: [
			{ name: "SETBRKDTINT", description: "SETBRKDTINT:1;", size: "1", shift: "0", mask: "0x1" },
			...
			{ name: "SETTOAWUSINT", description: "SETTOAWUSINT:1;", size: "1", shift: "6", mask: "0x40" },
			{ name: "SETTOA3WUSINT", description: "SETTOA3WUSINT:1;", size: "1", shift: "7", mask: "0x80" },
			{ name: "SETTXINT", description: "Set Transmitter Interrupt", size: "1", shift: "8", mask: "0x100" },
			{ name: "SETRXINT", description: "Receiver Interrupt Enable", size: "1", shift: "9", mask: "0x200" },
			...
			{ name: "SETISFEINT", description: "SETISFEINT:1;", size: "1", shift: "28", mask: "0x10000000" },
			{ name: "SETCEINT", description: "SETCEINT:1;      //29   Set Checksum-error Interrupt (LIN only)", size: "1", shift: "29", mask: "0x20000000" },
			{ name: "SETPBEINT", description: "SETPBEINT:1;     //30   Set Physical Bus Error Interrupt (LIN only)", size: "1", shift: "30", mask: "0x40000000" },
			{ name: "SETBEINT", description: "SETBEINT:1;      //31   Set Bit Error Interrupt (LIN only)", size: "1", shift: "31", mask: "0x80000000" },
		]
	},
	{ name: "SCICLEARINT", description: "Interrupt Disable Register", offset: "0x10", size: "32",
		bits: [
			{ name: "CLRBRKDTINT", description: "CLRBRKDTINT:1;", size: "1", shift: "0", mask: "0x1" },
			...
			{ name: "CLRTOAWUSINT", description: "CLRTOAWUSINT:1;", size: "1", shift: "6", mask: "0x40" },
			{ name: "CLRTOA3WUSINT", description: "CLRTOA3WUSINT:1;", size: "1", shift: "7", mask: "0x80" },
			...
			{ name: "CLRNREINT", description: "CLRNREINT:1;", size: "1", shift: "27", mask: "0x8000000" },
			{ name: "CLRISFEINT", description: "CLRISFEINT:1;", size: "1", shift: "28", mask: "0x10000000" },
			{ name: "CLRCEINT", description: "Clear Checksum-error Interrupt (LIN only)", size: "1", shift: "29", mask: "0x20000000" },
			{ name: "CLRPBEINT", description: "CLRPBEINT:1;", size: "1", shift: "30", mask: "0x40000000" },
			{ name: "CLRBEINT", description: "Clear Bit Error Interrupt (LIN only)", size: "1", shift: "31", mask: "0x80000000" },
		]
	},
	{ name: "SCISETINTLVL", description: "", offset: "0x14", size: "32",
		bits: [
			{ name: "SETBRKDTINTLVL", description: "SETBRKDTINTLVL:1;", size: "1", shift: "0", mask: "0x1" },
			...
			{ name: "SETTOAWUSINTLVL", description: "SETTOAWUSINTLVL:1;", size: "1", shift: "6", mask: "0x40" },
			{ name: "SETTOA3WUSINTLVL", description: "SETTOA3WUSINTLVL:1;", size: "1", shift: "7", mask: "0x80" },
			{ name: "SETTXINTLVL", description: "Set Transmitter Interrupt Level", size: "1", shift: "8", mask: "0x100" },
			{ name: "SETRXINTLVL", description: "Receiver Interrupt Enable Level", size: "1", shift: "9", mask: "0x200" },
			{ name: "SETIDINTLVL", description: "Set Identifier Interrupt Level (LIN only)", size: "1", shift: "13", mask: "0x2000" },
			...
			{ name: "SETNREINTLVL", description: "SETNREINTLVL:1;", size: "1", shift: "27", mask: "0x8000000" },
			{ name: "SETISFEINTLVL", description: "SETISFEINTLVL:1;", size: "1", shift: "28", mask: "0x10000000" },
			{ name: "SETCEINTLVL", description: "SETCEINTLVL:1;", size: "1", shift: "29", mask: "0x20000000" },
			{ name: "SETPBEINTLVL", description: "SETPBEINTLVL:1;", size: "1", shift: "30", mask: "0x40000000" },
			{ name: "SETBEINTLVL", description: "Set Bit Error Interrupt Level(LIN only)", size: "1", shift: "31", mask: "0x80000000" },
		]
	},
	{ name: "SCICLEARINTLVL", description: "", offset: "0x18", size: "32",
		bits: [
			{ name: "CLRBRKDTINTLVL", description: "CLRBRKDTINTLVL:1;", size: "1", shift: "0", mask: "0x1" },
			{ name: "CLRWAKEUPINTLVL", description: "Clear Wake-up Interrupt Level", size: "1", shift: "1", mask: "0x2" },
			{ name: "CLRTIMEOUTINTLVL", description: "Clear Timeout Interrupt Level (LIN only)", size: "1", shift: "4", mask: "0x10" },
			{ name: "CLRTOAWUSINTLVL", description: "CLRTOAWUSINTLVL:1;", size: "1", shift: "6", mask: "0x40" },
			{ name: "CLRTOA3WUSINTLVL", description: "CLRTOA3WUSINTLVL:1;", size: "1", shift: "7", mask: "0x80" },
			...
			{ name: "CLRIDINTLVL", description: "CLRIDINTLVL:1;", size: "1", shift: "13", mask: "0x2000" },
			...
			{ name: "CLRNREINTLVL", description: "CLRNREINTLVL:1;", size: "1", shift: "27", mask: "0x8000000" },
			{ name: "CLRISFEINTLVL", description: "CLRISFEINTLVL:1;", size: "1", shift: "28", mask: "0x10000000" },
			{ name: "CLRCEINTLVL", description: "CLRCEINTLVL:1;", size: "1", shift: "29", mask: "0x20000000" },
			{ name: "CLRPBEINTLVL", description: "CLRPBEINTLVL:1;", size: "1", shift: "30", mask: "0x40000000" },
			{ name: "CLRBEINTLVL", description: "CLRBEINTLVL:1;", size: "1", shift: "31", mask: "0x80000000" },
		]
	},
	{ name: "SCIFLR", description: "Flag Register", offset: "0x1C", size: "32",
		bits: [
			...
			{ name: "IDLE", description: "IDLE:1;", size: "1", shift: "2", mask: "0x4" },
			...
			{ name: "TOAWUS", description: "TOAWUS:1;", size: "1", shift: "6", mask: "0x40" },
			{ name: "TOA3WUS", description: "TOA3WUS:1;", size: "1", shift: "7", mask: "0x80" },
			...
			{ name: "TXEMPTY", description: "Transmitter Empty Clag", size: "1", shift: "11", mask: "0x800" },
			...
			{ name: "ISFE", description: "ISFE:1;", size: "1", shift: "28", mask: "0x10000000" },
	...
	{ name: "SCIINTVECT0", description: "", offset: "0x20", size: "32",
		bits: [
			{ name: "INTVECT0", description: "Interrupt vector offset for INT0", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "SCIINTVECT1", description: "", offset: "0x24", size: "32",
		bits: [
			{ name: "INTVECT1", description: "Interrupt vector offset for INT1", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "SCIFORMAT", description: "Length Control Register", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "BRSR", description: "Baud Rate Selection Register", offset: "0x2C", size: "32",
		bits: [
			{ name: "SCI_LIN_PSL", description: "SCI/LIN Prescaler Low", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "SCI_LIN_PSH", description: "SCI/LIN Prescaler High", size: "8", shift: "16", mask: "0xFF0000" },
			{ name: "M", description: "SCI/LIN Fractional Divider Selection", size: "4", shift: "24", mask: "0xF000000" },
		]
	},
	{ name: "SCIED", description: "Emulation buffer Register", offset: "0x30", size: "32",
		bits: [
		]
	},
	{ name: "SCIRD", description: "Receiver data buffer Register", offset: "0x34", size: "32",
		bits: [
		]
	},
	{ name: "SCITD", description: "Transmit data buffer Register", offset: "0x38", size: "32",
		bits: [
		]
	},
	{ name: "SCIPIO2", description: "Pin control Register 2", offset: "0x40", size: "32",
		bits: [
	...
	{ name: "LINCOMP", description: "Compare register", offset: "0x50", size: "32",
		bits: [
			{ name: "SBREAK", description: "Synch Break Extend", size: "3", shift: "0", mask: "0x7" },
			{ name: "SDEL", description: "Sync Delimiter Compare", size: "2", shift: "8", mask: "0x300" },
		]
	},
	{ name: "LINRD0", description: "Receive data register 0", offset: "0x54", size: "32",
		bits: [
	...
	{ name: "LINRD1", description: "Receive data register 1", offset: "0x58", size: "32",
		bits: [
			{ name: "RD7", description: "Receive Buffer 7", size: "8", shift: "0", mask: "0xFF" },
			{ name: "RD6", description: "Receive Buffer 6", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "RD5", description: "Receive Buffer 5", size: "8", shift: "16", mask: "0xFF0000" },
			{ name: "RD4", description: "Receive Buffer 4", size: "8", shift: "24", mask: "0xFF000000" },
		]
	},
	{ name: "LINMASK", description: "Acceptance mask register", offset: "0x5C", size: "32",
		bits: [
	...
	{ name: "LINID", description: "LIN ID Register", offset: "0x60", size: "32",
		bits: [
			{ name: "IDBYTE", description: "LIN message ID (LIN only)", size: "8", shift: "0", mask: "0xFF" },
			{ name: "IDSLAVETASKBYTE", description: "Received ID comparison ID (LIN only)", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "RECEIVEDID", description: "Current Message ID (LIN only)", size: "8", shift: "16", mask: "0xFF0000" },
		]
	},
	{ name: "LINTD0", description: "Transmit Data Register 0", offset: "0x64", size: "32",
		bits: [
	...
	{ name: "LINTD1", description: "Transmit Data Register 1", offset: "0x68", size: "32",
		bits: [
	...
	{ name: "MBRSR", description: "Baud Rate Selection Register", offset: "0x6C", size: "32",
		bits: [
		]
	},
	{ name: "IODFTCTRL", description: "IODFT for LIN", offset: "0x78", size: "32",
		bits: [
			...
			{ name: "BRKDTERRENA", description: "BRKDTERRENA:1;", size: "1", shift: "24", mask: "0x1000000" },
			{ name: "PERRENA", description: "PERRENA:1;", size: "1", shift: "25", mask: "0x2000000" },
			{ name: "FERRENA", description: "FERRENA:1;", size: "1", shift: "26", mask: "0x4000000" },
			{ name: "ISFERRENA", description: "ISFERRENA:1;", size: "1", shift: "28", mask: "0x10000000" },
