let EPWM_REGISTERS = [
	...
	{ name: "TBPHS", description: "Time Base Phase Register", offset: "0x3", size: "16",
		bits: [
		]
	},
	{ name: "TBCTR", description: "Time Base Counter", offset: "0x4", size: "16",
		bits: [
		]
	},
	{ name: "TBPRD", description: "Time Base Period register set", offset: "0x5", size: "16",
		bits: [
		]
	},
	{ name: "CMPCTL", description: "Compare control", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "CMPA", description: "Compare A reg", offset: "0x9", size: "16",
		bits: [
		]
	},
	{ name: "CMPB", description: "Compare B reg", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "AQCTLA", description: "Action qual output A", offset: "0xB", size: "16",
		bits: [
	...
	{ name: "AQCTLB", description: "Action qual output B", offset: "0xC", size: "16",
		bits: [
			{ name: "ZRO", description: "Action Counter = Zero", size: "2", shift: "0", mask: "0x3" },
			{ name: "PRD", description: "Action Counter = Period", size: "2", shift: "2", mask: "0xC" },
			{ name: "CAU", description: "Action Counter = Compare A up", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "AQSFRC", description: "Action qual SW force", offset: "0xD", size: "16",
		bits: [
	...
	{ name: "AQCSFRC", description: "Action qualifier continuous SW force", offset: "0xE", size: "16",
		bits: [
	...
	{ name: "DBCTL", description: "Dead-band control", offset: "0xF", size: "16",
		bits: [
	...
	{ name: "DBRED", description: "Dead-band rising edge delay", offset: "0x10", size: "16",
		bits: [
		]
	},
	{ name: "DBFED", description: "Dead-band falling edge delay", offset: "0x11", size: "16",
		bits: [
		]
	},
	{ name: "TZSEL", description: "Trip zone select", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "TZDCSEL", description: "Trip zone digital comparator select", offset: "0x13", size: "16",
		bits: [
	...
	{ name: "TZCTL", description: "Trip zone control", offset: "0x14", size: "16",
		bits: [
	...
	{ name: "TZEINT", description: "Trip zone interrupt enable", offset: "0x15", size: "16",
		bits: [
	...
	{ name: "TZFLG", description: "Trip zone interrupt flags", offset: "0x16", size: "16",
		bits: [
	...
	{ name: "TZCLR", description: "Trip zone clear", offset: "0x17", size: "16",
		bits: [
			{ name: "INT", description: "Global status", size: "1", shift: "0", mask: "0x1" },
			{ name: "CBC", description: "Trip Zones Cycle By Cycle Int", size: "1", shift: "1", mask: "0x2" },
			{ name: "OST", description: "Trip Zones One Shot Int", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "TZFRC", description: "Trip zone force interrupt", offset: "0x18", size: "16",
		bits: [
			{ name: "CBC", description: "Trip Zones Cycle By Cycle Int", size: "1", shift: "1", mask: "0x2" },
			{ name: "OST", description: "Trip Zones One Shot Int", size: "1", shift: "2", mask: "0x4" },
			{ name: "DCAEVT1", description: "Force DCAEVT1 event", size: "1", shift: "3", mask: "0x8" },
	...
	{ name: "ETSEL", description: "Event trigger selection", offset: "0x19", size: "16",
		bits: [
	...
	{ name: "ETPS", description: "Event trigger pre-scaler", offset: "0x1A", size: "16",
		bits: [
	...
	{ name: "ETFLG", description: "Event trigger flags", offset: "0x1B", size: "16",
		bits: [
	...
	{ name: "ETCLR", description: "Event trigger clear", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "ETFRC", description: "Event trigger force", offset: "0x1D", size: "16",
		bits: [
	...
	{ name: "PCCTL", description: "PWM chopper control", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "TBPRDM", description: "Timer Base period register mirror", offset: "0x2B", size: "16",
		bits: [
		]
	},
	{ name: "CMPAM", description: "Compare A register mirror", offset: "0x2D", size: "16",
		bits: [
		]
	},
	{ name: "DCTRIPSEL", description: "Digital Compare Trip Select", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "DCACTL", description: "Digital Compare A Control", offset: "0x31", size: "16",
		bits: [
			{ name: "EVT1SRCSEL", description: "DCBEVT1 Source Signal Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "EVT1FRCSYNCSEL", description: "EVT1FRCSYNCSEL:1;", size: "1", shift: "1", mask: "0x2" },
			...
			{ name: "EVT2FRCSYNCSEL", description: "EVT2FRCSYNCSEL:1;", size: "1", shift: "9", mask: "0x200" },
		]
	},
	{ name: "DCBCTL", description: "Digital Compare B Control", offset: "0x32", size: "16",
		bits: [
			{ name: "EVT1SRCSEL", description: "DCBEVT1 Source Signal Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "EVT1FRCSYNCSEL", description: "EVT1FRCSYNCSEL:1;", size: "1", shift: "1", mask: "0x2" },
			{ name: "EVT1SOCE", description: "DCEVT1 SOC, Enable/Disable", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "DCFCTL", description: "Digital Compare Filter Control", offset: "0x33", size: "16",
		bits: [
	...
	{ name: "DCCAPCTL", description: "Digital Compare Capture Control", offset: "0x34", size: "16",
		bits: [
	...
	{ name: "DCFOFFSET", description: "Digital Compare Filter Offset", offset: "0x35", size: "16",
		bits: [
		]
	},
	{ name: "DCFOFFSETCNT", description: "", offset: "0x36", size: "16",
		bits: [
		]
	},
	{ name: "DCFWINDOW", description: "Digital Compare Filter Window", offset: "0x37", size: "16",
		bits: [
		]
	},
	{ name: "DCFWINDOWCNT", description: "", offset: "0x38", size: "16",
		bits: [
		]
	},
	{ name: "DCCAP", description: "", offset: "0x39", size: "16",
		bits: [
		]
	},
];
