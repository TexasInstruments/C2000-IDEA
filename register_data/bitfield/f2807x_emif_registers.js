let EMIF_REGISTERS = [
	...
	{ name: "SDRAM_TR", description: "SDRAM Timing Register", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "TOTAL_SDRAM_AR", description: "Total SDRAM Accesses Register", offset: "0x18", size: "32",
		bits: [
		]
	},
	{ name: "TOTAL_SDRAM_ACTR", description: "Total SDRAM Activate Register", offset: "0x1A", size: "32",
		bits: [
		]
	},
	{ name: "SDR_EXT_TMNG", description: "SDRAM SR/PD Exit Timing Register", offset: "0x1E", size: "32",
		bits: [
			{ name: "T_XS", description: "Self Refresh exit to new command timing.", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "INT_RAW", description: "Interrupt Raw Register", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "INT_MSK", description: "Interrupt Masked Register", offset: "0x22", size: "32",
		bits: [
	...
	{ name: "INT_MSK_SET", description: "Interrupt Mask Set Register", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "INT_MSK_CLR", description: "Interrupt Mask Clear Register", offset: "0x26", size: "32",
		bits: [
