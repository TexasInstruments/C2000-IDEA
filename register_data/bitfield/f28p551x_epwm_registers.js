let EPWM_REGISTERS = [
	...
	{ name: "HRPWR", description: "HRPWM Power Register", offset: "0x21", size: "16",
		bits: [
			{ name: "CALPWRON", description: "Calibration Power On", size: "1", shift: "15", mask: "0x8000" },
		]
	},
	{ name: "HRMSTEP", description: "HRPWM MEP Step Register", offset: "0x26", size: "16",
		bits: [
	...
	{ name: "TBPRDHR", description: "Time Base Period High Resolution Register", offset: "0x62", size: "16",
		bits: [
			{ name: "TBPRDHR", description: "High res Time base period register", size: "8", shift: "8", mask: "0xFF00" },
		]
	},
	...
	{ name: "DCAHTRIPSEL", description: "Digital Compare AH Trip Select", offset: "0xD2", size: "16",
		bits: [
			...
			{ name: "TRIPINPUT13", description: "Trip Input 13 Select to DCAH Mux", size: "1", shift: "12", mask: "0x1000" },
	...
	{ name: "DCALTRIPSEL", description: "Digital Compare AL Trip Select", offset: "0xD3", size: "16",
		bits: [
			...
			{ name: "TRIPINPUT13", description: "Trip Input 13 Select to DCAL Mux", size: "1", shift: "12", mask: "0x1000" },
	...
	{ name: "DCBHTRIPSEL", description: "Digital Compare BH Trip Select", offset: "0xD4", size: "16",
		bits: [
			...
			{ name: "TRIPINPUT13", description: "Trip Input 13 Select to DCBH Mux", size: "1", shift: "12", mask: "0x1000" },
	...
	{ name: "DCBLTRIPSEL", description: "Digital Compare BL Trip Select", offset: "0xD5", size: "16",
		bits: [
			...
			{ name: "TRIPINPUT13", description: "Trip Input 13 Select to DCBL Mux", size: "1", shift: "12", mask: "0x1000" },
