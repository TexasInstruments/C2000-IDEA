let SYSCTRL_REGISTERS = [
	...
	{ name: "DC0", description: "Device Capability: Device Information", offset: "0x10", size: "32",
		bits: [
			{ name: "SINGLE_CORE", description: "Single Core vs Dual Core", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "DC1", description: "Device Capability: Processing Block Customization", offset: "0x12", size: "32",
		bits: [
	...
	{ name: "DC2", description: "Device Capability: EMIF Customization", offset: "0x14", size: "32",
		bits: [
			{ name: "EMIF1", description: "EMIF1", size: "1", shift: "0", mask: "0x1" },
			{ name: "EMIF2", description: "EMIF2", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "DC3", description: "Device Capability: Peripheral Customization", offset: "0x16", size: "32",
		bits: [
	...
	{ name: "DC4", description: "Device Capability: Peripheral Customization", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "DC5", description: "Device Capability: Peripheral Customization", offset: "0x1A", size: "32",
		bits: [
	...
	{ name: "DC6", description: "Device Capability: Peripheral Customization", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "DC7", description: "Device Capability: Peripheral Customization", offset: "0x1E", size: "32",
		bits: [
			{ name: "SD1", description: "SD1", size: "1", shift: "0", mask: "0x1" },
			{ name: "SD2", description: "SD2", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "DC8", description: "Device Capability: Peripheral Customization", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "DC9", description: "Device Capability: Peripheral Customization", offset: "0x22", size: "32",
		bits: [
	...
	{ name: "DC10", description: "Device Capability: Peripheral Customization", offset: "0x24", size: "32",
		bits: [
			{ name: "I2C_A", description: "I2C_A", size: "1", shift: "0", mask: "0x1" },
			{ name: "I2C_B", description: "I2C_B", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "DC11", description: "Device Capability: Peripheral Customization", offset: "0x26", size: "32",
		bits: [
			{ name: "CAN_A", description: "CAN_A", size: "1", shift: "0", mask: "0x1" },
			{ name: "CAN_B", description: "CAN_B", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "DC12", description: "Device Capability: Peripheral Customization", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "DC13", description: "Device Capability: Peripheral Customization", offset: "0x2A", size: "32",
		bits: [
			{ name: "uPP_A", description: "uPP_A", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "DC14", description: "Device Capability: Analog Modules Customization", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "DC15", description: "Device Capability: Analog Modules Customization", offset: "0x2E", size: "32",
		bits: [
	...
	{ name: "DC17", description: "Device Capability: Analog Modules Customization", offset: "0x32", size: "32",
		bits: [
	...
	{ name: "DC18", description: "Device Capability: CPU1 Lx SRAM Customization", offset: "0x34", size: "32",
		bits: [
	...
	{ name: "DC19", description: "Device Capability: CPU2 Lx SRAM Customization", offset: "0x36", size: "32",
		bits: [
	...
	{ name: "DC20", description: "Device Capability: GSx SRAM Customization", offset: "0x38", size: "32",
		bits: [
	...
	{ name: "SYSDBGCTL", description: "System Debug Control register", offset: "0x12C", size: "32",
		bits: [
	...
	{ name: "HIBBOOTMODE", description: "HIB Boot Mode Register", offset: "0x6", size: "32",
		bits: [
		]
	},
	...
	{ name: "PCLKCR12", description: "Peripheral Clock Gating Registers", offset: "0x3A", size: "32",
		bits: [
	...
	{ name: "SECMSEL", description: "Secondary Master Select register for common peripherals: Selects between CLA & DMA", offset: "0x74", size: "32",
		bits: [
