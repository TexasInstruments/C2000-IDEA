let PMBUS_REGISTERS = [
	{ name: "PMBCCR", description: "PMBUS CONTROLLER Mode Control Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "PMBTCR", description: "PMBUS TARGET Mode Configuration Register", offset: "0xC", size: "32",
		bits: [
			{ name: "TARGET_ADDR", description: "Configures the current device address of the TARGET.", size: "7", shift: "0", mask: "0x7F" },
	...
	{ name: "PMBHTA", description: "PMBUS Hold TARGET Address Register", offset: "0xE", size: "32",
		bits: [
	...
	{ name: "PMBTIMCLK", description: "PMBUS Clock Timing Register", offset: "0x14", size: "32",
		bits: [
			{ name: "CLK_HIGH_LIMIT", description: "Determines the PMBUS CONTROLLER clock high pulse width.", size: "8", shift: "0", mask: "0xFF" },
			{ name: "CLK_FREQ", description: "Determines the PMBUS CONTROLLER clock frequency.", size: "8", shift: "16", mask: "0xFF0000" },
		]
	},
	{ name: "PMBTIMSTSETUP", description: "PMBUS Start Setup Time Register", offset: "0x16", size: "32",
		bits: [
			{ name: "TSU_STA", description: "Setup time, rise edge of CONTROLLER clock to start edge.", size: "8", shift: "0", mask: "0xFF" },
		]
	},
