let SYSCTRL_REGISTERS = [
	...
	{ name: "BANKMUXSEL", description: "Flash Bank allocation to CPU. Internal note : This register is accessible (read-only) by CPU2, for devices with CPU2", offset: "0x60", size: "32",
		bits: [
	...
	{ name: "MCUCNF0", description: "MCU Configuration register for DC0.DUAL_CORE", offset: "0x78", size: "32",
		bits: [
			{ name: "DUAL_CORE", description: "User Configurable Single Core vs Dual Core", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "MCUCNF1", description: "MCU Configuration register for LockStep Feature on device", offset: "0x7A", size: "32",
		bits: [
	...
	{ name: "MCUCNF2", description: "MCU Configuration register for EtherCAT", offset: "0x7C", size: "32",
		bits: [
			{ name: "ETHERCAT", description: "ETHERCAT", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "MCUCNF3", description: "MCU Configuration register for Flash Bank 1", offset: "0x7E", size: "32",
		bits: [
	...
	{ name: "MCUCNF4", description: "MCU Configuration register for Flash Bank 2", offset: "0x80", size: "32",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCUCNF5", description: "MCU Configuration register for Flash Bank 3", offset: "0x82", size: "32",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCUCNF6", description: "MCU Configuration register for Flash Bank 4", offset: "0x84", size: "32",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCUCNF7", description: "MCU Configuration register for Flash Bank 5", offset: "0x86", size: "32",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCUCNFLOCK", description: "Lock bit for MCUCNFx registers", offset: "0x8C", size: "32",
		bits: [
	...
	{ name: "TRIMERRSTS", description: "TRIM Error Status register", offset: "0x8E", size: "32",
		bits: [
			{ name: "LERR", description: "TRIM Load error status", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "SOFTPRES0", description: "Processing Block Software Reset register", offset: "0x9C", size: "32",
		bits: [
	...
	{ name: "SOFTPRES1", description: "EMIF Software Reset register", offset: "0x9E", size: "32",
		bits: [
	...
	{ name: "SOFTPRES3", description: "ECAP Software Reset register", offset: "0xA2", size: "32",
		bits: [
	...
	{ name: "SOFTPRES4", description: "EQEP Software Reset register", offset: "0xA4", size: "32",
		bits: [
	...
	{ name: "SOFTPRES6", description: "Sigma Delta Software Reset register", offset: "0xA8", size: "32",
		bits: [
	...
	{ name: "SOFTPRES7", description: "SCI, UART Software Reset register", offset: "0xAA", size: "32",
		bits: [
	...
	{ name: "SOFTPRES8", description: "SPI Software Reset register", offset: "0xAC", size: "32",
		bits: [
	...
	{ name: "SOFTPRES9", description: "I2C Software Reset register", offset: "0xAE", size: "32",
		bits: [
	...
	{ name: "SOFTPRES10", description: "CAN Software Reset register", offset: "0xB0", size: "32",
		bits: [
	...
	{ name: "SOFTPRES11", description: "McBSP/USB Software Reset register", offset: "0xB2", size: "32",
		bits: [
			{ name: "USB_A", description: "USB_A software reset bit", size: "1", shift: "16", mask: "0x10000" },
		]
	},
	{ name: "SOFTPRES13", description: "ADC Software Reset register", offset: "0xB6", size: "32",
		bits: [
	...
	{ name: "SOFTPRES14", description: "CMPSS Software Reset register", offset: "0xB8", size: "32",
		bits: [
	...
	{ name: "SOFTPRES16", description: "DAC Software Reset register", offset: "0xBC", size: "32",
		bits: [
	...
	{ name: "SOFTPRES17", description: "CLB Software Reset register", offset: "0xBE", size: "32",
		bits: [
	...
	{ name: "SOFTPRES18", description: "FSI Software Reset register", offset: "0xC0", size: "32",
		bits: [
	...
	{ name: "SOFTPRES19", description: "LIN Software Reset register", offset: "0xC2", size: "32",
		bits: [
	...
	{ name: "SOFTPRES21", description: "DCC Software Reset register", offset: "0xC6", size: "32",
		bits: [
	...
	{ name: "SOFTPRES23", description: "ETHERCAT Software Reset register", offset: "0xCA", size: "32",
		bits: [
			{ name: "ETHERCAT", description: "ETHERCAT Module reset bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SOFTPRES26", description: "AES Software Reset register", offset: "0xD0", size: "32",
		bits: [
			{ name: "AESA", description: "AES Module Reset Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SOFTPRES27", description: "EPG Software Reset register", offset: "0xD2", size: "32",
		bits: [
			{ name: "EPG1", description: "EPG Module Reset Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SOFTPRES28", description: "Flash Software Reset register", offset: "0xD4", size: "32",
		bits: [
			{ name: "FLASHA", description: "Flash Wrapper Module Reset Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SOFTPRES29", description: "ADCCHECKER Software Reset register", offset: "0xD6", size: "32",
		bits: [
	...
	{ name: "CPUSEL1", description: "CPU Select register for common peripherals", offset: "0xF2", size: "32",
		bits: [
	...
	{ name: "CPUSEL2", description: "CPU Select register for common peripherals", offset: "0xF4", size: "32",
		bits: [
	...
	{ name: "CPUSEL3", description: "CPU Select register for common peripherals", offset: "0xF6", size: "32",
		bits: [
	...
	{ name: "CPUSEL4", description: "CPU Select register for common peripherals", offset: "0xF8", size: "32",
		bits: [
	...
	{ name: "CPUSEL5", description: "CPU Select register for common peripherals", offset: "0xFA", size: "32",
		bits: [
	...
	{ name: "CPUSEL6", description: "CPU Select register for common peripherals", offset: "0xFC", size: "32",
		bits: [
	...
	{ name: "CPUSEL7", description: "CPU Select register for common peripherals", offset: "0xFE", size: "32",
		bits: [
	...
	{ name: "CPUSEL8", description: "CPU Select register for common peripherals", offset: "0x100", size: "32",
		bits: [
	...
	{ name: "CPUSEL9", description: "CPU Select register for common peripherals", offset: "0x102", size: "32",
		bits: [
			{ name: "USB_A", description: "USB_A CPU select bit", size: "1", shift: "16", mask: "0x10000" },
		]
	},
	{ name: "CPUSEL11", description: "CPU Select register for common peripherals", offset: "0x106", size: "32",
		bits: [
	...
	{ name: "CPUSEL12", description: "CPU Select register for common peripherals", offset: "0x108", size: "32",
		bits: [
	...
	{ name: "CPUSEL13", description: "CPU select register for DCC", offset: "0x10A", size: "32",
		bits: [
	...
	{ name: "CPUSEL14", description: "CPU Select register for common peripherals", offset: "0x10C", size: "32",
		bits: [
	...
	{ name: "CPUSEL15", description: "CPU select register for CLB tiles", offset: "0x10E", size: "32",
		bits: [
	...
	{ name: "CPUSEL16", description: "CPU select register for FSI", offset: "0x110", size: "32",
		bits: [
	...
	{ name: "CPUSEL17", description: "CPU select register for LIN", offset: "0x112", size: "32",
		bits: [
	...
	{ name: "CPUSEL23", description: "CPU select register for EtherCAT", offset: "0x11E", size: "32",
		bits: [
			{ name: "ETHERCAT", description: "0 CPU select bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CPUSEL25", description: "CPU select register for HRCAL", offset: "0x122", size: "32",
		bits: [
	...
	{ name: "CPUSEL26", description: "CPU select register for AES", offset: "0x124", size: "32",
		bits: [
			{ name: "AESA", description: "AESA CPU select bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CPUSEL27", description: "CPU select register for EPG", offset: "0x126", size: "32",
		bits: [
			{ name: "EPG1", description: "EPG1 CPU select bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CPUSEL28", description: "CPU select register for ADCCHECKER tiles", offset: "0x128", size: "32",
		bits: [
	...
	{ name: "AUXPLLCTL1", description: "AUXPLL Control register-1", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "AUXPLLSTS", description: "AUXPLL Status register", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "AUXCLKDIVSEL", description: "Auxillary Clock Divider Select register", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "PERCLKDIVSEL", description: "Peripheral Clock Divider Select register", offset: "0x26", size: "32",
		bits: [
	...
	{ name: "ETHERCATCLKCTL", description: "EtherCAT Clock Control", offset: "0x40", size: "32",
		bits: [
	...
	{ name: "SYNCBUSY", description: "Pulse Transfer Sync Busy Status register", offset: "0x42", size: "32",
		bits: [
	...
	{ name: "ETHERCATCTL", description: "ETHERCAT control register.", offset: "0xC", size: "32",
		bits: [
			{ name: "I2CLOOPBACK", description: "Loopback I2C port of etherCAT IP to I2C_A.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PCLKCR0", description: "Peripheral Clock Gating Registers", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "PCLKCR1", description: "Peripheral Clock Gating Register - EMIF", offset: "0x12", size: "32",
		bits: [
	...
	{ name: "PCLKCR3", description: "Peripheral Clock Gating Register - ECAP", offset: "0x16", size: "32",
		bits: [
	...
	{ name: "PCLKCR4", description: "Peripheral Clock Gating Register - EQEP", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "PCLKCR6", description: "Peripheral Clock Gating Register - SDFM", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "PCLKCR7", description: "Peripheral Clock Gating Register - SCI, UART", offset: "0x1E", size: "32",
		bits: [
	...
	{ name: "PCLKCR8", description: "Peripheral Clock Gating Register - SPI", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "PCLKCR9", description: "Peripheral Clock Gating Register - I2C, PMBUS", offset: "0x22", size: "32",
		bits: [
	...
	{ name: "PCLKCR10", description: "Peripheral Clock Gating Register - CAN", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "PCLKCR11", description: "Peripheral Clock Gating Register - McBSP_USB", offset: "0x26", size: "32",
		bits: [
			{ name: "USB_A", description: "USB_A Clock Enable bit", size: "1", shift: "16", mask: "0x10000" },
		]
	},
	{ name: "PCLKCR13", description: "Peripheral Clock Gating Register - ADC", offset: "0x2A", size: "32",
		bits: [
	...
	{ name: "PCLKCR14", description: "Peripheral Clock Gating Register - CMPSS", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "PCLKCR16", description: "Peripheral Clock Gating Register Buf_DAC", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "PCLKCR17", description: "Peripheral Clock Gating Register - CLB", offset: "0x32", size: "32",
		bits: [
	...
	{ name: "PCLKCR18", description: "Peripheral Clock Gating Register - FSI", offset: "0x34", size: "32",
		bits: [
	...
	{ name: "PCLKCR19", description: "Peripheral Clock Gating Register - LIN", offset: "0x36", size: "32",
		bits: [
	...
	{ name: "PCLKCR21", description: "Peripheral Clock Gating Register - DCC", offset: "0x3A", size: "32",
		bits: [
	...
	{ name: "PCLKCR23", description: "Peripheral Clock Gating Register - EtherCAT", offset: "0x3E", size: "32",
		bits: [
			{ name: "ETHERCAT", description: "ETHERCAT Clock Enable Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PCLKCR25", description: "Peripheral Clock Gating Register - HRCAL0,1,2", offset: "0x42", size: "32",
		bits: [
	...
	{ name: "PCLKCR26", description: "Peripheral Clock Gating Register - AES", offset: "0x44", size: "32",
		bits: [
			{ name: "AESA", description: "AESA Clock Enable Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PCLKCR27", description: "Peripheral Clock Gating Register - EPG", offset: "0x46", size: "32",
		bits: [
			{ name: "EPG1", description: "EPG1 Clock Enable Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PCLKCR28", description: "Peripheral Clock Gating Register - ADCCHECKER", offset: "0x48", size: "32",
		bits: [
	...
	{ name: "LPMCR", description: "LPM Control Register", offset: "0x66", size: "32",
		bits: [
	...
	{ name: "CPUID", description: "Indicates CPU1 or CPU2", offset: "0x68", size: "32",
		bits: [
	...
	{ name: "TMR2CLKCTL", description: "Timer2 Clock Measurement functionality control register", offset: "0x72", size: "32",
		bits: [
	...
	{ name: "RESCCLR", description: "Reset Cause Clear Register", offset: "0x74", size: "32",
		bits: [
	...
	{ name: "RESC", description: "Reset Cause register", offset: "0x76", size: "32",
		bits: [
			{ name: "POR", description: "POR Reset Cause Indication Bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "XRSn", description: "XRSn Reset Cause Indication Bit", size: "1", shift: "1", mask: "0x2" },
			{ name: "WDRSn", description: "WDRSn Reset Cause Indication Bit", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCANWAKESTATUS", description: "MCAN Wake Status Register", offset: "0x8E", size: "32",
		bits: [
	...
	{ name: "MCANWAKESTATUSCLR", description: "MCAN Wake Status Clear Register", offset: "0x90", size: "32",
		bits: [
	...
	{ name: "CLKSTOPACK", description: "Peripheral Clock Stop Ackonwledge Register", offset: "0x94", size: "32",
		bits: [
	...
	{ name: "USER_REG1_SYSRSn", description: "Software Configurable registers reset by SYSRSn", offset: "0x96", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG2_SYSRSn", description: "Software Configurable registers reset by SYSRSn", offset: "0x98", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG1_XRSn", description: "Software Configurable registers reset by XRSn", offset: "0x9A", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG2_XRSn", description: "Software Configurable registers reset by XRSn", offset: "0x9C", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG1_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0x9E", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG2_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0xA0", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG3_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0xA2", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG4_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0xA4", size: "32",
		bits: [
		]
	},
	{ name: "CPUSYSLOCK1", description: "Lock bit for CPUSYS registers", offset: "0x0", size: "32",
	...
	{ name: "PCLKCR9", description: "Peripheral Clock Gating Register - I2C", offset: "0x22", size: "32",
		bits: [
			{ name: "I2C_A", description: "I2C_A Clock Enable bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "I2C_B", description: "I2C_B Clock Enable bit", size: "1", shift: "1", mask: "0x2" },
			{ name: "PMBUS_A", description: "PMBUS_A Clock Enable bit", size: "1", shift: "16", mask: "0x10000" },
	...
	{ name: "PCLKCR25", description: "Peripheral Clock Gating Register - HRCAL", offset: "0x42", size: "32",
		bits: [
			{ name: "HRCAL0", description: "HRCAL0 Clock Enable Bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "HRCAL1", description: "HRCAL1 Clock Enable Bit", size: "1", shift: "1", mask: "0x2" },
			{ name: "HRCAL2", description: "HRCAL2 Clock Enable Bit", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "PCLKCR28_ALT", description: "Peripheral Clock Gating Register - ADCCHECKER", offset: "0x48", size: "32",
		bits: [
			{ name: "ADCCHECKER1", description: "ADCCHECKER1 Clock Enable bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "ADCCHECKER2", description: "ADCCHECKER2 Clock Enable bit", size: "1", shift: "1", mask: "0x2" },
			{ name: "ADCCHECKER3", description: "ADCCHECKER3 Clock Enable bit", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CLA1TASKSRCSELLOCK", description: "CLA1 Task Trigger Source Select Lock Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "ADCA_AC", description: "ADCA Controller Access Control Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "ADCB_AC", description: "ADCB Controller Access Control Register", offset: "0x2", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
		]
	},
	{ name: "ADCC_AC", description: "ADCC Controller Access Control Register", offset: "0x4", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
		]
	},
	{ name: "CMPSS1_AC", description: "CMPSS1 Controller Access Control Register", offset: "0x10", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
	...
	{ name: "CMPSS2_AC", description: "CMPSS2 Controller Access Control Register", offset: "0x12", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CMPSS3_AC", description: "CMPSS3 Controller Access Control Register", offset: "0x14", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CMPSS4_AC", description: "CMPSS4 Controller Access Control Register", offset: "0x16", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CMPSS5_AC", description: "CMPSS5 Controller Access Control Register", offset: "0x18", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CMPSS6_AC", description: "CMPSS6 Controller Access Control Register", offset: "0x1A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CMPSS7_AC", description: "CMPSS7 Controller Access Control Register", offset: "0x1C", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CMPSS8_AC", description: "CMPSS8 Controller Access Control Register", offset: "0x1E", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CMPSS9_AC", description: "CMPSS9 Controller Access Control Register", offset: "0x20", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CMPSS10_AC", description: "CMPSS10 Controller Access Control Register", offset: "0x22", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CMPSS11_AC", description: "CMPSS11 Controller Access Control Register", offset: "0x24", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "DACA_AC", description: "DACA Controller Access Control Register", offset: "0x28", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "DACC_AC", description: "DACC Controller Access Control Register", offset: "0x2C", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM1_AC", description: "EPWM1 Controller Access Control Register", offset: "0x48", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM2_AC", description: "EPWM2 Controller Access Control Register", offset: "0x4A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM3_AC", description: "EPWM3 Controller Access Control Register", offset: "0x4C", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM4_AC", description: "EPWM4 Controller Access Control Register", offset: "0x4E", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM5_AC", description: "EPWM5 Controller Access Control Register", offset: "0x50", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM6_AC", description: "EPWM6 Controller Access Control Register", offset: "0x52", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM7_AC", description: "EPWM7 Controller Access Control Register", offset: "0x54", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM8_AC", description: "EPWM8 Controller Access Control Register", offset: "0x56", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM9_AC", description: "EPWM9 Controller Access Control Register", offset: "0x58", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM10_AC", description: "EPWM10 Controller Access Control Register", offset: "0x5A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM11_AC", description: "EPWM11 Controller Access Control Register", offset: "0x5C", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM12_AC", description: "EPWM12 Controller Access Control Register", offset: "0x5E", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM13_AC", description: "EPWM13 Controller Access Control Register", offset: "0x60", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM14_AC", description: "EPWM14 Controller Access Control Register", offset: "0x62", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM15_AC", description: "EPWM15 Controller Access Control Register", offset: "0x64", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM16_AC", description: "EPWM16 Controller Access Control Register", offset: "0x66", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM17_AC", description: "EPWM17 Controller Access Control Register", offset: "0x68", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EPWM18_AC", description: "EPWM18 Controller Access Control Register", offset: "0x6A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EQEP1_AC", description: "EQEP1 Controller Access Control Register", offset: "0x70", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EQEP2_AC", description: "EQEP2 Controller Access Control Register", offset: "0x72", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EQEP3_AC", description: "EQEP3 Controller Access Control Register", offset: "0x74", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EQEP4_AC", description: "EQEP4 Controller Access Control Register", offset: "0x76", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EQEP5_AC", description: "EQEP5 Controller Access Control Register", offset: "0x78", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "EQEP6_AC", description: "EQEP6 Controller Access Control Register", offset: "0x7A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "ECAP1_AC", description: "ECAP1 Controller Access Control Register", offset: "0x80", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "ECAP2_AC", description: "ECAP2 Controller Access Control Register", offset: "0x82", size: "32",
		bits: [
	...
	{ name: "ECAP3_AC", description: "ECAP3 Controller Access Control Register", offset: "0x84", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "ECAP4_AC", description: "ECAP4 Controller Access Control Register", offset: "0x86", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "ECAP5_AC", description: "ECAP5 Controller Access Control Register", offset: "0x88", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "ECAP6_AC", description: "ECAP6 Controller Access Control Register", offset: "0x8A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "ECAP7_AC", description: "ECAP7 Controller Access Control Register", offset: "0x8C", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "SDFM1_AC", description: "SDFM1 Controller Access Control Register", offset: "0xA8", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "SDFM2_AC", description: "SDFM2 Controller Access Control Register", offset: "0xAA", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "SDFM3_AC", description: "SDFM3 Controller Access Control Register", offset: "0xAC", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "SDFM4_AC", description: "SDFM4 Controller Access Control Register", offset: "0xAE", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "CLB1_AC", description: "CLB1 Controller Access Control Register", offset: "0xB0", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
		]
	},
	{ name: "CLB2_AC", description: "CLB2 Controller Access Control Register", offset: "0xB2", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
		]
	},
	{ name: "CLB3_AC", description: "CLB3 Controller Access Control Register", offset: "0xB4", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
		]
	},
	{ name: "CLB4_AC", description: "CLB4 Controller Access Control Register", offset: "0xB6", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
		]
	},
	{ name: "CLB5_AC", description: "CLB5 Controller Access Control Register", offset: "0xB8", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
		]
	},
	{ name: "CLB6_AC", description: "CLB6 Controller Access Control Register", offset: "0xBA", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
		]
	},
	{ name: "SCIA_AC", description: "SCIA Controller Access Control Register", offset: "0x100", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "SCIB_AC", description: "SCIB Controller Access Control Register", offset: "0x102", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "SPIA_AC", description: "SPIA Controller Access Control Register", offset: "0x110", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "SPIB_AC", description: "SPIB Controller Access Control Register", offset: "0x112", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "SPIC_AC", description: "SPIC Controller Access Control Register", offset: "0x114", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "SPID_AC", description: "SPID Controller Access Control Register", offset: "0x116", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "I2CA_AC", description: "I2CA Controller Access Control Register", offset: "0x120", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "I2CB_AC", description: "I2CB Controller Access Control Register", offset: "0x122", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "PMBUS_A_AC", description: "PMBUSA Controller Access Control Register", offset: "0x130", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "LIN_A_AC", description: "LINA Controller Access Control Register", offset: "0x138", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "LIN_B_AC", description: "LINB Controller Access Control Register", offset: "0x13A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "DCANA_AC", description: "DCANA Controller Access Control Register", offset: "0x140", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
	},
	{ name: "MCANA_AC", description: "MCANA Controller Access Control Register", offset: "0x148", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
	},
	{ name: "MCANB_AC", description: "MCANB Controller Access Control Register", offset: "0x14A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
	},
	{ name: "FSIATX_AC", description: "FSIA Controller Access Control Register", offset: "0x158", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "FSIARX_AC", description: "FSIB Controller Access Control Register", offset: "0x15A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "FSIBTX_AC", description: "FSIC Controller Access Control Register", offset: "0x15C", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "FSIBRX_AC", description: "FSID Controller Access Control Register", offset: "0x15E", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "FSICRX_AC", description: "FSIB Controller Access Control Register", offset: "0x162", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "FSIDRX_AC", description: "FSID Controller Access Control Register", offset: "0x166", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "USBA_AC", description: "USBA Controller Access Control Register", offset: "0x18A", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
	},
	{ name: "HRPWM0_AC", description: "HRPWM Controller Access Control Register", offset: "0x1B2", size: "32",
		bits: [
	...
	{ name: "HRPWM1_AC", description: "HRPWM Controller Access Control Register", offset: "0x1B4", size: "32",
		bits: [
			{ name: "CPU1_ACC", description: "CPU1 Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "HRPWM2_AC", description: "HRPWM Controller Access Control Register", offset: "0x1B6", size: "32",
		bits: [
			{ name: "CPU1_ACC", description: "CPU1 Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "CLA1_ACC", description: "CLA1 Access Conditions to Peripheral", size: "2", shift: "2", mask: "0xC" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "ETHERCAT_AC", description: "ETHERCAT Controller Access Control Register", offset: "0x1B8", size: "32",
		bits: [
			{ name: "CPU1_ACC", description: "CPU1 Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
	},
	{ name: "AESA_AC", description: "AES Controller Access Control Register", offset: "0x1BC", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
	},
	{ name: "UARTA_AC", description: "UART Controller Access Control Register", offset: "0x1BE", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
	},
	{ name: "UARTB_AC", description: "UART Controller Access Control Register", offset: "0x1C0", size: "32",
		bits: [
			{ name: "CPUx_ACC", description: "CPUx Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
	...
	{ name: "ADCSOCOUTSELECT1", description: "External ADCSOC Select Register (PWM17-32)", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "SYNCSOCLOCK", description: "SYNCSEL and EXTADCSOC Select Lock register", offset: "0x6", size: "32",
		bits: [
	...
	{ name: "LFUConfig_CPU1", description: "LFU configuration Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "LFUStatus_CPU1", description: "LFU Configuration Status Register", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "SWConfig1_SYSRSn", description: "Spare registers reset by SYSRSn", offset: "0x10", size: "32",
		bits: [
		]
	},
	{ name: "SWConfig2_SYSRSn", description: "Spare registers reset by SYSRSn", offset: "0x12", size: "32",
		bits: [
		]
	},
	{ name: "SWConfig1_XRSn", description: "Spare registers reset by XRSn", offset: "0x14", size: "32",
		bits: [
		]
	},
	{ name: "SWConfig2_XRSn", description: "Spare registers reset by XRSn", offset: "0x16", size: "32",
		bits: [
		]
	},
	{ name: "SWConfig1_PORESETn", description: "Spare registers reset by PORESETn", offset: "0x18", size: "32",
		bits: [
		]
	},
	{ name: "SWConfig2_PORESETn", description: "Spare registers reset by PORESETn", offset: "0x1A", size: "32",
		bits: [
		]
	},
	{ name: "LFU_LOCK", description: "LFU Lock Configuration", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "LFU_COMMIT", description: "LFU Commit Configuration", offset: "0x1E", size: "32",
		bits: [
	...
	{ name: "LFUConfig_CPU2", description: "LFU configuration Register", offset: "0x0", size: "32",
		bits: [
			{ name: "LFU_CPU", description: "SW configuration to implement LFU", size: "1", shift: "0", mask: "0x1" },
			{ name: "PieVectorSwap", description: "Swap of pie vector table", size: "1", shift: "12", mask: "0x1000" },
	...
	{ name: "LFUStatus_CPU2", description: "LFU Configuration Status Register", offset: "0x2", size: "32",
		bits: [
			{ name: "PieVectorSwap", description: "Indicate the status of PieVectorSwap", size: "1", shift: "12", mask: "0x1000" },
			{ name: "D23Swap", description: "Indicate the status of D2/3 memory swap", size: "1", shift: "20", mask: "0x100000" },
		]
	},
	{ name: "SWConfig1_SYSRSn", description: "Spare registers reset by SYSRSn", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "SYS_ERR_INT_FLG", description: "Status of interrupts due to multiple different errors in the system.", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "SYS_ERR_INT_CLR", description: "SYS_ERR_INT_FLG clear register", offset: "0x12", size: "32",
		bits: [
	...
	{ name: "LCM_ERR_FLG", description: "Status register indicating lockstep compare error flag", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "LCM_ERR_FLG_CLR", description: "LCM_ERR_FLG clear register", offset: "0x1A", size: "32",
		bits: [
			{ name: "GERR", description: "Global Error event flag", size: "1", shift: "0", mask: "0x1" },
			{ name: "CPU", description: "CPU Lokstep Miscompare flag", size: "1", shift: "1", mask: "0x2" },
			{ name: "DMA", description: "DMA Lokstep Miscompare flag", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "LCM_ERR_FLG_SET", description: "LCM_ERR_FLG set register", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "LCM_ERR_FLG_MASK", description: "LCM_ERR_FLG mask register", offset: "0x1E", size: "32",
		bits: [
	...
	{ name: "REGPARITY_ERR_FLG", description: "Status register indicating register parity error flag", offset: "0x20", size: "32",
		bits: [
			{ name: "GERR", description: "Global Error event flag", size: "1", shift: "0", mask: "0x1" },
	...
	{ name: "REGPARITY_ERR_FLG_CLR", description: "REGPARITY_ERR_FLG clear register", offset: "0x22", size: "32",
		bits: [
	...
	{ name: "REGPARITY_ERR_FLG_SET", description: "REGPARITY_ERR_FLG set register", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "REGPARITY_ERR_FLG_MASK", description: "REGPARITY_ERR_FLG mask register", offset: "0x26", size: "32",
		bits: [
