let FSI_REGISTERS = [
	{ name: "TX_MASTER_CTRL", description: "Transmit main control register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "TX_PING_TO_REF", description: "Transmit ping timeout counter reference", offset: "0xC", size: "32",
		bits: [
		]
	},
	{ name: "TX_PING_TO_CNT", description: "Transmit ping timeout current count", offset: "0xE", size: "32",
		bits: [
		]
	},
	...
	{ name: "RX_MASTER_CTRL", description: "Receive main control register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "RX_FRAME_WD_REF", description: "Receive frame watchdog counter reference", offset: "0x12", size: "32",
		bits: [
		]
	},
	{ name: "RX_FRAME_WD_CNT", description: "Receive frame watchdog current count", offset: "0x14", size: "32",
		bits: [
		]
	},
	...
	{ name: "RX_PING_WD_REF", description: "Receive ping watchdog counter reference", offset: "0x18", size: "32",
		bits: [
		]
	},
	{ name: "RX_PING_WD_CNT", description: "Receive pingwatchdog current count", offset: "0x1A", size: "32",
		bits: [
		]
	},
	...
	{ name: "RX_ECC_SEC_DATA", description: "Receive ECC corrected data register", offset: "0x24", size: "32",
		bits: [
		]
	},
	...
	{ name: "RX_TRIG_WIDTH_0", description: "Receive Trigger Wdith register 0", offset: "0x2E", size: "32",
		bits: [
	...
	{ name: "RX_VIS_1", description: "Receive debug visibility register 1", offset: "0x38", size: "32",
		bits: [
