let EPG_REGISTERS = [
	{ name: "GCTL0", description: "EPG Global control register 0", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "GCTL1", description: "EPG Global control register 1", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "GCTL2", description: "EPG Global control register 2", offset: "0x4", size: "32",
		bits: [
			{ name: "EPGOUT0_CLKOUTSEL", description: "Selects the clock signal source of EPG output 0.", size: "3", shift: "0", mask: "0x7" },
			{ name: "EPGOUT1_CLKOUTSEL", description: "Selects the clock signal source of EPG output 1.", size: "3", shift: "4", mask: "0x70" },
			{ name: "EPGOUT2_CLKOUTSEL", description: "Selects the clock signal source of EPG output 2.", size: "3", shift: "8", mask: "0x700" },
			{ name: "EPGOUT3_CLKOUTSEL", description: "Selects the clock signal source of EPG output 3.", size: "3", shift: "12", mask: "0x7000" },
			{ name: "EPGOUT4_CLKOUTSEL", description: "Selects the clock signal source of EPG output 4.", size: "3", shift: "16", mask: "0x70000" },
			{ name: "EPGOUT5_CLKOUTSEL", description: "Selects the clock signal source of EPG output 5.", size: "3", shift: "20", mask: "0x700000" },
			{ name: "EPGOUT6_CLKOUTSEL", description: "Selects the clock signal source of EPG output 6.", size: "3", shift: "24", mask: "0x7000000" },
			{ name: "EPGOUT7_CLKOUTSEL", description: "Selects the clock signal source of EPG output 7.", size: "3", shift: "28", mask: "0x70000000" },
		]
	},
	{ name: "GCTL3", description: "EPG Global control register 3", offset: "0x6", size: "32",
		bits: [
	...
	{ name: "EPGLOCK", description: "EPG LOCK Register", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "EPGCOMMIT", description: "EPG COMMIT register", offset: "0xA", size: "32",
		bits: [
	...
	{ name: "GINTSTS", description: "EPG Global interrupt status register.", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "GINTEN", description: "EPG Global interrupt enable register.", offset: "0xE", size: "32",
		bits: [
	...
	{ name: "GINTCLR", description: "EPG Global interrupt clear register.", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "GINTFRC", description: "EPG Global interrupt force register.", offset: "0x12", size: "32",
		bits: [
	...
	{ name: "CLKDIV0_CTL0", description: "Clock divider 0's control register 0", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "CLKDIV0_CLKOFFSET", description: "Clock divider 0's clock offset value", offset: "0x1E", size: "32",
		bits: [
	...
	{ name: "CLKDIV1_CTL0", description: "Clock divider 1's control register 0", offset: "0x24", size: "32",
		bits: [
			{ name: "PRD", description: "Clock divider value", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "CLKSTOP", description: "Clock Stop Configuration", size: "3", shift: "16", mask: "0x70000" },
		]
	},
	{ name: "CLKDIV1_CLKOFFSET", description: "Clock divider 1's clock offset value", offset: "0x2A", size: "32",
		bits: [
			{ name: "CLK0OFFSET", description: "Clock output 0 offset delay value.", size: "8", shift: "0", mask: "0xFF" },
			{ name: "CLK1OFFSET", description: "Clock output 0 offset delay value.", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "CLK2OFFSET", description: "Clock output 0 offset delay value.", size: "8", shift: "16", mask: "0xFF0000" },
	...
	{ name: "SIGGEN0_CTL0", description: "Signal generator 0's control register 0", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "SIGGEN0_CTL1", description: "Signal generator 0's control register 1", offset: "0x32", size: "32",
		bits: [
	...
	{ name: "SIGGEN0_DATA0", description: "Signal generator 0's data register 0", offset: "0x38", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA1", description: "Signal generator 0's data register 1", offset: "0x3A", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA0_ACTIVE", description: "Signal generator 0's data active register 0", offset: "0x3C", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA1_ACTIVE", description: "Signal generator 0's data active register 1", offset: "0x3E", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN1_CTL0", description: "Signal generator 1's control register 0", offset: "0x40", size: "32",
		bits: [
			{ name: "MODE", description: "Signal generator modes", size: "4", shift: "0", mask: "0xF" },
			{ name: "BRIN", description: "Reverse bits before transform", size: "1", shift: "5", mask: "0x20" },
			{ name: "BROUT", description: "Reverse bits after transform", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SIGGEN1_CTL1", description: "Signal generator 1's control register 1", offset: "0x42", size: "32",
		bits: [
			{ name: "DATA0_INSEL", description: "Select the source of DATA[0] bit.", size: "4", shift: "0", mask: "0xF" },
			{ name: "DATA63_INSEL", description: "Select the source of DATA[63] bit.", size: "4", shift: "28", mask: "0xF0000000" },
		]
	},
	{ name: "SIGGEN1_DATA0", description: "Signal generator 1's data register 0", offset: "0x48", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN1_DATA1", description: "Signal generator 1's data register 1", offset: "0x4A", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN1_DATA0_ACTIVE", description: "Signal generator 1's data active register 0", offset: "0x4C", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN1_DATA1_ACTIVE", description: "Signal generator 1's data active register 1", offset: "0x4E", size: "32",
		bits: [
		]
	},
	{ name: "REVISION", description: "IP Revision tie-off value", offset: "0x50", size: "32",
		bits: [
	...
	{ name: "EPGMXSEL0", description: "EPG Mux select register 0", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "EPGMXSEL1", description: "EPG Mux select register 1", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "EPGMXSELLOCK", description: "EPG Mux select register lock", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "EPGMXSELCOMMIT", description: "EPG Mux select register commit", offset: "0xE", size: "32",
		bits: [
