let INPUT_XBAR_REGISTERS = [
	{ name: "INPUTSELECTLOCK1", description: "Input Select Lock Register 1", offset: "0x340", size: "32",
		bits: [
	...
	{ name: "INPUTSELECTLOCK2", description: "Input Select Lock Register 2", offset: "0x342", size: "32",
		bits: [
