let DCSM_REGISTERS = [
	...
	{ name: "Z2_BOOTDEF_HIGH", description: "Boot definition (high 32bit)", offset: "0x4", size: "32",
		bits: [
		]
	},
	...
	{ name: "Z2_BOOTPIN_CONFIG", description: "Boot Pin Configuration", offset: "0x8", size: "32",
		bits: [
		]
	},
	{ name: "Z2_GPREG2", description: "Zone2 General Purpose Register-2", offset: "0xA", size: "32",
		bits: [
		]
	},
	{ name: "Z2_BOOTDEF_LOW", description: "Boot definition (low 32bit)", offset: "0xC", size: "32",
		bits: [
		]
	},
