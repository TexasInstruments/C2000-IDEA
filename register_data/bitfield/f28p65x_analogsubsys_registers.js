let ANALOGSUBSYS_REGISTERS = [
	...
	{ name: "CMPHPMXSEL1", description: "Bits to select one of the many sources on CopmHP inputs. Refer to Pimux diagram for details.", offset: "0x90", size: "32",
		bits: [
			{ name: "CMP11HPMXSEL", description: "CMP15HPMXSEL bits", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "CMPLPMXSEL1", description: "Bits to select one of the many sources on CopmLP inputs. Refer to Pimux diagram for details.", offset: "0x92", size: "32",
		bits: [
			{ name: "CMP11LPMXSEL", description: "CMP15LPMXSEL bits", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "ADCSOCFRCGB", description: "ADC Global SOC Force", offset: "0x10E", size: "32",
		bits: [
	...
	{ name: "ADCSOCFRCGBSEL", description: "ADC Global SOC Force Select", offset: "0x110", size: "16",
		bits: [
	...
	{ name: "AGPIOFILTER", description: "AGPIO Filter Control Register", offset: "0x111", size: "16",
		bits: [
	...
	{ name: "AGPIOCTRLG", description: "AGPIO Control Register", offset: "0x120", size: "32",
		bits: [
	...
	{ name: "AGPIOCTRLH", description: "AGPIO Control Register", offset: "0x122", size: "32",
		bits: [
	...
	{ name: "GPIOINENACTRL", description: "GPIOINENACTRL Control Register", offset: "0x134", size: "32",
		bits: [
