let XBAR_REGISTERS = [
	...
	{ name: "XBARCLR1", description: "X-Bar Input Flag Clear Register 1", offset: "0xA", size: "32",
		bits: [
	...
	{ name: "XBARCLR2", description: "X-Bar Input Flag Clear Register 2", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "XBARCLR3", description: "X-Bar Input Flag Clear Register 3", offset: "0xE", size: "32",
		bits: [
	...
	{ name: "XBARCLR4", description: "X-Bar Input Flag Clear Register 4", offset: "0x10", size: "32",
		bits: [
			{ name: "ERRORSTS_ERROR", description: "Input Flag clear for ERRORSTS_ERROR Signal", size: "1", shift: "28", mask: "0x10000000" },
		]
	},
	{ name: "XBARCLR5", description: "X-Bar Input Flag Clear Register 5", offset: "0x12", size: "32",
		bits: [
