let XBAR_REGISTERS = [
	...
	{ name: "XBARFLG4", description: "X-Bar Input Flag Register 4", offset: "0x6", size: "32",
		bits: [
			...
			{ name: "CLB7_OUT4", description: "Input Flag for CLB7_4.1 Signal", size: "1", shift: "12", mask: "0x1000" },
			{ name: "CLB7_OUT5", description: "Input Flag for CLB7_5.1 Signal", size: "1", shift: "13", mask: "0x2000" },
			{ name: "CLB8_OUT4", description: "Input Flag for CLB8_4.1 Signal", size: "1", shift: "14", mask: "0x4000" },
			{ name: "CLB8_OUT5", description: "Input Flag for CLB8_5.1 Signal", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "XBARCLR4", description: "X-Bar Input Flag Clear Register 4", offset: "0xE", size: "32",
		bits: [
			...
			{ name: "EMAC_PPS0", description: "Input Flag clear for EMAC_PPS0 Signal", size: "1", shift: "8", mask: "0x100" },
			...
			{ name: "CLB7_OUT4", description: "Input Flag clear for CLB7_OUT4 Signal", size: "1", shift: "12", mask: "0x1000" },
			{ name: "CLB7_OUT5", description: "Input Flag clear for CLB7_OUT5 Signal", size: "1", shift: "13", mask: "0x2000" },
			{ name: "CLB8_OUT4", description: "Input Flag clear for CLB8_OUT4 Signal", size: "1", shift: "14", mask: "0x4000" },
			{ name: "CLB8_OUT5", description: "Input Flag clear for CLB8_OUT5 Signal", size: "1", shift: "15", mask: "0x8000" },
