let ANALOGSUBSYS_REGISTERS = [
	{ name: "INTERNALTESTCTL", description: "INTERNALTEST Node Control Register", offset: "0x4A", size: "32",
		bits: [
	...
	{ name: "CONFIGLOCK", description: "Lock Register for all the config registers.", offset: "0x5E", size: "32",
		bits: [
	...
	{ name: "TSNSCTL", description: "Temperature Sensor Control Register", offset: "0x60", size: "16",
		bits: [
			{ name: "ENABLE", description: "Temperature Sensor Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "ANAREFPCTL", description: "Analog Reference Control Register for VREFHI", offset: "0x68", size: "16",
		bits: [
	...
	{ name: "ANAREFNCTL", description: "Analog Reference Control Register for VREFLO", offset: "0x69", size: "16",
		bits: [
	...
	{ name: "VMONCTL", description: "Voltage Monitor Control Register", offset: "0x70", size: "16",
		bits: [
			{ name: "BORLVMONDIS", description: "Disable BORL(ow) feature on VDDIO", size: "1", shift: "8", mask: "0x100" },
		]
	},
	{ name: "CMPHPMXSEL", description: "Bits to select one of the many sources on CompHP inputs. Refer to Pimux diagram for details.", offset: "0x82", size: "32",
		bits: [
	...
	{ name: "CMPLPMXSEL", description: "Bits to select one of the many sources on CompLP inputs. Refer to Pimux diagram for details.", offset: "0x84", size: "32",
		bits: [
	...
	{ name: "CMPHNMXSEL", description: "Bits to select one of the many sources on CompHN inputs. Refer to Pimux diagram for details.", offset: "0x86", size: "16",
		bits: [
	...
	{ name: "CMPLNMXSEL", description: "Bits to select one of the many sources on CompLN inputs. Refer to Pimux diagram for details.", offset: "0x87", size: "16",
		bits: [
	...
	{ name: "ADCDACLOOPBACK", description: "Enabble loopback from DAC to ADCs", offset: "0x88", size: "32",
		bits: [
	...
	{ name: "CMPSSCTL", description: "CMPSS Control Register", offset: "0x8B", size: "16",
		bits: [
			{ name: "CMP1LDACOUTEN", description: "Enable general purpose DAC functionality for CMPSS1.COMPDACL", size: "1", shift: "0", mask: "0x1" },
			{ name: "CMPSSCTLEN", description: "Enable the CMPSSCTL Register", size: "1", shift: "15", mask: "0x8000" },
		]
	},
	{ name: "CMPSSDACBUFCONFIG", description: "Config bits for CMPSS DAC buffer", offset: "0x8C", size: "32",
		bits: [
			{ name: "CMPSSADACL", description: "Configuration bits for CMPSS DACA", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "LOCK", description: "Lock Register", offset: "0x8E", size: "32",
		bits: [
	...
	{ name: "AGPIOFILTER", description: "AGPIO Filter Control Register", offset: "0x108", size: "16",
		bits: [
	...
	{ name: "AGPIOCTRLA", description: "AGPIO Control Register", offset: "0x10A", size: "32",
		bits: [
	...
	{ name: "AGPIOCTRLB", description: "AGPIO Control Register", offset: "0x10C", size: "32",
		bits: [
			{ name: "GPIO33", description: "AGPIOCTRL for GPIO33", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "AGPIOCTRLG", description: "AGPIO Control Register", offset: "0x116", size: "32",
		bits: [
	...
	{ name: "AGPIOCTRLH", description: "AGPIO Control Register", offset: "0x118", size: "32",
		bits: [
	...
	{ name: "GPIOINENACTRL", description: "GPIOINENACTRL Control Register", offset: "0x132", size: "32",
		bits: [
	...
	{ name: "IO_DRVSEL", description: "IO Drive strength select register", offset: "0x134", size: "16",
		bits: [
	...
	{ name: "IO_MODESEL", description: "IO Mode select register", offset: "0x135", size: "16",
		bits: [
	...
	{ name: "ADCSOCFRCGB", description: "ADC Global SOC Force", offset: "0x136", size: "32",
		bits: [
	...
	{ name: "ADCSOCFRCGBSEL", description: "ADC Global SOC Force Select", offset: "0x138", size: "16",
		bits: [
