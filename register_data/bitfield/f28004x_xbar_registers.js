let XBAR_REGISTERS = [
	...
	{ name: "XBARFLG4", description: "X-Bar Input Flag Register 4", offset: "0x6", size: "32",
		bits: [
			...
			{ name: "EMAC_PPS0", description: "Input Flag for EMAC_PPS0 Signal", size: "1", shift: "8", mask: "0x100" },
			...
			{ name: "CLB7_4_1", description: "Input Flag for CLB7_4.1 Signal", size: "1", shift: "12", mask: "0x1000" },
			{ name: "CLB7_5_1", description: "Input Flag for CLB7_5.1 Signal", size: "1", shift: "13", mask: "0x2000" },
			{ name: "CLB8_4_1", description: "Input Flag for CLB8_4.1 Signal", size: "1", shift: "14", mask: "0x4000" },
			{ name: "CLB8_5_1", description: "Input Flag for CLB8_5.1 Signal", size: "1", shift: "15", mask: "0x8000" },
			{ name: "CLB1_OUT4", description: "Input Flag for CLB1_OUT4 Signal", size: "1", shift: "16", mask: "0x10000" },
			{ name: "CLB1_OUT5", description: "Input Flag for CLB1_OUT5 Signal", size: "1", shift: "17", mask: "0x20000" },
			{ name: "CLB2_OUT4", description: "Input Flag for CLB2_OUT4 Signal", size: "1", shift: "18", mask: "0x40000" },
			{ name: "CLB2_OUT5", description: "Input Flag for CLB2_OUT5 Signal", size: "1", shift: "19", mask: "0x80000" },
			{ name: "CLB3_OUT4", description: "Input Flag for CLB3_OUT4 Signal", size: "1", shift: "20", mask: "0x100000" },
			{ name: "CLB3_OUT5", description: "Input Flag for CLB3_OUT5 Signal", size: "1", shift: "21", mask: "0x200000" },
			{ name: "CLB4_OUT4", description: "Input Flag for CLB4_OUT4 Signal", size: "1", shift: "22", mask: "0x400000" },
			{ name: "CLB4_OUT5", description: "Input Flag for CLB4_OUT5 Signal", size: "1", shift: "23", mask: "0x800000" },
	...
	{ name: "XBARCLR4", description: "X-Bar Input Flag Clear Register 4", offset: "0xE", size: "32",
		bits: [
			...
			{ name: "CLB7_4_1", description: "Input Flag clear for CLB7_4_1 Signal", size: "1", shift: "12", mask: "0x1000" },
			{ name: "CLB7_5_1", description: "Input Flag clear for CLB7_5_1 Signal", size: "1", shift: "13", mask: "0x2000" },
			{ name: "CLB8_4_1", description: "Input Flag clear for CLB8_4_1 Signal", size: "1", shift: "14", mask: "0x4000" },
			{ name: "CLB8_5_1", description: "Input Flag clear for CLB8_5_1 Signal", size: "1", shift: "15", mask: "0x8000" },
			{ name: "CLB1_OUT4", description: "Input Flag clear for CLB1_OUT4 Signal", size: "1", shift: "16", mask: "0x10000" },
			{ name: "CLB1_OUT5", description: "Input Flag clear for CLB1_OUT5 Signal", size: "1", shift: "17", mask: "0x20000" },
			{ name: "CLB2_OUT4", description: "Input Flag clear for CLB2_OUT4 Signal", size: "1", shift: "18", mask: "0x40000" },
			{ name: "CLB2_OUT5", description: "Input Flag clear for CLB2_OUT5 Signal", size: "1", shift: "19", mask: "0x80000" },
			{ name: "CLB3_OUT4", description: "Input Flag clear for CLB3_OUT4 Signal", size: "1", shift: "20", mask: "0x100000" },
			{ name: "CLB3_OUT5", description: "Input Flag clear for CLB3_OUT5 Signal", size: "1", shift: "21", mask: "0x200000" },
			{ name: "CLB4_OUT4", description: "Input Flag clear for CLB4_OUT4 Signal", size: "1", shift: "22", mask: "0x400000" },
			{ name: "CLB4_OUT5", description: "Input Flag clear for CLB4_OUT5 Signal", size: "1", shift: "23", mask: "0x800000" },
