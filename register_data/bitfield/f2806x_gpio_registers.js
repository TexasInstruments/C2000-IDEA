let GPIO_REGISTERS = [
	...
	{ name: "GPADIR", description: "", offset: "0xA", size: "32",
		bits: [
	...
	{ name: "GPACTRL2", description: "GPIO A Control Register 2", offset: "0xE", size: "16",
		bits: [
			{ name: "USB0IOEN", description: "USB I/O Enable Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "GPBCTRL", description: "", offset: "0x10", size: "32",
		bits: [
			{ name: "QUALPRD0", description: "GPIO32 to 39 Qual Cycles", size: "8", shift: "0", mask: "0xFF" },
			{ name: "QUALPRD1", description: "GPIO40 to 47 Qual Cycles", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "QUALPRD2", description: "GPIO48 to 55 Qual Cycles", size: "8", shift: "16", mask: "0xFF0000" },
			{ name: "QUALPRD3", description: "GPIO56 to 63 Qual Cycles", size: "8", shift: "24", mask: "0xFF000000" },
		]
	},
	...
	{ name: "GPBDIR", description: "", offset: "0x1A", size: "32",
		bits: [
			...
			{ name: "GPIO41", description: "GPIO41 Data", size: "1", shift: "9", mask: "0x200" },
			{ name: "GPIO42", description: "GPIO42 Data", size: "1", shift: "10", mask: "0x400" },
			{ name: "GPIO43", description: "GPIO43 Data", size: "1", shift: "11", mask: "0x800" },
			{ name: "GPIO44", description: "GPIO44 Data", size: "1", shift: "12", mask: "0x1000" },
			{ name: "GPIO50", description: "GPIO50 Data", size: "1", shift: "18", mask: "0x40000" },
			{ name: "GPIO51", description: "GPIO51 Data", size: "1", shift: "19", mask: "0x80000" },
			{ name: "GPIO52", description: "GPIO52 Data", size: "1", shift: "20", mask: "0x100000" },
			{ name: "GPIO53", description: "GPIO53 Data", size: "1", shift: "21", mask: "0x200000" },
			{ name: "GPIO54", description: "GPIO54 Data", size: "1", shift: "22", mask: "0x400000" },
			{ name: "GPIO55", description: "GPIO55 Data", size: "1", shift: "23", mask: "0x800000" },
			{ name: "GPIO56", description: "GPIO56 Data", size: "1", shift: "24", mask: "0x1000000" },
			{ name: "GPIO57", description: "GPIO57 Data", size: "1", shift: "25", mask: "0x2000000" },
			{ name: "GPIO58", description: "GPIO58 Data", size: "1", shift: "26", mask: "0x4000000" },
		]
	},
	...
	{ name: "AIOMUX1", description: "Analog IO Mux 1 Register", offset: "0x36", size: "32",
		bits: [
	...
	{ name: "AIODIR", description: "Analog IO Direction Register", offset: "0x3A", size: "32",
		bits: [
	...
	{ name: "AIODAT", description: "Analog IO Data Register (AIO0 to 15)", offset: "0x18", size: "32",
		bits: [
			{ name: "AIO2", description: "AIO2", size: "1", shift: "2", mask: "0x4" },
			{ name: "AIO4", description: "AIO4", size: "1", shift: "4", mask: "0x10" },
			{ name: "AIO6", description: "AIO6", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "AIOSET", description: "", offset: "0x1A", size: "32",
		bits: [
			{ name: "AIO2", description: "AIO2", size: "1", shift: "2", mask: "0x4" },
			{ name: "AIO4", description: "AIO4", size: "1", shift: "4", mask: "0x10" },
			{ name: "AIO6", description: "AIO6", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "AIOCLEAR", description: "", offset: "0x1C", size: "32",
		bits: [
			{ name: "AIO2", description: "AIO2", size: "1", shift: "2", mask: "0x4" },
			{ name: "AIO4", description: "AIO4", size: "1", shift: "4", mask: "0x10" },
			{ name: "AIO6", description: "AIO6", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "AIOTOGGLE", description: "", offset: "0x1E", size: "32",
		bits: [
			{ name: "AIO2", description: "AIO2", size: "1", shift: "2", mask: "0x4" },
			{ name: "AIO4", description: "AIO4", size: "1", shift: "4", mask: "0x10" },
			{ name: "AIO6", description: "AIO6", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "GPIOXINT1SEL", description: "", offset: "0x0", size: "16",
		bits: [
			{ name: "GPIOSEL", description: "Select GPIO Interrupt Input Source", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "GPIOXINT2SEL", description: "", offset: "0x1", size: "16",
		bits: [
			{ name: "GPIOSEL", description: "Select GPIO Interrupt Input Source", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "GPIOXINT3SEL", description: "", offset: "0x2", size: "16",
		bits: [
			{ name: "GPIOSEL", description: "Select GPIO Interrupt Input Source", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "GPIOLPMSEL", description: "", offset: "0x8", size: "32",
		bits: [
			{ name: "GPIO0", description: "GPIO0 Data", size: "1", shift: "0", mask: "0x1" },
			{ name: "GPIO1", description: "GPIO1 Data", size: "1", shift: "1", mask: "0x2" },
			{ name: "GPIO2", description: "GPIO2 Data", size: "1", shift: "2", mask: "0x4" },
