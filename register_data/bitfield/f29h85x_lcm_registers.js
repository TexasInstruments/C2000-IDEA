let LCM_REGISTERS = [
	...
	{ name: "LCM_CONTROL", description: "LCM Control configuration", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "LCM_STATUS", description: "LCM status register", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "LCM_STATUS_CLEAR", description: "LCM Status clear register", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "PARITY_TEST", description: "Enabling the parity test feature", offset: "0x68", size: "32",
		bits: [
			{ name: "TESTEN", description: "Parity test enable configuration", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "LCM_LOCK", description: "LCM lock configuration", offset: "0x70", size: "32",
		bits: [
	...
	{ name: "LCM_COMMIT", description: "LCM commit configuration", offset: "0x78", size: "32",
		bits: [
