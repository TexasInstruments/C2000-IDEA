let MEMCONFIG_REGISTERS = [
	...
	{ name: "LSxTEST", description: "Local Shared RAM TEST Register", offset: "0x2E", size: "32",
		bits: [
	...
	{ name: "LSxINIT", description: "Local Shared RAM Init Register", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "LSxINITDONE", description: "Local Shared RAM InitDone Status Register", offset: "0x32", size: "32",
		bits: [
	...
	{ name: "LSxRAMTEST_LOCK", description: "Lock register to LSx RAM TEST registers", offset: "0x34", size: "32",
		bits: [
	...
	{ name: "GSxLOCK", description: "Global Shared RAM Config Lock Register", offset: "0x3E", size: "32",
		bits: [
	...
	{ name: "GSxCOMMIT", description: "Global Shared RAM Config Lock Commit Register", offset: "0x40", size: "32",
		bits: [
	...
	{ name: "GSxACCPROT0", description: "Global Shared RAM Config Register 0", offset: "0x46", size: "32",
		bits: [
	...
	{ name: "GSxTEST", description: "Global Shared RAM TEST Register", offset: "0x4E", size: "32",
		bits: [
	...
	{ name: "GSxINIT", description: "Global Shared RAM Init Register", offset: "0x50", size: "32",
		bits: [
	...
	{ name: "GSxINITDONE", description: "Global Shared RAM InitDone Status Register", offset: "0x52", size: "32",
		bits: [
	...
	{ name: "GSxRAMTEST_LOCK", description: "Lock register to GSx RAM TEST registers", offset: "0x54", size: "32",
		bits: [
	...
	{ name: "MSGxLOCK", description: "Message RAM Config Lock Register", offset: "0x5E", size: "32",
		bits: [
	...
	{ name: "MSGxCOMMIT", description: "Message RAM Config Lock Commit Register", offset: "0x60", size: "32",
		bits: [
	...
	{ name: "MSGxTEST", description: "Message RAM TEST Register", offset: "0x6E", size: "32",
		bits: [
	...
	{ name: "MSGxINIT", description: "Message RAM Init Register", offset: "0x70", size: "32",
		bits: [
	...
	{ name: "MSGxINITDONE", description: "Message RAM InitDone Status Register", offset: "0x72", size: "32",
		bits: [
	...
	{ name: "MSGxRAMTEST_LOCK", description: "Lock register for MSGx RAM TEST Register", offset: "0x74", size: "32",
		bits: [
	...
	{ name: "ROM_LOCK", description: "ROM Config Lock Register", offset: "0x9E", size: "32",
		bits: [
	...
	{ name: "ROM_TEST", description: "ROM  TEST Register", offset: "0xA0", size: "32",
		bits: [
	...
	{ name: "ROM_FORCE_ERROR", description: "ROM Force Error register", offset: "0xA2", size: "32",
		bits: [
