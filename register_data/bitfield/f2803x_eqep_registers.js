let EQEP_REGISTERS = [
	...
	{ name: "QDECCTL", description: "Quadrature decoder control", offset: "0x14", size: "16",
		bits: [
			{ name: "QSP", description: "QSP:1;              //5   QEPS input polarity", size: "1", shift: "5", mask: "0x20" },
			{ name: "QIP", description: "QIP:1;              //6   QEPI input polarity", size: "1", shift: "6", mask: "0x40" },
			{ name: "QBP", description: "QBP:1;              //7   QEPB input polarity", size: "1", shift: "7", mask: "0x80" },
			{ name: "QAP", description: "QAP:1;              //8   QEPA input polarity", size: "1", shift: "8", mask: "0x100" },
			{ name: "IGATE", description: "IGATE:1;            //9   Index pulse gating option", size: "1", shift: "9", mask: "0x200" },
			{ name: "SWAP", description: "SWAP:1;             //10  CLK/DIR signal source for Position Counter", size: "1", shift: "10", mask: "0x400" },
			{ name: "XCR", description: "XCR:1;              //11  External clock rate", size: "1", shift: "11", mask: "0x800" },
			{ name: "SPSEL", description: "SPSEL:1;            //12  Sync output pin select", size: "1", shift: "12", mask: "0x1000" },
			{ name: "SOEN", description: "SOEN:1;             //13  Enable position compare sync", size: "1", shift: "13", mask: "0x2000" },
			{ name: "QSRC", description: "QSRC:2;             //15:14  Position counter source", size: "2", shift: "14", mask: "0xC000" },
		]
	},
