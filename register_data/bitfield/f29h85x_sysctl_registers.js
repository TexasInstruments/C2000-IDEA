let SYSCTL_REGISTERS = [
	{ name: "FRAMESEL:3", description: "2:0 FRAMESEL Selection for Peripheral Instance", offset: "0x0", size: "16",
		bits: [
		]
	},
	{ name: "CPUSEL:3", description: "5:3 CPUSEL Selection for Peripheral Instance", offset: "0x1", size: "16",
		bits: [
		]
	},
	{ name: "STANDBYEN:1", description: "6 STANDBYEN to enable peripheral clock gating based on CPUx", offset: "0x2", size: "16",
		bits: [
		]
	},
	{ name: "DBGHALTEN:1", description: "7 DBGHALTEN to enable peripheral clock gating based on CPUx", offset: "0x3", size: "16",
		bits: [
		]
	},
	{ name: "DEVCFGLOCK1", description: "Lock bit for PERxSYSCONFIG0-31 registers", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "DEVCFGLOCK2", description: "Lock bit for DEVCFG registers", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "DEVCFGLOCK3", description: "Lock bit for PERxSYSCONFIG32-63 registers", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "DEVCFGLOCK4", description: "Lock bit for PERxSYSCONFIG64-95 registers", offset: "0x6", size: "32",
		bits: [
	...
	{ name: "DEVCFGLOCK5", description: "Lock bit for PERxSYSCONFIG96-127 registers", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "PARTIDL", description: "Lower 32-bit of Device PART Identification Number", offset: "0x16", size: "32",
		bits: [
	...
	{ name: "PARTIDH", description: "Upper 32-bit of Device PART Identification Number", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "REVID", description: "Device Revision Number", offset: "0x1A", size: "32",
		bits: [
			{ name: "REVID", description: "Device Revision ID. This is specific to the Device", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "MCUCNF1", description: "MCUCNF Capability: EMIF Customization", offset: "0x1B0", size: "32",
		bits: [
			{ name: "EMIF1", description: "EMIF1 Present", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "MCUCNF2", description: "MCUCNF Capability: EPWM", offset: "0x1B2", size: "32",
		bits: [
	...
	{ name: "MCUCNF4", description: "MCUCNF Capability: EQEP", offset: "0x1B8", size: "32",
		bits: [
	...
	{ name: "MCUCNF7", description: "MCUCNF Capability: SCI, UART", offset: "0x1C2", size: "32",
		bits: [
	...
	{ name: "MCUCNF10", description: "MCUCNF Capability: CAN, MCAN", offset: "0x1CC", size: "32",
		bits: [
	...
	{ name: "MCUCNF13", description: "MCUCNF Capability: AMCUCNF", offset: "0x1D6", size: "32",
		bits: [
	...
	{ name: "MCUCNF14", description: "MCUCNF Capability: CMPSS", offset: "0x1D8", size: "32",
		bits: [
	...
	{ name: "MCUCNF16", description: "MCUCNF Capability: DAC", offset: "0x1DE", size: "32",
		bits: [
	...
	{ name: "MCUCNF17", description: "MCUCNF Capability: CLB", offset: "0x1E0", size: "32",
		bits: [
	...
	{ name: "MCUCNF18", description: "MCUCNF Capability: FSI", offset: "0x1E2", size: "32",
		bits: [
	...
	{ name: "MCUCNF19", description: "MCUCNF Capability: LIN", offset: "0x1E4", size: "32",
		bits: [
			{ name: "LIN_A", description: "LIN_A Present", size: "1", shift: "0", mask: "0x1" },
			{ name: "LIN_B", description: "LIN_B Present", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "MCUCNF23", description: "MCUCNF Capability: EtherCAT", offset: "0x1F2", size: "32",
		bits: [
			{ name: "ETHERCAT", description: "ETHERCAT", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "MCUCNF26", description: "Device Capability: HSM-Crypto Engines AES, SHA, PKA, TRNG", offset: "0x1FC", size: "32",
		bits: [
	...
	{ name: "MCUCNF31", description: "Device Capability: HSM-Crypto Engines SM2, SM3, SM4", offset: "0x20E", size: "32",
		bits: [
	...
	{ name: "MCUCNF64", description: "MCUCNF Capability: MCUCNF level, Processing Block, RTDMA Customization", offset: "0x290", size: "32",
		bits: [
	...
	{ name: "MCUCNF65", description: "MCUCNF Capability: On-chip SRAM Customization", offset: "0x292", size: "32",
		bits: [
	...
	{ name: "MCUCNF74", description: "MCUCNF Capability: FLC1.B0/B1", offset: "0x2B4", size: "32",
		bits: [
	...
	{ name: "MCUCNF76", description: "MCUCNF Capability: FLC1.B2/B3", offset: "0x2BA", size: "32",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCUCNF78", description: "MCUCNF Capability: FLC1.B4 256KB Data Flash", offset: "0x2C0", size: "32",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCUCNF79", description: "MCUCNF Capability: FLC2.B0/B1", offset: "0x2C2", size: "32",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCUCNF81", description: "MCUCNF Capability: FLC2.B2/B3", offset: "0x2C8", size: "32",
		bits: [
			{ name: "SECT15_0", description: "Flash sectors 15_0 present", size: "1", shift: "0", mask: "0x1" },
			{ name: "SECT31_16", description: "Flash sectors 31_16 present", size: "1", shift: "1", mask: "0x2" },
			{ name: "SECT47_32", description: "Flash sectors 47_32 present", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "MCUCNFLOCK1", description: "Lock bit for MCUCNFx registers", offset: "0x302", size: "32",
		bits: [
	...
	{ name: "MCUCNFLOCK3", description: "Lock bit for MCUCNFx registers", offset: "0x308", size: "32",
		bits: [
	...
	{ name: "LSEN", description: "Lockstep enable configuration", offset: "0x30A", size: "32",
		bits: [
	...
	{ name: "EPWMXLINKCFG", description: "Confugure which EPWM module instaces are linked in the XLINK scheme", offset: "0x33C", size: "32",
		bits: [
	...
	{ name: "SICCONFIG", description: "Safety Interconnect(SIC) Configuration - Enable and READY TIMEOUT value", offset: "0x342", size: "32",
		bits: [
	...
	{ name: "RSTSTAT", description: "Reset Status register for secondary CPUs", offset: "0x36C", size: "32",
		bits: [
	...
	{ name: "LPMSTAT", description: "LPM Status Register for secondary CPUs", offset: "0x36E", size: "32",
		bits: [
	...
	{ name: "TAP_STATUS", description: "Status of JTAG State machine & Debugger Connect", offset: "0x384", size: "32",
		bits: [
	...
	{ name: "TAP_CONTROL", description: "Disable TAP control", offset: "0x386", size: "32",
		bits: [
	...
	{ name: "DEVLIFECYCLE", description: "Reflect the state of the Device Life Cycle signals reported from the HSM", offset: "0x388", size: "32",
		bits: [
			{ name: "DEVTYPE", description: "These bits reflect the state from HSM DEVICE_TYPE", size: "4", shift: "0", mask: "0xF" },
			{ name: "HSSUBTYPE", description: "These bits reflect the state from the HSM HS_SUBTYPE", size: "4", shift: "8", mask: "0xF00" },
			{ name: "OVRFLASH", description: "Status of Override mode with access to Flash", size: "1", shift: "16", mask: "0x10000" },
			{ name: "OVRNOFLASH", description: "Status of Override mode with no access to Flash", size: "1", shift: "17", mask: "0x20000" },
		]
	},
	{ name: "SDFMTYPE", description: "Configures SDFM Type for the device", offset: "0x42E", size: "32",
		bits: [
	...
	{ name: "SYNCSELECT", description: "Sync Input and Output Select Register", offset: "0x45C", size: "32",
		bits: [
			{ name: "SYNCOUT", description: "Select Syncout Source", size: "5", shift: "24", mask: "0x1F000000" },
		]
	},
	{ name: "ADCSOCOUTSELECT", description: "External ADCSOC Select Register (PWM1-16)", offset: "0x45E", size: "32",
		bits: [
	...
	{ name: "ADCSOCOUTSELECT1", description: "External ADCSOC Select Register (PWM17-32)", offset: "0x460", size: "32",
		bits: [
	...
	{ name: "SYNCSOCLOCK", description: "SYNCSEL and ADCSOC Select Lock register", offset: "0x462", size: "32",
		bits: [
	...
	{ name: "HSMTOCPU_STS1", description: "HSM to C29x Signal Status1", offset: "0x484", size: "32",
		bits: [
			{ name: "SRAM_BANK0", description: "HSM to CPU USURP Communication Signal for SRAM_BANK0", size: "1", shift: "0", mask: "0x1" },
			{ name: "SRAM_BANK1", description: "HSM to CPU USURP Communication Signal for SRAM_BANK1", size: "1", shift: "1", mask: "0x2" },
			{ name: "SRAM_BANK2", description: "HSM to CPU USURP Communication Signal for SRAM_BANK2", size: "1", shift: "2", mask: "0x4" },
			{ name: "SRAM_BANK3", description: "HSM to CPU USURP Communication Signal for SRAM_BANK3", size: "1", shift: "3", mask: "0x8" },
			{ name: "SRAM_BANK4", description: "HSM to CPU USURP Communication Signal for SRAM_BANK4", size: "1", shift: "4", mask: "0x10" },
			{ name: "SRAM_BANK5", description: "HSM to CPU USURP Communication Signal for SRAM_BANK5", size: "1", shift: "5", mask: "0x20" },
			{ name: "SRAM_BANK6", description: "HSM to CPU USURP Communication Signal for SRAM_BANK6", size: "1", shift: "6", mask: "0x40" },
			{ name: "SRAM_BANK7", description: "HSM to CPU USURP Communication Signal for SRAM_BANK7", size: "1", shift: "7", mask: "0x80" },
			{ name: "FLC1", description: "HSM to CPU USURP Communication Signal for FLC1", size: "1", shift: "8", mask: "0x100" },
			{ name: "FLC2", description: "HSM to CPU USURP Communication Signal for FLC2", size: "1", shift: "9", mask: "0x200" },
			{ name: "LPOST", description: "HSM to CPU USURP Communication Signal for LPOST", size: "1", shift: "10", mask: "0x400" },
			{ name: "MPOST", description: "HSM to CPU USURP Communication Signal for MPOST", size: "1", shift: "11", mask: "0x800" },
			{ name: "SOC_GENR_1", description: "HSM to CPU USURP Communication Signal for SOC_GENR_1", size: "8", shift: "16", mask: "0xFF0000" },
			{ name: "SOC_GENR_2", description: "HSM to CPU USURP Communication Signal for SOC_GENR_2", size: "8", shift: "24", mask: "0xFF000000" },
		]
	},
	{ name: "HSMTOCPU_STS2", description: "HSM to C29x Signal Status2", offset: "0x486", size: "32",
		bits: [
			{ name: "FLC1_BANK0", description: "HSM to CPU USURP Communication Signal for FLC1_BANK0", size: "1", shift: "0", mask: "0x1" },
			{ name: "FLC2_BANK0", description: "HSM to CPU USURP Communication Signal for FLC2_BANK0", size: "1", shift: "4", mask: "0x10" },
			{ name: "FLC1_BANK1", description: "HSM to CPU USURP Communication Signal for FLC1_BANK1", size: "1", shift: "5", mask: "0x20" },
			{ name: "FLC2_BANK1", description: "HSM to CPU USURP Communication Signal for FLC2_BANK1", size: "1", shift: "9", mask: "0x200" },
			{ name: "FLC1_BANK2", description: "HSM to CPU USURP Communication Signal for FLC1_BANK2", size: "1", shift: "10", mask: "0x400" },
			{ name: "FLC2_BANK2", description: "HSM to CPU USURP Communication Signal for FLC2_BANK2", size: "1", shift: "14", mask: "0x4000" },
			{ name: "FLC1_BANK3", description: "HSM to CPU USURP Communication Signal for FLC1_BANK3", size: "1", shift: "15", mask: "0x8000" },
			{ name: "FLC2_BANK3", description: "HSM to CPU USURP Communication Signal for FLC2_BANK3", size: "1", shift: "19", mask: "0x80000" },
			{ name: "FLC1_BANK4", description: "HSM to CPU USURP Communication Signal for FLC1_BANK4", size: "1", shift: "20", mask: "0x100000" },
			{ name: "FLC2_BANK4", description: "HSM to CPU USURP Communication Signal for FLC2_BANK4", size: "1", shift: "24", mask: "0x1000000" },
		]
	},
	{ name: "HSM_SECURE_BOOT_INFO_REG0", description: "Status information of the secure boot process HSM to CPU1", offset: "0x488", size: "32",
		bits: [
		]
	},
	{ name: "HSM_SECURE_BOOT_INFO_REG1", description: "Status information of the secure boot process HSM to CPU1", offset: "0x48A", size: "32",
		bits: [
		]
	},
	{ name: "HSM_SECURE_BOOT_INFO_REG2", description: "Status information of the secure boot process HSM to CPU1", offset: "0x48C", size: "32",
		bits: [
		]
	},
	{ name: "HSM_SECURE_BOOT_INFO_REG3", description: "Status information of the secure boot process HSM to CPU1", offset: "0x48E", size: "32",
		bits: [
		]
	},
	{ name: "HSM_SECURE_BOOT_INFO_REG4", description: "Status information of the secure boot process HSM to CPU1", offset: "0x490", size: "32",
		bits: [
		]
	},
	{ name: "HSM_SECURE_BOOT_INFO_REG5", description: "Status information of the secure boot process HSM to CPU1", offset: "0x492", size: "32",
		bits: [
		]
	},
	{ name: "HSM_SECURE_BOOT_INFO_REG6", description: "Status information of the secure boot process HSM to CPU1", offset: "0x494", size: "32",
		bits: [
		]
	},
	{ name: "HSM_SECURE_BOOT_INFO_REG7", description: "Status information of the secure boot process HSM to CPU1", offset: "0x496", size: "32",
		bits: [
		]
	},
	{ name: "SOC_SECURE_BOOT_INFO_REG0", description: "Status information of the secure boot process CPU1 to HSM", offset: "0x498", size: "32",
		bits: [
		]
	},
	{ name: "SOC_SECURE_BOOT_INFO_REG1", description: "Status information of the secure boot process CPU1 to HSM", offset: "0x49A", size: "32",
		bits: [
		]
	},
	{ name: "SOC_SECURE_BOOT_INFO_REG2", description: "Status information of the secure boot process CPU1 to HSM", offset: "0x49C", size: "32",
		bits: [
		]
	},
	{ name: "SOC_SECURE_BOOT_INFO_REG3", description: "Status information of the secure boot process CPU1 to HSM", offset: "0x49E", size: "32",
		bits: [
		]
	},
	{ name: "SOC_SECURE_BOOT_INFO_REG4", description: "Status information of the secure boot process CPU1 to HSM", offset: "0x4A0", size: "32",
		bits: [
		]
	},
	{ name: "SOC_SECURE_BOOT_INFO_REG5", description: "Status information of the secure boot process CPU1 to HSM", offset: "0x4A2", size: "32",
		bits: [
		]
	},
	{ name: "SOC_SECURE_BOOT_INFO_REG6", description: "Status information of the secure boot process CPU1 to HSM", offset: "0x4A4", size: "32",
		bits: [
		]
	},
	{ name: "SOC_SECURE_BOOT_INFO_REG7", description: "Status information of the secure boot process CPU1 to HSM", offset: "0x4A6", size: "32",
		bits: [
		]
	},
	{ name: "CLKCFGLOCK1", description: "Lock bit for CLKCFG registers", offset: "0x4A8", size: "32",
		bits: [
	...
	{ name: "CLKSRCCTL1", description: "Clock Source Control register-1", offset: "0x4B2", size: "32",
		bits: [
			{ name: "OSCCLKSRCSEL", description: "OSCCLK Source Select Bit", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "CLKSRCCTL2", description: "Clock Source Control register-2", offset: "0x4B4", size: "32",
		bits: [
			...
			{ name: "MCANFBCLKSEL", description: "MCANF Bit Clock Source Select Bit", size: "2", shift: "20", mask: "0x300000" },
		]
	},
	{ name: "CLKSRCCTL3", description: "Clock Source Control register-3", offset: "0x4B6", size: "32",
		bits: [
			{ name: "XCLKOUTSEL", description: "XCLKOUT Source Select Bit", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "SYSPLLCTL1", description: "SYSPLL Control register-1", offset: "0x4B8", size: "32",
		bits: [
	...
	{ name: "SYSPLLMULT", description: "SYSPLL Multiplier register", offset: "0x4C2", size: "32",
		bits: [
	...
	{ name: "SYSPLLSTS", description: "SYSPLL Status register", offset: "0x4C4", size: "32",
		bits: [
	...
	{ name: "SYSCLKDIVSEL", description: "System Clock Divider Select register", offset: "0x4DA", size: "32",
		bits: [
			{ name: "PLLSYSCLKDIV", description: "PLLSYSCLK Divide Select", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "PERCLKDIVSEL", description: "Peripheral Clock Divider Select register", offset: "0x4E0", size: "32",
		bits: [
	...
	{ name: "XCLKOUTDIVSEL", description: "XCLKOUT Divider Select register", offset: "0x4E2", size: "32",
		bits: [
			{ name: "XCLKOUTDIV", description: "XCLKOUT Divide Select", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "HSMCLKDIVSEL", description: "HSM SYSCLK Divider Select register", offset: "0x4E4", size: "32",
		bits: [
			{ name: "HSMCLKDIV", description: "Divider value for HSMSYSCLK clock input to HSM", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "MCANCLKDIVSEL", description: "MCAN Bit Clock Divider Select register", offset: "0x4E6", size: "32",
		bits: [
	...
	{ name: "CLBCLKCTL", description: "CLB Clocking Control Register", offset: "0x4E8", size: "32",
		bits: [
	...
	{ name: "MCDCR", description: "Missing Clock Detect Control Register", offset: "0x4EE", size: "32",
		bits: [
			...
			{ name: "EXTR_FAULT_MCD_EN", description: "Configuration to enable EXTR_FAULTS as MCD cause", size: "1", shift: "12", mask: "0x1000" },
		]
	},
	{ name: "X1CNT", description: "10-bit Counter on X1 Clock", offset: "0x4F0", size: "32",
		bits: [
	...
	{ name: "XTALCR", description: "XTAL Control Register", offset: "0x4F2", size: "32",
		bits: [
	...
	{ name: "XTALCR2", description: "XTAL Control Register for pad init", offset: "0x500", size: "32",
		bits: [
	...
	{ name: "ETHERCATCLKCTL", description: "EtherCAT Clock Control", offset: "0x50A", size: "32",
		bits: [
	...
	{ name: "ETHERCATCTL", description: "ETHERCAT control register.", offset: "0x50C", size: "32",
		bits: [
			{ name: "I2CLOOPBACK", description: "Loopback I2C port of etherCAT IP to I2C_A.", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SYNCBUSY", description: "Pulse Transfer Sync Busy Status register", offset: "0x50E", size: "32",
		bits: [
	...
	{ name: "ESMXRSNCTL", description: "Enable ESM reset outputs for XRSn", offset: "0x51C", size: "32",
		bits: [
	...
	{ name: "EPWM1", description: "PER2SYSCONFIG -  Peripheral System Configuration for EPWM1", offset: "0x522", size: "32",
		bits: [
			...
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
			{ name: "DBGHALTEN", description: "DBGHALTEN to enable peripheral clock gating based on CPUx", size: "1", shift: "7", mask: "0x80" },
		]
	},
	{ name: "EPWM2", description: "PER3SYSCONFIG -  Peripheral System Configuration for EPWM2", offset: "0x524", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM3", description: "PER4SYSCONFIG -  Peripheral System Configuration for EPWM3", offset: "0x526", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM4", description: "PER5SYSCONFIG -  Peripheral System Configuration for EPWM4", offset: "0x528", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM5", description: "PER6SYSCONFIG -  Peripheral System Configuration for EPWM5", offset: "0x52A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM6", description: "PER7SYSCONFIG -  Peripheral System Configuration for EPWM6", offset: "0x52C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM7", description: "PER8SYSCONFIG -  Peripheral System Configuration for EPWM7", offset: "0x52E", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM8", description: "PER9SYSCONFIG -  Peripheral System Configuration for EPWM8", offset: "0x530", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM9", description: "PER10SYSCONFIG -  Peripheral System Configuration for EPWM9", offset: "0x532", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM10", description: "PER11SYSCONFIG -  Peripheral System Configuration for EPWM10", offset: "0x534", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM11", description: "PER12SYSCONFIG -  Peripheral System Configuration for EPWM11", offset: "0x536", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM12", description: "PER13SYSCONFIG -  Peripheral System Configuration for EPWM12", offset: "0x538", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM13", description: "PER14SYSCONFIG -  Peripheral System Configuration for EPWM13", offset: "0x53A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM14", description: "PER15SYSCONFIG -  Peripheral System Configuration for EPWM14", offset: "0x53C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM15", description: "PER16SYSCONFIG -  Peripheral System Configuration for EPWM15", offset: "0x53E", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM16", description: "PER17SYSCONFIG -  Peripheral System Configuration for EPWM16", offset: "0x540", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM17", description: "PER18SYSCONFIG -  Peripheral System Configuration for EPWM17", offset: "0x542", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPWM18", description: "PER19SYSCONFIG -  Peripheral System Configuration for EPWM18", offset: "0x544", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "HRCAL0", description: "PER21SYSCONFIG -  Peripheral System Configuration for HRCAL0", offset: "0x54A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "HRCAL1", description: "PER22SYSCONFIG -  Peripheral System Configuration for HRCAL1", offset: "0x54C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "HRCAL2", description: "PER23SYSCONFIG -  Peripheral System Configuration for HRCAL2", offset: "0x54E", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ECAP1", description: "PER24SYSCONFIG -  Peripheral System Configuration for ECAP1", offset: "0x550", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ECAP2", description: "PER25SYSCONFIG -  Peripheral System Configuration for ECAP2", offset: "0x552", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ECAP3", description: "PER26SYSCONFIG -  Peripheral System Configuration for ECAP3", offset: "0x554", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ECAP4", description: "PER27SYSCONFIG -  Peripheral System Configuration for ECAP4", offset: "0x556", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ECAP5", description: "PER28SYSCONFIG -  Peripheral System Configuration for ECAP5", offset: "0x558", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ECAP6", description: "PER29SYSCONFIG -  Peripheral System Configuration for ECAP6", offset: "0x55A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EQEP1", description: "PER30SYSCONFIG -  Peripheral System Configuration for EQEP1", offset: "0x55C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EQEP2", description: "PER31SYSCONFIG -  Peripheral System Configuration for EQEP2", offset: "0x55E", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EQEP3", description: "PER32SYSCONFIG -  Peripheral System Configuration for EQEP3", offset: "0x560", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EQEP4", description: "PER33SYSCONFIG -  Peripheral System Configuration for EQEP4", offset: "0x562", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EQEP5", description: "PER34SYSCONFIG -  Peripheral System Configuration for EQEP5", offset: "0x564", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EQEP6", description: "PER35SYSCONFIG -  Peripheral System Configuration for EQEP6", offset: "0x566", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDFM1", description: "PER36SYSCONFIG -  Peripheral System Configuration for SDFM1", offset: "0x568", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDFM2", description: "PER37SYSCONFIG -  Peripheral System Configuration for SDFM2", offset: "0x56A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDFM3", description: "PER38SYSCONFIG -  Peripheral System Configuration for SDFM3", offset: "0x56C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDFM4", description: "PER39SYSCONFIG -  Peripheral System Configuration for SDFM4", offset: "0x56E", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "UARTA", description: "PER40SYSCONFIG -  Peripheral System Configuration for UARTA", offset: "0x570", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "UARTB", description: "PER41SYSCONFIG -  Peripheral System Configuration for UARTB", offset: "0x572", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "UARTC", description: "PER42SYSCONFIG -  Peripheral System Configuration for UARTC", offset: "0x574", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "UARTD", description: "PER43SYSCONFIG -  Peripheral System Configuration for UARTD", offset: "0x576", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "UARTE", description: "PER44SYSCONFIG -  Peripheral System Configuration for UARTE", offset: "0x578", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "UARTF", description: "PER45SYSCONFIG -  Peripheral System Configuration for UARTF", offset: "0x57A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SPIA", description: "PER46SYSCONFIG -  Peripheral System Configuration for SPIA", offset: "0x57C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SPIB", description: "PER47SYSCONFIG -  Peripheral System Configuration for SPIB", offset: "0x57E", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SPIC", description: "PER48SYSCONFIG -  Peripheral System Configuration for SPIC", offset: "0x580", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SPID", description: "PER49SYSCONFIG -  Peripheral System Configuration for SPID", offset: "0x582", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SPIE", description: "PER50SYSCONFIG -  Peripheral System Configuration for SPIE", offset: "0x584", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "I2CA", description: "PER51SYSCONFIG -  Peripheral System Configuration for I2CA", offset: "0x586", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "I2CB", description: "PER52SYSCONFIG -  Peripheral System Configuration for I2CB", offset: "0x588", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "PMBUSA", description: "PER53SYSCONFIG -  Peripheral System Configuration for PMBUSA", offset: "0x58A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "LINA", description: "PER54SYSCONFIG -  Peripheral System Configuration for LINA", offset: "0x58C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "LINB", description: "PER55SYSCONFIG -  Peripheral System Configuration for LINB", offset: "0x58E", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "MCANA", description: "PER56SYSCONFIG -  Peripheral System Configuration for MCANA", offset: "0x590", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "MCANB", description: "PER57SYSCONFIG -  Peripheral System Configuration for MCANB", offset: "0x592", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "MCANC", description: "PER58SYSCONFIG -  Peripheral System Configuration for MCANC", offset: "0x594", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "MCAND", description: "PER59SYSCONFIG -  Peripheral System Configuration for MCAND", offset: "0x596", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "MCANE", description: "PER60SYSCONFIG -  Peripheral System Configuration for MCANE", offset: "0x598", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "MCANF", description: "PER61SYSCONFIG -  Peripheral System Configuration for MCANF", offset: "0x59A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCA", description: "PER62SYSCONFIG -  Peripheral System Configuration for ADCA", offset: "0x59C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCB", description: "PER63SYSCONFIG -  Peripheral System Configuration for ADCB", offset: "0x59E", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCC", description: "PER64SYSCONFIG -  Peripheral System Configuration for ADCC", offset: "0x5A0", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCD", description: "PER65SYSCONFIG -  Peripheral System Configuration for ADCD", offset: "0x5A2", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCE", description: "PER66SYSCONFIG -  Peripheral System Configuration for ADCE", offset: "0x5A4", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS1", description: "PER67SYSCONFIG -  Peripheral System Configuration for CMPSS1", offset: "0x5A6", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS2", description: "PER68SYSCONFIG -  Peripheral System Configuration for CMPSS2", offset: "0x5A8", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS3", description: "PER69SYSCONFIG -  Peripheral System Configuration for CMPSS3", offset: "0x5AA", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS4", description: "PER70SYSCONFIG -  Peripheral System Configuration for CMPSS4", offset: "0x5AC", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS5", description: "PER71SYSCONFIG -  Peripheral System Configuration for CMPSS5", offset: "0x5AE", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS6", description: "PER72SYSCONFIG -  Peripheral System Configuration for CMPSS6", offset: "0x5B0", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS7", description: "PER73SYSCONFIG -  Peripheral System Configuration for CMPSS7", offset: "0x5B2", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS8", description: "PER74SYSCONFIG -  Peripheral System Configuration for CMPSS8", offset: "0x5B4", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS9", description: "PER75SYSCONFIG -  Peripheral System Configuration for CMPSS9", offset: "0x5B6", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS10", description: "PER76SYSCONFIG -  Peripheral System Configuration for CMPSS10", offset: "0x5B8", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS11", description: "PER77SYSCONFIG -  Peripheral System Configuration for CMPSS11", offset: "0x5BA", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CMPSS12", description: "PER78SYSCONFIG -  Peripheral System Configuration for CMPSS12", offset: "0x5BC", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "DACA", description: "PER79SYSCONFIG -  Peripheral System Configuration for DACA", offset: "0x5BE", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "DACB", description: "PER80SYSCONFIG -  Peripheral System Configuration for DACB", offset: "0x5C0", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CLB1", description: "PER81SYSCONFIG -  Peripheral System Configuration for CLB1", offset: "0x5C2", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CLB2", description: "PER82SYSCONFIG -  Peripheral System Configuration for CLB2", offset: "0x5C4", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CLB3", description: "PER83SYSCONFIG -  Peripheral System Configuration for CLB3", offset: "0x5C6", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CLB4", description: "PER84SYSCONFIG -  Peripheral System Configuration for CLB4", offset: "0x5C8", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CLB5", description: "PER85SYSCONFIG -  Peripheral System Configuration for CLB5", offset: "0x5CA", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "CLB6", description: "PER86SYSCONFIG -  Peripheral System Configuration for CLB6", offset: "0x5CC", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "FSITXA", description: "PER87SYSCONFIG -  Peripheral System Configuration for FSITXA", offset: "0x5CE", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "FSITXB", description: "PER88SYSCONFIG -  Peripheral System Configuration for FSITXB", offset: "0x5D0", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "FSITXC", description: "PER89SYSCONFIG -  Peripheral System Configuration for FSITXC", offset: "0x5D2", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "FSITXD", description: "PER90SYSCONFIG -  Peripheral System Configuration for FSITXD", offset: "0x5D4", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "FSIRXA", description: "PER91SYSCONFIG -  Peripheral System Configuration for FSIRXA", offset: "0x5D6", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "FSIRXB", description: "PER92SYSCONFIG -  Peripheral System Configuration for FSIRXB", offset: "0x5D8", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "FSIRXC", description: "PER93SYSCONFIG -  Peripheral System Configuration for FSIRXC", offset: "0x5DA", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "FSIRXD", description: "PER94SYSCONFIG -  Peripheral System Configuration for FSIRXD", offset: "0x5DC", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "DCC1", description: "PER95SYSCONFIG -  Peripheral System Configuration for DCC1", offset: "0x5DE", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "DCC2", description: "PER96SYSCONFIG -  Peripheral System Configuration for DCC2", offset: "0x5E0", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "DCC3", description: "PER97SYSCONFIG -  Peripheral System Configuration for DCC3", offset: "0x5E2", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ETHERCATA", description: "PER98SYSCONFIG -  Peripheral System Configuration for ETHERCATA", offset: "0x5E4", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "EPG1", description: "PER99SYSCONFIG -  Peripheral System Configuration for EPG1", offset: "0x5E6", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SENT1", description: "PER100SYSCONFIG -  Peripheral System Configuration for SENT1", offset: "0x5E8", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SENT2", description: "PER101SYSCONFIG -  Peripheral System Configuration for SENT2", offset: "0x5EA", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SENT3", description: "PER102SYSCONFIG -  Peripheral System Configuration for SENT3", offset: "0x5EC", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SENT4", description: "PER103SYSCONFIG -  Peripheral System Configuration for SENT4", offset: "0x5EE", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SENT5", description: "PER104SYSCONFIG -  Peripheral System Configuration for SENT5", offset: "0x5F0", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SENT6", description: "PER105SYSCONFIG -  Peripheral System Configuration for SENT6", offset: "0x5F2", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER1", description: "PER106SYSCONFIG -  Peripheral System Configuration for ADCCHECKER1", offset: "0x5F4", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER2", description: "PER107SYSCONFIG -  Peripheral System Configuration for ADCCHECKER2", offset: "0x5F6", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER3", description: "PER108SYSCONFIG -  Peripheral System Configuration for ADCCHECKER3", offset: "0x5F8", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER4", description: "PER109SYSCONFIG -  Peripheral System Configuration for ADCCHECKER4", offset: "0x5FA", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER5", description: "PER110SYSCONFIG -  Peripheral System Configuration for ADCCHECKER5", offset: "0x5FC", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER6", description: "PER111SYSCONFIG -  Peripheral System Configuration for ADCCHECKER6", offset: "0x5FE", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER7", description: "PER112SYSCONFIG -  Peripheral System Configuration for ADCCHECKER7", offset: "0x600", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER8", description: "PER113SYSCONFIG -  Peripheral System Configuration for ADCCHECKER8", offset: "0x602", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER9", description: "PER114SYSCONFIG -  Peripheral System Configuration for ADCCHECKER9", offset: "0x604", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCCHECKER10", description: "PER115SYSCONFIG -  Peripheral System Configuration for ADCCHECKER10", offset: "0x606", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCSEAGGRCPU1", description: "PER116SYSCONFIG -  Peripheral System Configuration for ADCSEAGGRCPU1", offset: "0x608", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCSEAGGRCPU2", description: "PER117SYSCONFIG -  Peripheral System Configuration for ADCSEAGGRCPU2", offset: "0x60A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADCSEAGGRCPU3", description: "PER118SYSCONFIG -  Peripheral System Configuration for ADCSEAGGRCPU3", offset: "0x60C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "RTDMA1CH", description: "PER122SYSCONFIG -  Peripheral System Configuration for RTDMA1CH", offset: "0x61A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "RTDMA2CH", description: "PER123SYSCONFIG -  Peripheral System Configuration for RTDMA2CH", offset: "0x61C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "WADI1", description: "PER124SYSCONFIG -  Peripheral System Configuration for WADI1", offset: "0x61E", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "WADI2", description: "PER125SYSCONFIG -  Peripheral System Configuration for WADI2", offset: "0x620", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "INPUTXBARFLAGS", description: "PER126SYSCONFIG -  Peripheral System Configuration for INPUTXBARFlags", offset: "0x622", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "OUTPUTXBARFLAGS", description: "PER127SYSCONFIG -  Peripheral System Configuration for OUTPUTXBARFlags", offset: "0x624", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "DLTFIFOREGS", description: "PER128SYSCONFIG -  Peripheral System Configuration for DLTFIFORegs", offset: "0x626", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ADC_GLOBAL_REGS", description: "PER129SYSCONFIG -  Peripheral System Configuration for ADC_GLOBAL_REGS", offset: "0x628", size: "32",
		bits: [
		]
	},
	{ name: "ERROR_AGGREGATOR", description: "PER130SYSCONFIG -  Peripheral System Configuration for Error_Aggregator", offset: "0x62A", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "ESM", description: "PER131SYSCONFIG -  Peripheral System Configuration for ESM ESMCPU1/2/3 and ESMSYS", offset: "0x62C", size: "32",
		bits: [
			{ name: "FRAMESEL", description: "FRAMESEL Selection for Peripheral Instance", size: "3", shift: "0", mask: "0x7" },
			{ name: "CPUSEL", description: "CPUSEL Selection for Peripheral Instance", size: "3", shift: "3", mask: "0x38" },
			{ name: "STANDBYEN", description: "STANDBYEN to enable peripheral clock gating based on CPUx", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "PARITY_TEST", description: "Enables parity test", offset: "0x642", size: "32",
		bits: [
			{ name: "TESTEN", description: "Parity test enable configuration", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "CPUPERCFGLOCK1", description: "Lock bit for CPUx_PER_CFG registers", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "CPUPERCFGLOCK2", description: "Lock bit for CPUx_PER_CFG registers", offset: "0x2", size: "32",
		bits: [
			{ name: "PCLKCR32", description: "Lock bit for PCLKCR32 Register", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PCLKCR0", description: "Peripheral Clock Gating Registers", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "PCLKCR1", description: "Peripheral Clock Gating Register - EMIF", offset: "0xE", size: "32",
		bits: [
			{ name: "EMIF1", description: "EMIF1 Clock Enable bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PCLKCR2", description: "Peripheral Clock Gating Register - EPWM", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "PCLKCR3", description: "Peripheral Clock Gating Register - ECAP", offset: "0x12", size: "32",
		bits: [
	...
	{ name: "PCLKCR4", description: "Peripheral Clock Gating Register - EQEP", offset: "0x14", size: "32",
		bits: [
	...
	{ name: "PCLKCR6", description: "Peripheral Clock Gating Register - SDFM", offset: "0x1A", size: "32",
		bits: [
	...
	{ name: "PCLKCR7", description: "Peripheral Clock Gating Register - SCI, UART", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "PCLKCR8", description: "Peripheral Clock Gating Register - SPI", offset: "0x1E", size: "32",
		bits: [
	...
	{ name: "PCLKCR9", description: "Peripheral Clock Gating Register - I2C", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "PCLKCR10", description: "Peripheral Clock Gating Register - CAN", offset: "0x22", size: "32",
		bits: [
	...
	{ name: "PCLKCR13", description: "Peripheral Clock Gating Register - ADC", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "PCLKCR14", description: "Peripheral Clock Gating Register - CMPSS", offset: "0x2E", size: "32",
		bits: [
	...
	{ name: "PCLKCR16", description: "Peripheral Clock Gating Register Buf_DAC", offset: "0x34", size: "32",
		bits: [
	...
	{ name: "PCLKCR17", description: "Peripheral Clock Gating Register - CLB", offset: "0x36", size: "32",
		bits: [
	...
	{ name: "PCLKCR18", description: "Peripheral Clock Gating Register - FSI", offset: "0x38", size: "32",
		bits: [
	...
	{ name: "PCLKCR19", description: "Peripheral Clock Gating Register - LIN", offset: "0x3A", size: "32",
		bits: [
	...
	{ name: "PCLKCR20", description: "Peripheral Clock Gating Register - PMBUS", offset: "0x3C", size: "32",
		bits: [
			{ name: "PMBUS_A", description: "PMBUS_A Clock Enable bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PCLKCR21", description: "Peripheral Clock Gating Register - DCC", offset: "0x3E", size: "32",
		bits: [
	...
	{ name: "PCLKCR23", description: "Peripheral Clock Gating Register - EtherCAT", offset: "0x44", size: "32",
		bits: [
			{ name: "ETHERCAT", description: "ETHERCAT Clock Enable Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PCLKCR25", description: "Peripheral Clock Gating Register - HRCAL0,1,2", offset: "0x4A", size: "32",
		bits: [
	...
	{ name: "PCLKCR27", description: "Peripheral Clock Gating Register - EPG", offset: "0x50", size: "32",
		bits: [
			{ name: "EPG1", description: "EPG1 Clock Enable Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "PCLKCR28", description: "Peripheral Clock Gating Register - ADCCHECKER", offset: "0x52", size: "32",
		bits: [
	...
	{ name: "PCLKCR30", description: "Peripheral Clock Gating Register - SENT", offset: "0x58", size: "32",
		bits: [
	...
	{ name: "PCLKCR32", description: "Peripheral Clock Gating Register - WADI", offset: "0x5E", size: "32",
		bits: [
	...
	{ name: "SOFTPRES0", description: "Processing Block Software Reset register", offset: "0xDC", size: "32",
		bits: [
			{ name: "CPUTIMER", description: "Reset bit for modules CPUTIMER0, COUTIMER1 and CPUTIMER2", size: "1", shift: "4", mask: "0x10" },
	...
	{ name: "SOFTPRES1", description: "EMIF Software Reset register", offset: "0xDE", size: "32",
		bits: [
			{ name: "EMIF1", description: "EMIF1 software reset bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SOFTPRES2", description: "EPWM Software Reset register", offset: "0xE0", size: "32",
		bits: [
	...
	{ name: "SOFTPRES3", description: "ECAP Software Reset register", offset: "0xE2", size: "32",
		bits: [
	...
	{ name: "SOFTPRES4", description: "EQEP Software Reset register", offset: "0xE4", size: "32",
		bits: [
	...
	{ name: "SOFTPRES6", description: "Sigma Delta Software Reset register", offset: "0xEA", size: "32",
		bits: [
	...
	{ name: "SOFTPRES7", description: "SCI, UART Software Reset register", offset: "0xEC", size: "32",
		bits: [
	...
	{ name: "SOFTPRES8", description: "SPI Software Reset register", offset: "0xEE", size: "32",
		bits: [
	...
	{ name: "SOFTPRES9", description: "I2C Software Reset register", offset: "0xF0", size: "32",
		bits: [
	...
	{ name: "SOFTPRES10", description: "CAN Software Reset register", offset: "0xF2", size: "32",
		bits: [
	...
	{ name: "SOFTPRES13", description: "ADC Software Reset register", offset: "0xFC", size: "32",
		bits: [
	...
	{ name: "SOFTPRES14", description: "CMPSS Software Reset register", offset: "0xFE", size: "32",
		bits: [
	...
	{ name: "SOFTPRES16", description: "DAC Software Reset register", offset: "0x104", size: "32",
		bits: [
	...
	{ name: "SOFTPRES17", description: "CLB Software Reset register", offset: "0x106", size: "32",
		bits: [
	...
	{ name: "SOFTPRES18", description: "FSI Software Reset register", offset: "0x108", size: "32",
		bits: [
	...
	{ name: "SOFTPRES19", description: "LIN Software Reset register", offset: "0x10A", size: "32",
		bits: [
	...
	{ name: "SOFTPRES20", description: "PMBUS Software Reset register", offset: "0x10C", size: "32",
		bits: [
			{ name: "PMBUS_A", description: "PMBUS_A software reset bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SOFTPRES21", description: "DCC Software Reset register", offset: "0x10E", size: "32",
		bits: [
	...
	{ name: "SOFTPRES23", description: "ETHERCAT Software Reset register", offset: "0x114", size: "32",
		bits: [
			{ name: "ETHERCAT", description: "ETHERCAT Module reset bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SOFTPRES25", description: "HRCAL0,1,2 Software Reset register", offset: "0x11A", size: "32",
		bits: [
	...
	{ name: "SOFTPRES27", description: "EPG Software Reset register", offset: "0x120", size: "32",
		bits: [
			{ name: "EPG1", description: "EPG Module Reset Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SOFTPRES28", description: "ADCCHECKER Software Reset register", offset: "0x122", size: "32",
		bits: [
	...
	{ name: "SOFTPRES30", description: "SENT Software Reset register", offset: "0x128", size: "32",
		bits: [
	...
	{ name: "SOFTPRES32", description: "WADI Software Reset register", offset: "0x12E", size: "32",
		bits: [
	...
	{ name: "PARITY_TEST_ALT1", description: "Enables parity test", offset: "0x154", size: "32",
		bits: [
			{ name: "TESTEN", description: "Parity test enable configuration", size: "4", shift: "0", mask: "0xF" },
		]
	},
	...
	{ name: "CPUID", description: "Indicates CPU1, CPU2.. CPU6", offset: "0xA", size: "32",
		bits: [
			{ name: "CPUID", description: "Indicates CPU1, CPU2, CPU3, CPU4, CPU5 or CPU6", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "LPMCR", description: "LPM Control Register", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "CMPSSLPMSEL", description: "CMPSS LPM Wakeup select registers", offset: "0x26", size: "32",
		bits: [
	...
	{ name: "GPIOLPMSEL0", description: "GPIO LPM Wakeup select registers", offset: "0x28", size: "32",
		bits: [
	...
	{ name: "GPIOLPMSEL1", description: "GPIO LPM Wakeup select registers", offset: "0x2A", size: "32",
		bits: [
	...
	{ name: "TMR2CLKCTL", description: "Timer2 Clock Measurement functionality control register", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "RESCCLR", description: "Reset Cause Clear Register", offset: "0x2E", size: "32",
		bits: [
	...
	{ name: "RESC", description: "Reset Cause register", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "MCANWAKESTATUS", description: "MCAN Wake Status Register", offset: "0x5E", size: "32",
		bits: [
	...
	{ name: "MCANWAKESTATUSCLR", description: "MCAN Wake Status Clear Register", offset: "0x60", size: "32",
		bits: [
	...
	{ name: "CLKSTOPREQ", description: "Peripheral Clock Stop Request Register", offset: "0x62", size: "32",
		bits: [
	...
	{ name: "CLKSTOPACK", description: "Peripheral Clock Stop Ackonwledge Register", offset: "0x64", size: "32",
		bits: [
	...
	{ name: "USER_REG1_SYSRSn", description: "Software Configurable registers reset by SYSRSn", offset: "0x66", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG2_SYSRSn", description: "Software Configurable registers reset by SYSRSn", offset: "0x68", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG1_XRSn", description: "Software Configurable registers reset by XRSn", offset: "0x6A", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG2_XRSn", description: "Software Configurable registers reset by XRSn", offset: "0x6C", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG1_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0x6E", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG2_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0x70", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG3_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0x72", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG4_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0x74", size: "32",
		bits: [
		]
	},
	{ name: "SIMRESET", description: "Simulated Reset Register", offset: "0x7A", size: "32",
		bits: [
			{ name: "XRSn", description: "Generates a simulated XRSn", size: "1", shift: "1", mask: "0x2" },
			{ name: "KEY", description: "Key value to enable write", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "PARITY_TEST_ALT2", description: "Enables parity test", offset: "0x7C", size: "32",
		bits: [
			{ name: "TESTEN", description: "Parity test enable configuration", size: "4", shift: "0", mask: "0xF" },
		]
	},
	...
	{ name: "WDCNTR", description: "Watchdog Counter Register", offset: "0x45", size: "16",
		bits: [
			{ name: "WDCNTR", description: "WD Counter", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "WDKEY", description: "Watchdog Reset Key Register", offset: "0x48", size: "16",
		bits: [
			{ name: "WDKEY", description: "Key to pet the watchdog timer.", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SYNCBUSYWD", description: "SYNCBUSY status for Watchdog Register", offset: "0x4D", size: "16",
		bits: [
			{ name: "BUSY", description: "Status bit indicating synchronization in progress", size: "1", shift: "0", mask: "0x1" },
			{ name: "WDCR", description: "BUSY status bit for WDCR", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "WDCR", description: "Watchdog Control Register", offset: "0x4E", size: "16",
		bits: [
	...
	{ name: "WDWCR", description: "Watchdog Windowed Control Register", offset: "0x4F", size: "16",
		bits: [
...
module.exports = {
	sysctlRegisters: SYSCTL_REGISTERS,
}
