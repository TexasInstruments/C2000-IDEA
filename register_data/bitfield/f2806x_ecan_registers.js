let ECAN_REGISTERS = [
	...
	{ name: "CANBTC", description: "Bit Timing", offset: "0x16", size: "32",
		bits: [
			...
			{ name: "SJWREG", description: "Synchroniztion Jump Width register value", size: "2", shift: "8", mask: "0x300" },
			{ name: "BRPREG", description: "Baudrate prescaler register value", size: "8", shift: "16", mask: "0xFF0000" },
		]
	},
	...
	{ name: "CANGIF0", description: "Global Interrupt Flag 0", offset: "0x1E", size: "32",
		bits: [
			...
			{ name: "WLIF0", description: "Warning level interrupt flag", size: "1", shift: "8", mask: "0x100" },
			{ name: "EPIF0", description: "Error-passive interrupt flag", size: "1", shift: "9", mask: "0x200" },
			{ name: "BOIF0", description: "Bus-off interrupt flag", size: "1", shift: "10", mask: "0x400" },
			{ name: "RMLIF0", description: "Received message lost interrupt flag", size: "1", shift: "11", mask: "0x800" },
			{ name: "WUIF0", description: "Wakeup interrupt flag", size: "1", shift: "12", mask: "0x1000" },
			{ name: "WDIF0", description: "Write denied interrupt flag", size: "1", shift: "13", mask: "0x2000" },
			{ name: "AAIF0", description: "Abort Ack interrupt flag", size: "1", shift: "14", mask: "0x4000" },
			{ name: "GMIF0", description: "Global MBX interrupt flag", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "CANGIM", description: "Global Interrupt Mask 0", offset: "0x20", size: "32",
		bits: [
			...
			{ name: "WLIM", description: "Warning level interrupt mask", size: "1", shift: "8", mask: "0x100" },
			{ name: "EPIM", description: "Error-passive interrupt mask", size: "1", shift: "9", mask: "0x200" },
			{ name: "BOIM", description: "Bus-off interrupt mask", size: "1", shift: "10", mask: "0x400" },
			{ name: "RMLIM", description: "Received message lost interrupt mask", size: "1", shift: "11", mask: "0x800" },
			{ name: "WUIM", description: "Wakeup interrupt mask", size: "1", shift: "12", mask: "0x1000" },
			{ name: "WDIM", description: "Write denied interrupt mask", size: "1", shift: "13", mask: "0x2000" },
			{ name: "AAIM", description: "Abort Ack interrupt mask", size: "1", shift: "14", mask: "0x4000" },
			{ name: "TCOM", description: "TSC overflow interrupt mask", size: "1", shift: "16", mask: "0x10000" },
			{ name: "MTOM", description: "MBX Timeout interrupt mask", size: "1", shift: "17", mask: "0x20000" },
		]
	},
	{ name: "CANGIF1", description: "Global Interrupt Flag 1", offset: "0x22", size: "32",
		bits: [
			...
			{ name: "WLIF1", description: "Warning level interrupt flag", size: "1", shift: "8", mask: "0x100" },
			{ name: "EPIF1", description: "Error-passive interrupt flag", size: "1", shift: "9", mask: "0x200" },
			{ name: "BOIF1", description: "Bus-off interrupt flag", size: "1", shift: "10", mask: "0x400" },
			{ name: "RMLIF1", description: "Received message lost interrupt flag", size: "1", shift: "11", mask: "0x800" },
			{ name: "WUIF1", description: "Wakeup interrupt flag", size: "1", shift: "12", mask: "0x1000" },
			{ name: "WDIF1", description: "Write denied interrupt flag", size: "1", shift: "13", mask: "0x2000" },
			{ name: "AAIF1", description: "Abort Ack interrupt flag", size: "1", shift: "14", mask: "0x4000" },
			{ name: "GMIF1", description: "Global MBX interrupt flag", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "LAM0", description: "", offset: "0x0", size: "32",
		bits: [
			{ name: "LAM_L", description: "15:0", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "LAM_H", description: "28:16", size: "13", shift: "16", mask: "0x1FFF0000" },
