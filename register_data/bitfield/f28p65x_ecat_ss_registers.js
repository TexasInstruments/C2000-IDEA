let ECAT_SS_REGISTERS = [
	...
	{ name: "ESCSS_INTR_RIS", description: "EtherCATSS Interrupt Raw Status", offset: "0x2", size: "32",
		bits: [
			...
			{ name: "MDEVICE_RESET_RIS", description: "ECAT RESET RIS", size: "1", shift: "5", mask: "0x20" },
		]
	},
	{ name: "ESCSS_INTR_MASK", description: "EtherCATSS Interrupt Mask", offset: "0x4", size: "32",
		bits: [
			...
			{ name: "MDEVICE_RESET_MASK", description: "EtherCAT MainDevice Reset Mask", size: "1", shift: "5", mask: "0x20" },
		]
	},
	{ name: "ESCSS_INTR_MIS", description: "EtherCATSS Masked Interrupt Status", offset: "0x6", size: "32",
		bits: [
			...
			{ name: "MDEVICE_RESET_MIS", description: "EtherCAT MainDevice Reset MIS", size: "1", shift: "5", mask: "0x20" },
		]
	},
	{ name: "ESCSS_INTR_CLR", description: "EtherCATSS Interrupt Clear", offset: "0x8", size: "32",
		bits: [
			...
			{ name: "MDEVICE_RESET_CLR", description: "EtherCAT MainDevice Reset Clear", size: "1", shift: "5", mask: "0x20" },
		]
	},
	{ name: "ESCSS_INTR_SET", description: "EtherCATSS Interrupt Set to emulate", offset: "0xA", size: "32",
		bits: [
			...
			{ name: "MDEVICE_RESET_SET", description: "EtherCAT MainDevice Reset Emulate", size: "1", shift: "5", mask: "0x20" },
