let FSI_REGISTERS = [
	...
	{ name: "TX_CLK_CTRL", description: "Transmit clock control register", offset: "0x3", size: "16",
		bits: [
	...
	{ name: "TX_OPER_CTRL_LO", description: "Transmit operation control register low", offset: "0x6", size: "16",
		bits: [
	...
	{ name: "TX_OPER_CTRL_HI", description: "Transmit operation control register high", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "TX_FRAME_CTRL", description: "Transmit frame control register", offset: "0x8", size: "16",
		bits: [
	...
	{ name: "TX_FRAME_TAG_UDATA", description: "Transmit frame tag and user data register", offset: "0x9", size: "16",
		bits: [
	...
	{ name: "TX_BUF_PTR_LOAD", description: "Transmit buffer pointer control load register", offset: "0xA", size: "16",
		bits: [
			{ name: "BUF_PTR_LOAD", description: "Buffer Pointer Force Load", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "TX_BUF_PTR_STS", description: "Transmit buffer pointer control status register", offset: "0xB", size: "16",
		bits: [
	...
	{ name: "TX_PING_CTRL", description: "Transmit ping control register", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "TX_PING_TAG", description: "Transmit ping tag register", offset: "0xD", size: "16",
		bits: [
			{ name: "TAG", description: "Ping Frame Tag", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "TX_PING_TO_REF", description: "Transmit ping timeout counter reference", offset: "0xE", size: "32",
		bits: [
		]
	},
	{ name: "TX_PING_TO_CNT", description: "Transmit ping timeout current count", offset: "0x10", size: "32",
		bits: [
		]
	},
	{ name: "TX_INT_CTRL", description: "Transmit interrupt event control register", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "TX_DMA_CTRL", description: "Transmit DMA event control register", offset: "0x13", size: "16",
		bits: [
			{ name: "DMA_EVT_EN", description: "DMA Event Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "TX_LOCK_CTRL", description: "Transmit lock control register", offset: "0x14", size: "16",
		bits: [
			{ name: "LOCK", description: "Control Register Lock Enable", size: "1", shift: "0", mask: "0x1" },
			{ name: "KEY", description: "Write Key", size: "8", shift: "8", mask: "0xFF00" },
		]
	},
	{ name: "TX_EVT_STS", description: "Transmit event and error status flag register", offset: "0x17", size: "16",
		bits: [
	...
	{ name: "TX_EVT_CLR", description: "Transmit event and error clear register", offset: "0x1A", size: "16",
		bits: [
	...
	{ name: "TX_EVT_FRC", description: "Transmit event and error flag force register", offset: "0x1B", size: "16",
		bits: [
	...
	{ name: "TX_USER_CRC", description: "Transmit user-defined CRC register", offset: "0x1C", size: "16",
		bits: [
			{ name: "USER_CRC", description: "User-defined CRC", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "TX_ECC_DATA", description: "Transmit ECC data register", offset: "0x2B", size: "32",
		bits: [
	...
	{ name: "TX_ECC_VAL", description: "Transmit ECC value register", offset: "0x2D", size: "16",
		bits: [
			{ name: "ECC_VAL", description: "Computed ECC Value", size: "7", shift: "0", mask: "0x7F" },
		]
	},
	{ name: "TX_DLYLINE_CTRL", description: "Transmit delay Line control register", offset: "0x30", size: "16",
		bits: [
	...
	{ name: "RX_OPER_CTRL", description: "Receive operation control register", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "RX_FRAME_INFO", description: "Receive frame control register", offset: "0xA", size: "16",
		bits: [
			{ name: "FRAME_TYPE", description: "Received Frame Type", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RX_FRAME_TAG_UDATA", description: "Receive frame tag and user data register", offset: "0xB", size: "16",
		bits: [
	...
	{ name: "RX_DMA_CTRL", description: "Receive DMA event control register", offset: "0xC", size: "16",
		bits: [
			{ name: "DMA_EVT_EN", description: "DMA Event Enable", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "RX_EVT_STS", description: "Receive event and error status flag register", offset: "0xF", size: "16",
		bits: [
	...
	{ name: "RX_CRC_INFO", description: "Receive CRC info of received and computed CRC", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "RX_EVT_CLR", description: "Receive event and error clear register", offset: "0x11", size: "16",
		bits: [
	...
	{ name: "RX_EVT_FRC", description: "Receive event and error flag force register", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "RX_BUF_PTR_LOAD", description: "Receive buffer pointer load register", offset: "0x13", size: "16",
		bits: [
			{ name: "BUF_PTR_LOAD", description: "Load value for receive buffer pointer", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "RX_BUF_PTR_STS", description: "Receive buffer pointer status register", offset: "0x14", size: "16",
		bits: [
			{ name: "CURR_BUF_PTR", description: "Current Buffer Pointer Index", size: "4", shift: "0", mask: "0xF" },
			{ name: "CURR_WORD_CNT", description: "Available Words in Buffer", size: "5", shift: "8", mask: "0x1F00" },
		]
	},
	{ name: "RX_FRAME_WD_CTRL", description: "Receive frame watchdog control register", offset: "0x15", size: "16",
		bits: [
	...
	{ name: "RX_FRAME_WD_REF", description: "Receive frame watchdog counter reference", offset: "0x18", size: "32",
		bits: [
		]
	},
	{ name: "RX_FRAME_WD_CNT", description: "Receive frame watchdog current count", offset: "0x1A", size: "32",
		bits: [
		]
	},
	{ name: "RX_PING_WD_CTRL", description: "Receive ping watchdog control register", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "RX_PING_TAG", description: "Receive ping tag register", offset: "0x1D", size: "16",
		bits: [
			{ name: "PING_TAG", description: "Ping Frame Tag", size: "4", shift: "1", mask: "0x1E" },
		]
	},
	{ name: "RX_PING_WD_REF", description: "Receive ping watchdog counter reference", offset: "0x1E", size: "32",
		bits: [
		]
	},
	{ name: "RX_PING_WD_CNT", description: "Receive pingwatchdog current count", offset: "0x20", size: "32",
		bits: [
		]
	},
	{ name: "RX_INT1_CTRL", description: "Receive interrupt control register for RX_INT1", offset: "0x22", size: "16",
		bits: [
	...
	{ name: "RX_INT2_CTRL", description: "Receive interrupt control register for RX_INT2", offset: "0x23", size: "16",
		bits: [
	...
	{ name: "RX_LOCK_CTRL", description: "Receive lock control register", offset: "0x24", size: "16",
		bits: [
			{ name: "LOCK", description: "Control Register Lock Enable", size: "1", shift: "0", mask: "0x1" },
			{ name: "KEY", description: "Write Key", size: "8", shift: "8", mask: "0xFF00" },
		]
	},
	{ name: "RX_ECC_DATA", description: "Receive ECC data register", offset: "0x27", size: "32",
		bits: [
			{ name: "DATA_LOW", description: "ECC Data Lower 16 Bits", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA_HIGH", description: "ECC Data Upper 16 Bits", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "RX_ECC_VAL", description: "Receive ECC value register", offset: "0x29", size: "16",
		bits: [
			{ name: "ECC_VAL", description: "Computed ECC Value", size: "7", shift: "0", mask: "0x7F" },
		]
	},
	{ name: "RX_ECC_SEC_DATA", description: "Receive ECC corrected data register", offset: "0x2C", size: "32",
		bits: [
		]
	},
	{ name: "RX_ECC_LOG", description: "Receive ECC log and status register", offset: "0x2E", size: "16",
		bits: [
	...
	{ name: "RX_FRAME_TAG_CMP", description: "Receive frame tag compare register", offset: "0x31", size: "16",
		bits: [
	...
	{ name: "RX_PING_TAG_CMP", description: "Receive ping tag compare register", offset: "0x32", size: "16",
		bits: [
	...
	{ name: "RX_TRIG_CTRL_0", description: "Receive Trigger Control register 0", offset: "0x37", size: "32",
		bits: [
	...
	{ name: "RX_TRIG_WIDTH_0", description: "Receive Trigger Wdith register 0", offset: "0x39", size: "32",
		bits: [
			{ name: "RX_TRIG_WIDTH", description: "Output Pulse Width", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "RX_DLYLINE_CTRL", description: "Receive delay line control register", offset: "0x3B", size: "16",
		bits: [
	...
	{ name: "RX_TRIG_CTRL_1", description: "Receive Trigger Control register 1", offset: "0x3E", size: "32",
		bits: [
			{ name: "TRIG_EN", description: "Enable Trigger Function", size: "1", shift: "0", mask: "0x1" },
			{ name: "TRIG_SEL", description: "Input Select for Trigger", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RX_TRIG_DLY", description: "Delay for Trigger generation", size: "24", shift: "8", mask: "0xFFFFFF00" },
	...
	{ name: "RX_TRIG_CTRL_2", description: "Receive Trigger Control register 2", offset: "0x40", size: "32",
		bits: [
			{ name: "TRIG_EN", description: "Enable Trigger Function", size: "1", shift: "0", mask: "0x1" },
			{ name: "TRIG_SEL", description: "Input Select for Trigger", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RX_TRIG_DLY", description: "Delay for Trigger generation", size: "24", shift: "8", mask: "0xFFFFFF00" },
	...
	{ name: "RX_TRIG_CTRL_3", description: "Receive Trigger Control register 3", offset: "0x42", size: "32",
		bits: [
			{ name: "TRIG_EN", description: "Enable Trigger Function", size: "1", shift: "0", mask: "0x1" },
			{ name: "TRIG_SEL", description: "Input Select for Trigger", size: "4", shift: "1", mask: "0x1E" },
			{ name: "RX_TRIG_DLY", description: "Delay for Trigger generation", size: "24", shift: "8", mask: "0xFFFFFF00" },
	...
	{ name: "RX_VIS_1", description: "Receive debug visibility register 1", offset: "0x44", size: "32",
		bits: [
			{ name: "RX_CORE_STS", description: "Receiver Core Status", size: "1", shift: "3", mask: "0x8" },
		]
	},
	{ name: "RX_UDATA_FILTER", description: "Receive User Data Filter Control register", offset: "0x46", size: "16",
		bits: [
