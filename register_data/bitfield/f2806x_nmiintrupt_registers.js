let NMIINTRUPT_REGISTERS = [
	...
	{ name: "NMIFLGCLR", description: "", offset: "0x2", size: "16",
		bits: [
			...
			{ name: "CLOCKFAIL", description: "Clock Fail Flag Clear Bit", size: "1", shift: "1", mask: "0x2" },
		]
	},
	{ name: "NMIFLGFRC", description: "", offset: "0x3", size: "16",
		bits: [
			{ name: "CLOCKFAIL", description: "Clock Fail Flag Force Bit", size: "1", shift: "1", mask: "0x2" },
		]
	},
