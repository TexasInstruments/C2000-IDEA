let SYSCTRL_REGISTERS = [
	...
	{ name: "SOFTPRES25", description: "HIC Software Reset register", offset: "0xB4", size: "32",
		bits: [
	...
	{ name: "SCIB_AC", description: "SCIB Master Access Control Register", offset: "0x102", size: "32",
		bits: [
			{ name: "CPU1_ACC", description: "CPU1 Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "HICA_ACC", description: "HICA Access Contions to Peripheral", size: "2", shift: "6", mask: "0xC0" },
		]
	...
	{ name: "MCANA_AC", description: "MCANA Master Access Control Register", offset: "0x148", size: "32",
		bits: [
			{ name: "CPU1_ACC", description: "CPU1 Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "HICA_ACC", description: "HICA Access Contions to Peripheral", size: "2", shift: "6", mask: "0xC0" },
		]
	...
	{ name: "AESA_AC", description: "AES Master Access Control Register", offset: "0x1AE", size: "32",
		bits: [
			{ name: "CPU1_ACC", description: "CPU1 Access conditions to peripheral", size: "2", shift: "0", mask: "0x3" },
			{ name: "DMA1_ACC", description: "DMA1 Access Conditions to Peripheral", size: "2", shift: "4", mask: "0x30" },
		]
