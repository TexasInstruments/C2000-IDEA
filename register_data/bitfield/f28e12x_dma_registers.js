let DMA_REGISTERS = [
	...
	{ name: "SRC_BEG_ADDR_SHADOW", description: "Source Begin Address Shadow Register", offset: "0x10", size: "32",
		bits: [
		]
	},
	{ name: "SRC_ADDR_SHADOW", description: "Source Address Shadow Register", offset: "0x12", size: "32",
		bits: [
		]
	},
	{ name: "SRC_BEG_ADDR_ACTIVE", description: "Source Begin Address Active Register", offset: "0x14", size: "32",
		bits: [
		]
	},
	{ name: "SRC_ADDR_ACTIVE", description: "Source Address Active Register", offset: "0x16", size: "32",
		bits: [
		]
	},
	{ name: "DST_BEG_ADDR_SHADOW", description: "Destination Begin Address Shadow Register", offset: "0x18", size: "32",
		bits: [
		]
	},
	{ name: "DST_ADDR_SHADOW", description: "Destination Address Shadow Register", offset: "0x1A", size: "32",
		bits: [
		]
	},
	{ name: "DST_BEG_ADDR_ACTIVE", description: "Destination Begin Address Active Register", offset: "0x1C", size: "32",
		bits: [
		]
	},
	{ name: "DST_ADDR_ACTIVE", description: "Destination Address Active Register", offset: "0x1E", size: "32",
		bits: [
		]
	},
