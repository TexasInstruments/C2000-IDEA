let DCSM_REGISTERS = [
	...
	{ name: "Z1_BOOTDEF_HIGH", description: "Boot definition (high 32bit)", offset: "0x4", size: "32",
		bits: [
		]
	},
	...
	{ name: "Z1_BOOTPIN_CONFIG", description: "Boot Pin Configuration", offset: "0x8", size: "32",
		bits: [
		]
	},
	{ name: "Z1_GPREG2", description: "Zone1 General Purpose Register-2", offset: "0xA", size: "32",
		bits: [
		]
	},
	{ name: "Z1_BOOTDEF_LOW", description: "Boot definition (low 32bit)", offset: "0xC", size: "32",
		bits: [
		]
	},
	...
	{ name: "Z1_GRABRAMR", description: "Zone 1 Grab RAM Blocks Register", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "B0_Z1_EXEONLYSECTR", description: "Zone 1 Flash BANK0 Execute_Only Sector Register", offset: "0x1E", size: "32",
		bits: [
	...
	{ name: "Z1_EXEONLYRAMR", description: "Zone 1 RAM Execute_Only Block Register", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "Z2_GRABRAMR", description: "Zone 2 Grab RAM Blocks Register", offset: "0x1C", size: "32",
		bits: [
			{ name: "GRAB_RAM0", description: "Grab RAM LS0", size: "2", shift: "0", mask: "0x3" },
			{ name: "GRAB_RAM1", description: "Grab RAM LS1", size: "2", shift: "2", mask: "0xC" },
			{ name: "GRAB_RAM2", description: "Grab RAM LS2", size: "2", shift: "4", mask: "0x30" },
	...
	{ name: "B0_Z2_EXEONLYSECTR", description: "Zone 2 Flash BANK0 Execute_Only Sector Register", offset: "0x1E", size: "32",
		bits: [
			{ name: "EXEONLY_SECT0", description: "Execute-Only Flash Sector 0 in Flash BANK0", size: "1", shift: "0", mask: "0x1" },
			{ name: "EXEONLY_SECT1", description: "Execute-Only Flash Sector 1 in Flash BANK0", size: "1", shift: "1", mask: "0x2" },
			{ name: "EXEONLY_SECT2", description: "Execute-Only Flash Sector 2 in Flash BANK0", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "Z2_EXEONLYRAMR", description: "Zone 2 RAM Execute_Only Block Register", offset: "0x20", size: "32",
		bits: [
			{ name: "EXEONLY_RAM0", description: "Execute-Only RAM LS0", size: "1", shift: "0", mask: "0x1" },
			{ name: "EXEONLY_RAM1", description: "Execute-Only RAM LS1", size: "1", shift: "1", mask: "0x2" },
			{ name: "EXEONLY_RAM2", description: "Execute-Only RAM LS2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "SECERRSTAT", description: "Security Error Status Register", offset: "0xA", size: "32",
		bits: [
			{ name: "ERR", description: "Security Configuration load Error Status", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SECERRCLR", description: "Security Error Clear Register", offset: "0xC", size: "32",
		bits: [
			{ name: "ERR", description: "Clear Security Configuration Load Error Status Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SECERRFRC", description: "Security Error Force Register", offset: "0xE", size: "32",
		bits: [
	...
	{ name: "B1_Z1_EXEONLYSECTR", description: "Zone 1 Flash BANK1 Execute_Only Sector Register", offset: "0x1E", size: "32",
		bits: [
	...
	{ name: "B1_Z2_EXEONLYSECTR", description: "Zone 2 Flash BANK1 Execute_Only Sector Register", offset: "0x1E", size: "32",
		bits: [
			{ name: "EXEONLY_SECT0", description: "Execute-Only Flash Sector 0 in Flash BANK1", size: "1", shift: "0", mask: "0x1" },
			{ name: "EXEONLY_SECT1", description: "Execute-Only Flash Sector 1 in Flash BANK1", size: "1", shift: "1", mask: "0x2" },
			{ name: "EXEONLY_SECT2", description: "Execute-Only Flash Sector 2 in Flash BANK1", size: "1", shift: "2", mask: "0x4" },
