let SDFM_REGISTERS = [
	...
	{ name: "SDMFILEN", description: "SD Master Filter Enable", offset: "0x6", size: "16",
		bits: [
			{ name: "MFE", description: "Master Filter Enable.", size: "1", shift: "11", mask: "0x800" },
		]
	},
	{ name: "SDSTATUS", description: "SD Status Register", offset: "0x7", size: "16",
		bits: [
			{ name: "HZ1", description: "High-level Threshold crossing (Z) flag Ch1", size: "1", shift: "0", mask: "0x1" },
			{ name: "HZ2", description: "High-level Threshold crossing (Z) flag Ch2", size: "1", shift: "1", mask: "0x2" },
			{ name: "HZ3", description: "High-level Threshold crossing (Z) flag Ch3", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "SDINTMODE", description: "SD Interrupt Mode register", offset: "0x8", size: "16",
		bits: [
			{ name: "SDINTMODESEL", description: "CompxH/L events interrupt mode select", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SDCTLPARM1", description: "Control Parameter Register for Ch1", offset: "0x10", size: "16",
		bits: [
	...
	{ name: "SDDFPARM1", description: "Data Filter Parameter Register for Ch1", offset: "0x11", size: "16",
		bits: [
	...
	{ name: "SDDPARM1", description: "Data Parameter Register for Ch1", offset: "0x12", size: "16",
		bits: [
	...
	{ name: "SDFLT1CMPH1", description: "High-level Threshold Register for Ch1", offset: "0x13", size: "16",
		bits: [
			{ name: "HLT", description: "High-level threshold for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFLT1CMPL1", description: "Low-level Threshold Register for Ch1", offset: "0x14", size: "16",
		bits: [
			{ name: "LLT", description: "Low-level threshold for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDCPARM1", description: "Comparator Filter Parameter Register for Ch1", offset: "0x15", size: "16",
		bits: [
	...
	{ name: "SDDATA1", description: "Data Filter Data Register (16 or 32bit) for Ch1", offset: "0x16", size: "32",
		bits: [
	...
	{ name: "SDDATFIFO1", description: "Filter Data FIFO Output(32b) for Ch1", offset: "0x18", size: "32",
		bits: [
			{ name: "DATA16", description: "Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode, 16-bit Data in 16b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "SDCDATA1", description: "Comparator Filter Data Register (16b) for Ch1", offset: "0x1A", size: "16",
		bits: [
		]
	},
	{ name: "SDFLT1CMPH2", description: "Second high level threhold  for CH1", offset: "0x1B", size: "16",
		bits: [
			{ name: "HLT2", description: "Second High level threshold.", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFLT1CMPHZ", description: "High-level (Z) Threshold Register for Ch1", offset: "0x1C", size: "16",
		bits: [
			{ name: "HLTZ", description: "High-level threshold (Z) for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFIFOCTL1", description: "FIFO Control Register for Ch1", offset: "0x1D", size: "16",
		bits: [
	...
	{ name: "SDSYNC1", description: "SD Filter Sync control for Ch1", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "SDFLT1CMPL2", description: "Second low level threhold  for CH1", offset: "0x1F", size: "16",
		bits: [
			{ name: "LLT2", description: "Second low-level threshold for the comparator filter output.", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDCTLPARM2", description: "Control Parameter Register for Ch2", offset: "0x20", size: "16",
		bits: [
			{ name: "MOD", description: "Modulator clocking modes", size: "2", shift: "0", mask: "0x3" },
	...
	{ name: "SDDFPARM2", description: "Data Filter Parameter Register for Ch2", offset: "0x21", size: "16",
		bits: [
			{ name: "DOSR", description: "Data Filter Oversample Ratio= DOSR+1", size: "8", shift: "0", mask: "0xFF" },
			{ name: "FEN", description: "Filter Enable", size: "1", shift: "8", mask: "0x100" },
			{ name: "AE", description: "Ack Enable", size: "1", shift: "9", mask: "0x200" },
	...
	{ name: "SDDPARM2", description: "Data Parameter Register for Ch2", offset: "0x22", size: "16",
		bits: [
			{ name: "DR", description: "Data Representation (0/1 = 16/32b 2's complement)", size: "1", shift: "10", mask: "0x400" },
			{ name: "SH", description: "Shift Control (# bits to shift in 16b mode)", size: "5", shift: "11", mask: "0xF800" },
		]
	},
	{ name: "SDFLT2CMPH1", description: "High-level Threshold Register for Ch2", offset: "0x23", size: "16",
		bits: [
			{ name: "HLT", description: "High-level threshold for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFLT2CMPL1", description: "Low-level Threshold Register for Ch2", offset: "0x24", size: "16",
		bits: [
			{ name: "LLT", description: "Low-level threshold for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDCPARM2", description: "Comparator Filter Parameter Register for Ch2", offset: "0x25", size: "16",
		bits: [
			{ name: "COSR", description: "Comparator Oversample Ratio. Actual rate COSR+1", size: "5", shift: "0", mask: "0x1F" },
			{ name: "EN_CEVT1", description: "CEVT1 Interrupt enable.", size: "1", shift: "5", mask: "0x20" },
			{ name: "EN_CEVT2", description: "CEVT2 Interrupt enable.", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDDATA2", description: "Data Filter Data Register (16 or 32bit) for Ch2", offset: "0x26", size: "32",
		bits: [
			{ name: "DATA16", description: "Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode, 16-bit Data in 16b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "SDDATFIFO2", description: "Filter Data FIFO Output(32b) for Ch2", offset: "0x28", size: "32",
		bits: [
			{ name: "DATA16", description: "Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode, 16-bit Data in 16b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "SDCDATA2", description: "Comparator Filter Data Register (16b) for Ch2", offset: "0x2A", size: "16",
		bits: [
		]
	},
	{ name: "SDFLT2CMPH2", description: "Second high level threhold  for CH2", offset: "0x2B", size: "16",
		bits: [
			{ name: "HLT2", description: "Second High level threshold.", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFLT2CMPHZ", description: "High-level (Z) Threshold Register for Ch2", offset: "0x2C", size: "16",
		bits: [
			{ name: "HLTZ", description: "High-level threshold (Z) for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFIFOCTL2", description: "FIFO Control Register for Ch2", offset: "0x2D", size: "16",
		bits: [
			{ name: "SDFFIL", description: "SDFIFO Interrupt Level", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SDFFST", description: "SDFIFO Status", size: "5", shift: "6", mask: "0x7C0" },
			{ name: "FFIEN", description: "SDFIFO data ready Interrupt Enable", size: "1", shift: "12", mask: "0x1000" },
	...
	{ name: "SDSYNC2", description: "SD Filter Sync control for Ch2", offset: "0x2E", size: "16",
		bits: [
			{ name: "SYNCSEL", description: "SDSYNC Source Select", size: "6", shift: "0", mask: "0x3F" },
			{ name: "WTSYNCEN", description: "Wait-for-Sync Enable", size: "1", shift: "6", mask: "0x40" },
			{ name: "WTSYNFLG", description: "Wait-for-Sync Flag", size: "1", shift: "7", mask: "0x80" },
	...
	{ name: "SDFLT2CMPL2", description: "Second low level threhold  for CH2", offset: "0x2F", size: "16",
		bits: [
			{ name: "LLT2", description: "Second low-level threshold for the comparator filter output.", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDCTLPARM3", description: "Control Parameter Register for Ch3", offset: "0x30", size: "16",
		bits: [
			{ name: "MOD", description: "Modulator clocking modes", size: "2", shift: "0", mask: "0x3" },
	...
	{ name: "SDDFPARM3", description: "Data Filter Parameter Register for Ch3", offset: "0x31", size: "16",
		bits: [
			{ name: "DOSR", description: "Data Filter Oversample Ratio= DOSR+1", size: "8", shift: "0", mask: "0xFF" },
			{ name: "FEN", description: "Filter Enable", size: "1", shift: "8", mask: "0x100" },
			{ name: "AE", description: "Ack Enable", size: "1", shift: "9", mask: "0x200" },
	...
	{ name: "SDDPARM3", description: "Data Parameter Register for Ch3", offset: "0x32", size: "16",
		bits: [
			{ name: "DR", description: "Data Representation (0/1 = 16/32b 2's complement)", size: "1", shift: "10", mask: "0x400" },
			{ name: "SH", description: "Shift Control (# bits to shift in 16b mode)", size: "5", shift: "11", mask: "0xF800" },
		]
	},
	{ name: "SDFLT3CMPH1", description: "High-level Threshold Register for Ch3", offset: "0x33", size: "16",
		bits: [
			{ name: "HLT", description: "High-level threshold for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFLT3CMPL1", description: "Low-level Threshold Register for Ch3", offset: "0x34", size: "16",
		bits: [
			{ name: "LLT", description: "Low-level threshold for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDCPARM3", description: "Comparator Filter Parameter Register for Ch3", offset: "0x35", size: "16",
		bits: [
			{ name: "COSR", description: "Comparator Oversample Ratio. Actual rate COSR+1", size: "5", shift: "0", mask: "0x1F" },
			{ name: "EN_CEVT1", description: "CEVT1 Interrupt enable.", size: "1", shift: "5", mask: "0x20" },
			{ name: "EN_CEVT2", description: "CEVT2 Interrupt enable.", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDDATA3", description: "Data Filter Data Register (16 or 32bit) for Ch3", offset: "0x36", size: "32",
		bits: [
			{ name: "DATA16", description: "Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode, 16-bit Data in 16b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "SDDATFIFO3", description: "Filter Data FIFO Output(32b) for Ch3", offset: "0x38", size: "32",
		bits: [
			{ name: "DATA16", description: "Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode, 16-bit Data in 16b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "SDCDATA3", description: "Comparator Filter Data Register (16b) for Ch3", offset: "0x3A", size: "16",
		bits: [
		]
	},
	{ name: "SDFLT3CMPH2", description: "Second high level threhold  for CH3", offset: "0x3B", size: "16",
		bits: [
			{ name: "HLT2", description: "Second High level threshold.", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFLT3CMPHZ", description: "High-level (Z) Threshold Register for Ch3", offset: "0x3C", size: "16",
		bits: [
			{ name: "HLTZ", description: "High-level threshold (Z) for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFIFOCTL3", description: "FIFO Control Register for Ch3", offset: "0x3D", size: "16",
		bits: [
			{ name: "SDFFIL", description: "SDFIFO Interrupt Level", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SDFFST", description: "SDFIFO Status", size: "5", shift: "6", mask: "0x7C0" },
			{ name: "FFIEN", description: "SDFIFO data ready Interrupt Enable", size: "1", shift: "12", mask: "0x1000" },
	...
	{ name: "SDSYNC3", description: "SD Filter Sync control for Ch3", offset: "0x3E", size: "16",
		bits: [
			{ name: "SYNCSEL", description: "SDSYNC Source Select", size: "6", shift: "0", mask: "0x3F" },
			{ name: "WTSYNCEN", description: "Wait-for-Sync Enable", size: "1", shift: "6", mask: "0x40" },
			{ name: "WTSYNFLG", description: "Wait-for-Sync Flag", size: "1", shift: "7", mask: "0x80" },
	...
	{ name: "SDFLT3CMPL2", description: "Second low level threhold  for CH3", offset: "0x3F", size: "16",
		bits: [
			{ name: "LLT2", description: "Second low-level threshold for the comparator filter output.", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDCTLPARM4", description: "Control Parameter Register for Ch4", offset: "0x40", size: "16",
		bits: [
			{ name: "MOD", description: "Modulator clocking modes", size: "2", shift: "0", mask: "0x3" },
	...
	{ name: "SDDFPARM4", description: "Data Filter Parameter Register for Ch4", offset: "0x41", size: "16",
		bits: [
			{ name: "DOSR", description: "Data Filter Oversample Ratio= DOSR+1", size: "8", shift: "0", mask: "0xFF" },
			{ name: "FEN", description: "Filter Enable", size: "1", shift: "8", mask: "0x100" },
			{ name: "AE", description: "Ack Enable", size: "1", shift: "9", mask: "0x200" },
	...
	{ name: "SDDPARM4", description: "Data Parameter Register for Ch4", offset: "0x42", size: "16",
		bits: [
			{ name: "DR", description: "Data Representation (0/1 = 16/32b 2's complement)", size: "1", shift: "10", mask: "0x400" },
			{ name: "SH", description: "Shift Control (# bits to shift in 16b mode)", size: "5", shift: "11", mask: "0xF800" },
		]
	},
	{ name: "SDFLT4CMPH1", description: "High-level Threshold Register for Ch4", offset: "0x43", size: "16",
		bits: [
			{ name: "HLT", description: "High-level threshold for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFLT4CMPL1", description: "Low-level Threshold Register for Ch4", offset: "0x44", size: "16",
		bits: [
			{ name: "LLT", description: "Low-level threshold for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDCPARM4", description: "Comparator Filter Parameter Register for Ch4", offset: "0x45", size: "16",
		bits: [
			{ name: "COSR", description: "Comparator Oversample Ratio. Actual rate COSR+1", size: "5", shift: "0", mask: "0x1F" },
			{ name: "EN_CEVT1", description: "CEVT1 Interrupt enable.", size: "1", shift: "5", mask: "0x20" },
			{ name: "EN_CEVT2", description: "CEVT2 Interrupt enable.", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "SDDATA4", description: "Data Filter Data Register (16 or 32bit) for Ch4", offset: "0x46", size: "32",
		bits: [
			{ name: "DATA16", description: "Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode, 16-bit Data in 16b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "SDDATFIFO4", description: "Filter Data FIFO Output(32b) for Ch4", offset: "0x48", size: "32",
		bits: [
			{ name: "DATA16", description: "Lo-order 16b in 32b mode", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "DATA32HI", description: "Hi-order 16b in 32b mode, 16-bit Data in 16b mode", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "SDCDATA4", description: "Comparator Filter Data Register (16b) for Ch4", offset: "0x4A", size: "16",
		bits: [
		]
	},
	{ name: "SDFLT4CMPH2", description: "Second high level threhold  for CH4", offset: "0x4B", size: "16",
		bits: [
			{ name: "HLT2", description: "Second High level threshold.", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFLT4CMPHZ", description: "High-level (Z) Threshold Register for Ch4", offset: "0x4C", size: "16",
		bits: [
			{ name: "HLTZ", description: "High-level threshold (Z) for the comparator filter output", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDFIFOCTL4", description: "FIFO Control Register for Ch4", offset: "0x4D", size: "16",
		bits: [
			{ name: "SDFFIL", description: "SDFIFO Interrupt Level", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SDFFST", description: "SDFIFO Status", size: "5", shift: "6", mask: "0x7C0" },
			{ name: "FFIEN", description: "SDFIFO data ready Interrupt Enable", size: "1", shift: "12", mask: "0x1000" },
	...
	{ name: "SDSYNC4", description: "SD Filter Sync control for Ch4", offset: "0x4E", size: "16",
		bits: [
			{ name: "SYNCSEL", description: "SDSYNC Source Select", size: "6", shift: "0", mask: "0x3F" },
			{ name: "WTSYNCEN", description: "Wait-for-Sync Enable", size: "1", shift: "6", mask: "0x40" },
			{ name: "WTSYNFLG", description: "Wait-for-Sync Flag", size: "1", shift: "7", mask: "0x80" },
	...
	{ name: "SDFLT4CMPL2", description: "Second low level threhold  for CH4", offset: "0x4F", size: "16",
		bits: [
			{ name: "LLT2", description: "Second low-level threshold for the comparator filter output.", size: "15", shift: "0", mask: "0x7FFF" },
		]
	},
	{ name: "SDCOMP1CTL", description: "SD Comparator event filter1 Control Register", offset: "0x60", size: "16",
		bits: [
	...
	{ name: "SDCOMP1EVT2FLTCTL", description: "COMPL/CEVT2 Digital filter1 Control Register", offset: "0x61", size: "16",
		bits: [
	...
	{ name: "SDCOMP1EVT2FLTCLKCTL", description: "COMPL/CEVT2 Digital filter1 Clock Control Register", offset: "0x62", size: "16",
		bits: [
			{ name: "CLKPRESCALE", description: "Sample Clock Prescale", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "SDCOMP1EVT1FLTCTL", description: "COMPH/CEVT1 Digital filter1 Control Register", offset: "0x63", size: "16",
		bits: [
			{ name: "SAMPWIN", description: "Sample Window", size: "5", shift: "4", mask: "0x1F0" },
			{ name: "THRESH", description: "Majority Voting Threshold", size: "5", shift: "9", mask: "0x3E00" },
			{ name: "FILINIT", description: "Filter Initialization Bit", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "SDCOMP1EVT1FLTCLKCTL", description: "COMPH/CEVT1 Digital filter1 Clock Control Register", offset: "0x64", size: "16",
		bits: [
			{ name: "CLKPRESCALE", description: "Sample Clock Prescale", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "SDCOMP1LOCK", description: "SD  compartor event filter1 Lock Register", offset: "0x67", size: "16",
		bits: [
	...
	{ name: "SDCOMP2CTL", description: "SD Comparator event filter2 Control Register", offset: "0x68", size: "16",
		bits: [
			{ name: "CEVT1DIGFILTSEL", description: "High Comparator Trip Select", size: "2", shift: "2", mask: "0xC" },
			{ name: "CEVT2DIGFILTSEL", description: "Low Comparator Trip Select", size: "2", shift: "10", mask: "0xC00" },
		]
	},
	{ name: "SDCOMP2EVT2FLTCTL", description: "COMPL/CEVT2 Digital filter2 Control Register", offset: "0x69", size: "16",
		bits: [
			{ name: "SAMPWIN", description: "Sample Window", size: "5", shift: "4", mask: "0x1F0" },
			{ name: "THRESH", description: "Majority Voting Threshold", size: "5", shift: "9", mask: "0x3E00" },
			{ name: "FILINIT", description: "Filter Initialization Bit", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "SDCOMP2EVT2FLTCLKCTL", description: "COMPL/CEVT2 Digital filter2 Clock Control Register", offset: "0x6A", size: "16",
		bits: [
			{ name: "CLKPRESCALE", description: "Sample Clock Prescale", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "SDCOMP2EVT1FLTCTL", description: "COMPH/CEVT1 Digital filter2 Control Register", offset: "0x6B", size: "16",
		bits: [
			{ name: "SAMPWIN", description: "Sample Window", size: "5", shift: "4", mask: "0x1F0" },
			{ name: "THRESH", description: "Majority Voting Threshold", size: "5", shift: "9", mask: "0x3E00" },
			{ name: "FILINIT", description: "Filter Initialization Bit", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "SDCOMP2EVT1FLTCLKCTL", description: "COMPH/CEVT1 Digital filter2 Clock Control Register", offset: "0x6C", size: "16",
		bits: [
			{ name: "CLKPRESCALE", description: "Sample Clock Prescale", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "SDCOMP2LOCK", description: "SD  compartor event filter2 Lock Register", offset: "0x6F", size: "16",
		bits: [
			{ name: "SDCOMP2CTL", description: "COMPCTL Lock", size: "1", shift: "0", mask: "0x1" },
			{ name: "COMP", description: "COMPevent filter registers Lock", size: "1", shift: "3", mask: "0x8" },
		]
	},
	{ name: "SDCOMP3CTL", description: "SD Comparator event filter3 Control Register", offset: "0x70", size: "16",
		bits: [
			{ name: "CEVT1DIGFILTSEL", description: "High Comparator Trip Select", size: "2", shift: "2", mask: "0xC" },
			{ name: "CEVT2DIGFILTSEL", description: "Low Comparator Trip Select", size: "2", shift: "10", mask: "0xC00" },
		]
	},
	{ name: "SDCOMP3EVT2FLTCTL", description: "COMPL/CEVT2 Digital filter3 Control Register", offset: "0x71", size: "16",
		bits: [
			{ name: "SAMPWIN", description: "Sample Window", size: "5", shift: "4", mask: "0x1F0" },
			{ name: "THRESH", description: "Majority Voting Threshold", size: "5", shift: "9", mask: "0x3E00" },
			{ name: "FILINIT", description: "Filter Initialization Bit", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "SDCOMP3EVT2FLTCLKCTL", description: "COMPL/CEVT2 Digital filter3 Clock Control Register", offset: "0x72", size: "16",
		bits: [
			{ name: "CLKPRESCALE", description: "Sample Clock Prescale", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "SDCOMP3EVT1FLTCTL", description: "COMPH/CEVT1 Digital filter3 Control Register", offset: "0x73", size: "16",
		bits: [
			{ name: "SAMPWIN", description: "Sample Window", size: "5", shift: "4", mask: "0x1F0" },
			{ name: "THRESH", description: "Majority Voting Threshold", size: "5", shift: "9", mask: "0x3E00" },
			{ name: "FILINIT", description: "Filter Initialization Bit", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "SDCOMP3EVT1FLTCLKCTL", description: "COMPH/CEVT1 Digital filter3 Clock Control Register", offset: "0x74", size: "16",
		bits: [
			{ name: "CLKPRESCALE", description: "Sample Clock Prescale", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "SDCOMP3LOCK", description: "SD  compartor event filter3 Lock Register", offset: "0x77", size: "16",
		bits: [
			{ name: "SDCOMP3CTL", description: "COMPCTL Lock", size: "1", shift: "0", mask: "0x1" },
			{ name: "COMP", description: "COMPevent filter registers Lock", size: "1", shift: "3", mask: "0x8" },
		]
	},
	{ name: "SDCOMP4CTL", description: "SD Comparator event filter4 Control Register", offset: "0x78", size: "16",
		bits: [
			{ name: "CEVT1DIGFILTSEL", description: "High Comparator Trip Select", size: "2", shift: "2", mask: "0xC" },
			{ name: "CEVT2DIGFILTSEL", description: "Low Comparator Trip Select", size: "2", shift: "10", mask: "0xC00" },
		]
	},
	{ name: "SDCOMP4EVT2FLTCTL", description: "COMPL/CEVT2 Digital filter4 Control Register", offset: "0x79", size: "16",
		bits: [
			{ name: "SAMPWIN", description: "Sample Window", size: "5", shift: "4", mask: "0x1F0" },
			{ name: "THRESH", description: "Majority Voting Threshold", size: "5", shift: "9", mask: "0x3E00" },
			{ name: "FILINIT", description: "Filter Initialization Bit", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "SDCOMP4EVT2FLTCLKCTL", description: "COMPL/CEVT2 Digital filter4 Clock Control Register", offset: "0x7A", size: "16",
		bits: [
			{ name: "CLKPRESCALE", description: "Sample Clock Prescale", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "SDCOMP4EVT1FLTCTL", description: "COMPH/CEVT1 Digital filter4 Control Register", offset: "0x7B", size: "16",
		bits: [
			{ name: "SAMPWIN", description: "Sample Window", size: "5", shift: "4", mask: "0x1F0" },
			{ name: "THRESH", description: "Majority Voting Threshold", size: "5", shift: "9", mask: "0x3E00" },
			{ name: "FILINIT", description: "Filter Initialization Bit", size: "1", shift: "15", mask: "0x8000" },
	...
	{ name: "SDCOMP4EVT1FLTCLKCTL", description: "COMPH/CEVT1 Digital filter4 Clock Control Register", offset: "0x7C", size: "16",
		bits: [
			{ name: "CLKPRESCALE", description: "Sample Clock Prescale", size: "10", shift: "0", mask: "0x3FF" },
		]
	},
	{ name: "SDCOMP4LOCK", description: "SD  compartor event filter4 Lock Register", offset: "0x7F", size: "16",
		bits: [
