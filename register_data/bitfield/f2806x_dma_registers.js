let DMA_REGISTERS = [
	...
	{ name: "CONTROL", description: "Control Register", offset: "0x1", size: "16",
		bits: [
			...
			{ name: "SYNCFLG", description: "Sync Flag Bit", size: "1", shift: "9", mask: "0x200" },
			{ name: "SYNCERR", description: "Sync Error Flag Bit", size: "1", shift: "10", mask: "0x400" },
	...
	{ name: "BURST_COUNT", description: "Burst Count Register", offset: "0x3", size: "16",
		bits: [
			{ name: "BURSTCOUNT", description: "Burst Transfer Count", size: "5", shift: "0", mask: "0x1F" },
		]
	},
