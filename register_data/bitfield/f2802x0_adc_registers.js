let ADC_REGISTERS = [
	...
	{ name: "ADCINTFLG", description: "ADC Interrupt Flag", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "ADCINTFLGCLR", description: "ADC Interrupt Flag Clear", offset: "0x5", size: "16",
		bits: [
			{ name: "ADCINT1", description: "ADC Interrupt Flag 1", size: "1", shift: "0", mask: "0x1" },
			{ name: "ADCINT2", description: "ADC Interrupt Flag 2", size: "1", shift: "1", mask: "0x2" },
			{ name: "ADCINT3", description: "ADC Interrupt Flag 3", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "ADCINTOVF", description: "ADC Interrupt Overflow", offset: "0x6", size: "16",
		bits: [
			{ name: "ADCINT1", description: "ADC Interrupt Flag 1", size: "1", shift: "0", mask: "0x1" },
			{ name: "ADCINT2", description: "ADC Interrupt Flag 2", size: "1", shift: "1", mask: "0x2" },
			{ name: "ADCINT3", description: "ADC Interrupt Flag 3", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "SOCPRICTL", description: "ADC SOC Priority Control", offset: "0x10", size: "16",
		bits: [
			...
			{ name: "ONESHOT", description: "ONESHOT:1;", size: "1", shift: "15", mask: "0x8000" },
		]
	},
