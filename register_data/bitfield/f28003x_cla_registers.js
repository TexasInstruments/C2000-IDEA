let CLA_REGISTERS = [
	...
	{ name: "_MVECTBGRNDACTIVE", description: "Active register for MVECTBGRND.", offset: "0x1B", size: "16",
		bits: [
		]
	},
	...
	{ name: "_MSTSBGRND", description: "Status register for the back ground task.", offset: "0x1D", size: "16",
		bits: [
			{ name: "RUN", description: "Background task run status bit.", size: "1", shift: "0", mask: "0x1" },
			{ name: "_BGINTM", description: "Indicates whether background task can be interrupted.", size: "1", shift: "1", mask: "0x2" },
			{ name: "BGOVF", description: "background task harware trigger overflow.", size: "1", shift: "2", mask: "0x4" },
		]
	},
	{ name: "_MCTLBGRND", description: "Control register for the back ground task.", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "_MVECTBGRND", description: "Vector for the back ground task.", offset: "0x1F", size: "16",
		bits: [
		]
	},
	...
	{ name: "_MAR0", description: "CLA Auxiliary Register 0", offset: "0x2A", size: "16",
		bits: [
		]
	},
	{ name: "_MAR1", description: "CLA Auxiliary Register 1", offset: "0x2B", size: "16",
		bits: [
		]
	},
	{ name: "_MSTF", description: "CLA Floating-Point Status Register", offset: "0x2E", size: "32",
		bits: [
			...
			{ name: "_RPC", description: "Return PC", size: "16", shift: "12", mask: "0xFFFF000" },
		]
	},
	{ name: "_MR0", description: "CLA Floating-Point Result Register 0", offset: "0x30", size: "32",
		bits: [
		]
	},
	{ name: "_MR1", description: "CLA Floating-Point Result Register 1", offset: "0x34", size: "32",
		bits: [
		]
	},
	{ name: "_MR2", description: "CLA Floating-Point Result Register 2", offset: "0x38", size: "32",
		bits: [
		]
	},
	{ name: "_MR3", description: "CLA Floating-Point Result Register 3", offset: "0x3C", size: "32",
		bits: [
		]
	},
	{ name: "_MPSACTL", description: "CLA PSA Control Register", offset: "0x42", size: "16",
		bits: [
	...
	{ name: "_MPSA1", description: "CLA PSA1 Register", offset: "0x44", size: "32",
		bits: [
		]
	},
	{ name: "_MPSA2", description: "CLA PSA2 Register", offset: "0x46", size: "32",
		bits: [
		]
	},
	{ name: "SOFTINTEN", description: "CLA Software Interrupt Enable Register", offset: "0x0", size: "16",
		bits: [
			{ name: "TASK1", description: "Configure Software Interrupt or End of Task interrupt.", size: "1", shift: "0", mask: "0x1" },
			{ name: "TASK2", description: "Configure Software Interrupt or End of Task interrupt.", size: "1", shift: "1", mask: "0x2" },
			{ name: "TASK3", description: "Configure Software Interrupt or End of Task interrupt.", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "SOFTINTFRC", description: "CLA Software Interrupt Force Register", offset: "0x2", size: "16",
		bits: [
