let CLB_REGISTERS = [
	{ name: "CLB_COUNT_RESET", description: "Counter Block RESET", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "CLB_COUNT_MODE_1", description: "Counter Block MODE_1", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "CLB_COUNT_MODE_0", description: "Counter Block MODE_0", offset: "0x6", size: "32",
		bits: [
	...
	{ name: "CLB_COUNT_EVENT", description: "Counter Block EVENT", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "CLB_FSM_EXTRA_IN0", description: "FSM Extra EXT_IN0", offset: "0xA", size: "32",
		bits: [
	...
	{ name: "CLB_FSM_EXTERNAL_IN0", description: "FSM EXT_IN0", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "CLB_FSM_EXTERNAL_IN1", description: "FSM_EXT_IN1", offset: "0xE", size: "32",
		bits: [
	...
	{ name: "CLB_FSM_EXTRA_IN1", description: "FSM Extra_EXT_IN1", offset: "0x10", size: "32",
		bits: [
			{ name: "SEL_0", description: "FSM extra ext input select 0", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SEL_1", description: "FSM extra ext input select 1", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "SEL_2", description: "FSM extra ext input select 2", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_LUT4_IN0", description: "LUT4_0/1/2 IN0 input source", offset: "0x12", size: "32",
		bits: [
	...
	{ name: "CLB_LUT4_IN1", description: "LUT4_0/1/2 IN1 input source", offset: "0x14", size: "32",
		bits: [
			{ name: "SEL_0", description: "Select inputs for unit 0", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SEL_1", description: "Select inputs for unit 1", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "SEL_2", description: "Select inputs for unit 2", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_LUT4_IN2", description: "LUT4_0/1/2 IN2 input source", offset: "0x16", size: "32",
		bits: [
			{ name: "SEL_0", description: "Select inputs for unit 0", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SEL_1", description: "Select inputs for unit 1", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "SEL_2", description: "Select inputs for unit 2", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_LUT4_IN3", description: "LUT4_0/1/2 IN3 input source", offset: "0x18", size: "32",
		bits: [
			{ name: "SEL_0", description: "Select inputs for unit 0", size: "5", shift: "0", mask: "0x1F" },
			{ name: "SEL_1", description: "Select inputs for unit 1", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "SEL_2", description: "Select inputs for unit 2", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_FSM_LUT_FN1_0", description: "LUT function for FSM Unit 1 and Unit 0", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "CLB_FSM_LUT_FN2", description: "LUT function for FSM Unit 2", offset: "0x1E", size: "32",
		bits: [
			{ name: "FN1", description: "FSM LUT output function for unit 2", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "CLB_LUT4_FN1_0", description: "LUT function for LUT4 block of Unit 1 and 0", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "CLB_LUT4_FN2", description: "LUT function for LUT4 block of Unit 2", offset: "0x22", size: "32",
		bits: [
			{ name: "FN1", description: "LUT4 output function for unit 2", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "CLB_FSM_NEXT_STATE_0", description: "FSM Next state equations for Unit 0", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "CLB_FSM_NEXT_STATE_1", description: "FSM Next state equations for Unit 1", offset: "0x26", size: "32",
		bits: [
			{ name: "S0", description: "FSM next state function for S0", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "S1", description: "FSM next state function for S1", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "CLB_FSM_NEXT_STATE_2", description: "FSM Next state equations for Unit 2", offset: "0x28", size: "32",
		bits: [
			{ name: "S0", description: "FSM next state function for S0", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "S1", description: "FSM next state function for S1", size: "16", shift: "16", mask: "0xFFFF0000" },
		]
	},
	{ name: "CLB_MISC_CONTROL", description: "Static controls for Ctr,FSM", offset: "0x2A", size: "32",
		bits: [
	...
	{ name: "CLB_OUTPUT_LUT_0", description: "Inp Sel, LUT fns for Out0", offset: "0x2C", size: "32",
		bits: [
	...
	{ name: "CLB_OUTPUT_LUT_1", description: "Inp Sel, LUT fns for Out1", offset: "0x2E", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_OUTPUT_LUT_2", description: "Inp Sel, LUT fns for Out2", offset: "0x30", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_OUTPUT_LUT_3", description: "Inp Sel, LUT fns for Out3", offset: "0x32", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_OUTPUT_LUT_4", description: "Inp Sel, LUT fns for Out4", offset: "0x34", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_OUTPUT_LUT_5", description: "Inp Sel, LUT fns for Out5", offset: "0x36", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_OUTPUT_LUT_6", description: "Inp Sel, LUT fns for Out6", offset: "0x38", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_OUTPUT_LUT_7", description: "Inp Sel, LUT fns for Out7", offset: "0x3A", size: "32",
		bits: [
			{ name: "IN0", description: "Select value for IN0 of output LUT", size: "5", shift: "0", mask: "0x1F" },
			{ name: "IN1", description: "Select value for IN1 of output LUT", size: "5", shift: "5", mask: "0x3E0" },
			{ name: "IN2", description: "Select value for IN2 of output LUT", size: "5", shift: "10", mask: "0x7C00" },
	...
	{ name: "CLB_HLC_EVENT_SEL", description: "Event Selector register for the High Level controller", offset: "0x3C", size: "32",
		bits: [
	...
	{ name: "CLB_COUNT_MATCH_TAP_SEL", description: "Counter tap values for match1 and match2 outputs", offset: "0x3E", size: "32",
		bits: [
	...
	{ name: "CLB_OUTPUT_COND_CTRL_0", description: "Output conditioning control for output 0", offset: "0x40", size: "32",
		bits: [
	...
	{ name: "CLB_OUTPUT_COND_CTRL_1", description: "Output conditioning control for output 1", offset: "0x42", size: "32",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "CLB_OUTPUT_COND_CTRL_2", description: "Output conditioning control for output 2", offset: "0x44", size: "32",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "CLB_OUTPUT_COND_CTRL_3", description: "Output conditioning control for output 3", offset: "0x46", size: "32",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "CLB_OUTPUT_COND_CTRL_4", description: "Output conditioning control for output 4", offset: "0x48", size: "32",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "CLB_OUTPUT_COND_CTRL_5", description: "Output conditioning control for output 5", offset: "0x4A", size: "32",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "CLB_OUTPUT_COND_CTRL_6", description: "Output conditioning control for output 6", offset: "0x4C", size: "32",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "CLB_OUTPUT_COND_CTRL_7", description: "Output conditioning control for output 7", offset: "0x4E", size: "32",
		bits: [
			{ name: "LEVEL_1_SEL", description: "Level 1 Mux Select", size: "1", shift: "0", mask: "0x1" },
			{ name: "LEVEL_2_SEL", description: "Level 2 Mux Select", size: "2", shift: "1", mask: "0x6" },
			{ name: "LEVEL_3_SEL", description: "Level 3 Mux Select", size: "2", shift: "3", mask: "0x18" },
	...
	{ name: "CLB_MISC_ACCESS_CTRL", description: "Miscellaneous Access and enable control", offset: "0x50", size: "16",
		bits: [
	...
	{ name: "CLB_SPI_DATA_CTRL_HI", description: "CLB to SPI buffer control High", offset: "0x51", size: "16",
		bits: [
	...
	{ name: "CLB_LOAD_ADDR", description: "Indirect address", offset: "0x2", size: "32",
		bits: [
			{ name: "ADDR", description: "Indirect Address", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "CLB_LOAD_DATA", description: "Data for indirect loads", offset: "0x4", size: "32",
		bits: [
		]
	},
	{ name: "CLB_INPUT_FILTER", description: "Input filter selection for both edge detection and synchronizers", offset: "0x6", size: "32",
		bits: [
	...
	{ name: "CLB_IN_MUX_SEL_0", description: "Input selection to decide between Signals and GP register", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "CLB_LCL_MUX_SEL_1", description: "Input Mux selection for local mux", offset: "0xA", size: "32",
		bits: [
	...
	{ name: "CLB_LCL_MUX_SEL_2", description: "Input Mux selection for local mux", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "CLB_BUF_PTR", description: "PUSH and PULL pointers", offset: "0xE", size: "32",
		bits: [
	...
	{ name: "CLB_GP_REG", description: "General purpose register for CELL inputs", offset: "0x10", size: "32",
		bits: [
		]
	},
	{ name: "CLB_OUT_EN", description: "CELL output enable register", offset: "0x12", size: "32",
		bits: [
		]
	},
	{ name: "CLB_GLBL_MUX_SEL_1", description: "Global Mux select for CELL inputs", offset: "0x14", size: "32",
		bits: [
	...
	{ name: "CLB_GLBL_MUX_SEL_2", description: "Global Mux select for CELL inputs", offset: "0x16", size: "32",
		bits: [
	...
	{ name: "CLB_PRESCALE_CTRL", description: "Prescaler register control", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "CLB_INTR_TAG_REG", description: "Interrupt Tag register", offset: "0x20", size: "16",
		bits: [
		]
	},
	{ name: "CLB_LOCK", description: "Lock control register", offset: "0x22", size: "32",
		bits: [
	...
	{ name: "CLB_HLC_INSTR_READ_PTR", description: "HLC instruction read pointer", offset: "0x24", size: "16",
		bits: [
			{ name: "READ_PTR", description: "HLC instruction read pointer", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "CLB_HLC_INSTR_VALUE", description: "HLC instruction read value", offset: "0x26", size: "16",
		bits: [
			{ name: "INSTR", description: "HLC instruction value", size: "12", shift: "0", mask: "0xFFF" },
		]
	},
	{ name: "CLB_DBG_OUT_2", description: "Visibility for CLB inputs and final  asynchronous outputs", offset: "0x2E", size: "32",
		bits: [
	...
	{ name: "CLB_DBG_R0", description: "R0 of High level Controller", offset: "0x30", size: "32",
		bits: [
		]
	},
	{ name: "CLB_DBG_R1", description: "R1 of High level Controller", offset: "0x32", size: "32",
		bits: [
		]
	},
	{ name: "CLB_DBG_R2", description: "R2 of High level Controller", offset: "0x34", size: "32",
		bits: [
		]
	},
	{ name: "CLB_DBG_R3", description: "R3 of High level Controller", offset: "0x36", size: "32",
		bits: [
		]
	},
	{ name: "CLB_DBG_C0", description: "Count of Unit 0", offset: "0x38", size: "32",
		bits: [
		]
	},
	{ name: "CLB_DBG_C1", description: "Count of Unit 1", offset: "0x3A", size: "32",
		bits: [
		]
	},
	{ name: "CLB_DBG_C2", description: "Count of Unit 2", offset: "0x3C", size: "32",
		bits: [
		]
	},
	{ name: "CLB_DBG_OUT", description: "Outputs of various units in the Cell", offset: "0x3E", size: "32",
		bits: [
