let ECAT_SS_REGISTERS = [
	...
	{ name: "ESCSS_GPOUT_SEL", description: "GPOUT IO pad connect select", offset: "0x10", size: "32",
		bits: [
		]
	},
	{ name: "ESCSS_LED_CONFIG", description: "Selection of LED o/p connect to IO pad", offset: "0x16", size: "32",
		bits: [
	...
	{ name: "ESCSS_MISC_CONFIG", description: "Miscelleneous Configuration", offset: "0x18", size: "32",
		bits: [
