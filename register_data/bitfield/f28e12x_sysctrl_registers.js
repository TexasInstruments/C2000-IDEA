let SYSCTRL_REGISTERS = [
	{ name: "PARTIDL", description: "Lower 32-bit of Device PART Identification Number", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "REVID", description: "Device Revision Number", offset: "0x6", size: "32",
		bits: [
			{ name: "REVID", description: "Device Revision ID. This is specific to the Device", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "DC_MEMORY", description: "Device Capability: Memory Blocks Customization", offset: "0xE", size: "32",
		bits: [
	...
	{ name: "PERCNF", description: "Peripheral Configuration register - GPIO", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "TRIMERRSTS", description: "TRIM Error Status register", offset: "0x12", size: "32",
		bits: [
			{ name: "LERR", description: "TRIM Load error status", size: "16", shift: "0", mask: "0xFFFF" },
		]
	},
	{ name: "SOFTPRES_PROC_INFRA", description: "Processing and Infra Blocks Software Reset register", offset: "0x1E", size: "32",
		bits: [
	...
	{ name: "SOFTPRES_CTRL_PERIPH", description: "Control Peripherals Software Reset register", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "SOFTPRES_COMM_PERIPH", description: "Communication Peripherals Software Reset register", offset: "0x22", size: "32",
		bits: [
	...
	{ name: "ECAPTYPE", description: "Configures ECAP Type for the device", offset: "0x2A", size: "32",
		bits: [
	...
	{ name: "CLKCFGLOCK", description: "Lock bit for CLKCFG registers", offset: "0x0", size: "32",
		bits: [
			{ name: "ALL", description: "Lock bit for CLKCFG registers", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CLKSRCCTL1", description: "Clock Source Control register-1", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "CLKSRCCTL2", description: "Clock Source Control register-2", offset: "0x4", size: "32",
		bits: [
			{ name: "CANABCLKSEL", description: "CANA Bit Clock Source Select Bit", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "CLKSRCCTL3", description: "Clock Source Control register-3", offset: "0x6", size: "32",
		bits: [
			{ name: "XCLKOUTSEL", description: "XCLKOUT Source Select Bit", size: "4", shift: "0", mask: "0xF" },
		]
	},
	{ name: "SYSPLLCTL", description: "SYSPLL Control register", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "SYSPLLMULT", description: "SYSPLL Multiplier register", offset: "0xA", size: "32",
		bits: [
	...
	{ name: "SYSPLLSTS", description: "SYSPLL Status register", offset: "0xC", size: "32",
		bits: [
			{ name: "LOCKS", description: "SYSPLL Lock Status Bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SYSCLKDIVSEL", description: "System Clock Divider Select register", offset: "0xE", size: "32",
		bits: [
			{ name: "PLLSYSCLKDIV", description: "PLLSYSCLK Divide Select", size: "6", shift: "0", mask: "0x3F" },
		]
	},
	{ name: "XCLKOUTDIVSEL", description: "XCLKOUT Divider Select register", offset: "0x12", size: "32",
		bits: [
			{ name: "XCLKOUTDIV", description: "XCLKOUT Divide Select", size: "2", shift: "0", mask: "0x3" },
		]
	},
	{ name: "LOSPCP", description: "Low Speed Clock Source Prescalar", offset: "0x14", size: "32",
		bits: [
			{ name: "LSPCLKDIV", description: "LSPCLK Divide Select", size: "3", shift: "0", mask: "0x7" },
		]
	},
	{ name: "MCDCR", description: "Missing Clock Detect Control Register", offset: "0x16", size: "32",
		bits: [
	...
	{ name: "X1CNT", description: "10-bit Counter on X1 Clock", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "XTALCR", description: "XTAL Control Register", offset: "0x1A", size: "32",
		bits: [
	...
	{ name: "XTALCR2", description: "XTAL Control Register for pad init", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "CLKFAILCFG", description: "Clock Fail cause Configuration", offset: "0x1E", size: "32",
		bits: [
			{ name: "DCC0_ERROR_EN", description: "DCC0 Error causes Clock fail NMI, ERROR", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "CLKSRCSTS", description: "Clock Source Status", offset: "0x20", size: "32",
		bits: [
	...
	{ name: "CPUSYSLOCK", description: "Lock bit for CPUSYS registers", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "LPMCR", description: "LPM Control Register", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "TMR2CLKCTL", description: "Timer2 Clock Measurement functionality control register", offset: "0xE", size: "32",
		bits: [
	...
	{ name: "RESCCLR", description: "Reset Cause Clear Register", offset: "0x10", size: "32",
		bits: [
	...
	{ name: "RESC", description: "Reset Cause register", offset: "0x12", size: "32",
		bits: [
			{ name: "POR", description: "POR Reset Cause Indication Bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "XRSn", description: "XRSn Reset Cause Indication Bit", size: "1", shift: "1", mask: "0x2" },
			{ name: "WDRSn", description: "WDRSn Reset Cause Indication Bit", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "CMPSSLPMSEL", description: "CMPSS LPM Wakeup select registers", offset: "0x14", size: "32",
		bits: [
	...
	{ name: "CLKSTOPACK", description: "Peripheral Clock Stop Ackonwledge Register", offset: "0x18", size: "32",
		bits: [
			{ name: "CAN_A", description: "CAN_A Clock Stop Ack Bit", size: "1", shift: "4", mask: "0x10" },
		]
	},
	{ name: "USER_REG1_SYSRSn", description: "Software Configurable registers reset by SYSRSn", offset: "0x1A", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG2_SYSRSn", description: "Software Configurable registers reset by SYSRSn", offset: "0x1C", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG1_XRSn", description: "Software Configurable registers reset by XRSn", offset: "0x1E", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG2_XRSn", description: "Software Configurable registers reset by XRSn", offset: "0x20", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG1_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0x22", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG2_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0x24", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG3_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0x26", size: "32",
		bits: [
		]
	},
	{ name: "USER_REG4_PORESETn", description: "Software Configurable registers reset by PORESETn", offset: "0x28", size: "32",
		bits: [
		]
	},
	{ name: "PERCLKCR", description: "Peripheral Clock Control", offset: "0x3C", size: "32",
		bits: [
	...
	{ name: "DMACLASRCSELLOCK", description: "DMA/CLA Trigger Source Select Lock Register", offset: "0x0", size: "32",
		bits: [
			{ name: "ALL", description: "DMACLASRCSEL Registers Lock bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "DMACHSRCSEL1", description: "DMA Channel Trigger Source Select Register-1", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "LFU_LOCK", description: "LFU Lock Configuration", offset: "0x4", size: "32",
		bits: [
			{ name: "LFUConfig", description: "Register lock configuration", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "LFU_COMMIT", description: "LFU Commit Configuration", offset: "0x6", size: "32",
		bits: [
			{ name: "LFUConfig", description: "Register commit configuration", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "SYS_ERR_INT_FLG", description: "Status of interrupts due to multiple different errors in the system.", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "SYS_ERR_INT_CLR", description: "SYS_ERR_INT_FLG clear register", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "SYS_ERR_INT_SET", description: "SYS_ERR_INT_FLG set register", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "SYS_ERR_MASK", description: "SYS_ERR_MASK register", offset: "0x6", size: "32",
		bits: [
