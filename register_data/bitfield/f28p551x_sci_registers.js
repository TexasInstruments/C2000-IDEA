let SCI_REGISTERS = [
	...
	{ name: "SCIRXST", description: "Receive status register", offset: "0x5", size: "16",
		bits: [
	...
	{ name: "SCIRXEMU", description: "Receive emulation buffer register", offset: "0x6", size: "16",
		bits: [
			{ name: "ERXDT", description: "Receive emulation buffer data", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SCIRXBUF", description: "Receive data buffer", offset: "0x7", size: "16",
		bits: [
	...
	{ name: "SCIFFRX", description: "FIFO receive register", offset: "0xB", size: "16",
		bits: [
	...
	{ name: "SCIPRI", description: "SCI priority control", offset: "0xF", size: "16",
		bits: [
