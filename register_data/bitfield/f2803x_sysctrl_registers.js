let SYSCTRL_REGISTERS = [
	...
	{ name: "PLLSTS", description: "1: PLL Status Register", offset: "0x1", size: "16",
		bits: [
			...
			{ name: "DIVSEL", description: "DIVSEL", size: "2", shift: "7", mask: "0x180" },
	...
	{ name: "CLKCTL", description: "2: Clock Control Register", offset: "0x2", size: "16",
		bits: [
			{ name: "OSCCLKSRCSEL", description: "OSCCLKSRCSEL:1;     //0   Oscillator clock source select bit", size: "1", shift: "0", mask: "0x1" },
			{ name: "OSCCLKSRC2SEL", description: "OSCCLKSRC2SEL:1;    //1   Oscillator 2 clock source select bit", size: "1", shift: "1", mask: "0x2" },
			{ name: "WDCLKSRCSEL", description: "WDCLKSRCSEL:1;      //2   Watchdog clock source select bit", size: "1", shift: "2", mask: "0x4" },
			{ name: "TMR2CLKSRCSEL", description: "TMR2CLKSRCSEL:2;    //4:3 CPU timer 2 clock source select bit", size: "2", shift: "3", mask: "0x18" },
			{ name: "TMR2CLKPRESCALE", description: "TMR2CLKPRESCALE:3;  //7:5 CPU timer 2 clock pre-scale value", size: "3", shift: "5", mask: "0xE0" },
			{ name: "INTOSC1OFF", description: "INTOSC1OFF:1;       //8   Internal oscillator off bit", size: "1", shift: "8", mask: "0x100" },
			{ name: "INTOSC1HALTI", description: "INTOSC1HALTI:1;     //9   Internal oscillator 1 halt mode ignore bit", size: "1", shift: "9", mask: "0x200" },
			{ name: "INTOSC2OFF", description: "INTOSC2OFF:1;       //10  Internal oscillator 2 off bit", size: "1", shift: "10", mask: "0x400" },
			{ name: "INTOSC2HALTI", description: "INTOSC2HALTI:1;     //11  Internal oscillator 2 halt mode ignore bit", size: "1", shift: "11", mask: "0x800" },
			{ name: "WDHALTI", description: "WDHALTI:1;          //12  Watchdog halt mode ignore bit", size: "1", shift: "12", mask: "0x1000" },
			{ name: "XCLKINOFF", description: "XCLKINOFF:1;        //13  XCLKIN off bit", size: "1", shift: "13", mask: "0x2000" },
			{ name: "XTALOSCOFF", description: "XTALOSCOFF:1;       //14  Crystal (External) oscillator off bit", size: "1", shift: "14", mask: "0x4000" },
			{ name: "NMIRESETSEL", description: "NMIRESETSEL:1;      //15  NMI reset select bit", size: "1", shift: "15", mask: "0x8000" },
		]
	},
	...
	{ name: "PCLKCR2", description: "", offset: "0x9", size: "16",
		bits: [
			{ name: "HRCAP1ENCLK", description: "HRCAP1ENCLK:1;", size: "1", shift: "8", mask: "0x100" },
			{ name: "HRCAP2ENCLK", description: "HRCAP2ENCLK:1;", size: "1", shift: "9", mask: "0x200" },
		]
	},
	...
	{ name: "PCLKCR0", description: "", offset: "0xC", size: "16",
		bits: [
			{ name: "HRPWMENCLK", description: "Enable low speed clk to HRPWM", size: "1", shift: "0", mask: "0x1" },
			{ name: "LINAENCLK", description: "Enable low speed clk to LIN-A", size: "1", shift: "1", mask: "0x2" },
			...
			{ name: "SPIBENCLK", description: "Enable low speed clk to SPI-B", size: "1", shift: "9", mask: "0x200" },
	...
	{ name: "PCLKCR1", description: "", offset: "0xD", size: "16",
		bits: [
			...
			{ name: "EPWM7ENCLK", description: "Enable SYSCLKOUT to EPWM7", size: "1", shift: "6", mask: "0x40" },
	...
	{ name: "PCLKCR3", description: "16: Peripheral clock register", offset: "0x10", size: "16",
		bits: [
			...
			{ name: "COMP3ENCLK", description: "Enable SYSCLKOUT to COMP3", size: "1", shift: "2", mask: "0x4" },
			...
			{ name: "CPUTIMER2ENCLK", description: "Enable SYSCLKOUT to CPTIMER2", size: "1", shift: "10", mask: "0x400" },
			{ name: "CLA1ENCLK", description: "Enable SYSCLKOUT to CLA1", size: "1", shift: "14", mask: "0x4000" },
		]
	},
