let LIN_REGISTERS = [
	...
	{ name: "SCIGCR1", description: "Global Control Register 1", offset: "0x4", size: "32",
		bits: [
			...
			{ name: "TIMINGMODE", description: "SCI timing mode bit. Should be set to 1 for SCI mode.", size: "1", shift: "1", mask: "0x2" },
	...
	{ name: "SCISETINT", description: "Interrupt Enable Register", offset: "0xC", size: "32",
		bits: [
			{ name: "SETBRKDTINT", description: "Set Break-detect Interrupt (SCI compatible mode)", size: "1", shift: "0", mask: "0x1" },
			...
			{ name: "SETTOAWUSINT", description: "Set Timeout After Wakeup Signal Interrupt (LIN only)", size: "1", shift: "6", mask: "0x40" },
			{ name: "SETTOA3WUSINT", description: "Set Timeout After 3 Wakeup Signals Interrupt (LIN only)", size: "1", shift: "7", mask: "0x80" },
			...
			{ name: "SETISFEINT", description: "Set Inconsistent-Sync-Field-Error Interrupt (LIN only)", size: "1", shift: "28", mask: "0x10000000" },
	...
	{ name: "SCICLEARINT", description: "Interrupt Disable Register", offset: "0x10", size: "32",
		bits: [
			{ name: "CLRBRKDTINT", description: "Clear Break-detect Interrupt (SCI compatible mode", size: "1", shift: "0", mask: "0x1" },
			...
			{ name: "CLRTOAWUSINT", description: "Clear Timeout After Wakeup Signal Interrupt (LIN only)", size: "1", shift: "6", mask: "0x40" },
			{ name: "CLRTOA3WUSINT", description: "Clear Timeout After 3 Wakeup Signals Interrupt (LIN only)", size: "1", shift: "7", mask: "0x80" },
			...
			{ name: "CLRNREINT", description: "Clear No-Response-Error Interrupt (LIN only)", size: "1", shift: "27", mask: "0x8000000" },
			{ name: "CLRISFEINT", description: "Clear Inconsistent-Sync-Field-Error Interrupt (LIN only)", size: "1", shift: "28", mask: "0x10000000" },
			{ name: "CLRCEINT", description: "Clear Checksum-error Interrupt (LIN only)", size: "1", shift: "29", mask: "0x20000000" },
			{ name: "CLRPBEINT", description: "Clear Physical Bus Error Interrupt (LIN only)", size: "1", shift: "30", mask: "0x40000000" },
			{ name: "CLRBEINT", description: "Clear Bit Error Interrupt (LIN only)", size: "1", shift: "31", mask: "0x80000000" },
		]
	},
	{ name: "SCISETINTLVL", description: "Set Interrupt Level Register", offset: "0x14", size: "32",
		bits: [
			{ name: "SETBRKDTINTLVL", description: "Set Break-detect Interrupt Level (SCI compatible mode)", size: "1", shift: "0", mask: "0x1" },
			...
			{ name: "SETTOAWUSINTLVL", description: "Set Timeout After Wakeup Signal Interrupt Level (LIN only)", size: "1", shift: "6", mask: "0x40" },
			{ name: "SETTOA3WUSINTLVL", description: "Set Timeout After 3 Wakeup Signals Interrupt Level", size: "1", shift: "7", mask: "0x80" },
			...
			{ name: "SETNREINTLVL", description: "Set No-Response-Error Interrupt Level (LIN only)", size: "1", shift: "27", mask: "0x8000000" },
			{ name: "SETISFEINTLVL", description: "Set Inconsistent-Sync-Field-Error Interrupt Level", size: "1", shift: "28", mask: "0x10000000" },
			{ name: "SETCEINTLVL", description: "Set Checksum-error Interrupt Level (LIN only)", size: "1", shift: "29", mask: "0x20000000" },
			{ name: "SETPBEINTLVL", description: "Set Physical Bus Error Interrupt Level (LIN only)", size: "1", shift: "30", mask: "0x40000000" },
			{ name: "SETBEINTLVL", description: "Set Bit Error Interrupt Level (LIN only)", size: "1", shift: "31", mask: "0x80000000" },
		]
	},
	{ name: "SCICLEARINTLVL", description: "Clear Interrupt Level Register", offset: "0x18", size: "32",
		bits: [
			{ name: "CLRBRKDTINTLVL", description: "Clear Break-detect Interrupt Level (SCI compatible mode)", size: "1", shift: "0", mask: "0x1" },
			...
			{ name: "CLRTOAWUSINTLVL", description: "Clear Timeout After Wakeup Signal Interrupt Level (LIN only)", size: "1", shift: "6", mask: "0x40" },
			...
			{ name: "CLRIDINTLVL", description: "Clear Identifier Interrupt Level (LIN only)", size: "1", shift: "13", mask: "0x2000" },
			...
			{ name: "CLRNREINTLVL", description: "Clear No-Response-Error Interrupt Level (LIN only)", size: "1", shift: "27", mask: "0x8000000" },
			{ name: "CLRISFEINTLVL", description: "Clear Inconsistent-Sync-Field-Error", size: "1", shift: "28", mask: "0x10000000" },
			{ name: "CLRCEINTLVL", description: "Clear Checksum-error Interrupt Level (LIN only)", size: "1", shift: "29", mask: "0x20000000" },
			{ name: "CLRPBEINTLVL", description: "Clear Physical Bus Error Interrupt Level (LIN only)", size: "1", shift: "30", mask: "0x40000000" },
			{ name: "CLRBEINTLVL", description: "Clear Bit Error Interrupt Level (LIN only)", size: "1", shift: "31", mask: "0x80000000" },
		]
	},
	...
	{ name: "SCIINTVECT0", description: "Interrupt Vector Offset Register 0", offset: "0x20", size: "32",
		bits: [
			{ name: "INTVECT0", description: "LIN Module reset bit", size: "5", shift: "0", mask: "0x1F" },
		]
	},
	{ name: "SCIINTVECT1", description: "Interrupt Vector Offset Register 1", offset: "0x24", size: "32",
		bits: [
	...
	{ name: "SCIPIO0", description: "Pin control Register 0", offset: "0x3C", size: "32",
		bits: [
	...
	{ name: "SCIPIO2", description: "Pin control Register 2", offset: "0x44", size: "32",
		bits: [
	...
	{ name: "LINCOMP", description: "Compare register", offset: "0x60", size: "32",
		bits: [
	...
	{ name: "LINRD0", description: "Receive data register 0", offset: "0x64", size: "32",
		bits: [
	...
	{ name: "LINRD1", description: "Receive data register 1", offset: "0x68", size: "32",
		bits: [
	...
	{ name: "LINMASK", description: "Acceptance mask register", offset: "0x6C", size: "32",
		bits: [
	...
	{ name: "LINID", description: "LIN ID Register", offset: "0x70", size: "32",
		bits: [
			{ name: "IDBYTE", description: "LIN message ID (LIN only)", size: "8", shift: "0", mask: "0xFF" },
			{ name: "IDSLAVETASKBYTE", description: "ID  Slave Task byte (LIN only)", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "RECEIVEDID", description: "Current Message ID (LIN only)", size: "8", shift: "16", mask: "0xFF0000" },
		]
	},
	{ name: "LINTD0", description: "Transmit Data Register 0", offset: "0x74", size: "32",
		bits: [
	...
	{ name: "LINTD1", description: "Transmit Data Register 1", offset: "0x78", size: "32",
		bits: [
	...
	{ name: "MBRSR", description: "Maximum Baud Rate Selection Register", offset: "0x7C", size: "32",
		bits: [
			{ name: "MBR", description: "Received Data.", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
	{ name: "IODFTCTRL", description: "IODFT for LIN", offset: "0x90", size: "32",
		bits: [
			...
			{ name: "BRKDTERRENA", description: "Break Detect Error Enable (SCI compatibility mode)", size: "1", shift: "24", mask: "0x1000000" },
			{ name: "PERRENA", description: "Parity Error Enable (SCI compatibility mode)", size: "1", shift: "25", mask: "0x2000000" },
			{ name: "FERRENA", description: "Frame Error Enable (SCI compatibility mode)", size: "1", shift: "26", mask: "0x4000000" },
			{ name: "ISFERRENA", description: "Inconsistent Sync Field Error Enable (LIN mode)", size: "1", shift: "28", mask: "0x10000000" },
	...
	{ name: "LIN_GLB_INT_EN", description: "LIN Global Interrupt Enable Register", offset: "0xE0", size: "32",
		bits: [
	...
	{ name: "LIN_GLB_INT_FLG", description: "LIN Global Interrupt Flag Register", offset: "0xE4", size: "32",
		bits: [
	...
	{ name: "LIN_GLB_INT_CLR", description: "LIN Global Interrupt Clear Register", offset: "0xE8", size: "32",
		bits: [
