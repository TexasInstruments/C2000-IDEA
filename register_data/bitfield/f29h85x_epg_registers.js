let EPG_REGISTERS = [
	...
	{ name: "CLKDIV0_CTL0", description: "Clock divider 0's control register 0", offset: "0x1C", size: "32",
		bits: [
	...
	{ name: "CLKDIV0_CLKOFFSET", description: "Clock divider 0's clock offset value", offset: "0x26", size: "32",
		bits: [
	...
	{ name: "CLKDIV1_CTL0", description: "Clock divider 1's control register 0", offset: "0x30", size: "32",
		bits: [
			{ name: "PRD", description: "Clock divider value", size: "16", shift: "0", mask: "0xFFFF" },
			{ name: "CLKSTOP", description: "Clock Stop Configuration", size: "3", shift: "16", mask: "0x70000" },
		]
	},
	{ name: "CLKDIV1_CLKOFFSET", description: "Clock divider 1's clock offset value", offset: "0x3A", size: "32",
		bits: [
			{ name: "CLK0OFFSET", description: "Clock output 0 offset delay value.", size: "8", shift: "0", mask: "0xFF" },
			{ name: "CLK1OFFSET", description: "Clock output 0 offset delay value.", size: "8", shift: "8", mask: "0xFF00" },
			{ name: "CLK2OFFSET", description: "Clock output 0 offset delay value.", size: "8", shift: "16", mask: "0xFF0000" },
	...
	{ name: "SIGGEN0_CTL0", description: "Signal generator 0's control register 0", offset: "0x44", size: "32",
		bits: [
	...
	{ name: "SIGGEN0_CTL1", description: "Signal generator 0's control register 1", offset: "0x46", size: "32",
		bits: [
	...
	{ name: "SIGGEN0_DATA0", description: "Signal generator 0's data register 0", offset: "0x50", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA1", description: "Signal generator 0's data register 1", offset: "0x52", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA0_ACTIVE", description: "Signal generator 0's data active register 0", offset: "0x54", size: "32",
		bits: [
		]
	},
	{ name: "SIGGEN0_DATA1_ACTIVE", description: "Signal generator 0's data active register 1", offset: "0x56", size: "32",
		bits: [
		]
	},
	{ name: "REVISION", description: "IP Revision tie-off value", offset: "0x78", size: "32",
		bits: [
	...
	{ name: "EPGMXSELLOCK", description: "EPG Mux select register lock", offset: "0x16", size: "32",
		bits: [
			{ name: "EPGMXSEL0", description: "EPGMXSEL0 lock bit", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "EPGMXSELCOMMIT", description: "EPG Mux select register commit", offset: "0x18", size: "32",
		bits: [
