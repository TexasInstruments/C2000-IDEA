let ECAP_REGISTERS = [
	...
	{ name: "CTRPHS", description: "Counter Phase Offset Value Register", offset: "0x2", size: "32",
		bits: [
		]
	},
	{ name: "CAP1", description: "Capture 1 Register", offset: "0x4", size: "32",
		bits: [
		]
	},
	{ name: "CAP2", description: "Capture 2 Register", offset: "0x6", size: "32",
		bits: [
		]
	},
	{ name: "CAP3", description: "Capture 3 Register", offset: "0x8", size: "32",
		bits: [
		]
	},
	{ name: "CAP4", description: "Capture 4 Register", offset: "0xA", size: "32",
		bits: [
		]
	},
	{ name: "ECCTL0", description: "Capture Control Register 0", offset: "0x18", size: "32",
		bits: [
	...
	{ name: "ECCTL1", description: "Capture Control Register 1", offset: "0x1A", size: "16",
		bits: [
	...
	{ name: "ECCTL2", description: "Capture Control Register 2", offset: "0x1B", size: "16",
		bits: [
	...
	{ name: "ECEINT", description: "Capture Interrupt Enable Register", offset: "0x1C", size: "16",
		bits: [
	...
	{ name: "ECFLG", description: "Capture Interrupt Flag Register", offset: "0x1D", size: "16",
		bits: [
	...
	{ name: "ECCLR", description: "Capture Interrupt Clear Register", offset: "0x1E", size: "16",
		bits: [
	...
	{ name: "ECFRC", description: "Capture Interrupt Force Register", offset: "0x1F", size: "16",
		bits: [
	...
	{ name: "ECAPSYNCINSEL", description: "SYNC source select register", offset: "0x28", size: "32",
		bits: [
			{ name: "SEL", description: "SYNCIN source select", size: "7", shift: "0", mask: "0x7F" },
		]
	},
	{ name: "HRCTL", description: "High-Res Control Register", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "HRINTEN", description: "High-Res Calibration Interrupt Enable Register", offset: "0x6", size: "32",
		bits: [
	...
	{ name: "HRFLG", description: "High-Res Calibration Interrupt Flag Register", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "HRCLR", description: "High-Res Calibration Interrupt Clear Register", offset: "0xA", size: "32",
		bits: [
	...
	{ name: "HRFRC", description: "High-Res Calibration Interrupt Force Register", offset: "0xC", size: "32",
		bits: [
	...
	{ name: "HRCALPRD", description: "High-Res Calibration Period Register", offset: "0xE", size: "32",
		bits: [
		]
	},
	{ name: "HRSYSCLKCTR", description: "High-Res Calibration SYSCLK Counter Register", offset: "0x10", size: "32",
		bits: [
		]
	},
	{ name: "HRSYSCLKCAP", description: "High-Res Calibration SYSCLK Capture Register", offset: "0x12", size: "32",
		bits: [
		]
	},
	{ name: "HRCLKCTR", description: "High-Res Calibration HRCLK Counter Register", offset: "0x14", size: "32",
		bits: [
		]
	},
	{ name: "HRCLKCAP", description: "High-Res Calibration HRCLK Capture Register", offset: "0x16", size: "32",
		bits: [
		]
	},
];
