let PGA_REGISTERS = [
	{ name: "PGACTL", description: "PGA Control Register", offset: "0x0", size: "16",
		bits: [
	...
	{ name: "MUXSEL", description: "Mux Selection Register", offset: "0x1", size: "16",
		bits: [
			{ name: "PMUXSEL", description: "Positive Input Mux Select", size: "2", shift: "0", mask: "0x3" },
			{ name: "NMUXSEL", description: "Negative Input Mux Select", size: "3", shift: "4", mask: "0x70" },
			{ name: "MMUXSEL", description: "M Mux Select", size: "3", shift: "8", mask: "0x700" },
	...
	{ name: "OFFSETTRIM", description: "Offset Trim Register", offset: "0x2", size: "32",
		bits: [
	...
	{ name: "PGATYPE", description: "PGA Type Register", offset: "0x5", size: "16",
		bits: [
	...
	{ name: "PGALOCK", description: "PGA Lock Register", offset: "0x6", size: "16",
		bits: [
