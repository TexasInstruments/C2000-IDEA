let SPI_REGISTERS = [
	...
	{ name: "SPIBRR", description: "SPI Baud Rate Register", offset: "0x5", size: "16",
		bits: [
			{ name: "SPI_BIT_RATE", description: "SPI Bit Rate Control", size: "7", shift: "0", mask: "0x7F" },
		]
	},
	{ name: "SPIRXEMU", description: "SPI Emulation Buffer Register", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "SPIRXBUF", description: "SPI Serial Input Buffer Register", offset: "0x9", size: "16",
		bits: [
		]
	},
	{ name: "SPITXBUF", description: "SPI Serial Output Buffer Register", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "SPIDAT", description: "SPI Serial Data Register", offset: "0xB", size: "16",
		bits: [
		]
	},
	{ name: "SPIFFTX", description: "SPI FIFO Transmit Register", offset: "0xC", size: "16",
		bits: [
	...
	{ name: "SPIFFRX", description: "SPI FIFO Receive Register", offset: "0xD", size: "16",
		bits: [
	...
	{ name: "SPIFFCT", description: "SPI FIFO Control Register", offset: "0xE", size: "16",
		bits: [
			{ name: "TXDLY", description: "FIFO Transmit Delay Bits", size: "8", shift: "0", mask: "0xFF" },
		]
	},
	{ name: "SPIPRI", description: "SPI Priority Control Register", offset: "0x13", size: "16",
		bits: [
