let ICL_XBAR_REGISTERS = [
	{ name: "ICLXBARG0SEL", description: "ICLXBAR G0 Input Select", offset: "0x0", size: "32",
		bits: [
	...
	{ name: "ICLXBARG1SEL", description: "ICLXBAR G1 Input Select", offset: "0x2", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "ICLXBARG2SEL", description: "ICLXBAR G2 Input Select", offset: "0x4", size: "32",
		bits: [
			{ name: "INPUT0", description: "Select bit for INPUT0", size: "1", shift: "0", mask: "0x1" },
			{ name: "INPUT1", description: "Select bit for INPUT1", size: "1", shift: "1", mask: "0x2" },
			{ name: "INPUT2", description: "Select bit for INPUT2", size: "1", shift: "2", mask: "0x4" },
	...
	{ name: "ICLXBAROutInvert", description: "Output Signal Invert Select", offset: "0x30", size: "32",
		bits: [
	...
	{ name: "ICLXBARLock", description: "Configuration Lock register", offset: "0x7E", size: "32",
		bits: [
