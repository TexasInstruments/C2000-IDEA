let ECAP_REGISTERS = [
	...
	{ name: "ECCTL0", description: "Capture Control Register 0", offset: "0x12", size: "32",
		bits: [
	...
	{ name: "ECAPSYNCINSEL", description: "SYNC source select register", offset: "0x1E", size: "32",
		bits: [
	...
	{ name: "HRINTEN", description: "High-Res Calibration Interrupt Enable Register", offset: "0x4", size: "32",
		bits: [
	...
	{ name: "HRFLG", description: "High-Res Calibration Interrupt Flag Register", offset: "0x6", size: "32",
		bits: [
	...
	{ name: "HRCLR", description: "High-Res Calibration Interrupt Clear Register", offset: "0x8", size: "32",
		bits: [
	...
	{ name: "HRFRC", description: "High-Res Calibration Interrupt Force Register", offset: "0xA", size: "32",
		bits: [
	...
	{ name: "HRCALPRD", description: "High-Res Calibration Period Register", offset: "0xC", size: "32",
		bits: [
		]
	},
	{ name: "HRSYSCLKCTR", description: "High-Res Calibration SYSCLK Counter Register", offset: "0xE", size: "32",
		bits: [
		]
	},
	{ name: "HRSYSCLKCAP", description: "High-Res Calibration SYSCLK Capture Register", offset: "0x10", size: "32",
		bits: [
		]
	},
	{ name: "HRCLKCTR", description: "High-Res Calibration HRCLK Counter Register", offset: "0x12", size: "32",
		bits: [
		]
	},
	{ name: "HRCLKCAP", description: "High-Res Calibration HRCLK Capture Register", offset: "0x14", size: "32",
		bits: [
		]
	},
];
