let CMPSS_REGISTERS = [
	...
	{ name: "COMPHYSCTL", description: "CMPSS Comparator Hysteresis Control Register", offset: "0x1", size: "16",
		bits: [
			{ name: "COMPHYS", description: "Comparator Hysteresis Trim", size: "3", shift: "0", mask: "0x7" },
		]
	},
	...
	{ name: "COMPDACCTL", description: "CMPSS DAC Control Register", offset: "0x4", size: "16",
		bits: [
	...
	{ name: "RAMPMAXREFA", description: "CMPSS Ramp Max Reference Active Register", offset: "0x8", size: "16",
		bits: [
		]
	},
	{ name: "RAMPMAXREFS", description: "CMPSS Ramp Max Reference Shadow Register", offset: "0xA", size: "16",
		bits: [
		]
	},
	{ name: "RAMPDECVALA", description: "CMPSS Ramp Decrement Value Active Register", offset: "0xC", size: "16",
		bits: [
		]
	},
	{ name: "RAMPDECVALS", description: "CMPSS Ramp Decrement Value Shadow Register", offset: "0xE", size: "16",
		bits: [
		]
	},
	{ name: "RAMPSTS", description: "CMPSS Ramp Status Register", offset: "0x10", size: "16",
		bits: [
		]
	},
	...
	{ name: "RAMPDLYA", description: "CMPSS Ramp Delay Active Register", offset: "0x14", size: "16",
		bits: [
			{ name: "DELAY", description: "Ramp Delay Value", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
	{ name: "RAMPDLYS", description: "CMPSS Ramp Delay Shadow Register", offset: "0x15", size: "16",
		bits: [
			{ name: "DELAY", description: "Ramp Delay Value", size: "13", shift: "0", mask: "0x1FFF" },
		]
	},
