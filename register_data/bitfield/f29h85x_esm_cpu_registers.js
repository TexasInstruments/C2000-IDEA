let ESM_CPU_REGISTERS = [
	...
	{ name: "PIN_CTRL", description: "Error Pin Control Register", offset: "0x2E", size: "32",
		bits: [
			{ name: "polarity", description: "11:8", size: "4", shift: "0", mask: "0xF" },
			{ name: "pwm_en", description: "7:4", size: "4", shift: "4", mask: "0xF0" },
			{ name: "key", description: "3:0", size: "4", shift: "8", mask: "0xF00" },
		]
	},
	...
	{ name: "HI_PRI_WD_CFG", description: "High Priority Watchdog Config Register", offset: "0x5E", size: "32",
		bits: [
			{ name: "wd_en", description: "3:0", size: "4", shift: "0", mask: "0xF" },
			{ name: "emu_free", description: "11:8", size: "4", shift: "8", mask: "0xF00" },
		]
	},
	{ name: "HI_PRI_WD_CNTR", description: "High Priority Watchdog Counter Value Register", offset: "0x60", size: "32",
		bits: [
		]
	},
	{ name: "HI_PRI_WD_CNTR_PRE", description: "High Priority Watchdog Pre-Load Register", offset: "0x62", size: "32",
		bits: [
		]
	},
	{ name: "HI_PRI_WD_INTR_SET", description: "High Priority Watchdog Interrupt Status/Set Register", offset: "0x64", size: "32",
		bits: [
			{ name: "val", description: "0", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "HI_PRI_WD_INTR_CLR", description: "High Priority Watchdog Interrupt Status/Clear Register", offset: "0x66", size: "32",
		bits: [
			{ name: "val", description: "0", size: "1", shift: "0", mask: "0x1" },
		]
	},
	{ name: "GROUP_N_LOCK", description: "Group N Interrupt Lock Register", offset: "0xD4", size: "32",
		bits: [
		]
	},
	{ name: "GROUP_N_COMMIT", description: "Group N Interrupt Commit Register", offset: "0xD6", size: "32",
		bits: [
		]
	},
	{ name: "ERR_PIN_INFLUENCE_LOCK", description: "Error Pin Influence Lock Register", offset: "0xE0", size: "32",
		bits: [
		]
	},
	{ name: "ERR_PIN_INFLUENCE_COMMIT", description: "Error Pin Influence Commit Register", offset: "0xE2", size: "32",
		bits: [
		]
	},
	{ name: "CRI_PRI_INFLUENCE_LOCK", description: "Critical Prioirty Interrupt Influence Lock Register", offset: "0xE4", size: "32",
		bits: [
		]
	},
	{ name: "CRI_PRI_INFLUENCE_COMMIT", description: "Critical Priority Interrupt Influence Lock Register", offset: "0xE6", size: "32",
		bits: [
		]
	},
	{ name: "MMR_CONFIG_LOCK", description: "MMR Config Lock Register", offset: "0xE8", size: "32",
		bits: [
	...
	{ name: "MMR_CONFIG_COMMIT", description: "MMR Config Commit Register", offset: "0xEA", size: "32",
		bits: [
...
module.exports = {
	esm_cpuRegisters: ESM_CPU_REGISTERS,
}
