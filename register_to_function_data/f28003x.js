let REGISTER_TO_FUNCTION = 
{
    ...
    "ERR_POS": [
        ...
        "Flash_clearLowErrorType",
        "Flash_clearHighErrorType"
    ],
    "ERR_STATUS_CLR": [
        "Flash_clearLowErrorStatus",
        "Flash_clearHighErrorStatus"
    ...
    "BASESEL": [
        ...
        "HIC_getSelectedBaseAddressIndex"
    ],
    "HOSTCR": [
        "HIC_configureHostAccessMode",
        "HIC_getHostAccessMode"
    ],
    "ERRADDR": [
        "HIC_getErrorAddress"
    ],
    ...
    "H2DINTEN": [
        "HIC_enableH2DInterrupt",
        "HIC_disableH2DInterrupt"
    ],
    "H2DINTFLG": [
        "HIC_getH2DInterruptStatus"
    ],
    "H2DINTCLR": [
        "HIC_clearH2DInterrupt"
    ],
    "H2DINTFRC": [
        "HIC_forceH2DInterrupt"
    ],
    "D2HINTEN": [
        "HIC_enableD2HInterrupt",
        "HIC_disableD2HInterrupt"
    ],
    "D2HINTFLG": [
        "HIC_getD2HInterruptStatus"
    ],
    "D2HINTCLR": [
        "HIC_clearD2HInterrupt"
    ],
    "D2HINTFRC": [
        "HIC_forceD2HInterrupt"
    ],
    "ACCVIOADDR": [
        "HIC_getAccessViolationAddress"
    ],
    "H2D_BUF0": [
        "HIC_readH2DBuffer",
        "HIC_writeH2DBuffer",
